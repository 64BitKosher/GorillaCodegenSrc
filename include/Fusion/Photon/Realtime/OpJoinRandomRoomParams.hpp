...
NEED_NO_BOX(::Fusion::Photon::Realtime::OpJoinRandomRoomParams);
DEFINE_IL2CPP_ARG_TYPE(::Fusion::Photon::Realtime::OpJoinRandomRoomParams*, "Fusion.Photon.Realtime", "OpJoinRandomRoomParams");
// Type namespace: Fusion.Photon.Realtime
namespace Fusion::Photon::Realtime {
  // Size: 0x38
  #pragma pack(push, 1)
  // Autogenerated type: Fusion.Photon.Realtime.OpJoinRandomRoomParams
  ...
  class OpJoinRandomRoomParams : public ::Il2CppObject {
    ...
    // public Fusion.Photon.Realtime.MatchmakingMode MatchingType
    // Size: 0x1
    // Offset: 0x19
    ::Fusion::Photon::Realtime::MatchmakingMode MatchingType;
    // Field size check
    static_assert(sizeof(::Fusion::Photon::Realtime::MatchmakingMode) == 0x1);
    // Padding between fields: MatchingType and: TypedLobby
    char __padding2[0x6] = {};
    // public Fusion.Photon.Realtime.TypedLobby TypedLobby
    // Size: 0x8
    // Offset: 0x20
    ::Fusion::Photon::Realtime::TypedLobby* TypedLobby;
    // Field size check
    ...
    // Get instance field reference: public Fusion.Photon.Realtime.MatchmakingMode MatchingType
    [[deprecated("Use field access instead!")]] ::Fusion::Photon::Realtime::MatchmakingMode& dyn_MatchingType();
    // Get instance field reference: public Fusion.Photon.Realtime.TypedLobby TypedLobby
    [[deprecated("Use field access instead!")]] ::Fusion::Photon::Realtime::TypedLobby*& dyn_TypedLobby();
    ...
    static OpJoinRandomRoomParams* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Fusion::Photon::Realtime::OpJoinRandomRoomParams::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OpJoinRandomRoomParams*, creationType>()));
    }
  }; // Fusion.Photon.Realtime.OpJoinRandomRoomParams
  #pragma pack(pop)
  static check_size<sizeof(OpJoinRandomRoomParams), 48 + sizeof(::ArrayW<::StringW>)> __Fusion_Photon_Realtime_OpJoinRandomRoomParamsSizeCheck;
  static_assert(sizeof(OpJoinRandomRoomParams) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Fusion::Photon::Realtime::OpJoinRandomRoomParams::New_ctor
// Il2CppName: .ctor

...
NEED_NO_BOX(::Fusion::Photon::Realtime::OperationCode);
DEFINE_IL2CPP_ARG_TYPE(::Fusion::Photon::Realtime::OperationCode*, "Fusion.Photon.Realtime", "OperationCode");
// Type namespace: Fusion.Photon.Realtime
namespace Fusion::Photon::Realtime {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: Fusion.Photon.Realtime.OperationCode
  ...
  class OperationCode : public ::Il2CppObject {
    ...
    static OperationCode* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Fusion::Photon::Realtime::OperationCode::.ctor");
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Fusion::Photon::Realtime::OperationCode::New_ctor
// Il2CppName: .ctor

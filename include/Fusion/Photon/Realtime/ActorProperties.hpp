...
NEED_NO_BOX(::Fusion::Photon::Realtime::ActorProperties);
DEFINE_IL2CPP_ARG_TYPE(::Fusion::Photon::Realtime::ActorProperties*, "Fusion.Photon.Realtime", "ActorProperties");
// Type namespace: Fusion.Photon.Realtime
namespace Fusion::Photon::Realtime {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: Fusion.Photon.Realtime.ActorProperties
  ...
  class ActorProperties : public ::Il2CppObject {
    ...
    static ActorProperties* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Fusion::Photon::Realtime::ActorProperties::.ctor");
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Fusion::Photon::Realtime::ActorProperties::New_ctor
// Il2CppName: .ctor

...
NEED_NO_BOX(::GorillaLocomotion::Gameplay::NoncontrollableBroomstick);
DEFINE_IL2CPP_ARG_TYPE(::GorillaLocomotion::Gameplay::NoncontrollableBroomstick*, "GorillaLocomotion.Gameplay", "NoncontrollableBroomstick");
// Type namespace: GorillaLocomotion.Gameplay
namespace GorillaLocomotion::Gameplay {
  // Size: 0x71
  #pragma pack(push, 1)
  // Autogenerated type: GorillaLocomotion.Gameplay.NoncontrollableBroomstick
  // [TokenAttribute] Offset: FFFFFFFF
  class NoncontrollableBroomstick : public ::Photon::Pun::MonoBehaviourPun/*, public ::GorillaLocomotion::Gameplay::IGorillaGrabable, public ::Photon::Pun::IPunObservable*/ {
    public:
    public:
    ...
    static NoncontrollableBroomstick* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GorillaLocomotion::Gameplay::NoncontrollableBroomstick::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NoncontrollableBroomstick*, creationType>()));
    }
  }; // GorillaLocomotion.Gameplay.NoncontrollableBroomstick
  #pragma pack(pop)
  static check_size<sizeof(NoncontrollableBroomstick), 112 + sizeof(bool)> __GorillaLocomotion_Gameplay_NoncontrollableBroomstickSizeCheck;
  static_assert(sizeof(NoncontrollableBroomstick) == 0x71);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::Awake
// Il2CppName: Awake
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)()>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::Awake)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "Awake", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::Update
// Il2CppName: Update
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)()>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::Update)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "Update", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::OnPhotonSerializeView
// Il2CppName: OnPhotonSerializeView
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)(::Photon::Pun::PhotonStream*, ::Photon::Pun::PhotonMessageInfo)>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::OnPhotonSerializeView)> {
  static const MethodInfo* get() {
    static auto* stream = &::il2cpp_utils::GetClassFromName("Photon.Pun", "PhotonStream")->byval_arg;
    static auto* info = &::il2cpp_utils::GetClassFromName("Photon.Pun", "PhotonMessageInfo")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "OnPhotonSerializeView", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stream, info});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GetProgress
// Il2CppName: GetProgress
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)()>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GetProgress)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "GetProgress", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GetCurrentSpeed
// Il2CppName: GetCurrentSpeed
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)()>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GetCurrentSpeed)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "GetCurrentSpeed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GorillaLocomotion_Gameplay_IGorillaGrabable_OnGrabbed
// Il2CppName: GorillaLocomotion.Gameplay.IGorillaGrabable.OnGrabbed
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Transform* (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)(::GlobalNamespace::GorillaGrabber*)>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GorillaLocomotion_Gameplay_IGorillaGrabable_OnGrabbed)> {
  static const MethodInfo* get() {
    static auto* g = &::il2cpp_utils::GetClassFromName("", "GorillaGrabber")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "GorillaLocomotion.Gameplay.IGorillaGrabable.OnGrabbed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{g});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GorillaLocomotion_Gameplay_IGorillaGrabable_OnGrabReleased
// Il2CppName: GorillaLocomotion.Gameplay.IGorillaGrabable.OnGrabReleased
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Transform* (GorillaLocomotion::Gameplay::NoncontrollableBroomstick::*)(::GlobalNamespace::GorillaGrabber*)>(&GorillaLocomotion::Gameplay::NoncontrollableBroomstick::GorillaLocomotion_Gameplay_IGorillaGrabable_OnGrabReleased)> {
  static const MethodInfo* get() {
    static auto* g = &::il2cpp_utils::GetClassFromName("", "GorillaGrabber")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GorillaLocomotion::Gameplay::NoncontrollableBroomstick*), "GorillaLocomotion.Gameplay.IGorillaGrabable.OnGrabReleased", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{g});
  }
};
// Writing MetadataGetter for method: GorillaLocomotion::Gameplay::NoncontrollableBroomstick::New_ctor
// Il2CppName: .ctor

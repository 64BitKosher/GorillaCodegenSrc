...
namespace System {
  ...
  class Exception : public ::Il2CppObject/*, public ::System::Runtime::Serialization::ISerializable*/ {
    public:
    ...
    // private System.Int32 caught_in_unmanaged
    // Size: 0x4
    // Offset: 0x88
    ...
    // Get instance field reference: private System.Int32 caught_in_unmanaged
    [[deprecated("Use field access instead!")]] int& dyn_caught_in_unmanaged();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Exception), 136 + sizeof(int)> __System_ExceptionSizeCheck;
  static_assert(sizeof(Exception) == 0x8C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::NullConsoleDriver::set_ForegroundColor
// Il2CppName: set_ForegroundColor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::NullConsoleDriver::*)(::System::ConsoleColor)>(&System::NullConsoleDriver::set_ForegroundColor)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "ConsoleColor")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::NullConsoleDriver*), "set_ForegroundColor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: System::NullConsoleDriver::ResetColor
// Il2CppName: ResetColor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::NullConsoleDriver::*)()>(&System::NullConsoleDriver::ResetColor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::NullConsoleDriver*), "ResetColor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

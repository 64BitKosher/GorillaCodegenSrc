...
namespace System::Runtime::Remoting {
  ...
  class RemotingConfiguration : public ::Il2CppObject {
    ...
    static ::System::Runtime::Remoting::CustomErrorsModes _get__errorMode();
    // Set static field: static private System.Runtime.Remoting.CustomErrorsModes _errorMode
    static void _set__errorMode(::System::Runtime::Remoting::CustomErrorsModes value);
    ...
    // static public System.Boolean IsActivationAllowed(System.Type svrType)
    // Offset: 0x4524468
...
// Writing MetadataGetter for method: System::Runtime::Remoting::RemotingConfiguration::IsActivationAllowed
// Il2CppName: IsActivationAllowed
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::System::Type*)>(&System::Runtime::Remoting::RemotingConfiguration::IsActivationAllowed)> {
  static const MethodInfo* get() {
    static auto* svrType = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Runtime::Remoting::RemotingConfiguration*), "IsActivationAllowed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{svrType});
  }
};

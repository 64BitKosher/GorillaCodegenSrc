...
namespace System::Runtime::Serialization {
  ...
  class FormatterConverter : public ::Il2CppObject/*, public ::System::Runtime::Serialization::IFormatterConverter*/ {
    ...
    // static private System.Void ThrowValueNullException()
    // Offset: 0x45509A4
...
// Writing MetadataGetter for method: System::Runtime::Serialization::FormatterConverter::ThrowValueNullException
// Il2CppName: ThrowValueNullException
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&System::Runtime::Serialization::FormatterConverter::ThrowValueNullException)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Runtime::Serialization::FormatterConverter*), "ThrowValueNullException", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

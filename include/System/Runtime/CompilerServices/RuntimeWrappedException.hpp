...
namespace System::Runtime::CompilerServices {
  ...
  class RuntimeWrappedException : public ::System::Exception {
    ...
    public:
    // private System.Object _wrappedException
    // Size: 0x8
    // Offset: 0x90
    ::Il2CppObject* wrappedException;
    // Field size check
    ...
    // Get instance field reference: private System.Object _wrappedException
    [[deprecated("Use field access instead!")]] ::Il2CppObject*& dyn__wrappedException();
    // public System.Void .ctor(System.Object thrownObject)
    // Offset: 0x4577520
  ...
  #pragma pack(pop)
  static check_size<sizeof(RuntimeWrappedException), 144 + sizeof(::Il2CppObject*)> __System_Runtime_CompilerServices_RuntimeWrappedExceptionSizeCheck;
  static_assert(sizeof(RuntimeWrappedException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

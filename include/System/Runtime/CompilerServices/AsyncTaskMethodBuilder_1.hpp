...
namespace System::Runtime::CompilerServices {
  ...
  struct AsyncTaskMethodBuilder_1/*, public ::System::ValueType*/ {
    ...
    // static System.Threading.Tasks.Task`1<TResult> GetTaskForResult(TResult result)
    // Offset: 0xFFFFFFFFFFFFFFFF
    static ::System::Threading::Tasks::Task_1<TResult>* GetTaskForResult(TResult result) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<AsyncTaskMethodBuilder_1<TResult>>::get(), "GetTaskForResult", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(result)})));
      return ::il2cpp_utils::RunMethodRethrow<::System::Threading::Tasks::Task_1<TResult>*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, result);
    }

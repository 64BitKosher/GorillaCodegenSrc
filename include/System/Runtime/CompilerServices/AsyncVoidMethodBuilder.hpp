...
namespace System::Runtime::CompilerServices {
  ...
  struct AsyncVoidMethodBuilder/*, public ::System::ValueType*/ {
    ...
    void AwaitOnCompleted(ByRef<TAwaiter> awaiter, ByRef<TStateMachine> stateMachine) {
      ...
      static_assert(std::is_convertible_v<std::remove_pointer_t<TStateMachine>, ::System::Runtime::CompilerServices::IAsyncStateMachine>);
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Runtime::CompilerServices::AsyncVoidMethodBuilder::AwaitOnCompleted");
...
// Writing MetadataGetter for method: System::Runtime::CompilerServices::AsyncVoidMethodBuilder::AwaitOnCompleted

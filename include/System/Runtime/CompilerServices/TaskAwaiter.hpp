...
namespace System::Runtime::CompilerServices {
  ...
  struct TaskAwaiter/*, public ::System::ValueType, public ::System::Runtime::CompilerServices::ICriticalNotifyCompletion*/ {
    public:
    // Nested type: ::System::Runtime::CompilerServices::TaskAwaiter::$$c__DisplayClass11_0
    ...
    // static private System.Action OutputWaitEtwEvents(System.Threading.Tasks.Task task, System.Action continuation)
    // Offset: 0x45780DC
...
// Writing MetadataGetter for method: System::Runtime::CompilerServices::TaskAwaiter::OutputWaitEtwEvents
// Il2CppName: OutputWaitEtwEvents
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Action* (*)(::System::Threading::Tasks::Task*, ::System::Action*)>(&System::Runtime::CompilerServices::TaskAwaiter::OutputWaitEtwEvents)> {
  static const MethodInfo* get() {
    static auto* task = &::il2cpp_utils::GetClassFromName("System.Threading.Tasks", "Task")->byval_arg;
    static auto* continuation = &::il2cpp_utils::GetClassFromName("System", "Action")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Runtime::CompilerServices::TaskAwaiter), "OutputWaitEtwEvents", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{task, continuation});
  }
};

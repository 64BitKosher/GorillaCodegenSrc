...
namespace System::Runtime::CompilerServices {
  ...
  class StateMachineAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.Type <StateMachineType>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ...
    // Get instance field reference: private readonly System.Type <StateMachineType>k__BackingField
    ...
    // public System.Type get_StateMachineType()
    // Offset: 0x45777DC
...
// Writing MetadataGetter for method: System::Runtime::CompilerServices::StateMachineAttribute::get_StateMachineType
// Il2CppName: get_StateMachineType
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (System::Runtime::CompilerServices::StateMachineAttribute::*)()>(&System::Runtime::CompilerServices::StateMachineAttribute::get_StateMachineType)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Runtime::CompilerServices::StateMachineAttribute*), "get_StateMachineType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

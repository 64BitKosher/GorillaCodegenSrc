...
namespace System::Runtime::CompilerServices {
  ...
  class NullableAttribute : public ::System::Attribute {
    ...
    static NullableAttribute* New_ctor(uint8_t param_0) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Runtime::CompilerServices::NullableAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NullableAttribute*, creationType>(param_0)));
    }
    // public System.Void .ctor(System.Byte[] )
    // Offset: 0x2680754
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static NullableAttribute* New_ctor(::ArrayW<uint8_t> param_0) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Runtime::CompilerServices::NullableAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NullableAttribute*, creationType>(param_0)));
    }

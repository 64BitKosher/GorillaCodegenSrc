...
namespace System::Runtime::CompilerServices {
  ...
  class CallSiteBinder : public ::Il2CppObject {
    ...
    // static private System.Linq.Expressions.Expression`1<T> Stitch(System.Linq.Expressions.Expression binding, System.Runtime.CompilerServices.CallSiteBinder/LambdaSignature`1<T> signature)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class T>

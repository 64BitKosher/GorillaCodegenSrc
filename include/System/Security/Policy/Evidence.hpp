...
// Writing MetadataGetter for method: System::Security::Policy::Evidence::get_IsSynchronized
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Security::Policy::Evidence::*)()>(&System::Security::Policy::Evidence::get_IsSynchronized)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Security::Policy::Evidence*), "get_IsSynchronized", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

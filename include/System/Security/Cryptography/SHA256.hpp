...
namespace System::Security::Cryptography {
  ...
  class SHA256 : public ::System::Security::Cryptography::HashAlgorithm {
    ...
    // static public System.Security.Cryptography.SHA256 Create(System.String hashName)
    // Offset: 0x4509CF4
    static ::System::Security::Cryptography::SHA256* Create(::StringW hashName);
...
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::SHA256* (*)(::StringW)>(&System::Security::Cryptography::SHA256::Create)> {
  static const MethodInfo* get() {
    static auto* hashName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::SHA256*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{hashName});
  }
};

...
namespace System::Security::Cryptography {
  ...
  class SymmetricAlgorithm : public ::Il2CppObject/*, public ::System::IDisposable*/ {
    ...
    // public System.Void set_FeedbackSize(System.Int32 value)
    // Offset: 0x450D568
    ...
    // public System.Security.Cryptography.KeySizes[] get_LegalBlockSizes()
    // Offset: 0x450DA8C
    ::ArrayW<::System::Security::Cryptography::KeySizes*> get_LegalBlockSizes();
    ...
    // static public System.Security.Cryptography.SymmetricAlgorithm Create()
    // Offset: 0x450DD00
...
// Writing MetadataGetter for method: System::Security::Cryptography::SymmetricAlgorithm::set_FeedbackSize
// Il2CppName: set_FeedbackSize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Security::Cryptography::SymmetricAlgorithm::*)(int)>(&System::Security::Cryptography::SymmetricAlgorithm::set_FeedbackSize)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::SymmetricAlgorithm*), "set_FeedbackSize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: System::Security::Cryptography::SymmetricAlgorithm::get_LegalBlockSizes
// Il2CppName: get_LegalBlockSizes
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::Security::Cryptography::KeySizes*> (System::Security::Cryptography::SymmetricAlgorithm::*)()>(&System::Security::Cryptography::SymmetricAlgorithm::get_LegalBlockSizes)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::SymmetricAlgorithm*), "get_LegalBlockSizes", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::SymmetricAlgorithm* (*)()>(&System::Security::Cryptography::SymmetricAlgorithm::Create)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::SymmetricAlgorithm*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Security::Cryptography::SymmetricAlgorithm::Create
// Il2CppName: Create

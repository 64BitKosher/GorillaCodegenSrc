...
// Writing MetadataGetter for method: System::Security::Cryptography::AesManaged::set_FeedbackSize
// Il2CppName: set_FeedbackSize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Security::Cryptography::AesManaged::*)(int)>(&System::Security::Cryptography::AesManaged::set_FeedbackSize)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::AesManaged*), "set_FeedbackSize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

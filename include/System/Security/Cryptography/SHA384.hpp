...
namespace System::Security::Cryptography {
  ...
  class SHA384 : public ::System::Security::Cryptography::HashAlgorithm {
    ...
    // static public System.Security.Cryptography.SHA384 Create(System.String hashName)
    // Offset: 0x450ABC4
    static ::System::Security::Cryptography::SHA384* Create(::StringW hashName);
...
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::SHA384* (*)(::StringW)>(&System::Security::Cryptography::SHA384::Create)> {
  static const MethodInfo* get() {
    static auto* hashName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::SHA384*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{hashName});
  }
};

...
namespace System::Security::Cryptography {
  ...
  class AsymmetricSignatureDeformatter : public ::Il2CppObject {
    ...
    // public System.Boolean VerifySignature(System.Security.Cryptography.HashAlgorithm hash, System.Byte[] rgbSignature)
    // Offset: 0x44F37D4
    bool VerifySignature(::System::Security::Cryptography::HashAlgorithm* hash, ::ArrayW<uint8_t> rgbSignature);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Security::Cryptography::AsymmetricSignatureDeformatter::*)(::System::Security::Cryptography::HashAlgorithm*, ::ArrayW<uint8_t>)>(&System::Security::Cryptography::AsymmetricSignatureDeformatter::VerifySignature)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::AsymmetricSignatureDeformatter*), "VerifySignature", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{hash, rgbSignature});
  }
};
// Writing MetadataGetter for method: System::Security::Cryptography::AsymmetricSignatureDeformatter::VerifySignature
// Il2CppName: VerifySignature

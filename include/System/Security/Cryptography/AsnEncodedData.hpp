...
namespace System::Security::Cryptography {
  ...
  class AsnEncodedData : public ::Il2CppObject {
    ...
    // public System.Void .ctor(System.Security.Cryptography.AsnEncodedData asnEncodedData)
    // Offset: 0x4F91ED4
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static AsnEncodedData* New_ctor(::System::Security::Cryptography::AsnEncodedData* asnEncodedData) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Security::Cryptography::AsnEncodedData::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<AsnEncodedData*, creationType>(asnEncodedData)));
    }

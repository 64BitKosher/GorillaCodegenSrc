...
namespace System::Security::Cryptography {
  ...
  class MD5 : public ::System::Security::Cryptography::HashAlgorithm {
    ...
    // static public System.Security.Cryptography.MD5 Create(System.String algName)
    // Offset: 0x44FAAC8
    static ::System::Security::Cryptography::MD5* Create(::StringW algName);
...
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::MD5* (*)(::StringW)>(&System::Security::Cryptography::MD5::Create)> {
  static const MethodInfo* get() {
    static auto* algName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::MD5*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{algName});
  }
};

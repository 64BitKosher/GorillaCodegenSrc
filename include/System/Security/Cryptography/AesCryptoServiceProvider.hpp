...
namespace System::Security::Cryptography {
  ...
  class AesCryptoServiceProvider : public ::System::Security::Cryptography::Aes {
    ...
    // public override System.Void set_FeedbackSize(System.Int32 value)
    // Offset: 0x4B70C04
    // Implemented from: System.Security.Cryptography.SymmetricAlgorithm
    // Base method: System.Void SymmetricAlgorithm::set_FeedbackSize(System.Int32 value)
...
// Writing MetadataGetter for method: System::Security::Cryptography::AesCryptoServiceProvider::set_FeedbackSize
// Il2CppName: set_FeedbackSize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Security::Cryptography::AesCryptoServiceProvider::*)(int)>(&System::Security::Cryptography::AesCryptoServiceProvider::set_FeedbackSize)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::AesCryptoServiceProvider*), "set_FeedbackSize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

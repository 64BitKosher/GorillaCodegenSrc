...
namespace System::Security::Cryptography {
  ...
  class MD5CryptoServiceProvider : public ::System::Security::Cryptography::MD5 {
    ...
    public:
    // static field const value: static private System.Int32 BLOCK_SIZE_BYTES
    static constexpr const int BLOCK_SIZE_BYTES = 64;
    // Get static field: static private System.Int32 BLOCK_SIZE_BYTES
    static int _get_BLOCK_SIZE_BYTES();
    // Set static field: static private System.Int32 BLOCK_SIZE_BYTES
    static void _set_BLOCK_SIZE_BYTES(int value);

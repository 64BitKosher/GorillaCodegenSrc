...
namespace System::Security::Cryptography {
  ...
  class DES : public ::System::Security::Cryptography::SymmetricAlgorithm {
    ...
    // static public System.Security.Cryptography.DES Create(System.String algName)
    // Offset: 0x44F5904
    static ::System::Security::Cryptography::DES* Create(::StringW algName);
...
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::DES* (*)(::StringW)>(&System::Security::Cryptography::DES::Create)> {
  static const MethodInfo* get() {
    static auto* algName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::Cryptography::DES*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{algName});
  }
};

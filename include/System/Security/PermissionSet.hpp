...
namespace System::Security {
  ...
  class PermissionSet : public ::Il2CppObject/*, public ::System::Security::ISecurityEncodable, public ::System::Collections::ICollection, public ::System::Runtime::Serialization::IDeserializationCallback*/ {
    public:
    public:
...
// Writing MetadataGetter for method: System::Security::PermissionSet::get_IsSynchronized
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Security::PermissionSet::*)()>(&System::Security::PermissionSet::get_IsSynchronized)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Security::PermissionSet*), "get_IsSynchronized", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

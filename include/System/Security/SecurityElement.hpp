...
namespace System::Security {
  ...
  class SecurityElement : public ::Il2CppObject {
    ...
    // public System.String Attribute(System.String name)
    // Offset: 0x44E8528
    ::StringW Attribute(::StringW name);
    ...
    // public System.String SearchForTextOfTag(System.String tag)
    // Offset: 0x44E89B0
    ::StringW SearchForTextOfTag(::StringW tag);
...
// Writing MetadataGetter for method: System::Security::SecurityElement::Attribute
// Il2CppName: Attribute
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Security::SecurityElement::*)(::StringW)>(&System::Security::SecurityElement::Attribute)> {
  static const MethodInfo* get() {
    static auto* name = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::SecurityElement*), "Attribute", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{name});
  }
};
...
// Writing MetadataGetter for method: System::Security::SecurityElement::SearchForTextOfTag
// Il2CppName: SearchForTextOfTag
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Security::SecurityElement::*)(::StringW)>(&System::Security::SecurityElement::SearchForTextOfTag)> {
  static const MethodInfo* get() {
    static auto* tag = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Security::SecurityElement*), "SearchForTextOfTag", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{tag});
  }
};

...
namespace System {
  ...
  template<typename T1, typename T2, typename T3, typename T4>
  struct ValueTuple_4/*, public ::System::ValueType, public ::System::IEquatable_1<::System::ValueTuple_4<T1, T2, T3, T4>>, public ::System::Collections::IStructuralEquatable, public ::System::Collections::IStructuralComparable, public ::System::IComparable, public ::System::IComparable_1<::System::ValueTuple_4<T1, T2, T3, T4>>, public ::System::IValueTupleInternal*/ {
    public:
    public:
    // public T1 Item1
    // Size: 0xFFFFFFFF
    ...
    bool Equals(::System::ValueTuple_4<T1, T2, T3, T4> other) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_4<T1, T2, T3, T4>), -1)));
    ...
    int System_IValueTupleInternal_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_4::System.IValueTupleInternal.GetHashCode");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_4<T1, T2, T3, T4>), -1)));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method, comparer);
    }
    ...
    ::StringW System_IValueTupleInternal_ToStringEnd() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_4::System.IValueTupleInternal.ToStringEnd");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_4<T1, T2, T3, T4>), -1)));
    ...
    int System_Runtime_CompilerServices_ITuple_get_Length() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_4::System.Runtime.CompilerServices.ITuple.get_Length");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_4<T1, T2, T3, T4>), -1)));

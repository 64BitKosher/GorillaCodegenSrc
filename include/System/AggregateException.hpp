...
namespace System {
  ...
  class AggregateException : public ::System::Exception {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static AggregateException* New_ctor(::StringW message, ::System::Exception* innerException) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::AggregateException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<AggregateException*, creationType>(message, innerException)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(AggregateException), 144 + sizeof(::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Exception*>*)> __System_AggregateExceptionSizeCheck;
  static_assert(sizeof(AggregateException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: System::AggregateException::get_Message
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::AggregateException::*)()>(&System::AggregateException::get_Message)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::AggregateException*), "get_Message", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

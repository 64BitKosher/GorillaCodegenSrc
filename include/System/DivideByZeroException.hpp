...
namespace System {
  ...
  class DivideByZeroException : public ::System::ArithmeticException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static DivideByZeroException* New_ctor(::StringW message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::DivideByZeroException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<DivideByZeroException*, creationType>(message)));
    }
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static DivideByZeroException* New_ctor(::StringW message, ::System::Exception* innerException) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::DivideByZeroException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<DivideByZeroException*, creationType>(message, innerException)));
    }

...
namespace System {
  ...
  class UnitySerializationHolder : public ::Il2CppObject/*, public ::System::Runtime::Serialization::ISerializable, public ::System::Runtime::Serialization::IObjectReference*/ {
    ...
    // Offset: 0x46A11A8
    ::System::Type* MakeElementTypes(::System::Type* type);
    // static System.Void GetUnitySerializationInfo(System.Runtime.Serialization.SerializationInfo info, System.Int32 unityType)
    // Offset: 0x46A129C
    static void GetUnitySerializationInfo(::System::Runtime::Serialization::SerializationInfo* info, int unityType);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::System::Runtime::Serialization::SerializationInfo*, int)>(&System::UnitySerializationHolder::GetUnitySerializationInfo)> {
  static const MethodInfo* get() {
    static auto* info = &::il2cpp_utils::GetClassFromName("System.Runtime.Serialization", "SerializationInfo")->byval_arg;
    static auto* unityType = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::UnitySerializationHolder*), "GetUnitySerializationInfo", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{info, unityType});
  }
};
// Writing MetadataGetter for method: System::UnitySerializationHolder::GetUnitySerializationInfo
// Il2CppName: GetUnitySerializationInfo

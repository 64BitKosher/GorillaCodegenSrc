...
namespace System {
  // Forward declaring type: Tuple`6<T1, T2, T3, T4, T5, T6>
  template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
  class Tuple_6;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Tuple_6, "System", "Tuple`6");
// Type namespace: System
namespace System {
  // WARNING Size may be invalid!
  // Autogenerated type: System.Tuple`6
  // [TokenAttribute] Offset: FFFFFFFF
  template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
  class Tuple_6 : public ::Il2CppObject/*, public ::System::Collections::IStructuralEquatable, public ::System::Collections::IStructuralComparable, public ::System::IComparable, public ::System::ITupleInternal*/ {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] T1& dyn_m_Item1() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::dyn_m_Item1");
    ...
    [[deprecated("Use field access instead!")]] T2& dyn_m_Item2() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::dyn_m_Item2");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] T3& dyn_m_Item3() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::dyn_m_Item3");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] T4& dyn_m_Item4() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::dyn_m_Item4");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] T5& dyn_m_Item5() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::dyn_m_Item5");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] T6& dyn_m_Item6() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::dyn_m_Item6");
      auto ___internal__instance = this;
    ...
    T1 get_Item1() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::get_Item1");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    T2 get_Item2() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::get_Item2");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    T3 get_Item3() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::get_Item3");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    T4 get_Item4() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::get_Item4");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    T5 get_Item5() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::get_Item5");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    T6 get_Item6() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::get_Item6");
    ...
    static Tuple_6<T1, T2, T3, T4, T5, T6>* New_ctor(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Tuple_6<T1, T2, T3, T4, T5, T6>*, creationType>(item1, item2, item3, item4, item5, item6)));
    }
    ...
    bool System_Collections_IStructuralEquatable_Equals(::Il2CppObject* other, ::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.Collections.IStructuralEquatable.Equals");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
    ...
    int System_IComparable_CompareTo(::Il2CppObject* obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.IComparable.CompareTo");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
    ...
    int System_Collections_IStructuralComparable_CompareTo(::Il2CppObject* other, ::System::Collections::IComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.Collections.IStructuralComparable.CompareTo");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
    ...
    int System_Collections_IStructuralEquatable_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.Collections.IStructuralEquatable.GetHashCode");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
    ...
    int System_ITupleInternal_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.ITupleInternal.GetHashCode");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method, comparer);
    }
    ...
    ::StringW System_ITupleInternal_ToString(::System::Text::StringBuilder* sb) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.ITupleInternal.ToString");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
    ...
    int System_Runtime_CompilerServices_ITuple_get_Length() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::System.Runtime.CompilerServices.ITuple.get_Length");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Tuple_6<T1, T2, T3, T4, T5, T6>*), -1)));
    ...
    bool Equals(::Il2CppObject* obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::Equals");
    ...
    int GetHashCode() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::GetHashCode");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::Il2CppObject*), -1));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method);
    }
    ...
    ::StringW ToString() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Tuple_6::ToString");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::Il2CppObject*), -1));
      return ::il2cpp_utils::RunMethodRethrow<::StringW, false>(this, ___internal__method);
    }
  }; // System.Tuple`6
  // Could not write size check! Type: System.Tuple`6 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

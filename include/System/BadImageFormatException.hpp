...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BadImageFormatException), 152 + sizeof(::StringW)> __System_BadImageFormatExceptionSizeCheck;
  static_assert(sizeof(BadImageFormatException) == 0xA0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

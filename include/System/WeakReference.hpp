...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WeakReference), 24 + sizeof(::System::Runtime::InteropServices::GCHandle)> __System_WeakReferenceSizeCheck;
  static_assert(sizeof(WeakReference) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

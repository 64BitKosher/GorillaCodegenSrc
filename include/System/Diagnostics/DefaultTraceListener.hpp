...
namespace System::Diagnostics {
  ...
  class DefaultTraceListener : public ::System::Diagnostics::TraceListener {
    ...
    // static private System.Void WriteWindowsDebugString(System.Char* message)
    // Offset: 0x4F8D7A8
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Il2CppChar*)>(&System::Diagnostics::DefaultTraceListener::WriteWindowsDebugString)> {
  static const MethodInfo* get() {
    static auto* message = &il2cpp_functions::Class_GetPtrClass(::il2cpp_utils::GetClassFromName("System", "Char"))->byval_arg;

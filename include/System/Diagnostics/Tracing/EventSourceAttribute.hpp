...
namespace System::Diagnostics::Tracing {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EventSourceAttribute), 24 + sizeof(::StringW)> __System_Diagnostics_Tracing_EventSourceAttributeSizeCheck;
  static_assert(sizeof(EventSourceAttribute) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

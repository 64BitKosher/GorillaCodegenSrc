...
namespace System::Diagnostics {
  ...
  class StackFrame : public ::Il2CppObject {
    ...
    static StackFrame* New_ctor(int skipFrames) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Diagnostics::StackFrame::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<StackFrame*, creationType>(skipFrames)));
    }
    ...
    // public System.Int32 GetFileColumnNumber()
    // Offset: 0x4619B48
...
// Writing MetadataGetter for method: System::Diagnostics::StackFrame::GetFileColumnNumber
// Il2CppName: GetFileColumnNumber
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Diagnostics::StackFrame::*)()>(&System::Diagnostics::StackFrame::GetFileColumnNumber)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Diagnostics::StackFrame*), "GetFileColumnNumber", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

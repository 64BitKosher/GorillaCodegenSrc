...
namespace System::Diagnostics {
  ...
  class AsyncStreamReader : public ::Il2CppObject {
    ...
    // private System.IAsyncResult asyncReadResult
    // Size: 0x8
    // Offset: 0x50
    ::System::IAsyncResult* asyncReadResult;
    // Field size check
    ...
    // Get instance field reference: private System.IAsyncResult asyncReadResult
    [[deprecated("Use field access instead!")]] ::System::IAsyncResult*& dyn_asyncReadResult();
  ...
  #pragma pack(pop)
  static check_size<sizeof(AsyncStreamReader), 80 + sizeof(::System::IAsyncResult*)> __System_Diagnostics_AsyncStreamReaderSizeCheck;
  static_assert(sizeof(AsyncStreamReader) == 0x58);
}

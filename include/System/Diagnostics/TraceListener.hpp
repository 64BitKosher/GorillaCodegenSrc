...
namespace System::Diagnostics {
  ...
  class TraceListener : public ::System::MarshalByRefObject/*, public ::System::IDisposable*/ {
    ...
    // public System.Void WriteLine(System.String message, System.String category)
    // Offset: 0x4F87DE8
    void WriteLine(::StringW message, ::StringW category);
...
// Il2CppName: WriteLine
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Diagnostics::TraceListener::*)(::StringW, ::StringW)>(&System::Diagnostics::TraceListener::WriteLine)> {
  static const MethodInfo* get() {
    static auto* message = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* category = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Diagnostics::TraceListener*), "WriteLine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{message, category});
  }
};

...
namespace System::Xml {
  ...
  class XmlEventCache : public ::System::Xml::XmlRawWriter {
    ...
    struct XmlEvent/*, public ::System::ValueType*/ {
      ...
      // Get instance field reference: private System.Xml.XmlEventCache/XmlEventType eventType
    ...
    static_assert(sizeof(::StringW) == 0x8);
    public:
    // Get instance field reference: private System.Collections.Generic.List`1<System.Xml.XmlEventCache/XmlEvent[]> pages
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<::ArrayW<::System::Xml::XmlEventCache::XmlEvent>>*& dyn_pages();
    // Get instance field reference: private System.Xml.XmlEventCache/XmlEvent[] pageCurr
  ...
  #pragma pack(pop)
  static check_size<sizeof(XmlEventCache), 120 + sizeof(::StringW)> __System_Xml_XmlEventCacheSizeCheck;
  static_assert(sizeof(XmlEventCache) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

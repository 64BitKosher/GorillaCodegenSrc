...
namespace System::Xml {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CharEntityEncoderFallback), 40 + sizeof(int)> __System_Xml_CharEntityEncoderFallbackSizeCheck;
  static_assert(sizeof(CharEntityEncoderFallback) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

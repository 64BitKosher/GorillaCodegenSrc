...
namespace System::Xml::Linq {
  ...
  struct ElementWriter/*, public ::System::ValueType*/ {
    ...
    // private System.Xml.Linq.NamespaceResolver _resolver
    // Size: 0x18
    // Offset: 0x8
    ...
    // Get instance field reference: private System.Xml.XmlWriter _writer
    [[deprecated("Use field access instead!")]] ::System::Xml::XmlWriter*& dyn__writer();
    // Get instance field reference: private System.Xml.Linq.NamespaceResolver _resolver
    [[deprecated("Use field access instead!")]] ::System::Xml::Linq::NamespaceResolver& dyn__resolver();

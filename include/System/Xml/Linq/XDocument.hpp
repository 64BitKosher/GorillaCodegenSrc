...
namespace System::Xml::Linq {
  ...
  class XDocument : public ::System::Xml::Linq::XContainer {
    public:
    public:
    // private System.Xml.Linq.XDeclaration _declaration
    // Size: 0x8
    // Offset: 0x30
    ...
    public:
    // Get instance field reference: private System.Xml.Linq.XDeclaration _declaration
    [[deprecated("Use field access instead!")]] ::System::Xml::Linq::XDeclaration*& dyn__declaration();

...
namespace System::Xml::Linq {
  ...
  // [XmlTypeConvertorAttribute] Offset: FFFFFFFF
  class XElement : public ::System::Xml::Linq::XContainer/*, public ::System::Xml::Serialization::IXmlSerializable*/ {
    public:
    // Nested type: ::System::Xml::Linq::XElement::$GetAttributes$d__116
    ...
    // Offset: 0x4D1D188
    void ReadElementFromImpl(::System::Xml::XmlReader* r, ::System::Xml::Linq::LoadOptions o);
...
// Writing MetadataGetter for method: System::Xml::Linq::XElement::ReadElementFromImpl
// Il2CppName: ReadElementFromImpl
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Linq::XElement::*)(::System::Xml::XmlReader*, ::System::Xml::Linq::LoadOptions)>(&System::Xml::Linq::XElement::ReadElementFromImpl)> {
  static const MethodInfo* get() {
    static auto* r = &::il2cpp_utils::GetClassFromName("System.Xml", "XmlReader")->byval_arg;
    static auto* o = &::il2cpp_utils::GetClassFromName("System.Xml.Linq", "LoadOptions")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Linq::XElement*), "ReadElementFromImpl", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{r, o});
  }
};

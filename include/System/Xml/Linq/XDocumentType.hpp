...
namespace System::Xml::Linq {
  ...
  class XDocumentType : public ::System::Xml::Linq::XNode {
    ...
    // private System.String _publicId
    // Size: 0x8
    // Offset: 0x30
    ::StringW publicId;
    // Field size check
    ...
    // Get instance field reference: private System.String _publicId
    [[deprecated("Use field access instead!")]] ::StringW& dyn__publicId();
    // Get instance field reference: private System.String _systemId
    [[deprecated("Use field access instead!")]] ::StringW& dyn__systemId();
  ...
  #pragma pack(pop)
  static check_size<sizeof(XDocumentType), 64 + sizeof(::StringW)> __System_Xml_Linq_XDocumentTypeSizeCheck;
  static_assert(sizeof(XDocumentType) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

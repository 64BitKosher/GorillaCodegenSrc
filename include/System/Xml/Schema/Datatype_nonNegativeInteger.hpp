...
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_nonNegativeInteger::get_HasValueFacets
// Il2CppName: get_HasValueFacets
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Xml::Schema::Datatype_nonNegativeInteger::*)()>(&System::Xml::Schema::Datatype_nonNegativeInteger::get_HasValueFacets)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Schema::Datatype_nonNegativeInteger*), "get_HasValueFacets", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

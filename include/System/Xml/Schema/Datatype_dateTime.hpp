...
namespace System::Xml::Schema {
  // Forward declaring type: Datatype_dateTime
...
namespace System::Xml::Schema {
  // Size: 0x3C
  #pragma pack(push, 1)
  // Autogenerated type: System.Xml.Schema.Datatype_dateTime
  ...
  class Datatype_dateTime : public ::System::Xml::Schema::Datatype_dateTimeBase {
    ...
    static Datatype_dateTime* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Xml::Schema::Datatype_dateTime::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Datatype_dateTime*, creationType>()));
    }
  }; // System.Xml.Schema.Datatype_dateTime
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_dateTime::New_ctor
// Il2CppName: .ctor

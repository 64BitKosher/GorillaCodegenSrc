...
namespace System::Xml::Schema {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XmlSchemaException), 184 + sizeof(::StringW)> __System_Xml_Schema_XmlSchemaExceptionSizeCheck;
  static_assert(sizeof(XmlSchemaException) == 0xC0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

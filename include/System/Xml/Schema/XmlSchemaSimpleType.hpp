...
namespace System::Xml::Schema {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XmlSchemaSimpleType), 152 + sizeof(::System::Xml::Schema::XmlSchemaSimpleTypeContent*)> __System_Xml_Schema_XmlSchemaSimpleTypeSizeCheck;
  static_assert(sizeof(XmlSchemaSimpleType) == 0xA0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: System::Xml::Schema::XmlSchemaSimpleType::Clone
// Il2CppName: Clone
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Xml::Schema::XmlSchemaObject* (System::Xml::Schema::XmlSchemaSimpleType::*)()>(&System::Xml::Schema::XmlSchemaSimpleType::Clone)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Schema::XmlSchemaSimpleType*), "Clone", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace System::Xml::Schema {
  // Forward declaring type: Datatype_time
  class Datatype_time;
}
...
namespace System::Xml::Schema {
  // Size: 0x3C
  #pragma pack(push, 1)
  // Autogenerated type: System.Xml.Schema.Datatype_time
  ...
  class Datatype_time : public ::System::Xml::Schema::Datatype_dateTimeBase {
    ...
    static Datatype_time* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<Datatype_time*, creationType>()));
    }
  }; // System.Xml.Schema.Datatype_time
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_time::get_TypeCode
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Xml::Schema::XmlTypeCode (System::Xml::Schema::Datatype_time::*)()>(&System::Xml::Schema::Datatype_time::get_TypeCode)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Schema::Datatype_time*), "get_TypeCode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_time::New_ctor
// Il2CppName: .ctor

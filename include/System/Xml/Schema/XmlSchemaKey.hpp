...
namespace System::Xml::Schema {
  // Forward declaring type: XmlSchemaKey
  class XmlSchemaKey;
}
...
namespace System::Xml::Schema {
  // Size: 0x78
  #pragma pack(push, 1)
  // Autogenerated type: System.Xml.Schema.XmlSchemaKey
  ...
  class XmlSchemaKey : public ::System::Xml::Schema::XmlSchemaIdentityConstraint {
    ...
    static XmlSchemaKey* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Xml::Schema::XmlSchemaKey::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<XmlSchemaKey*, creationType>()));
    }
  }; // System.Xml.Schema.XmlSchemaKey
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Xml::Schema::XmlSchemaKey::New_ctor
// Il2CppName: .ctor

...
namespace System::Xml::XPath {
  ...
  class XPathNavigator : public ::System::Xml::XPath::XPathItem/*, public ::System::ICloneable, public ::System::Xml::IXmlNamespaceResolver*/ {
    public:
...
// Writing MetadataGetter for method: System::Xml::XPath::XPathNavigator::GetNamespacesInScope
// Il2CppName: GetNamespacesInScope
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IDictionary_2<::StringW, ::StringW>* (System::Xml::XPath::XPathNavigator::*)(::System::Xml::XmlNamespaceScope)>(&System::Xml::XPath::XPathNavigator::GetNamespacesInScope)> {
  static const MethodInfo* get() {
    static auto* scope = &::il2cpp_utils::GetClassFromName("System.Xml", "XmlNamespaceScope")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Xml::XPath::XPathNavigator*), "GetNamespacesInScope", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{scope});
  }
};

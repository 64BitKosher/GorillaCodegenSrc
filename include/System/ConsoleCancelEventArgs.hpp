...
namespace System {
  ...
  class ConsoleCancelEventArgs : public ::System::EventArgs {
    ...
    // private System.Boolean <Cancel>k__BackingField
    // Size: 0x1
    // Offset: 0x14
    bool Cancel;
    // Field size check
    ...
    public:
    // Get instance field reference: private readonly System.ConsoleSpecialKey _type
    [[deprecated("Use field access instead!")]] ::System::ConsoleSpecialKey& dyn__type();
    // Get instance field reference: private System.Boolean <Cancel>k__BackingField
    [[deprecated("Use field access instead!")]] bool& dyn_$Cancel$k__BackingField();

...
namespace System::Net {
  ...
  class KnownHttpVerb : public ::Il2CppObject {
    ...
    // Offset: 0x4FD6908
    static void _cctor();
    // public System.Boolean Equals(System.Net.KnownHttpVerb verb)
    // Offset: 0x4FD6CB8
    bool Equals(::System::Net::KnownHttpVerb* verb);
...
// Writing MetadataGetter for method: System::Net::KnownHttpVerb::Equals
// Il2CppName: Equals
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Net::KnownHttpVerb::*)(::System::Net::KnownHttpVerb*)>(&System::Net::KnownHttpVerb::Equals)> {
  static const MethodInfo* get() {
    static auto* verb = &::il2cpp_utils::GetClassFromName("System.Net", "KnownHttpVerb")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Net::KnownHttpVerb*), "Equals", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{verb});
  }
};

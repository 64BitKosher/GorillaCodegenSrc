...
// Writing MetadataGetter for method: System::Net::BasicClient::get_CanPreAuthenticate
// Il2CppName: get_CanPreAuthenticate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Net::BasicClient::*)()>(&System::Net::BasicClient::get_CanPreAuthenticate)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::BasicClient*), "get_CanPreAuthenticate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

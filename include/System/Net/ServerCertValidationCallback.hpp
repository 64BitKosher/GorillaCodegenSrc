...
// Writing MetadataGetter for method: System::Net::ServerCertValidationCallback::get_ValidationCallback
// Il2CppName: get_ValidationCallback
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::Security::RemoteCertificateValidationCallback* (System::Net::ServerCertValidationCallback::*)()>(&System::Net::ServerCertValidationCallback::get_ValidationCallback)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::ServerCertValidationCallback*), "get_ValidationCallback", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

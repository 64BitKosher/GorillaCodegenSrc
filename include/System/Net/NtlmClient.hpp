...
// Writing MetadataGetter for method: System::Net::NtlmClient::get_CanPreAuthenticate
// Il2CppName: get_CanPreAuthenticate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Net::NtlmClient::*)()>(&System::Net::NtlmClient::get_CanPreAuthenticate)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::NtlmClient*), "get_CanPreAuthenticate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

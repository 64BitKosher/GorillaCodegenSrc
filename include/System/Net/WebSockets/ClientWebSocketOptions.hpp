...
// Writing MetadataGetter for method: System::Net::WebSockets::ClientWebSocketOptions::set_Proxy
// Il2CppName: set_Proxy
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Net::WebSockets::ClientWebSocketOptions::*)(::System::Net::IWebProxy*)>(&System::Net::WebSockets::ClientWebSocketOptions::set_Proxy)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System.Net", "IWebProxy")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Net::WebSockets::ClientWebSocketOptions*), "set_Proxy", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

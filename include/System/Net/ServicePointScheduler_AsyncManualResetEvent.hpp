...
namespace System::Net {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: System.Net.ServicePointScheduler/AsyncManualResetEvent
  ...
  class ServicePointScheduler::AsyncManualResetEvent : public ::Il2CppObject {
    ...
    // public System.Boolean WaitOne(System.Int32 millisecondTimeout)
    // Offset: 0x4EB37D8
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (System::Net::ServicePointScheduler::AsyncManualResetEvent::*)()>(&System::Net::ServicePointScheduler::AsyncManualResetEvent::WaitAsync)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::ServicePointScheduler::AsyncManualResetEvent*), "WaitAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Net::ServicePointScheduler::AsyncManualResetEvent::WaitOne
// Il2CppName: WaitOne
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Net::ServicePointScheduler::AsyncManualResetEvent::*)(int)>(&System::Net::ServicePointScheduler::AsyncManualResetEvent::WaitOne)> {
  static const MethodInfo* get() {
    static auto* millisecondTimeout = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Net::ServicePointScheduler::AsyncManualResetEvent*), "WaitOne", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{millisecondTimeout});
  }
};
// Writing MetadataGetter for method: System::Net::ServicePointScheduler::AsyncManualResetEvent::WaitAsync
// Il2CppName: WaitAsync

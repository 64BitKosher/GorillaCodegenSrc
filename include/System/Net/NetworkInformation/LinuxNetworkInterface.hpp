...
namespace System::Net::NetworkInformation {
  ...
  class LinuxNetworkInterface : public ::System::Net::NetworkInformation::UnixNetworkInterface {
    ...
    // static private System.Boolean unitydroid_get_network_interface_up_state(System.String ifname, ref System.Boolean is_up)
    // Offset: 0x4EC8FA8
    static bool unitydroid_get_network_interface_up_state(::StringW ifname, ByRef<bool> is_up);
  ...
  #pragma pack(pop)
  static check_size<sizeof(LinuxNetworkInterface), 64 + sizeof(::StringW)> __System_Net_NetworkInformation_LinuxNetworkInterfaceSizeCheck;
  static_assert(sizeof(LinuxNetworkInterface) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Net::NetworkInformation::LinuxNetworkInterface::unitydroid_get_network_interface_up_state
// Il2CppName: unitydroid_get_network_interface_up_state
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ByRef<bool>)>(&System::Net::NetworkInformation::LinuxNetworkInterface::unitydroid_get_network_interface_up_state)> {
  static const MethodInfo* get() {
    static auto* ifname = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* is_up = &::il2cpp_utils::GetClassFromName("System", "Boolean")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Net::NetworkInformation::LinuxNetworkInterface*), "unitydroid_get_network_interface_up_state", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ifname, is_up});
  }
};

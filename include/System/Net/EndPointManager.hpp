...
namespace System::Net {
  ...
  class EndPointManager : public ::Il2CppObject {
    ...
    static EndPointManager* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Net::EndPointManager::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<EndPointManager*, creationType>()));
    }
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Net::EndPointManager::New_ctor
// Il2CppName: .ctor

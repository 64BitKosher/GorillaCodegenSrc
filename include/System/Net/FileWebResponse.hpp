...
namespace System::Net {
  ...
  class FileWebResponse : public ::System::Net::WebResponse/*, public ::System::Net::ICloseEx*/ {
    ...
    // static field const value: static private System.Int32 DefaultFileStreamBufferSize
    static constexpr const int DefaultFileStreamBufferSize = 8192;
    // Get static field: static private System.Int32 DefaultFileStreamBufferSize
    static int _get_DefaultFileStreamBufferSize();
    // Set static field: static private System.Int32 DefaultFileStreamBufferSize
    static void _set_DefaultFileStreamBufferSize(int value);
    // static field const value: static private System.String DefaultFileContentType
    static constexpr const char* DefaultFileContentType = "application/octet-stream";
    // Get static field: static private System.String DefaultFileContentType
    static ::StringW _get_DefaultFileContentType();
    // Set static field: static private System.String DefaultFileContentType
    static void _set_DefaultFileContentType(::StringW value);
...
// Writing MetadataGetter for method: System::Net::FileWebResponse::get_ContentLength
// Il2CppName: get_ContentLength
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int64_t (System::Net::FileWebResponse::*)()>(&System::Net::FileWebResponse::get_ContentLength)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::FileWebResponse*), "get_ContentLength", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Net::FileWebResponse::get_ContentType
// Il2CppName: get_ContentType
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Net::FileWebResponse::*)()>(&System::Net::FileWebResponse::get_ContentType)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::FileWebResponse*), "get_ContentType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: System::Net::FileWebResponse::get_SupportsHeaders
// Il2CppName: get_SupportsHeaders
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Net::FileWebResponse::*)()>(&System::Net::FileWebResponse::get_SupportsHeaders)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::FileWebResponse*), "get_SupportsHeaders", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

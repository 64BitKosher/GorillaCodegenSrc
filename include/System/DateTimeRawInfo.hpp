...
namespace System {
  ...
  struct DateTimeRawInfo/*, public ::System::ValueType*/ {
    ...
    constexpr DateTimeRawInfo(int* num_ = {}, int numCount_ = {}, int month_ = {}, int year_ = {}, int dayOfWeek_ = {}, int era_ = {}, ::System::DateTimeParse::TM timeMark_ = {}, double fraction_ = {}, bool hasSameDateAndTimeSeparators_ = {}) noexcept : num{num_}, numCount{numCount_}, month{month_}, year{year_}, dayOfWeek{dayOfWeek_}, era{era_}, timeMark{timeMark_}, fraction{fraction_}, hasSameDateAndTimeSeparators{hasSameDateAndTimeSeparators_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(DateTimeRawInfo), 40 + sizeof(bool)> __System_DateTimeRawInfoSizeCheck;
  static_assert(sizeof(DateTimeRawInfo) == 0x29);
}

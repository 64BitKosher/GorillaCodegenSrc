...
namespace System {
  ...
  class OperationCanceledException : public ::System::SystemException {
    ...
    // public System.Void .ctor(System.String message, System.Exception innerException, System.Threading.CancellationToken token)
    // Offset: 0x466AD74
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static OperationCanceledException* New_ctor(::StringW message, ::System::Exception* innerException, ::System::Threading::CancellationToken token) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::OperationCanceledException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OperationCanceledException*, creationType>(message, innerException, token)));
    }
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static OperationCanceledException* New_ctor(::StringW message, ::System::Exception* innerException) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::OperationCanceledException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OperationCanceledException*, creationType>(message, innerException)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(OperationCanceledException), 144 + sizeof(::System::Threading::CancellationToken)> __System_OperationCanceledExceptionSizeCheck;
  static_assert(sizeof(OperationCanceledException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

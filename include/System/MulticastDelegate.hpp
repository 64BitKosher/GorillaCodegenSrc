...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MulticastDelegate), 120 + sizeof(::ArrayW<::System::Delegate*>)> __System_MulticastDelegateSizeCheck;
  static_assert(sizeof(MulticastDelegate) == 0x80);
}

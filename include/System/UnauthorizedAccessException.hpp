...
namespace System {
  ...
  class UnauthorizedAccessException : public ::System::SystemException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static UnauthorizedAccessException* New_ctor(::StringW message, ::System::Exception* inner) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::UnauthorizedAccessException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UnauthorizedAccessException*, creationType>(message, inner)));
    }

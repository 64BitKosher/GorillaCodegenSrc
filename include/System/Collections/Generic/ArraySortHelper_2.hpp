...
namespace System::Collections::Generic {
  ...
  class ArraySortHelper_2 : public ::Il2CppObject {
    ...
    // Get static field: static private readonly System.Collections.Generic.ArraySortHelper`2<TKey,TValue> s_defaultArraySortHelper
    ...
    // Set static field: static private readonly System.Collections.Generic.ArraySortHelper`2<TKey,TValue> s_defaultArraySortHelper
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    static void _cctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::Generic::ArraySortHelper_2::.cctor");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ArraySortHelper_2<TKey, TValue>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));

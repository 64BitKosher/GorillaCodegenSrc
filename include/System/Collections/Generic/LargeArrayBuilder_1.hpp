...
namespace System::Collections::Generic {
  ...
  struct LargeArrayBuilder_1/*, public ::System::ValueType*/ {
    ...
    // private System.Void AddWithBufferAllocation(T item, ref T[] destination, ref System.Int32 index)
    // Offset: 0xFFFFFFFFFFFFFFFF
    void AddWithBufferAllocation(T item, ByRef<::ArrayW<T>> destination, ByRef<int> index) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::Generic::LargeArrayBuilder_1::AddWithBufferAllocation");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(*this, "AddWithBufferAllocation", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(item), ::il2cpp_utils::ExtractType(destination), ::il2cpp_utils::ExtractType(index)})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, item, byref(destination), byref(index));
    }

...
namespace System::Collections::Generic {
  ...
  class IntrospectiveSortUtilities : public ::Il2CppObject {
    public:
    // static System.Int32 FloorLog2PlusOne(System.Int32 n)
    // Offset: 0x462CAFC
...
// Writing MetadataGetter for method: System::Collections::Generic::IntrospectiveSortUtilities::FloorLog2PlusOne
// Il2CppName: FloorLog2PlusOne
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(int)>(&System::Collections::Generic::IntrospectiveSortUtilities::FloorLog2PlusOne)> {
  static const MethodInfo* get() {
    static auto* n = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Collections::Generic::IntrospectiveSortUtilities*), "FloorLog2PlusOne", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{n});
  }
};

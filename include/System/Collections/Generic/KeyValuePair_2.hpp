...
namespace System::Collections::Generic {
  ...
  struct KeyValuePair_2/*, public ::System::ValueType*/ {
    ...
    // Get instance field: private readonly TKey key
    ...
    // Autogenerated instance field getter
    // Get instance field: private readonly TValue value
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    void Deconstruct(ByRef<TKey> key, ByRef<TValue> value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::Generic::KeyValuePair_2::Deconstruct");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(*this, "Deconstruct", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<TKey&>(), ::il2cpp_utils::ExtractIndependentType<TValue&>()})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, byref(key), byref(value));
    }

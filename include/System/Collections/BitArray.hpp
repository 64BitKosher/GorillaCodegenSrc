...
namespace System::Collections {
  ...
  class BitArray : public ::Il2CppObject/*, public ::System::Collections::ICollection, public ::System::ICloneable*/ {
    public:
    ...
    // public System.Void .ctor(System.Collections.BitArray bits)
    // Offset: 0x4623EEC
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static BitArray* New_ctor(::System::Collections::BitArray* bits) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::BitArray::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<BitArray*, creationType>(bits)));
    }
...
// Writing MetadataGetter for method: System::Collections::BitArray::get_IsSynchronized
// Il2CppName: get_IsSynchronized
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Collections::BitArray::*)()>(&System::Collections::BitArray::get_IsSynchronized)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Collections::BitArray*), "get_IsSynchronized", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace System::Collections::ObjectModel {
  ...
  class KeyedCollection_2 : public ::System::Collections::ObjectModel::Collection_1<TItem> {
    public:
    public:
    // private readonly System.Collections.Generic.IEqualityComparer`1<TKey> comparer
    // Size: 0x8
    // Offset: 0x0
    ...
    // private readonly System.Int32 threshold
    // Size: 0x4
    // Offset: 0x0
    int threshold;
    // Field size check
    ...
    // Get instance field: private readonly System.Collections.Generic.IEqualityComparer`1<TKey> comparer
    ...
    // Autogenerated instance field getter
    // Get instance field: private readonly System.Int32 threshold
    ...
    // private System.Collections.Generic.List`1<TItem> get_Items()
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::System::Collections::Generic::List_1<TItem>* get_Items() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::ObjectModel::KeyedCollection_2::get_Items");
      ...
      return ::il2cpp_utils::RunMethodRethrow<::System::Collections::Generic::List_1<TItem>*, false>(this, ___internal__method);
    }
    ...
    // public System.Boolean TryGetValue(TKey key, out TItem item)
    // Offset: 0xFFFFFFFFFFFFFFFF
    bool TryGetValue(TKey key, ByRef<TItem> item) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::ObjectModel::KeyedCollection_2::TryGetValue");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "TryGetValue", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(key), ::il2cpp_utils::ExtractIndependentType<TItem&>()})));
    ...
    TKey GetKeyForItem(TItem item) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Collections::ObjectModel::KeyedCollection_2<TKey, TItem>*), -1)));

...
namespace System::ComponentModel {
  ...
  class TypeConverterAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <ConverterTypeName>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW ConverterTypeName;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <ConverterTypeName>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$ConverterTypeName$k__BackingField();

...
namespace System::ComponentModel {
  ...
  class DesignTimeVisibleAttribute : public ::System::Attribute {
    ...
    // Get instance field reference: private readonly System.Boolean <Visible>k__BackingField
    [[deprecated("Use field access instead!")]] bool& dyn_$Visible$k__BackingField();
    ...
    // Offset: 0x4F01A90
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static DesignTimeVisibleAttribute* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ComponentModel::DesignTimeVisibleAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<DesignTimeVisibleAttribute*, creationType>()));
    }

...
namespace System::ComponentModel {
  ...
  class DesignerCategoryAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <Category>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW Category;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <Category>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$Category$k__BackingField();

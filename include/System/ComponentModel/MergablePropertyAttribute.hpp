...
namespace System::ComponentModel {
  ...
  class MergablePropertyAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.Boolean <AllowMerge>k__BackingField
    // Size: 0x1
    // Offset: 0x10
    bool AllowMerge;
    // Field size check
    ...
    // Get instance field reference: private readonly System.Boolean <AllowMerge>k__BackingField
    [[deprecated("Use field access instead!")]] bool& dyn_$AllowMerge$k__BackingField();

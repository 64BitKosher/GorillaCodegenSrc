...
namespace System::ComponentModel {
  ...
  class PropertyChangedEventArgs : public ::System::EventArgs {
    public:
    public:
    // private readonly System.String _propertyName
    // Size: 0x8
    // Offset: 0x10
    ...
    // Get instance field reference: private readonly System.String _propertyName
...
// Writing MetadataGetter for method: System::ComponentModel::PropertyChangedEventArgs::get_PropertyName
// Il2CppName: get_PropertyName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::ComponentModel::PropertyChangedEventArgs::*)()>(&System::ComponentModel::PropertyChangedEventArgs::get_PropertyName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::ComponentModel::PropertyChangedEventArgs*), "get_PropertyName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

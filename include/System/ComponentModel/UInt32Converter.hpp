...
namespace System::ComponentModel {
  ...
  class UInt32Converter : public ::System::ComponentModel::BaseNumberConverter {
    ...
    static UInt32Converter* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ComponentModel::UInt32Converter::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UInt32Converter*, creationType>()));
    }
...
// Writing MetadataGetter for method: System::ComponentModel::UInt32Converter::New_ctor
// Il2CppName: .ctor

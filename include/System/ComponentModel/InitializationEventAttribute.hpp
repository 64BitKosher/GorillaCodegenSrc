...
namespace System::ComponentModel {
  ...
  class InitializationEventAttribute : public ::System::Attribute {
    ...
    // Get instance field reference: private readonly System.String <EventName>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$EventName$k__BackingField();

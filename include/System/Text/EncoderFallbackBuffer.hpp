...
namespace System::Text {
  ...
  class EncoderFallbackBuffer : public ::Il2CppObject {
    ...
    public:
    // static field const value: static private System.Int32 iMaxRecursion
    static constexpr const int iMaxRecursion = 250;
    // Get static field: static private System.Int32 iMaxRecursion
    static int _get_iMaxRecursion();
    // Set static field: static private System.Int32 iMaxRecursion
    static void _set_iMaxRecursion(int value);

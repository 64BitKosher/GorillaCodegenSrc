...
namespace System::Text {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalEncoderBestFitFallback), 24 + sizeof(::ArrayW<::Il2CppChar>)> __System_Text_InternalEncoderBestFitFallbackSizeCheck;
  static_assert(sizeof(InternalEncoderBestFitFallback) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

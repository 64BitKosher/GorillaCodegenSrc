...
namespace System::Text {
  ...
  class DecoderFallbackException : public ::System::ArgumentException {
    public:
    public:
    // private System.Byte[] _bytesUnknown
    // Size: 0x8
    // Offset: 0x98
    ...
    // Get instance field reference: private System.Byte[] _bytesUnknown
    [[deprecated("Use field access instead!")]] ::ArrayW<uint8_t>& dyn__bytesUnknown();
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static DecoderFallbackException* New_ctor(::System::Runtime::Serialization::SerializationInfo* serializationInfo, ::System::Runtime::Serialization::StreamingContext streamingContext) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Text::DecoderFallbackException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<DecoderFallbackException*, creationType>(serializationInfo, streamingContext)));
    }
  }; // System.Text.DecoderFallbackException
  #pragma pack(pop)
  static check_size<sizeof(DecoderFallbackException), 160 + sizeof(int)> __System_Text_DecoderFallbackExceptionSizeCheck;
  static_assert(sizeof(DecoderFallbackException) == 0xA4);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

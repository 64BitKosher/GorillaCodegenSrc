...
namespace System::Text {
  ...
  class InternalEncoderBestFitFallbackBuffer : public ::System::Text::EncoderFallbackBuffer {
    ...
    // Get instance field reference: private System.Text.InternalEncoderBestFitFallback _oFallback
    [[deprecated("Use field access instead!")]] ::System::Text::InternalEncoderBestFitFallback*& dyn__oFallback();

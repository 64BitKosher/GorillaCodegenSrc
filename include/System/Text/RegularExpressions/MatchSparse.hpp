...
namespace System::Text::RegularExpressions {
  ...
  class MatchSparse : public ::System::Text::RegularExpressions::Match {
    ...
    public:
    // readonly System.Collections.Hashtable _caps
    // Size: 0x8
    // Offset: 0x78
    ...
    // Get instance field reference: readonly System.Collections.Hashtable _caps
  ...
  #pragma pack(pop)
  static check_size<sizeof(MatchSparse), 120 + sizeof(::System::Collections::Hashtable*)> __System_Text_RegularExpressions_MatchSparseSizeCheck;
  static_assert(sizeof(MatchSparse) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

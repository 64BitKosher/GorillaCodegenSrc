...
namespace System::IO {
  ...
  class TextReader::SyncTextReader : public ::System::IO::TextReader {
    public:
    public:
    // readonly System.IO.TextReader _in
    // Size: 0x8
    // Offset: 0x18
    ...
    // Get instance field reference: readonly System.IO.TextReader _in
...
// Il2CppName: Read
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::IO::TextReader::SyncTextReader::*)(::ArrayW<::Il2CppChar>, int, int)>(&System::IO::TextReader::SyncTextReader::Read)> {
  static const MethodInfo* get() {

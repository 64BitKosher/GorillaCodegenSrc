...
namespace System::IO {
  ...
  class CStreamWriter : public ::System::IO::StreamWriter {
    ...
    // public override System.Void WriteLine(System.String val)
    // Offset: 0x45E18F8
    // Implemented from: System.IO.StreamWriter
    // Base method: System.Void StreamWriter::WriteLine(System.String val)
    void WriteLine(::StringW val);
  }; // System.IO.CStreamWriter
  #pragma pack(pop)
  static check_size<sizeof(CStreamWriter), 112 + sizeof(::System::TermInfoDriver*)> __System_IO_CStreamWriterSizeCheck;
  static_assert(sizeof(CStreamWriter) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: System::IO::CStreamWriter::WriteLine
// Il2CppName: WriteLine
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::IO::CStreamWriter::*)(::StringW)>(&System::IO::CStreamWriter::WriteLine)> {
  static const MethodInfo* get() {
    static auto* val = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::IO::CStreamWriter*), "WriteLine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{val});
  }
};

...
namespace System::IO {
  ...
  class PinnedBufferMemoryStream : public ::System::IO::UnmanagedMemoryStream {
    ...
    // Base method: System.Int32 UnmanagedMemoryStream::Read(System.Span`1<System.Byte> buffer)
    int Read(::System::Span_1<uint8_t> buffer);
    // public override System.Void Write(System.ReadOnlySpan`1<System.Byte> buffer)
    // Offset: 0x45A0B68
    // Implemented from: System.IO.UnmanagedMemoryStream
    // Base method: System.Void UnmanagedMemoryStream::Write(System.ReadOnlySpan`1<System.Byte> buffer)
  ...
  static_assert(sizeof(PinnedBufferMemoryStream) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: System::IO::PinnedBufferMemoryStream::Read
// Il2CppName: Read
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::IO::PinnedBufferMemoryStream::*)(::System::Span_1<uint8_t>)>(&System::IO::PinnedBufferMemoryStream::Read)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(System::IO::PinnedBufferMemoryStream*), "Read", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{buffer});
  }
};
// Writing MetadataGetter for method: System::IO::PinnedBufferMemoryStream::Write
// Il2CppName: Write
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::IO::PinnedBufferMemoryStream::*)(::System::ReadOnlySpan_1<uint8_t>)>(&System::IO::PinnedBufferMemoryStream::Write)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(System::IO::PinnedBufferMemoryStream*), "Write", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{buffer});
  }
};

...
namespace System::IO::Compression {
  ...
  class DeflateStreamNative : public ::Il2CppObject {
    ...
    // private System.Exception last_error
    // Size: 0x8
    // Offset: 0x40
    ::System::Exception* last_error;
    // Field size check
    static_assert(sizeof(::System::Exception*) == 0x8);
    public:
    // Get instance field reference: private System.IO.Compression.DeflateStreamNative/UnmanagedReadOrWrite feeder
    ...
    // Get instance field reference: private System.IO.Compression.DeflateStreamNative/SafeDeflateStreamHandle z_stream
    ...
    // Get instance field reference: private System.Exception last_error
    [[deprecated("Use field access instead!")]] ::System::Exception*& dyn_last_error();
    ...
    // Offset: 0x4F55140
    void CheckResult(int result, ::StringW where);
  ...
  #pragma pack(pop)
  static check_size<sizeof(DeflateStreamNative), 64 + sizeof(::System::Exception*)> __System_IO_Compression_DeflateStreamNativeSizeCheck;
  static_assert(sizeof(DeflateStreamNative) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::IO::Compression::DeflateStreamNative::*)(int, ::StringW)>(&System::IO::Compression::DeflateStreamNative::CheckResult)> {
  static const MethodInfo* get() {

...
namespace System::IO {
  ...
  class FileNotFoundException : public ::System::IO::IOException {
    ...
    // private readonly System.String <FusionLog>k__BackingField
    // Size: 0x8
    // Offset: 0x98
    ::StringW FusionLog;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <FusionLog>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$FusionLog$k__BackingField();
...
// Writing MetadataGetter for method: System::IO::FileNotFoundException::get_FileName
// Il2CppName: get_FileName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::IO::FileNotFoundException::*)()>(&System::IO::FileNotFoundException::get_FileName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::IO::FileNotFoundException*), "get_FileName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace System::Data {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ForeignKeyConstraint), 120 + sizeof(::StringW)> __System_Data_ForeignKeyConstraintSizeCheck;
  static_assert(sizeof(ForeignKeyConstraint) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

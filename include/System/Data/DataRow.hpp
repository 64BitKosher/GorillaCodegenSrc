...
namespace System::Data {
  ...
  class DataRow : public ::Il2CppObject {
    ...
    // public System.String GetColumnError(System.String columnName)
    // Offset: 0x4C3B8FC
    ::StringW GetColumnError(::StringW columnName);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Data::DataRow::*)(::StringW)>(&System::Data::DataRow::GetColumnError)> {
  static const MethodInfo* get() {
    static auto* columnName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Data::DataRow*), "GetColumnError", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{columnName});
  }
};
// Writing MetadataGetter for method: System::Data::DataRow::GetColumnError
// Il2CppName: GetColumnError

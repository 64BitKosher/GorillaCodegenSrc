...
// Writing MetadataGetter for method: System::Data::DataColumnCollection::FinishInitCollection
// Il2CppName: FinishInitCollection
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Data::DataColumnCollection::*)()>(&System::Data::DataColumnCollection::FinishInitCollection)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Data::DataColumnCollection*), "FinishInitCollection", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

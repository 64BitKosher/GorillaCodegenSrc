...
namespace System {
  ...
  class DomainNameHelper : public ::Il2CppObject {
    ...
    // Offset: 0x4F653A0
    static ::StringW IdnEquivalent(::StringW hostname);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::StringW)>(&System::DomainNameHelper::IdnEquivalent)> {
  static const MethodInfo* get() {
    static auto* hostname = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::DomainNameHelper*), "IdnEquivalent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{hostname});
  }
};
// Writing MetadataGetter for method: System::DomainNameHelper::IdnEquivalent
// Il2CppName: IdnEquivalent

...
namespace System::Globalization {
  ...
  class SortKey : public ::Il2CppObject {
    ...
    // System.Void .ctor(System.String localeName, System.String str, System.Globalization.CompareOptions options, System.Byte[] keyData)
    // Offset: 0x4606190
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static SortKey* New_ctor(::StringW localeName, ::StringW str, ::System::Globalization::CompareOptions options, ::ArrayW<uint8_t> keyData) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Globalization::SortKey::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SortKey*, creationType>(localeName, str, options, keyData)));
    }

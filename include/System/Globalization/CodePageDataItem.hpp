...
namespace System::Globalization {
  ...
  class CodePageDataItem : public ::Il2CppObject {
    ...
    // Get instance field reference: System.String m_bodyName
    [[deprecated("Use field access instead!")]] ::StringW& dyn_m_bodyName();
  ...
  #pragma pack(pop)
  static check_size<sizeof(CodePageDataItem), 48 + sizeof(uint)> __System_Globalization_CodePageDataItemSizeCheck;
  static_assert(sizeof(CodePageDataItem) == 0x34);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

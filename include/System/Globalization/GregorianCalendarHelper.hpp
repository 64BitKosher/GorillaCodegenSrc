...
namespace System::Globalization {
  ...
  class GregorianCalendarHelper : public ::Il2CppObject {
    ...
    // private System.Int32 GetYearOffset(System.Int32 year, System.Int32 era, System.Boolean throwOnError)
    // Offset: 0x45FD2CC
    ...
    // public System.Int32 ToFourDigitYear(System.Int32 year, System.Int32 twoDigitYearMax)
    // Offset: 0x45FE508
...
// Writing MetadataGetter for method: System::Globalization::GregorianCalendarHelper::GetYearOffset
// Il2CppName: GetYearOffset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Globalization::GregorianCalendarHelper::*)(int, int, bool)>(&System::Globalization::GregorianCalendarHelper::GetYearOffset)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(System::Globalization::GregorianCalendarHelper*), "GetYearOffset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{year, era, throwOnError});
  }
};
...
// Writing MetadataGetter for method: System::Globalization::GregorianCalendarHelper::GetDaysInYear
// Il2CppName: GetDaysInYear
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Globalization::GregorianCalendarHelper::*)(int, int)>(&System::Globalization::GregorianCalendarHelper::GetDaysInYear)> {
  static const MethodInfo* get() {
    static auto* year = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* era = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Globalization::GregorianCalendarHelper*), "GetDaysInYear", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{year, era});
  }
};
...
// Writing MetadataGetter for method: System::Globalization::GregorianCalendarHelper::ToFourDigitYear
// Il2CppName: ToFourDigitYear
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Globalization::GregorianCalendarHelper::*)(int, int)>(&System::Globalization::GregorianCalendarHelper::ToFourDigitYear)> {
  static const MethodInfo* get() {
    static auto* year = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* twoDigitYearMax = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Globalization::GregorianCalendarHelper*), "ToFourDigitYear", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{year, twoDigitYearMax});
  }
};

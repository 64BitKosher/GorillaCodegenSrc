...
namespace System::Reflection {
  ...
  class AssemblyInformationalVersionAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <InformationalVersion>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW InformationalVersion;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <InformationalVersion>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$InformationalVersion$k__BackingField();

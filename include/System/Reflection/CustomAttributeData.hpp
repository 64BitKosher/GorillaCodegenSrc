...
namespace System::Reflection {
  ...
  class CustomAttributeData : public ::Il2CppObject {
    ...
    // System.Void .ctor(System.Reflection.ConstructorInfo ctorInfo)
    // Offset: 0x45917BC
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static CustomAttributeData* New_ctor(::System::Reflection::ConstructorInfo* ctorInfo) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Reflection::CustomAttributeData::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CustomAttributeData*, creationType>(ctorInfo)));
    }
    // System.Void .ctor(System.Reflection.ConstructorInfo ctorInfo, System.Collections.Generic.IList`1<System.Reflection.CustomAttributeTypedArgument> ctorArgs, System.Collections.Generic.IList`1<System.Reflection.CustomAttributeNamedArgument> namedArgs)
    // Offset: 0x45918C8
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static CustomAttributeData* New_ctor(::System::Reflection::ConstructorInfo* ctorInfo, ::System::Collections::Generic::IList_1<::System::Reflection::CustomAttributeTypedArgument>* ctorArgs, ::System::Collections::Generic::IList_1<::System::Reflection::CustomAttributeNamedArgument>* namedArgs) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Reflection::CustomAttributeData::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CustomAttributeData*, creationType>(ctorInfo, ctorArgs, namedArgs)));
    }

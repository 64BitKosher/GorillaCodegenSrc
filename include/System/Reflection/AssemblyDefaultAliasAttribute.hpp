...
namespace System::Reflection {
  ...
  class AssemblyDefaultAliasAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <DefaultAlias>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW DefaultAlias;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <DefaultAlias>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$DefaultAlias$k__BackingField();

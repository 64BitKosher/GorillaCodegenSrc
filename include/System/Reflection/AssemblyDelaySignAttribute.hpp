...
namespace System::Reflection {
  ...
  class AssemblyDelaySignAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.Boolean <DelaySign>k__BackingField
    // Size: 0x1
    // Offset: 0x10
    bool DelaySign;
    // Field size check
    ...
    // Get instance field reference: private readonly System.Boolean <DelaySign>k__BackingField
    [[deprecated("Use field access instead!")]] bool& dyn_$DelaySign$k__BackingField();

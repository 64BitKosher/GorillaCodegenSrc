...
namespace System::Reflection {
  ...
  class AssemblyKeyFileAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <KeyFile>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW KeyFile;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <KeyFile>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$KeyFile$k__BackingField();

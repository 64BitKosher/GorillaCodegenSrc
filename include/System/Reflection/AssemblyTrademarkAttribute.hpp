...
namespace System::Reflection {
  ...
  class AssemblyTrademarkAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <Trademark>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW Trademark;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <Trademark>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$Trademark$k__BackingField();

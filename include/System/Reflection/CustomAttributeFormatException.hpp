...
namespace System::Reflection {
  ...
  class CustomAttributeFormatException : public ::System::FormatException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static CustomAttributeFormatException* New_ctor(::StringW message, ::System::Exception* inner) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Reflection::CustomAttributeFormatException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CustomAttributeFormatException*, creationType>(message, inner)));
    }

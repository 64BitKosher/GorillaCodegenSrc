...
namespace System::Reflection {
  ...
  class AssemblyCompanyAttribute : public ::System::Attribute {
    public:
    public:
    // private readonly System.String <Company>k__BackingField
    // Size: 0x8
    // Offset: 0x10
    ::StringW Company;
    // Field size check
    ...
    // Get instance field reference: private readonly System.String <Company>k__BackingField
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$Company$k__BackingField();

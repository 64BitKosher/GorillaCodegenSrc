...
namespace System {
  ...
  class ObjectDisposedException : public ::System::InvalidOperationException {
    ...
    // Get instance field reference: private System.String _objectName
    [[deprecated("Use field access instead!")]] ::StringW& dyn__objectName();
  ...
  #pragma pack(pop)
  static check_size<sizeof(ObjectDisposedException), 144 + sizeof(::StringW)> __System_ObjectDisposedExceptionSizeCheck;
  static_assert(sizeof(ObjectDisposedException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

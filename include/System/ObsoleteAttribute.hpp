...
// Writing MetadataGetter for method: System::ObsoleteAttribute::get_IsError
// Il2CppName: get_IsError
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::ObsoleteAttribute::*)()>(&System::ObsoleteAttribute::get_IsError)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::ObsoleteAttribute*), "get_IsError", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::ObsoleteAttribute::New_ctor
// Il2CppName: .ctor

...
namespace System::Linq::Expressions::Interpreter {
  ...
  class TryCatchFinallyHandler : public ::Il2CppObject {
    ...
    // Offset: 0x4BBCAA0
    ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*> get_Handlers();
...
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::TryCatchFinallyHandler::get_Handlers
// Il2CppName: get_Handlers
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*> (System::Linq::Expressions::Interpreter::TryCatchFinallyHandler::*)()>(&System::Linq::Expressions::Interpreter::TryCatchFinallyHandler::get_Handlers)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::TryCatchFinallyHandler*), "get_Handlers", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

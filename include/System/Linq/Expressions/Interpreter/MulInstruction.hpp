...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: MulInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.MulInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class MulInstruction : public ::System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulInt16
    class MulInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulInt32
    class MulInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulInt64
    class MulInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulUInt16
    class MulUInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulUInt32
    class MulUInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulUInt64
    class MulUInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulSingle
    class MulSingle;
    // Nested type: ::System::Linq::Expressions::Interpreter::MulInstruction::MulDouble
    class MulDouble;
    ...
    static MulInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Linq::Expressions::Interpreter::MulInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MulInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.MulInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Linq::Expressions::Interpreter::Instruction* (*)(::System::Type*)>(&System::Linq::Expressions::Interpreter::MulInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::MulInstruction::*)()>(&System::Linq::Expressions::Interpreter::MulInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::MulInstruction::*)()>(&System::Linq::Expressions::Interpreter::MulInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::MulInstruction::*)()>(&System::Linq::Expressions::Interpreter::MulInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulInstruction::New_ctor
// Il2CppName: .ctor

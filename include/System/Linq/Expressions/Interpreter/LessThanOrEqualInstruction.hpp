...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: LessThanOrEqualInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.LessThanOrEqualInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class LessThanOrEqualInstruction : public ::System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualSByte
    class LessThanOrEqualSByte;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualInt16
    class LessThanOrEqualInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualChar
    class LessThanOrEqualChar;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualInt32
    class LessThanOrEqualInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualInt64
    class LessThanOrEqualInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualByte
    class LessThanOrEqualByte;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualUInt16
    class LessThanOrEqualUInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualUInt32
    class LessThanOrEqualUInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualUInt64
    class LessThanOrEqualUInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualSingle
    class LessThanOrEqualSingle;
    // Nested type: ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::LessThanOrEqualDouble
    ...
    static LessThanOrEqualInstruction* New_ctor(::Il2CppObject* nullValue) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LessThanOrEqualInstruction*, creationType>(nullValue)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(LessThanOrEqualInstruction), 16 + sizeof(::Il2CppObject*)> __System_Linq_Expressions_Interpreter_LessThanOrEqualInstructionSizeCheck;
  static_assert(sizeof(LessThanOrEqualInstruction) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Linq::Expressions::Interpreter::Instruction* (*)(::System::Type*, bool)>(&System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    static auto* liftedToNull = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type, liftedToNull});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::*)()>(&System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::*)()>(&System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::*)()>(&System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: OrInstruction
  class OrInstruction;
}
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.OrInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class OrInstruction : public ::System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrSByte
    class OrSByte;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrInt16
    class OrInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrInt32
    class OrInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrInt64
    class OrInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrByte
    class OrByte;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrUInt16
    class OrUInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrUInt32
    class OrUInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrUInt64
    class OrUInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::OrInstruction::OrBoolean
    class OrBoolean;
    ...
    static OrInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Linq::Expressions::Interpreter::OrInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OrInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.OrInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::OrInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Linq::Expressions::Interpreter::Instruction* (*)(::System::Type*)>(&System::Linq::Expressions::Interpreter::OrInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::OrInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::OrInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::OrInstruction::*)()>(&System::Linq::Expressions::Interpreter::OrInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::OrInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::OrInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::OrInstruction::*)()>(&System::Linq::Expressions::Interpreter::OrInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::OrInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::OrInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::OrInstruction::*)()>(&System::Linq::Expressions::Interpreter::OrInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::OrInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::OrInstruction::New_ctor
// Il2CppName: .ctor

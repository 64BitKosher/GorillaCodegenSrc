...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: ModuloInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.ModuloInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class ModuloInstruction : public ::System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloInt16
    class ModuloInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloInt32
    class ModuloInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloInt64
    class ModuloInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloUInt16
    class ModuloUInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloUInt32
    class ModuloUInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloUInt64
    class ModuloUInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloSingle
    class ModuloSingle;
    // Nested type: ::System::Linq::Expressions::Interpreter::ModuloInstruction::ModuloDouble
    class ModuloDouble;
    ...
    static ModuloInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Linq::Expressions::Interpreter::ModuloInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ModuloInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.ModuloInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ModuloInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Linq::Expressions::Interpreter::Instruction* (*)(::System::Type*)>(&System::Linq::Expressions::Interpreter::ModuloInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ModuloInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ModuloInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::ModuloInstruction::*)()>(&System::Linq::Expressions::Interpreter::ModuloInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ModuloInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ModuloInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::ModuloInstruction::*)()>(&System::Linq::Expressions::Interpreter::ModuloInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ModuloInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ModuloInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::ModuloInstruction::*)()>(&System::Linq::Expressions::Interpreter::ModuloInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ModuloInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ModuloInstruction::New_ctor
// Il2CppName: .ctor

...
namespace System::Linq::Expressions::Interpreter {
  ...
  class HybridReferenceDictionary_2 : public ::Il2CppObject {
    ...
    // WARNING Size may be invalid!
    // Autogenerated type: System.Linq.Expressions.Interpreter.HybridReferenceDictionary`2/<GetEnumeratorWorker>d__7
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    class $GetEnumeratorWorker$d__7 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public ::System::Collections::Generic::IEnumerator_1<::System::Collections::Generic::KeyValuePair_2<TKey, TValue>>*/ {
      ...
      [[deprecated("Use field access instead!")]] int& dyn_$i$5__2() {
        static auto ___internal__logger = ::Logger::get().WithContext("::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2::$GetEnumeratorWorker$d__7::dyn_$i$5__2");
        auto ___internal__instance = this;
    ...
    }; // System.Linq.Expressions.Interpreter.HybridReferenceDictionary`2/<GetEnumeratorWorker>d__7
    // Could not write size check! Type: System.Linq.Expressions.Interpreter.HybridReferenceDictionary`2/<GetEnumeratorWorker>d__7 is generic, or has no fields that are valid for size checks!
    public:

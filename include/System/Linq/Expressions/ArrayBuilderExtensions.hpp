...
#include "System/Collections/Generic/ArrayBuilder_1_.hpp"
...
namespace System::Linq::Expressions {
  ...
  class ArrayBuilderExtensions : public ::Il2CppObject {
    ...
    template<class T>
    static ::System::Collections::ObjectModel::ReadOnlyCollection_1<T>* ToReadOnly(::System::Collections::Generic::ArrayBuilder_1_<T> builder) {

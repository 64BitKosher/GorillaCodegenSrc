...
namespace System::Threading {
  ...
  class AbandonedMutexException : public ::System::SystemException {
    public:
    public:
    // private System.Int32 _mutexIndex
    // Size: 0x4
    // Offset: 0x8C
    int mutexIndex;
    // Field size check
    ...
    public:
    // Get instance field reference: private System.Int32 _mutexIndex
    [[deprecated("Use field access instead!")]] int& dyn__mutexIndex();
    // Get instance field reference: private System.Threading.Mutex _mutex
    [[deprecated("Use field access instead!")]] ::System::Threading::Mutex*& dyn__mutex();

...
// Writing MetadataGetter for method: System::Threading::Tasks::ITaskCompletionAction::get_InvokeMayRunArbitraryCode
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Threading::Tasks::ITaskCompletionAction::*)()>(&System::Threading::Tasks::ITaskCompletionAction::get_InvokeMayRunArbitraryCode)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Threading::Tasks::ITaskCompletionAction*), "get_InvokeMayRunArbitraryCode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

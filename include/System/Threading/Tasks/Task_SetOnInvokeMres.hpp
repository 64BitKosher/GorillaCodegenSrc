...
// Writing MetadataGetter for method: System::Threading::Tasks::Task::SetOnInvokeMres::get_InvokeMayRunArbitraryCode
// Il2CppName: get_InvokeMayRunArbitraryCode
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Threading::Tasks::Task::SetOnInvokeMres::*)()>(&System::Threading::Tasks::Task::SetOnInvokeMres::get_InvokeMayRunArbitraryCode)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Threading::Tasks::Task::SetOnInvokeMres*), "get_InvokeMayRunArbitraryCode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

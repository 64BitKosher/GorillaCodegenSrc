...
namespace System::Threading::Tasks {
  ...
  class Task::ContingentProperties : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x30
    ::Il2CppObject* m_cancellationRegistration;
    // Field size check
    ...
    // Size: 0x8
    // Offset: 0x40
    ::System::Collections::Generic::LowLevelListWithIList_1<::System::Threading::Tasks::Task*>* m_exceptionalChildren;
    // Field size check
    static_assert(sizeof(::System::Collections::Generic::LowLevelListWithIList_1<::System::Threading::Tasks::Task*>*) == 0x8);
    public:
    ...
    // Get instance field reference: System.Object m_cancellationRegistration
    [[deprecated("Use field access instead!")]] ::Il2CppObject*& dyn_m_cancellationRegistration();
    ...
    // Get instance field reference: System.Collections.Generic.LowLevelListWithIList`1<System.Threading.Tasks.Task> m_exceptionalChildren
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::LowLevelListWithIList_1<::System::Threading::Tasks::Task*>*& dyn_m_exceptionalChildren();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Task::ContingentProperties), 64 + sizeof(::System::Collections::Generic::LowLevelListWithIList_1<::System::Threading::Tasks::Task*>*)> __System_Threading_Tasks_Task_ContingentPropertiesSizeCheck;
...
// Writing MetadataGetter for method: System::Threading::Tasks::Task::ContingentProperties::UnregisterCancellationCallback
// Il2CppName: UnregisterCancellationCallback
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::Tasks::Task::ContingentProperties::*)()>(&System::Threading::Tasks::Task::ContingentProperties::UnregisterCancellationCallback)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Threading::Tasks::Task::ContingentProperties*), "UnregisterCancellationCallback", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace System::Threading {
  ...
  class NativeEventCalls : public ::Il2CppObject {
    ...
    // static private System.IntPtr CreateEvent_icall(System.Boolean manual, System.Boolean initial, System.Char* name, System.Int32 name_length, out System.Int32 errorCode)
    // Offset: 0x46CEF4C
    static ::System::IntPtr CreateEvent_icall(bool manual, bool initial, ::Il2CppChar* name, int name_length, ByRef<int> errorCode);
...
// Writing MetadataGetter for method: System::Threading::NativeEventCalls::CreateEvent_icall
// Il2CppName: CreateEvent_icall
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IntPtr (*)(bool, bool, ::Il2CppChar*, int, ByRef<int>)>(&System::Threading::NativeEventCalls::CreateEvent_icall)> {
  static const MethodInfo* get() {
    static auto* manual = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    static auto* initial = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    ...
    static auto* errorCode = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Threading::NativeEventCalls*), "CreateEvent_icall", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{manual, initial, name, name_length, errorCode});
  }
};

...
namespace System::Numerics {
  ...
  class BigIntegerCalculator : public ::Il2CppObject {
    ...
    // Offset: 0x4CFD638
    static ::ArrayW<uint> Divide(::ArrayW<uint> left, uint right);
...
// Il2CppName: Divide
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint> (*)(::ArrayW<uint>, uint)>(&System::Numerics::BigIntegerCalculator::Divide)> {
  static const MethodInfo* get() {
    static auto* left = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "UInt32"), 1)->byval_arg;
    static auto* right = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;

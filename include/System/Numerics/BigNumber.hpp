...
namespace System::Numerics {
  ...
  class BigNumber : public ::Il2CppObject {
    ...
    // static private System.Boolean HexNumberToBigInteger(ref System.Numerics.BigNumber/BigNumberBuffer number, ref System.Numerics.BigInteger value)
    // Offset: 0x4D001F0
    ...
    // static private System.Boolean NumberToBigInteger(ref System.Numerics.BigNumber/BigNumberBuffer number, ref System.Numerics.BigInteger value)
    // Offset: 0x4D003A0
    ...
    // static private System.String FormatBigIntegerToHex(System.Boolean targetSpan, System.Numerics.BigInteger value, System.Char format, System.Int32 digits, System.Globalization.NumberFormatInfo info, System.Span`1<System.Char> destination, out System.Int32 charsWritten, out System.Boolean spanSuccess)
    // Offset: 0x4D007F8
    static ::StringW FormatBigIntegerToHex(bool targetSpan, ::System::Numerics::BigInteger value, ::Il2CppChar format, int digits, ::System::Globalization::NumberFormatInfo* info, ::System::Span_1<::Il2CppChar> destination, ByRef<int> charsWritten, ByRef<bool> spanSuccess);
    ...
    // static private System.String FormatBigInteger(System.Boolean targetSpan, System.Numerics.BigInteger value, System.String formatString, System.ReadOnlySpan`1<System.Char> formatSpan, System.Globalization.NumberFormatInfo info, System.Span`1<System.Char> destination, out System.Int32 charsWritten, out System.Boolean spanSuccess)
    // Offset: 0x4D01110
    static ::StringW FormatBigInteger(bool targetSpan, ::System::Numerics::BigInteger value, ::StringW formatString, ::System::ReadOnlySpan_1<::Il2CppChar> formatSpan, ::System::Globalization::NumberFormatInfo* info, ::System::Span_1<::Il2CppChar> destination, ByRef<int> charsWritten, ByRef<bool> spanSuccess);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppChar (*)(::System::ReadOnlySpan_1<::Il2CppChar>, ByRef<int>)>(&System::Numerics::BigNumber::ParseFormatSpecifier)> {
  static const MethodInfo* get() {
...
// Writing MetadataGetter for method: System::Numerics::BigNumber::FormatBigIntegerToHex
// Il2CppName: FormatBigIntegerToHex
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(bool, ::System::Numerics::BigInteger, ::Il2CppChar, int, ::System::Globalization::NumberFormatInfo*, ::System::Span_1<::Il2CppChar>, ByRef<int>, ByRef<bool>)>(&System::Numerics::BigNumber::FormatBigIntegerToHex)> {
  static const MethodInfo* get() {
    static auto* targetSpan = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    ...
    static auto* spanSuccess = &::il2cpp_utils::GetClassFromName("System", "Boolean")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Numerics::BigNumber*), "FormatBigIntegerToHex", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{targetSpan, value, format, digits, info, destination, charsWritten, spanSuccess});
  }
};
...
// Il2CppName: FormatBigInteger
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(bool, ::System::Numerics::BigInteger, ::StringW, ::System::ReadOnlySpan_1<::Il2CppChar>, ::System::Globalization::NumberFormatInfo*, ::System::Span_1<::Il2CppChar>, ByRef<int>, ByRef<bool>)>(&System::Numerics::BigNumber::FormatBigInteger)> {
  static const MethodInfo* get() {
    static auto* targetSpan = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    static auto* value = &::il2cpp_utils::GetClassFromName("System.Numerics", "BigInteger")->byval_arg;
    static auto* formatString = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* formatSpan = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System", "ReadOnlySpan`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Char")})->byval_arg;
    static auto* info = &::il2cpp_utils::GetClassFromName("System.Globalization", "NumberFormatInfo")->byval_arg;
    static auto* destination = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System", "Span`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Char")})->byval_arg;
    static auto* charsWritten = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    static auto* spanSuccess = &::il2cpp_utils::GetClassFromName("System", "Boolean")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Numerics::BigNumber*), "FormatBigInteger", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{targetSpan, value, formatString, formatSpan, info, destination, charsWritten, spanSuccess});
  }
};

...
namespace System {
  ...
  struct Int64/*, public ::System::ValueType, public ::System::IComparable, public ::System::IConvertible, public ::System::IFormattable, public ::System::IComparable_1<int64_t>, public ::System::IEquatable_1<int64_t>, public ::System::ISpanFormattable*/ {
    public:
    public:
    // private readonly System.Int64 m_value
    // Size: 0x8
    // Offset: 0x0
    int64_t m_value;
    // Field size check
    ...
    // Get instance field reference: private readonly System.Int64 m_value
...
// Writing MetadataGetter for method: System::Int64::TryFormat
// Il2CppName: TryFormat
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Int64::*)(::System::Span_1<::Il2CppChar>, ByRef<int>, ::System::ReadOnlySpan_1<::Il2CppChar>, ::System::IFormatProvider*)>(&System::Int64::TryFormat)> {
  static const MethodInfo* get() {
    ...
    static auto* provider = &::il2cpp_utils::GetClassFromName("System", "IFormatProvider")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Int64), "TryFormat", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{destination, charsWritten, format, provider});
  }
};

...
namespace System {
  // Forward declaring type: ValueTuple`6<T1, T2, T3, T4, T5, T6>
  template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
  struct ValueTuple_6;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::System::ValueTuple_6, "System", "ValueTuple`6");
// Type namespace: System
namespace System {
  // WARNING Size may be invalid!
  // Autogenerated type: System.ValueTuple`6
  // [TokenAttribute] Offset: FFFFFFFF
  template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
  struct ValueTuple_6/*, public ::System::ValueType, public ::System::IEquatable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>, public ::System::Collections::IStructuralEquatable, public ::System::Collections::IStructuralComparable, public ::System::IComparable, public ::System::IComparable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>, public ::System::IValueTupleInternal*/ {
    public:
    public:
    // public T1 Item1
    // Size: 0xFFFFFFFF
    ...
    T6 Item6;
    public:
    // Creating value type constructor for type: ValueTuple_6
    constexpr ValueTuple_6(T1 Item1_ = {}, T2 Item2_ = {}, T3 Item3_ = {}, T4 Item4_ = {}, T5 Item5_ = {}, T6 Item6_ = {}) noexcept : Item1{Item1_}, Item2{Item2_}, Item3{Item3_}, Item4{Item4_}, Item5{Item5_}, Item6{Item6_} {}
    // Creating interface conversion operator: operator ::System::ValueType
    operator ::System::ValueType() noexcept {
      return *reinterpret_cast<::System::ValueType*>(this);
    }
    // Creating interface conversion operator: operator ::System::IEquatable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>
    operator ::System::IEquatable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>() noexcept {
      return *reinterpret_cast<::System::IEquatable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>*>(this);
    }
    ...
    // Creating interface conversion operator: operator ::System::IComparable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>
    operator ::System::IComparable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>() noexcept {
      return *reinterpret_cast<::System::IComparable_1<::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>>*>(this);
    }
    ...
    [[deprecated("Use field access instead!")]] T1& dyn_Item1() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::dyn_Item1");
    ...
    [[deprecated("Use field access instead!")]] T2& dyn_Item2() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::dyn_Item2");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T3& dyn_Item3() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::dyn_Item3");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T4& dyn_Item4() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::dyn_Item4");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T5& dyn_Item5() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::dyn_Item5");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T6& dyn_Item6() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::dyn_Item6");
      auto ___internal__instance = *this;
    ...
    // public System.Void .ctor(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6)
    // Offset: 0xFFFFFFFFFFFFFFFF
    // ABORTED: conflicts with another method.  ValueTuple_6(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6)
    // public System.Boolean Equals(System.ValueTuple`6<T1,T2,T3,T4,T5,T6> other)
    // Offset: 0xFFFFFFFFFFFFFFFF
    bool Equals(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6> other) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::Equals");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
    ...
    bool System_Collections_IStructuralEquatable_Equals(::Il2CppObject* other, ::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.Collections.IStructuralEquatable.Equals");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
    ...
    int System_IComparable_CompareTo(::Il2CppObject* other) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.IComparable.CompareTo");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method, other);
    }
    // public System.Int32 CompareTo(System.ValueTuple`6<T1,T2,T3,T4,T5,T6> other)
    // Offset: 0xFFFFFFFFFFFFFFFF
    int CompareTo(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6> other) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::CompareTo");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method, other);
    }
    ...
    int System_Collections_IStructuralComparable_CompareTo(::Il2CppObject* other, ::System::Collections::IComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.Collections.IStructuralComparable.CompareTo");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
    ...
    int System_Collections_IStructuralEquatable_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.Collections.IStructuralEquatable.GetHashCode");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
    ...
    int GetHashCodeCore(::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::GetHashCodeCore");
    ...
    int System_IValueTupleInternal_GetHashCode(::System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.IValueTupleInternal.GetHashCode");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method, comparer);
    }
    ...
    ::StringW System_IValueTupleInternal_ToStringEnd() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.IValueTupleInternal.ToStringEnd");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
    ...
    int System_Runtime_CompilerServices_ITuple_get_Length() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::System.Runtime.CompilerServices.ITuple.get_Length");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueTuple_6<T1, T2, T3, T4, T5, T6>), -1)));
    ...
    int GetHashCode() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::GetHashCode");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueType*), -1));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method);
    }
    ...
    ::StringW ToString() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ValueTuple_6::ToString");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(*this, classof(::System::ValueType*), -1));
      return ::il2cpp_utils::RunMethodRethrow<::StringW, false>(this, ___internal__method);
    }
  }; // System.ValueTuple`6
  // Could not write size check! Type: System.ValueTuple`6 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

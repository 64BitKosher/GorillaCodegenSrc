...
namespace System {
  ...
  class NullReferenceException : public ::System::SystemException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static NullReferenceException* New_ctor(::StringW message, ::System::Exception* innerException) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::NullReferenceException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NullReferenceException*, creationType>(message, innerException)));
    }

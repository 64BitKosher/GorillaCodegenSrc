...
namespace System {
  ...
  class OutOfMemoryException : public ::System::SystemException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static OutOfMemoryException* New_ctor(::StringW message, ::System::Exception* innerException) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::OutOfMemoryException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OutOfMemoryException*, creationType>(message, innerException)));
    }

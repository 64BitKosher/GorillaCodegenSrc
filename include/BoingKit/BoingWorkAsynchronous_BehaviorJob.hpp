...
DEFINE_IL2CPP_ARG_TYPE(::BoingKit::BoingWorkAsynchronous::BehaviorJob, "BoingKit", "BoingWorkAsynchronous/BehaviorJob");
// Type namespace: BoingKit
namespace BoingKit {
  // WARNING Size may be invalid!
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: BoingKit.BoingWorkAsynchronous/BehaviorJob
  // [TokenAttribute] Offset: FFFFFFFF
  struct BoingWorkAsynchronous::BehaviorJob/*, public ::System::ValueType, public ::Unity::Jobs::IJobParallelFor*/ {
    public:
    public:
    ...
    static_assert(sizeof(float) == 0x4);
    public:
    // Creating value type constructor for type: BehaviorJob
    constexpr BehaviorJob(::Unity::Collections::NativeArray_1<::BoingKit::BoingWork::Params> Params_ = {}, ::Unity::Collections::NativeArray_1<::BoingKit::BoingWork::Output> Output_ = {}, float DeltaTime_ = {}, float FixedDeltaTime_ = {}) noexcept : Params{Params_}, Output{Output_}, DeltaTime{DeltaTime_}, FixedDeltaTime{FixedDeltaTime_} {}
  ...
  }; // BoingKit.BoingWorkAsynchronous/BehaviorJob
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: BoingKit::BoingWorkAsynchronous::BehaviorJob::Execute
// Il2CppName: Execute
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (BoingKit::BoingWorkAsynchronous::BehaviorJob::*)(int)>(&BoingKit::BoingWorkAsynchronous::BehaviorJob::Execute)> {
  static const MethodInfo* get() {
    static auto* index = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(BoingKit::BoingWorkAsynchronous::BehaviorJob), "Execute", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{index});
  }
};

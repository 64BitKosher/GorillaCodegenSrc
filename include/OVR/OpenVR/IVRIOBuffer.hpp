...
namespace OVR::OpenVR {
  ...
  struct IVRIOBuffer/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: OVR.OpenVR.IVRIOBuffer/_Open Open
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRIOBuffer::_Open*& dyn_Open();
    // Get instance field reference: OVR.OpenVR.IVRIOBuffer/_Close Close
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRIOBuffer::_Close*& dyn_Close();
    // Get instance field reference: OVR.OpenVR.IVRIOBuffer/_Read Read
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRIOBuffer::_Read*& dyn_Read();
    // Get instance field reference: OVR.OpenVR.IVRIOBuffer/_Write Write
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRIOBuffer::_Write*& dyn_Write();
    // Get instance field reference: OVR.OpenVR.IVRIOBuffer/_PropertyContainer PropertyContainer

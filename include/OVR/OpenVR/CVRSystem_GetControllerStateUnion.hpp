...
namespace OVR::OpenVR {
  ...
  struct CVRSystem::GetControllerStateUnion/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public OVR.OpenVR.IVRSystem/_GetControllerState pGetControllerState
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRSystem::_GetControllerState*& dyn_pGetControllerState();
    // Get instance field reference: public OVR.OpenVR.CVRSystem/_GetControllerStatePacked pGetControllerStatePacked
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::CVRSystem::_GetControllerStatePacked*& dyn_pGetControllerStatePacked();

...
namespace OVR::OpenVR {
  ...
  struct IVRNotifications/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: OVR.OpenVR.IVRNotifications/_CreateNotification CreateNotification
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRNotifications::_CreateNotification*& dyn_CreateNotification();
    // Get instance field reference: OVR.OpenVR.IVRNotifications/_RemoveNotification RemoveNotification

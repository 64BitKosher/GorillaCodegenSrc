...
namespace OVR::OpenVR {
  ...
  struct IVRResources/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: OVR.OpenVR.IVRResources/_LoadSharedResource LoadSharedResource
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRResources::_LoadSharedResource*& dyn_LoadSharedResource();
    // Get instance field reference: OVR.OpenVR.IVRResources/_GetResourceFullPath GetResourceFullPath

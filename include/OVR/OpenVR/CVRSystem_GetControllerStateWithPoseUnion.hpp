...
namespace OVR::OpenVR {
  ...
  struct CVRSystem::GetControllerStateWithPoseUnion/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public OVR.OpenVR.IVRSystem/_GetControllerStateWithPose pGetControllerStateWithPose
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRSystem::_GetControllerStateWithPose*& dyn_pGetControllerStateWithPose();
    // Get instance field reference: public OVR.OpenVR.CVRSystem/_GetControllerStateWithPosePacked pGetControllerStateWithPosePacked

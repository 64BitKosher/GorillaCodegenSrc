...
namespace OVR::OpenVR {
  ...
  struct CVRSystem::PollNextEventUnion/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public OVR.OpenVR.IVRSystem/_PollNextEvent pPollNextEvent
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRSystem::_PollNextEvent*& dyn_pPollNextEvent();
    // Get instance field reference: public OVR.OpenVR.CVRSystem/_PollNextEventPacked pPollNextEventPacked
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::CVRSystem::_PollNextEventPacked*& dyn_pPollNextEventPacked();

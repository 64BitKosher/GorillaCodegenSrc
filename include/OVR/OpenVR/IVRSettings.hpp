...
namespace OVR::OpenVR {
  ...
  struct IVRSettings/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: OVR.OpenVR.IVRSettings/_GetSettingsErrorNameFromEnum GetSettingsErrorNameFromEnum

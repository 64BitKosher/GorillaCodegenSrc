...
namespace OVR::OpenVR {
  ...
  struct CVROverlay::PollNextOverlayEventUnion/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public OVR.OpenVR.IVROverlay/_PollNextOverlayEvent pPollNextOverlayEvent
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVROverlay::_PollNextOverlayEvent*& dyn_pPollNextOverlayEvent();
    // Get instance field reference: public OVR.OpenVR.CVROverlay/_PollNextOverlayEventPacked pPollNextOverlayEventPacked

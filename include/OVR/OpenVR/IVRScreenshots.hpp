...
namespace OVR::OpenVR {
  ...
  struct IVRScreenshots/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_RequestScreenshot RequestScreenshot
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRScreenshots::_RequestScreenshot*& dyn_RequestScreenshot();
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_HookScreenshot HookScreenshot
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRScreenshots::_HookScreenshot*& dyn_HookScreenshot();
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_GetScreenshotPropertyType GetScreenshotPropertyType
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRScreenshots::_GetScreenshotPropertyType*& dyn_GetScreenshotPropertyType();
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_GetScreenshotPropertyFilename GetScreenshotPropertyFilename
    ...
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_UpdateScreenshotProgress UpdateScreenshotProgress
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRScreenshots::_UpdateScreenshotProgress*& dyn_UpdateScreenshotProgress();
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_TakeStereoScreenshot TakeStereoScreenshot
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRScreenshots::_TakeStereoScreenshot*& dyn_TakeStereoScreenshot();
    // Get instance field reference: OVR.OpenVR.IVRScreenshots/_SubmitScreenshot SubmitScreenshot

...
namespace OVR {
  ...
  class SoundEmitter : public ::UnityEngine::MonoBehaviour {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: OVR.SoundEmitter/FadeState
    // [TokenAttribute] Offset: FFFFFFFF
    struct FadeState/*, public ::System::Enum*/ {
      ...
      // static field const value: static public OVR.SoundEmitter/FadeState Null
      ...
      // static field const value: static public OVR.SoundEmitter/FadeState FadingIn
      ...
      // static field const value: static public OVR.SoundEmitter/FadeState FadingOut
      ...
      // static field const value: static public OVR.SoundEmitter/FadeState Ducking
    ...
    char __padding1[0x3] = {};
    // private OVR.SoundEmitter/FadeState state
    // Size: 0x4
    // Offset: 0x28
    ...
    // Get instance field reference: private OVR.SoundEmitter/FadeState state
  ...
  #pragma pack(pop)
  static check_size<sizeof(SoundEmitter), 136 + sizeof(::OVR::SoundGroup*)> __OVR_SoundEmitterSizeCheck;
  static_assert(sizeof(SoundEmitter) == 0x90);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace Photon::Realtime {
  ...
  class LoadBalancingClient : public ::Il2CppObject/*, public ::ExitGames::Client::Photon::IPhotonPeerListener*/ {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // private readonly System.Collections.Generic.Queue`1<Photon.Realtime.LoadBalancingClient/CallbackTargetChange> callbackTargetChanges
    // Size: 0x8
    // Offset: 0x168
    ...
    // Get instance field reference: private readonly System.Collections.Generic.Queue`1<Photon.Realtime.LoadBalancingClient/CallbackTargetChange> callbackTargetChanges
    ...
    // private System.Void UpdateCallbackTarget(Photon.Realtime.LoadBalancingClient/CallbackTargetChange change, System.Collections.Generic.List`1<T> container)

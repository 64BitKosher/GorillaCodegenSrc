...
namespace Photon::Realtime {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ConnectionHandler), 56 + sizeof(::System::Diagnostics::Stopwatch*)> __Photon_Realtime_ConnectionHandlerSizeCheck;
...
// Writing MetadataGetter for method: Photon::Realtime::ConnectionHandler::StaticReset
// Il2CppName: StaticReset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&Photon::Realtime::ConnectionHandler::StaticReset)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Photon::Realtime::ConnectionHandler*), "StaticReset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

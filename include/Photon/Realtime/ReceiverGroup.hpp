...
namespace Photon::Realtime {
  // Size: 0x1
  #pragma pack(push, 1)
  // Autogenerated type: Photon.Realtime.ReceiverGroup
  ...
  struct ReceiverGroup/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Photon.Realtime.ReceiverGroup Others
    static constexpr const uint8_t Others = 0u;
    // Get static field: static public Photon.Realtime.ReceiverGroup Others
    static ::Photon::Realtime::ReceiverGroup _get_Others();
    // Set static field: static public Photon.Realtime.ReceiverGroup Others
    static void _set_Others(::Photon::Realtime::ReceiverGroup value);
    // static field const value: static public Photon.Realtime.ReceiverGroup All
    static constexpr const uint8_t All = 1u;
    // Get static field: static public Photon.Realtime.ReceiverGroup All
    static ::Photon::Realtime::ReceiverGroup _get_All();
    // Set static field: static public Photon.Realtime.ReceiverGroup All
    static void _set_All(::Photon::Realtime::ReceiverGroup value);
    // static field const value: static public Photon.Realtime.ReceiverGroup MasterClient
    static constexpr const uint8_t MasterClient = 2u;
    // Get static field: static public Photon.Realtime.ReceiverGroup MasterClient
    static ::Photon::Realtime::ReceiverGroup _get_MasterClient();
    // Set static field: static public Photon.Realtime.ReceiverGroup MasterClient
    static void _set_MasterClient(::Photon::Realtime::ReceiverGroup value);
    // Get instance field reference: public System.Byte value__
    [[deprecated("Use field access instead!")]] uint8_t& dyn_value__();
  }; // Photon.Realtime.ReceiverGroup
  #pragma pack(pop)
  static check_size<sizeof(ReceiverGroup), 0 + sizeof(uint8_t)> __Photon_Realtime_ReceiverGroupSizeCheck;

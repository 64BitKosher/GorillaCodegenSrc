...
namespace Photon::Realtime {
  ...
  class LoadBalancingPeer : public ::ExitGames::Client::Photon::PhotonPeer {
    ...
    // public Photon.Realtime.EnterRoomParams enterRoomParams
    // Size: 0x8
    // Offset: 0x120
    ...
    // Get instance field reference: public Photon.Realtime.EnterRoomParams enterRoomParams
  ...
  #pragma pack(pop)
  static check_size<sizeof(LoadBalancingPeer), 288 + sizeof(::Photon::Realtime::EnterRoomParams*)> __Photon_Realtime_LoadBalancingPeerSizeCheck;
  static_assert(sizeof(LoadBalancingPeer) == 0x128);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

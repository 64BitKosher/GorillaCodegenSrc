...
namespace Photon::Voice {
  // Forward declaring type: BufferReaderPushAdapter`1<T>
  template<typename T>
  class BufferReaderPushAdapter_1;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Photon::Voice::BufferReaderPushAdapter_1, "Photon.Voice", "BufferReaderPushAdapter`1");
// Type namespace: Photon.Voice
namespace Photon::Voice {
  // WARNING Size may be invalid!
  // Autogenerated type: Photon.Voice.BufferReaderPushAdapter`1
  // [TokenAttribute] Offset: FFFFFFFF
  template<typename T>
  class BufferReaderPushAdapter_1 : public ::Photon::Voice::BufferReaderPushAdapterBase_1<T> {
    public:
    public:
    // protected T[] buffer
    // Size: 0x8
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<T>& dyn_buffer() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::BufferReaderPushAdapter_1::dyn_buffer");
    ...
    static BufferReaderPushAdapter_1<T>* New_ctor(::Photon::Voice::LocalVoice* localVoice, ::Photon::Voice::IDataReader_1<T>* reader) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::BufferReaderPushAdapter_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<BufferReaderPushAdapter_1<T>*, creationType>(localVoice, reader)));
    }
    ...
    void Service(::Photon::Voice::LocalVoice* localVoice) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::BufferReaderPushAdapter_1::Service");
  ...
  }; // Photon.Voice.BufferReaderPushAdapter`1
  // Could not write size check! Type: Photon.Voice.BufferReaderPushAdapter`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Voice {
  ...
  // Autogenerated type: Photon.Voice.VoiceClient/<>c__DisplayClass50_0`1
  ...
  class VoiceClient::$$c__DisplayClass50_0_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] int& dyn_frameSize() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::VoiceClient::$$c__DisplayClass50_0_1::dyn_frameSize");
      auto ___internal__instance = this;
    ...
    ::Photon::Voice::LocalVoice* $CreateLocalVoiceFramed$b__0(uint8_t vId, int chId) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::VoiceClient::$$c__DisplayClass50_0_1::<CreateLocalVoiceFramed>b__0");
  ...
  }; // Photon.Voice.VoiceClient/<>c__DisplayClass50_0`1
  // Could not write size check! Type: Photon.Voice.VoiceClient/<>c__DisplayClass50_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Voice {
  ...
  class Platform : public ::Il2CppObject {
    ...
    // static public Photon.Voice.IAudioDesc CreateDefaultAudioSource(Photon.Voice.ILogger logger, Photon.Voice.DeviceInfo dev, System.Int32 samplingRate, System.Int32 channels, System.Object otherParams)
    // Offset: 0x4A63708
    static ::Photon::Voice::IAudioDesc* CreateDefaultAudioSource(::Photon::Voice::ILogger* logger, ::Photon::Voice::DeviceInfo dev, int samplingRate, int channels, ::Il2CppObject* otherParams);
...
// Writing MetadataGetter for method: Photon::Voice::Platform::CreateDefaultAudioSource
// Il2CppName: CreateDefaultAudioSource
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Photon::Voice::IAudioDesc* (*)(::Photon::Voice::ILogger*, ::Photon::Voice::DeviceInfo, int, int, ::Il2CppObject*)>(&Photon::Voice::Platform::CreateDefaultAudioSource)> {
  static const MethodInfo* get() {
    static auto* logger = &::il2cpp_utils::GetClassFromName("Photon.Voice", "ILogger")->byval_arg;
    static auto* dev = &::il2cpp_utils::GetClassFromName("Photon.Voice", "DeviceInfo")->byval_arg;
    static auto* samplingRate = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* channels = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* otherParams = &::il2cpp_utils::GetClassFromName("System", "Object")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Photon::Voice::Platform*), "CreateDefaultAudioSource", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{logger, dev, samplingRate, channels, otherParams});
  }
};

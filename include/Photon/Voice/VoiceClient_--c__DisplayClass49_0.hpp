...
NEED_NO_BOX(::Photon::Voice::VoiceClient::$$c__DisplayClass49_0);
DEFINE_IL2CPP_ARG_TYPE(::Photon::Voice::VoiceClient::$$c__DisplayClass49_0*, "Photon.Voice", "VoiceClient/<>c__DisplayClass49_0");
// Type namespace: Photon.Voice
namespace Photon::Voice {
  // Size: 0x50
  #pragma pack(push, 1)
  // Autogenerated type: Photon.Voice.VoiceClient/<>c__DisplayClass49_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  class VoiceClient::$$c__DisplayClass49_0 : public ::Il2CppObject {
    public:
    public:
    ...
    static VoiceClient::$$c__DisplayClass49_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::VoiceClient::$$c__DisplayClass49_0::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<VoiceClient::$$c__DisplayClass49_0*, creationType>()));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(VoiceClient::$$c__DisplayClass49_0), 32 + sizeof(::Photon::Voice::VoiceInfo)> __Photon_Voice_VoiceClient_$$c__DisplayClass49_0SizeCheck;
  static_assert(sizeof(VoiceClient::$$c__DisplayClass49_0) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Photon::Voice::VoiceClient::$$c__DisplayClass49_0::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: Photon::Voice::VoiceClient::$$c__DisplayClass49_0::$CreateLocalVoice$b__0
// Il2CppName: <CreateLocalVoice>b__0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Photon::Voice::LocalVoice* (Photon::Voice::VoiceClient::$$c__DisplayClass49_0::*)(uint8_t, int)>(&Photon::Voice::VoiceClient::$$c__DisplayClass49_0::$CreateLocalVoice$b__0)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Photon::Voice::VoiceClient::$$c__DisplayClass49_0*), "<CreateLocalVoice>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{vId, chId});
  }
};

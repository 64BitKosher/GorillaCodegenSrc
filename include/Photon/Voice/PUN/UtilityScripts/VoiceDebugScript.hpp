...
namespace Photon::Voice::PUN::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(VoiceDebugScript), 67 + sizeof(bool)> __Photon_Voice_PUN_UtilityScripts_VoiceDebugScriptSizeCheck;
  static_assert(sizeof(VoiceDebugScript) == 0x44);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

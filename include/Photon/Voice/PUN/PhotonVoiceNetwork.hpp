...
namespace Photon::Voice::PUN {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonVoiceNetwork), 286 + sizeof(bool)> __Photon_Voice_PUN_PhotonVoiceNetworkSizeCheck;
  static_assert(sizeof(PhotonVoiceNetwork) == 0x11F);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

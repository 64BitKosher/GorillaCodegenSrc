...
namespace Photon::Voice {
  ...
  class Framer_1 : public ::Il2CppObject {
    ...
    class $Frame$d__5;
    // WARNING Size may be invalid!
    // Autogenerated type: Photon.Voice.Framer`1/<Frame>d__5
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    }; // Photon.Voice.Framer`1/<Frame>d__5
    // Could not write size check! Type: Photon.Voice.Framer`1/<Frame>d__5 is generic, or has no fields that are valid for size checks!
    public:
    // private T[] frame
    // Size: 0x8
    // Offset: 0x0

...
namespace Photon::Voice {
  ...
  // Autogenerated type: Photon.Voice.AudioUtil/LevelMeter`1
  ...
  }; // Photon.Voice.AudioUtil/LevelMeter`1
  // Could not write size check! Type: Photon.Voice.AudioUtil/LevelMeter`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Voice {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ImageBufferNativeAlloc), 96 + sizeof(::Photon::Voice::ImageBufferNativePool_1<::Photon::Voice::ImageBufferNativeAlloc*>*)> __Photon_Voice_ImageBufferNativeAllocSizeCheck;
  static_assert(sizeof(ImageBufferNativeAlloc) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Voice::Unity {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AudioOutCapture), 32 + sizeof(::System::Action_2<::ArrayW<float>, int>*)> __Photon_Voice_Unity_AudioOutCaptureSizeCheck;
  static_assert(sizeof(AudioOutCapture) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Voice::Unity {
  ...
  class RemoteVoiceLink : public ::Il2CppObject/*, public ::System::IEquatable_1<::Photon::Voice::Unity::RemoteVoiceLink*>*/ {
    ...
    // public System.Void .ctor(Photon.Voice.VoiceInfo info, System.Int32 playerId, System.Int32 voiceId, System.Int32 channelId)
    // Offset: 0x4A8EF8C
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static RemoteVoiceLink* New_ctor(::Photon::Voice::VoiceInfo info, int playerId, int voiceId, int channelId) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Photon::Voice::Unity::RemoteVoiceLink::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<RemoteVoiceLink*, creationType>(info, playerId, voiceId, channelId)));
    }
    // public System.Void Init(ref Photon.Voice.RemoteVoiceOptions options)
    // Offset: 0x4A8EFE8
    void Init(ByRef<::Photon::Voice::RemoteVoiceOptions> options);
...
// Writing MetadataGetter for method: Photon::Voice::Unity::RemoteVoiceLink::Init
// Il2CppName: Init
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Photon::Voice::Unity::RemoteVoiceLink::*)(ByRef<::Photon::Voice::RemoteVoiceOptions>)>(&Photon::Voice::Unity::RemoteVoiceLink::Init)> {
  static const MethodInfo* get() {
    static auto* options = &::il2cpp_utils::GetClassFromName("Photon.Voice", "RemoteVoiceOptions")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Photon::Voice::Unity::RemoteVoiceLink*), "Init", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{options});
  }
};

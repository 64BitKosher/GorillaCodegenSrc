...
namespace Photon::Voice::Unity::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SaveIncomingStreamToFile), 56 + sizeof(bool)> __Photon_Voice_Unity_UtilityScripts_SaveIncomingStreamToFileSizeCheck;
  static_assert(sizeof(SaveIncomingStreamToFile) == 0x39);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

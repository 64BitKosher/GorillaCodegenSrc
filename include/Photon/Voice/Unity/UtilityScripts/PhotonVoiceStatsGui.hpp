...
namespace Photon::Voice::Unity::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonVoiceStatsGui), 80 + sizeof(::Photon::Voice::VoiceClient*)> __Photon_Voice_Unity_UtilityScripts_PhotonVoiceStatsGuiSizeCheck;
  static_assert(sizeof(PhotonVoiceStatsGui) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

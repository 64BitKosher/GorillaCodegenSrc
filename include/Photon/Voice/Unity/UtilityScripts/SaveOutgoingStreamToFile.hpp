...
namespace Photon::Voice::Unity::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SaveOutgoingStreamToFile), 48 + sizeof(::CSCore::Codecs::WAV::WaveWriter*)> __Photon_Voice_Unity_UtilityScripts_SaveOutgoingStreamToFileSizeCheck;
  static_assert(sizeof(SaveOutgoingStreamToFile) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

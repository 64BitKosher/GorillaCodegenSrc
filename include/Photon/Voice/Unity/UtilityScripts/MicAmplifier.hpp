...
namespace Photon::Voice::Unity::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MicAmplifier), 64 + sizeof(::Photon::Voice::Unity::UtilityScripts::MicAmplifierShort*)> __Photon_Voice_Unity_UtilityScripts_MicAmplifierSizeCheck;
  static_assert(sizeof(MicAmplifier) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

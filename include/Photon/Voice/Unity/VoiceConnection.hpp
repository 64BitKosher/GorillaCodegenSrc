...
namespace Photon::Voice::Unity {
  ...
  class VoiceConnection : public ::Photon::Realtime::ConnectionHandler/*, public ::Photon::Voice::Unity::ILoggable*/ {
    ...
    // protected System.Void OnOperationResponseReceived(ExitGames.Client.Photon.OperationResponse operationResponse)
    // Offset: 0x4A94A90
    void OnOperationResponseReceived(::ExitGames::Client::Photon::OperationResponse* operationResponse);
  ...
  #pragma pack(pop)
  static check_size<sizeof(VoiceConnection), 264 + sizeof(float)> __Photon_Voice_Unity_VoiceConnectionSizeCheck;
  static_assert(sizeof(VoiceConnection) == 0x10C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Photon::Voice::Unity::VoiceConnection::OnOperationResponseReceived
// Il2CppName: OnOperationResponseReceived
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Photon::Voice::Unity::VoiceConnection::*)(::ExitGames::Client::Photon::OperationResponse*)>(&Photon::Voice::Unity::VoiceConnection::OnOperationResponseReceived)> {
  static const MethodInfo* get() {
    static auto* operationResponse = &::il2cpp_utils::GetClassFromName("ExitGames.Client.Photon", "OperationResponse")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Photon::Voice::Unity::VoiceConnection*), "OnOperationResponseReceived", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{operationResponse});
  }
};

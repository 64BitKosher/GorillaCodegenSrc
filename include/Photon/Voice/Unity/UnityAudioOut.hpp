...
namespace Photon::Voice::Unity {
  ...
  class UnityAudioOut : public ::Photon::Voice::AudioOutDelayControl_1<float> {
    public:
    public:
    // protected readonly UnityEngine.AudioSource source
    // Size: 0x8
    // Offset: 0xA8
    ::UnityEngine::AudioSource* source;
    // Field size check
    static_assert(sizeof(::UnityEngine::AudioSource*) == 0x8);
    // protected UnityEngine.AudioClip clip
    // Size: 0x8
    // Offset: 0xB0
    ...
    public:
    // Get instance field reference: protected readonly UnityEngine.AudioSource source
    [[deprecated("Use field access instead!")]] ::UnityEngine::AudioSource*& dyn_source();
    // Get instance field reference: protected UnityEngine.AudioClip clip
    [[deprecated("Use field access instead!")]] ::UnityEngine::AudioClip*& dyn_clip();
    // public System.Void .ctor(UnityEngine.AudioSource audioSource, Photon.Voice.AudioOutDelayControl/PlayDelayConfig playDelayConfig, Photon.Voice.ILogger logger, System.String logPrefix, System.Boolean debugInfo)
    // Offset: 0x4A7C7B4

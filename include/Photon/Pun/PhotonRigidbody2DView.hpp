...
namespace Photon::Pun {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonRigidbody2DView), 72 + sizeof(float)> __Photon_Pun_PhotonRigidbody2DViewSizeCheck;
  static_assert(sizeof(PhotonRigidbody2DView) == 0x4C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

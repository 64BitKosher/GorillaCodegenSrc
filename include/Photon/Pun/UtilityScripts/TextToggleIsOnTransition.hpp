...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TextToggleIsOnTransition), 112 + sizeof(bool)> __Photon_Pun_UtilityScripts_TextToggleIsOnTransitionSizeCheck;
  static_assert(sizeof(TextToggleIsOnTransition) == 0x71);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

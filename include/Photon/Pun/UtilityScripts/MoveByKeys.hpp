...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MoveByKeys), 72 + sizeof(::UnityEngine::Rigidbody2D*)> __Photon_Pun_UtilityScripts_MoveByKeysSizeCheck;
  static_assert(sizeof(MoveByKeys) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

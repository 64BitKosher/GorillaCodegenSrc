...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonLagSimulationGui), 56 + sizeof(::ExitGames::Client::Photon::PhotonPeer*)> __Photon_Pun_UtilityScripts_PhotonLagSimulationGuiSizeCheck;
  static_assert(sizeof(PhotonLagSimulationGui) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GraphicToggleIsOnTransition), 112 + sizeof(bool)> __Photon_Pun_UtilityScripts_GraphicToggleIsOnTransitionSizeCheck;
  static_assert(sizeof(GraphicToggleIsOnTransition) == 0x71);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

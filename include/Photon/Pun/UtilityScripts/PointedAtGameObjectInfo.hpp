...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PointedAtGameObjectInfo), 40 + sizeof(::UnityEngine::Transform*)> __Photon_Pun_UtilityScripts_PointedAtGameObjectInfoSizeCheck;
  static_assert(sizeof(PointedAtGameObjectInfo) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

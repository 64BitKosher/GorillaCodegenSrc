...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SmoothSyncMovement), 56 + sizeof(::UnityEngine::Quaternion)> __Photon_Pun_UtilityScripts_SmoothSyncMovementSizeCheck;
  static_assert(sizeof(SmoothSyncMovement) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Pun::UtilityScripts {
  ...
  class OnJoinedInstantiate : public ::UnityEngine::MonoBehaviour/*, public ::Photon::Realtime::IMatchmakingCallbacks*/ {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Photon.Pun.UtilityScripts.OnJoinedInstantiate/SpawnSequence
    // [TokenAttribute] Offset: FFFFFFFF
    struct SpawnSequence/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Photon.Pun.UtilityScripts.OnJoinedInstantiate/SpawnSequence Connection
      ...
      // static field const value: static public Photon.Pun.UtilityScripts.OnJoinedInstantiate/SpawnSequence Random
      ...
      // static field const value: static public Photon.Pun.UtilityScripts.OnJoinedInstantiate/SpawnSequence RoundRobin
    ...
    // public Photon.Pun.UtilityScripts.OnJoinedInstantiate/SpawnSequence Sequence
    // Size: 0x4
    // Offset: 0x28
    ...
    // Get instance field reference: public Photon.Pun.UtilityScripts.OnJoinedInstantiate/SpawnSequence Sequence
  ...
  #pragma pack(pop)
  static check_size<sizeof(OnJoinedInstantiate), 100 + sizeof(int)> __Photon_Pun_UtilityScripts_OnJoinedInstantiateSizeCheck;
  static_assert(sizeof(OnJoinedInstantiate) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: Photon::Pun::UtilityScripts::OnJoinedInstantiate::OnPreLeavingRoom
// Il2CppName: OnPreLeavingRoom
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Photon::Pun::UtilityScripts::OnJoinedInstantiate::*)()>(&Photon::Pun::UtilityScripts::OnJoinedInstantiate::OnPreLeavingRoom)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Photon::Pun::UtilityScripts::OnJoinedInstantiate*), "OnPreLeavingRoom", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace Photon::Pun::UtilityScripts {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ConnectAndJoinRandom), 44 + sizeof(int)> __Photon_Pun_UtilityScripts_ConnectAndJoinRandomSizeCheck;
  static_assert(sizeof(ConnectAndJoinRandom) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Photon::Pun::UtilityScripts {
  ...
  class PhotonStatsGui : public ::UnityEngine::MonoBehaviour {
    ...
    // Get instance field reference: public System.Boolean turnOn
    [[deprecated("Use field access instead!")]] bool& dyn_turnOn();
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonStatsGui), 60 + sizeof(bool)> __Photon_Pun_UtilityScripts_PhotonStatsGuiSizeCheck;
  static_assert(sizeof(PhotonStatsGui) == 0x3D);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

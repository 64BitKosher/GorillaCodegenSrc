...
namespace Photon::Pun {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MonoBehaviourPun), 32 + sizeof(::Photon::Pun::PhotonView*)> __Photon_Pun_MonoBehaviourPunSizeCheck;
  static_assert(sizeof(MonoBehaviourPun) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

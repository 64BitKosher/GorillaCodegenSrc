...
namespace Photon::Pun {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonHandler), 88 + sizeof(::System::Collections::Generic::List_1<int>*)> __Photon_Pun_PhotonHandlerSizeCheck;
  static_assert(sizeof(PhotonHandler) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Photon::Pun::PhotonHandler::OnPreLeavingRoom
// Il2CppName: OnPreLeavingRoom
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Photon::Pun::PhotonHandler::*)()>(&Photon::Pun::PhotonHandler::OnPreLeavingRoom)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Photon::Pun::PhotonHandler*), "OnPreLeavingRoom", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace Photon::Pun {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: Photon.Pun.PhotonAnimatorView/SynchronizedParameter
  // [TokenAttribute] Offset: FFFFFFFF
  class PhotonAnimatorView::SynchronizedParameter : public ::Il2CppObject {
    public:
    public:
    // public Photon.Pun.PhotonAnimatorView/ParameterType Type
    // Size: 0x4
    // Offset: 0x10
    ::Photon::Pun::PhotonAnimatorView::ParameterType Type;
    // Field size check
    static_assert(sizeof(::Photon::Pun::PhotonAnimatorView::ParameterType) == 0x4);
    // public Photon.Pun.PhotonAnimatorView/SynchronizeType SynchronizeType
    // Size: 0x4
    // Offset: 0x14
    ...
    public:
    // Get instance field reference: public Photon.Pun.PhotonAnimatorView/ParameterType Type
    [[deprecated("Use field access instead!")]] ::Photon::Pun::PhotonAnimatorView::ParameterType& dyn_Type();
    // Get instance field reference: public Photon.Pun.PhotonAnimatorView/SynchronizeType SynchronizeType

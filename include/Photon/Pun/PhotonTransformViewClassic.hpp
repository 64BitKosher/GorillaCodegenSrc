...
namespace Photon::Pun {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhotonTransformViewClassic), 97 + sizeof(bool)> __Photon_Pun_PhotonTransformViewClassicSizeCheck;
  static_assert(sizeof(PhotonTransformViewClassic) == 0x62);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Cysharp::Text::Utf8PreparedFormat_7, "Cysharp.Text", "Utf8PreparedFormat`7");
// Type namespace: Cysharp.Text
namespace Cysharp::Text {
  // WARNING Size may be invalid!
  // Autogenerated type: Cysharp.Text.Utf8PreparedFormat`7
  // [TokenAttribute] Offset: FFFFFFFF
  // [NullableContextAttribute] Offset: FFFFFFFF
  // [NullableAttribute] Offset: FFFFFFFF
  template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
  class Utf8PreparedFormat_7 : public ::Il2CppObject {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$FormatString$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::dyn_$FormatString$k__BackingField");
    ...
    [[deprecated("Use field access instead!")]] int& dyn_$MinSize$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::dyn_$MinSize$k__BackingField");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<::Cysharp::Text::Utf8FormatSegment>& dyn_segments() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::dyn_segments");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<uint8_t>& dyn_utf8PreEncodedbuffer() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::dyn_utf8PreEncodedbuffer");
      auto ___internal__instance = this;
    ...
    ::StringW get_FormatString() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::get_FormatString");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    int get_MinSize() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::get_MinSize");
    ...
    static Utf8PreparedFormat_7<T1, T2, T3, T4, T5, T6, T7>* New_ctor(::StringW format) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Utf8PreparedFormat_7<T1, T2, T3, T4, T5, T6, T7>*, creationType>(format)));
    }
    // public System.String Format(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::StringW Format(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::Format");
      ...
      return ::il2cpp_utils::RunMethodRethrow<::StringW, false>(this, ___internal__method, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }
    // public System.Void FormatTo(ref TBufferWriter sb, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class TBufferWriter>
    void FormatTo(ByRef<TBufferWriter> sb, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<TBufferWriter>, ::System::Buffers::IBufferWriter_1<uint8_t>>);
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf8PreparedFormat_7::FormatTo");
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___generic__method, byref(sb), arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }
  }; // Cysharp.Text.Utf8PreparedFormat`7
  // Could not write size check! Type: Cysharp.Text.Utf8PreparedFormat`7 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

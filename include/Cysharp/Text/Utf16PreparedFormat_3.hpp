...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Cysharp::Text::Utf16PreparedFormat_3, "Cysharp.Text", "Utf16PreparedFormat`3");
// Type namespace: Cysharp.Text
namespace Cysharp::Text {
  // WARNING Size may be invalid!
  // Autogenerated type: Cysharp.Text.Utf16PreparedFormat`3
  // [TokenAttribute] Offset: FFFFFFFF
  // [NullableAttribute] Offset: FFFFFFFF
  // [NullableContextAttribute] Offset: FFFFFFFF
  template<typename T1, typename T2, typename T3>
  class Utf16PreparedFormat_3 : public ::Il2CppObject {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$FormatString$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::dyn_$FormatString$k__BackingField");
    ...
    [[deprecated("Use field access instead!")]] int& dyn_$MinSize$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::dyn_$MinSize$k__BackingField");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<::Cysharp::Text::Utf16FormatSegment>& dyn_segments() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::dyn_segments");
      auto ___internal__instance = this;
    ...
    ::StringW get_FormatString() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::get_FormatString");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    int get_MinSize() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::get_MinSize");
    ...
    static Utf16PreparedFormat_3<T1, T2, T3>* New_ctor(::StringW format) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Utf16PreparedFormat_3<T1, T2, T3>*, creationType>(format)));
    }
    // public System.String Format(T1 arg1, T2 arg2, T3 arg3)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::StringW Format(T1 arg1, T2 arg2, T3 arg3) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::Format");
    ...
    void FormatTo(ByRef<TBufferWriter> sb, T1 arg1, T2 arg2, T3 arg3) {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_3::FormatTo");
  ...
  }; // Cysharp.Text.Utf16PreparedFormat`3
  // Could not write size check! Type: Cysharp.Text.Utf16PreparedFormat`3 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

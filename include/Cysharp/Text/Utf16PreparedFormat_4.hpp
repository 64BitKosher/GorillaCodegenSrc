...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Cysharp::Text::Utf16PreparedFormat_4, "Cysharp.Text", "Utf16PreparedFormat`4");
// Type namespace: Cysharp.Text
namespace Cysharp::Text {
  // WARNING Size may be invalid!
  // Autogenerated type: Cysharp.Text.Utf16PreparedFormat`4
  // [TokenAttribute] Offset: FFFFFFFF
  // [NullableContextAttribute] Offset: FFFFFFFF
  // [NullableAttribute] Offset: FFFFFFFF
  template<typename T1, typename T2, typename T3, typename T4>
  class Utf16PreparedFormat_4 : public ::Il2CppObject {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] ::StringW& dyn_$FormatString$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::dyn_$FormatString$k__BackingField");
    ...
    [[deprecated("Use field access instead!")]] int& dyn_$MinSize$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::dyn_$MinSize$k__BackingField");
      auto ___internal__instance = this;
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<::Cysharp::Text::Utf16FormatSegment>& dyn_segments() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::dyn_segments");
      auto ___internal__instance = this;
    ...
    ::StringW get_FormatString() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::get_FormatString");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    int get_MinSize() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::get_MinSize");
    ...
    static Utf16PreparedFormat_4<T1, T2, T3, T4>* New_ctor(::StringW format) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Utf16PreparedFormat_4<T1, T2, T3, T4>*, creationType>(format)));
    }
    // public System.String Format(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::StringW Format(T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::Format");
    ...
    void FormatTo(ByRef<TBufferWriter> sb, T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("::Cysharp::Text::Utf16PreparedFormat_4::FormatTo");
  ...
  }; // Cysharp.Text.Utf16PreparedFormat`4
  // Could not write size check! Type: Cysharp.Text.Utf16PreparedFormat`4 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

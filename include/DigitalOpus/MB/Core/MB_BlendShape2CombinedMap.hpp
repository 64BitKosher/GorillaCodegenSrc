...
namespace DigitalOpus::MB::Core {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB_BlendShape2CombinedMap), 32 + sizeof(::DigitalOpus::MB::Core::SerializableSourceBlendShape2Combined*)> __DigitalOpus_MB_Core_MB_BlendShape2CombinedMapSizeCheck;
  static_assert(sizeof(MB_BlendShape2CombinedMap) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

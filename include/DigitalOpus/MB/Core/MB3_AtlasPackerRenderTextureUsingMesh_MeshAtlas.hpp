...
namespace DigitalOpus::MB::Core {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_AtlasPackerRenderTextureUsingMesh/MeshAtlas
  ...
  class MB3_AtlasPackerRenderTextureUsingMesh::MeshAtlas : public ::Il2CppObject {
    ...
    // static public DigitalOpus.MB.Core.MB3_AtlasPackerRenderTextureUsingMesh/MeshRectInfo AddQuad(UnityEngine.Rect wldRect, UnityEngine.Rect uvRect, System.Collections.Generic.List`1<UnityEngine.Vector3> verts, System.Collections.Generic.List`1<UnityEngine.Vector2> uvs, System.Collections.Generic.List`1<System.Int32> tris)
    // Offset: 0x43EFE60
  ...
  }; // DigitalOpus.MB.Core.MB3_AtlasPackerRenderTextureUsingMesh/MeshAtlas
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace DigitalOpus::MB::Core {
  // Size: 0xA0
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_MeshCombinerSingle/MeshChannels
  ...
  class MB3_MeshCombinerSingle::MeshChannels : public ::Il2CppObject {
    ...
    // public DigitalOpus.MB.Core.MB3_MeshCombinerSingle/MBBlendShape[] blendShapes
    // Size: 0x8
    // Offset: 0x98
    ...
    // Get instance field reference: public DigitalOpus.MB.Core.MB3_MeshCombinerSingle/MBBlendShape[] blendShapes
  ...
  }; // DigitalOpus.MB.Core.MB3_MeshCombinerSingle/MeshChannels
  #pragma pack(pop)

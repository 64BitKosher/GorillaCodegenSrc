...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_TextureCombiner : public ::Il2CppObject {
    ...
    // private System.Collections.IEnumerator __RunTexturePackerOnly(DigitalOpus.MB.Core.MB3_TextureCombiner/CombineTexturesIntoAtlasesCoroutineResult result, MB_AtlasesAndRects resultAtlasesAndRects, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, System.Boolean splitAtlasWhenPackingIfTooBig, DigitalOpus.MB.Core.MB2_EditorMethodsInterface textureEditorMethods, System.Collections.Generic.List`1<DigitalOpus.MB.Core.AtlasPackingResult> packingResult)
    // Offset: 0x43DED54
    ...
    // System.Void AddTemporaryTexture(DigitalOpus.MB.Core.MB3_TextureCombiner/TemporaryTexture tt)
    // Offset: 0x43DF10C

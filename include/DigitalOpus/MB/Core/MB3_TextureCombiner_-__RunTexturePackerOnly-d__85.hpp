...
namespace DigitalOpus::MB::Core {
  // Size: 0x60
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombiner/<__RunTexturePackerOnly>d__85
  ...
  }; // DigitalOpus.MB.Core.MB3_TextureCombiner/<__RunTexturePackerOnly>d__85
  #pragma pack(pop)

...
namespace DigitalOpus::MB::Core {
  // Size: 0x38
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB2_TexturePackerRegular/Node
  ...
  class MB2_TexturePackerRegular::Node : public ::Il2CppObject {
    ...
    char __padding0[0x4] = {};
    // DigitalOpus.MB.Core.MB2_TexturePackerRegular/Node[] child
    // Size: 0x8
    // Offset: 0x18
    ...
    public:
    // Get instance field reference: DigitalOpus.MB.Core.MB2_TexturePacker/NodeType isFullAtlas
    [[deprecated("Use field access instead!")]] ::DigitalOpus::MB::Core::MB2_TexturePacker::NodeType& dyn_isFullAtlas();
    // Get instance field reference: DigitalOpus.MB.Core.MB2_TexturePackerRegular/Node[] child
    [[deprecated("Use field access instead!")]] ::ArrayW<::DigitalOpus::MB::Core::MB2_TexturePackerRegular::Node*>& dyn_child();
    // Get instance field reference: DigitalOpus.MB.Core.MB2_TexturePacker/PixRect r
    [[deprecated("Use field access instead!")]] ::DigitalOpus::MB::Core::MB2_TexturePacker::PixRect*& dyn_r();
    // Get instance field reference: DigitalOpus.MB.Core.MB2_TexturePacker/Image img
    ...
    // System.Void .ctor(DigitalOpus.MB.Core.MB2_TexturePacker/NodeType rootType)
    // Offset: 0x43D69B8
    ...
    // Offset: 0x43DA228
    bool isLeaf();
    // DigitalOpus.MB.Core.MB2_TexturePackerRegular/Node Insert(DigitalOpus.MB.Core.MB2_TexturePacker/Image im, System.Boolean handed)
    // Offset: 0x43D6A30
    ::DigitalOpus::MB::Core::MB2_TexturePackerRegular::Node* Insert(::DigitalOpus::MB::Core::MB2_TexturePacker::Image* im, bool handed);
  }; // DigitalOpus.MB.Core.MB2_TexturePackerRegular/Node
  #pragma pack(pop)

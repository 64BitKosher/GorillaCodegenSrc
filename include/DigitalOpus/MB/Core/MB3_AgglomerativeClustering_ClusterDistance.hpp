...
namespace DigitalOpus::MB::Core {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterDistance
  // [TokenAttribute] Offset: FFFFFFFF
  class MB3_AgglomerativeClustering::ClusterDistance : public ::Il2CppObject {
    public:
    public:
    // public DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode a
    // Size: 0x8
    // Offset: 0x10
    ...
    // public DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode b
    // Size: 0x8
    // Offset: 0x18
    ...
    static_assert(sizeof(::DigitalOpus::MB::Core::MB3_AgglomerativeClustering::ClusterNode*) == 0x8);
    public:
    // Get instance field reference: public DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode a
    [[deprecated("Use field access instead!")]] ::DigitalOpus::MB::Core::MB3_AgglomerativeClustering::ClusterNode*& dyn_a();
    // Get instance field reference: public DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode b
    [[deprecated("Use field access instead!")]] ::DigitalOpus::MB::Core::MB3_AgglomerativeClustering::ClusterNode*& dyn_b();
    // public System.Void .ctor(DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode aa, DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode bb)
    // Offset: 0x43AE038
  ...
  }; // DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterDistance
  #pragma pack(pop)

...
namespace DigitalOpus::MB::Core {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB_TexSet/PipelineVariationAllTexturesUseSameMatTiling
  ...
  }; // DigitalOpus.MB.Core.MB_TexSet/PipelineVariationAllTexturesUseSameMatTiling
  #pragma pack(pop)

...
NEED_NO_BOX(::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline);
DEFINE_IL2CPP_ARG_TYPE(::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*, "DigitalOpus.MB.Core", "MB3_TextureCombinerPackerMeshBakerHorizontalVertical/VerticalPipeline");
// Type namespace: DigitalOpus.MB.Core
namespace DigitalOpus::MB::Core {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerHorizontalVertical/VerticalPipeline
  // [TokenAttribute] Offset: FFFFFFFF
  class MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline : public ::Il2CppObject/*, public ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*/ {
    public:
    ...
    static MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*, creationType>()));
    }
  }; // DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerHorizontalVertical/VerticalPipeline
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::GetPackingAlg
// Il2CppName: GetPackingAlg
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::DigitalOpus::MB::Core::MB2_PackingAlgorithmEnum (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::*)()>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::GetPackingAlg)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*), "GetPackingAlg", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::SortTexSetIntoBins
// Il2CppName: SortTexSetIntoBins
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::*)(::DigitalOpus::MB::Core::MB_TexSet*, ::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB_TexSet*>*, ::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB_TexSet*>*, int, int)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::SortTexSetIntoBins)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*), "SortTexSetIntoBins", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{texSet, horizontalVert, regular, maxAtlasWidth, maxAtlasHeight});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::GetEdge2EdgeTreatment
// Il2CppName: GetEdge2EdgeTreatment
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::DigitalOpus::MB::Core::MB_TextureTilingTreatment (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::*)()>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::GetEdge2EdgeTreatment)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*), "GetEdge2EdgeTreatment", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::InitializeAtlasPadding
// Il2CppName: InitializeAtlasPadding
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::*)(ByRef<::DigitalOpus::MB::Core::AtlasPadding>, int)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::InitializeAtlasPadding)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*), "InitializeAtlasPadding", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{padding, paddingValue});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::MergeAtlasPackingResultStackBonAInternal
// Il2CppName: MergeAtlasPackingResultStackBonAInternal
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::*)(::DigitalOpus::MB::Core::AtlasPackingResult*, ::DigitalOpus::MB::Core::AtlasPackingResult*, ByRef<::UnityEngine::Rect>, ByRef<::UnityEngine::Rect>, bool, int, int, ByRef<int>, ByRef<int>)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::MergeAtlasPackingResultStackBonAInternal)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*), "MergeAtlasPackingResultStackBonAInternal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{a, b, AatlasToFinal, BatlasToFinal, stretchBToAtlasWidth, maxWidthDim, maxHeightDim, atlasX, atlasY});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::GetExtraRoomForRegularAtlas
// Il2CppName: GetExtraRoomForRegularAtlas
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::*)(int, int, int, int, ByRef<int>, ByRef<int>)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::GetExtraRoomForRegularAtlas)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline*), "GetExtraRoomForRegularAtlas", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{usedHorizontalVertWidth, usedHorizontalVertHeight, maxAtlasWidth, maxAtlasHeight, atlasRegularMaxWidth, atlasRegularMaxHeight});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::VerticalPipeline::New_ctor
// Il2CppName: .ctor

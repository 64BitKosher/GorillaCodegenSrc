...
namespace DigitalOpus::MB::Core {
  // Size: 0x88
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBaker/<CreateAtlases>d__1
  ...
  }; // DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBaker/<CreateAtlases>d__1
  #pragma pack(pop)

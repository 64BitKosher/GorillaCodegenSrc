...
NEED_NO_BOX(::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline);
DEFINE_IL2CPP_ARG_TYPE(::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*, "DigitalOpus.MB.Core", "MB3_TextureCombinerPackerMeshBakerHorizontalVertical/IPipeline");
// Type namespace: DigitalOpus.MB.Core
namespace DigitalOpus::MB::Core {
  // Size: 0x0
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerHorizontalVertical/IPipeline
  // [TokenAttribute] Offset: FFFFFFFF
  class MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline {
    public:
  ...
  }; // DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerHorizontalVertical/IPipeline
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::GetPackingAlg
// Il2CppName: GetPackingAlg
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::DigitalOpus::MB::Core::MB2_PackingAlgorithmEnum (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::*)()>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::GetPackingAlg)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*), "GetPackingAlg", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::SortTexSetIntoBins
// Il2CppName: SortTexSetIntoBins
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::*)(::DigitalOpus::MB::Core::MB_TexSet*, ::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB_TexSet*>*, ::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB_TexSet*>*, int, int)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::SortTexSetIntoBins)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*), "SortTexSetIntoBins", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{texSet, horizontalVert, regular, maxAtlasWidth, maxAtlasHeight});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::GetEdge2EdgeTreatment
// Il2CppName: GetEdge2EdgeTreatment
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::DigitalOpus::MB::Core::MB_TextureTilingTreatment (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::*)()>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::GetEdge2EdgeTreatment)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*), "GetEdge2EdgeTreatment", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::InitializeAtlasPadding
// Il2CppName: InitializeAtlasPadding
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::*)(ByRef<::DigitalOpus::MB::Core::AtlasPadding>, int)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::InitializeAtlasPadding)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*), "InitializeAtlasPadding", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{padding, paddingValue});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::MergeAtlasPackingResultStackBonAInternal
// Il2CppName: MergeAtlasPackingResultStackBonAInternal
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::*)(::DigitalOpus::MB::Core::AtlasPackingResult*, ::DigitalOpus::MB::Core::AtlasPackingResult*, ByRef<::UnityEngine::Rect>, ByRef<::UnityEngine::Rect>, bool, int, int, ByRef<int>, ByRef<int>)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::MergeAtlasPackingResultStackBonAInternal)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*), "MergeAtlasPackingResultStackBonAInternal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{a, b, AatlasToFinal, BatlasToFinal, stretchBToAtlasWidth, maxWidthDim, maxHeightDim, atlasX, atlasY});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::GetExtraRoomForRegularAtlas
// Il2CppName: GetExtraRoomForRegularAtlas
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::*)(int, int, int, int, ByRef<int>, ByRef<int>)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline::GetExtraRoomForRegularAtlas)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerHorizontalVertical::IPipeline*), "GetExtraRoomForRegularAtlas", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{usedHorizontalVertWidth, usedHorizontalVertHeight, maxAtlasWidth, maxAtlasHeight, atlasRegularMaxWidth, atlasRegularMaxHeight});
  }
};

...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_MeshBakerGrouperCluster : public ::DigitalOpus::MB::Core::MB3_MeshBakerGrouperCore {
    ...
    char __padding3[0x4] = {};
    // private System.Collections.Generic.List`1<DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode> _clustersToDraw
    // Size: 0x8
    // Offset: 0x30
    ...
    // Get instance field reference: private System.Collections.Generic.List`1<DigitalOpus.MB.Core.MB3_AgglomerativeClustering/ClusterNode> _clustersToDraw

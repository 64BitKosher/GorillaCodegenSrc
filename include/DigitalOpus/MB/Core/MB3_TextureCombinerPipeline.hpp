...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_TextureCombinerPipeline : public ::Il2CppObject {
    ...
    // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/CreateAtlasForProperty
    // [TokenAttribute] Offset: FFFFFFFF
    struct CreateAtlasForProperty/*, public ::System::ValueType*/ {
      ...
      ::StringW ToString();
    }; // DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/CreateAtlasForProperty
    #pragma pack(pop)
    ...
    // static System.Boolean _ShouldWeCreateAtlasForThisProperty(System.Int32 propertyIndex, System.Boolean considerNonTextureProperties, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/CreateAtlasForProperty[] allTexturesAreNullAndSameColor)
    // Offset: 0x43F4980
    ...
    // static System.Boolean _DoAnySrcMatsHaveProperty(System.Int32 propertyIndex, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/CreateAtlasForProperty[] allTexturesAreNullAndSameColor)
    // Offset: 0x43F4A14
    ...
    // static System.Boolean _CollectPropertyNames(DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.MB2_LogLevel LOG_LEVEL)
    // Offset: 0x43F4A48
    ...
    // static private DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/CreateAtlasForProperty[] CalculateAllTexturesAreNullAndSameColor(DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.MB2_LogLevel LOG_LEVEL)
    // Offset: 0x43F506C
    ...
    // System.Collections.IEnumerator CalculateIdealSizesForTexturesInAtlasAndPadding(DigitalOpus.MB.Core.ProgressUpdateDelegate progressInfo, DigitalOpus.MB.Core.MB3_TextureCombiner/CombineTexturesIntoAtlasesCoroutineResult result, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.MB3_TextureCombiner combiner, DigitalOpus.MB.Core.MB2_EditorMethodsInterface textureEditorMethods, DigitalOpus.MB.Core.MB2_LogLevel LOG_LEVEL)
    // Offset: 0x43F561C
    ...
    // private System.Void FillAtlasPackingResultAuxillaryData(DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.AtlasPackingResult[] atlasPackingResults)
    // Offset: 0x43F5804
    ...
    // private System.Void FillResultAtlasesAndRects(DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.AtlasPackingResult atlasPackingResult, MB_AtlasesAndRects resultAtlasesAndRects, UnityEngine.Texture2D[] atlases)
    // Offset: 0x43F5BEC

...
namespace TMPro {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_Dropdown::DropdownItem), 56 + sizeof(::UnityEngine::UI::Toggle*)> __TMPro_TMP_Dropdown_DropdownItemSizeCheck;
  static_assert(sizeof(TMP_Dropdown::DropdownItem) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

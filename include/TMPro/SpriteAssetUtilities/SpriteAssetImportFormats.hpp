...
namespace TMPro::SpriteAssetUtilities {
  // Forward declaring type: SpriteAssetImportFormats
...
namespace TMPro::SpriteAssetUtilities {
  ...
  struct SpriteAssetImportFormats/*, public ::System::Enum*/ {
    ...
    // static field const value: static public TMPro.SpriteAssetUtilities.SpriteAssetImportFormats TexturePackerJsonArray
    static constexpr const int TexturePackerJsonArray = 1;
    // Get static field: static public TMPro.SpriteAssetUtilities.SpriteAssetImportFormats TexturePackerJsonArray
    static ::TMPro::SpriteAssetUtilities::SpriteAssetImportFormats _get_TexturePackerJsonArray();
    // Set static field: static public TMPro.SpriteAssetUtilities.SpriteAssetImportFormats TexturePackerJsonArray
    static void _set_TexturePackerJsonArray(::TMPro::SpriteAssetUtilities::SpriteAssetImportFormats value);

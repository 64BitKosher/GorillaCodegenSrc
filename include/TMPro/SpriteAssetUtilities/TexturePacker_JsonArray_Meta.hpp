...
namespace TMPro::SpriteAssetUtilities {
  ...
  // Autogenerated type: TMPro.SpriteAssetUtilities.TexturePacker_JsonArray/Meta
  ...
  struct TexturePacker_JsonArray::Meta/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // public TMPro.SpriteAssetUtilities.TexturePacker_JsonArray/SpriteSize size
    // Size: 0x8
    // Offset: 0x20
    ...
    // Get instance field reference: public TMPro.SpriteAssetUtilities.TexturePacker_JsonArray/SpriteSize size

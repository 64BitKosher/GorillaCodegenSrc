...
namespace TMPro {
  ...
  struct FontFeatureLookupFlags/*, public ::System::Enum*/ {
    ...
    // static field const value: static public TMPro.FontFeatureLookupFlags None
    static constexpr const int None = 0;
    // Get static field: static public TMPro.FontFeatureLookupFlags None
    static ::TMPro::FontFeatureLookupFlags _get_None();
    // Set static field: static public TMPro.FontFeatureLookupFlags None
    static void _set_None(::TMPro::FontFeatureLookupFlags value);

...
namespace TMPro {
  ...
  struct TextAlignmentOptions/*, public ::System::Enum*/ {
    ...
    // static field const value: static public TMPro.TextAlignmentOptions Converted
    static constexpr const int Converted = 65535;
    // Get static field: static public TMPro.TextAlignmentOptions Converted
    static ::TMPro::TextAlignmentOptions _get_Converted();

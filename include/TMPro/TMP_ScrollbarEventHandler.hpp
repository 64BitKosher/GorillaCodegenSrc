...
namespace TMPro {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_ScrollbarEventHandler), 32 + sizeof(bool)> __TMPro_TMP_ScrollbarEventHandlerSizeCheck;
  static_assert(sizeof(TMP_ScrollbarEventHandler) == 0x21);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

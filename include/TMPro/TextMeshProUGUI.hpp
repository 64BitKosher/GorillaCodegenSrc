...
namespace TMPro {
  ...
  class TextMeshProUGUI : public ::TMPro::TMP_Text/*, public ::UnityEngine::UI::ILayoutElement*/ {
    public:
    // Nested type: ::TMPro::TextMeshProUGUI::$DelayedGraphicRebuild$d__18
    class $DelayedGraphicRebuild$d__18;
    // Nested type: ::TMPro::TextMeshProUGUI::$DelayedMaterialRebuild$d__19
    ...
    void SetCulling();
    // override System.Int32 SetArraySizes(TMPro.TMP_Text/UnicodeChar[] unicodeChars)
    // Offset: 0x535E184
    // Implemented from: TMPro.TMP_Text
    // Base method: System.Int32 TMP_Text::SetArraySizes(TMPro.TMP_Text/UnicodeChar[] unicodeChars)

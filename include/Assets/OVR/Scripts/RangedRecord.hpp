...
namespace Assets::OVR::Scripts {
  ...
  class RangedRecord : public ::Assets::OVR::Scripts::Record {
    ...
    // public System.Void .ctor(System.Int32 order, System.String cat, System.String msg, System.Single val, System.Single minVal, System.Single maxVal)
    // Offset: 0x4990170
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static RangedRecord* New_ctor(int order, ::StringW cat, ::StringW msg, float val, float minVal, float maxVal) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Assets::OVR::Scripts::RangedRecord::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<RangedRecord*, creationType>(order, cat, msg, val, minVal, maxVal)));
    }
  }; // Assets.OVR.Scripts.RangedRecord
  #pragma pack(pop)
  static check_size<sizeof(RangedRecord), 48 + sizeof(float)> __Assets_OVR_Scripts_RangedRecordSizeCheck;
  static_assert(sizeof(RangedRecord) == 0x34);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Assets::OVR::Scripts {
  ...
  class Record : public ::Il2CppObject {
    ...
    // Padding between fields: sortOrder and: category
    char __padding0[0x4] = {};
    ...
    // public System.Void .ctor(System.Int32 order, System.String cat, System.String msg)
    // Offset: 0x499011C
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static Record* New_ctor(int order, ::StringW cat, ::StringW msg) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Assets::OVR::Scripts::Record::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Record*, creationType>(order, cat, msg)));
    }
  }; // Assets.OVR.Scripts.Record
  #pragma pack(pop)
  static check_size<sizeof(Record), 32 + sizeof(::StringW)> __Assets_OVR_Scripts_RecordSizeCheck;

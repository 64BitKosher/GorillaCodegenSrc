...
namespace POpusCodec {
  ...
  class Wrapper : public ::Il2CppObject {
    ...
    // static private System.Void HandleStatusCode(POpusCodec.Enums.OpusStatusCode statusCode, params System.Object[] info)
    // Offset: 0x4A60B4C
    static void HandleStatusCode(::POpusCodec::Enums::OpusStatusCode statusCode, ::ArrayW<::Il2CppObject*> info);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::POpusCodec::Enums::OpusStatusCode, ::ArrayW<::Il2CppObject*>)>(&POpusCodec::Wrapper::HandleStatusCode)> {
  static const MethodInfo* get() {
    static auto* statusCode = &::il2cpp_utils::GetClassFromName("POpusCodec.Enums", "OpusStatusCode")->byval_arg;
    static auto* info = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Object"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(POpusCodec::Wrapper*), "HandleStatusCode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{statusCode, info});
  }
};

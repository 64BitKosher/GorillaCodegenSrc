...
namespace POpusCodec {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OpusException), 140 + sizeof(::POpusCodec::Enums::OpusStatusCode)> __POpusCodec_OpusExceptionSizeCheck;
  static_assert(sizeof(OpusException) == 0x90);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

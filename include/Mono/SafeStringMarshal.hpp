...
namespace Mono {
  ...
  struct SafeStringMarshal/*, public ::System::ValueType, public ::System::IDisposable*/ {
    ...
    // static private System.IntPtr StringToUtf8_icall(ref System.String str)
    // Offset: 0x44A1714
    static ::System::IntPtr StringToUtf8_icall(ByRef<::StringW> str);
...
// Writing MetadataGetter for method: Mono::SafeStringMarshal::StringToUtf8_icall
// Il2CppName: StringToUtf8_icall
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IntPtr (*)(ByRef<::StringW>)>(&Mono::SafeStringMarshal::StringToUtf8_icall)> {
  static const MethodInfo* get() {
    static auto* str = &::il2cpp_utils::GetClassFromName("System", "String")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::SafeStringMarshal), "StringToUtf8_icall", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{str});
  }
};

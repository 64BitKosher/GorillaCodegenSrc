...
namespace Mono::Math {
  ...
  class BigInteger_::Kernel : public ::Il2CppObject {
    public:
    // static public Mono.Math.BigInteger AddSameSign(Mono.Math.BigInteger bi1, Mono.Math.BigInteger bi2)
    // Offset: 0x44BB0B8
    static ::Mono::Math::BigInteger_* AddSameSign(::Mono::Math::BigInteger_* bi1, ::Mono::Math::BigInteger_* bi2);
...
// Writing MetadataGetter for method: Mono::Math::BigInteger_::Kernel::AddSameSign
// Il2CppName: AddSameSign
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::Math::BigInteger_* (*)(::Mono::Math::BigInteger_*, ::Mono::Math::BigInteger_*)>(&Mono::Math::BigInteger_::Kernel::AddSameSign)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Mono::Math::BigInteger_::Kernel*), "AddSameSign", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{bi1, bi2});
  }
};

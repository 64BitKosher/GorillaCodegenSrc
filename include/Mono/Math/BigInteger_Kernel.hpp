...
// Writing MetadataGetter for method: Mono::Math::BigInteger::Kernel::AddSameSign
// Il2CppName: AddSameSign
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::Math::BigInteger* (*)(::Mono::Math::BigInteger*, ::Mono::Math::BigInteger*)>(&Mono::Math::BigInteger::Kernel::AddSameSign)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Mono::Math::BigInteger::Kernel*), "AddSameSign", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{bi1, bi2});
  }
};

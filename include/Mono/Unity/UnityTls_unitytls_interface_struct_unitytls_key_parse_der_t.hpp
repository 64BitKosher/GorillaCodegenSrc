...
NEED_NO_BOX(::Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_key_parse_der_t);
...
namespace Mono::Unity {
  // Size: 0x80
  #pragma pack(push, 1)
  // Autogenerated type: Mono.Unity.UnityTls/unitytls_interface_struct/unitytls_key_parse_der_t

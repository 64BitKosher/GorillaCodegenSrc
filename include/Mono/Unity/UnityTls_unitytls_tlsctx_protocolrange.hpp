...
namespace Mono::Unity {
  ...
  struct UnityTls::unitytls_tlsctx_protocolrange/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public Mono.Unity.UnityTls/unitytls_protocol min
    [[deprecated("Use field access instead!")]] ::Mono::Unity::UnityTls::unitytls_protocol& dyn_min();
    // Get instance field reference: public Mono.Unity.UnityTls/unitytls_protocol max

...
namespace Mono {
  ...
  // Autogenerated type: Mono.ValueTuple`5
  // [TokenAttribute] Offset: FFFFFFFF
  template<typename T1, typename T2, typename T3, typename T4, typename T5>
  struct ValueTuple_5/*, public ::System::ValueType*/ {
    public:
    public:
    // public T1 Item1
    // Size: 0xFFFFFFFF
    ...
    [[deprecated("Use field access instead!")]] T1& dyn_Item1() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Mono::ValueTuple_5::dyn_Item1");
    ...
    [[deprecated("Use field access instead!")]] T2& dyn_Item2() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Mono::ValueTuple_5::dyn_Item2");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T3& dyn_Item3() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Mono::ValueTuple_5::dyn_Item3");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T4& dyn_Item4() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Mono::ValueTuple_5::dyn_Item4");
      auto ___internal__instance = *this;
    ...
    [[deprecated("Use field access instead!")]] T5& dyn_Item5() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Mono::ValueTuple_5::dyn_Item5");
      auto ___internal__instance = *this;
  ...
  // Could not write size check! Type: Mono.ValueTuple`5 is generic, or has no fields that are valid for size checks!
}

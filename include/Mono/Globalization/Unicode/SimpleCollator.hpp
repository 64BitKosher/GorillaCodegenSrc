...
namespace Mono::Globalization::Unicode {
  ...
  class SimpleCollator : public ::Il2CppObject/*, public ::System::Globalization::ISimpleCollator*/ {
    public:
    ...
    public:
    // Creating interface conversion operator: operator ::System::Globalization::ISimpleCollator
    operator ::System::Globalization::ISimpleCollator() noexcept {
      return *reinterpret_cast<::System::Globalization::ISimpleCollator*>(this);
    }
    ...
    // private System.Int32 System.Globalization.ISimpleCollator.Compare(System.String s1, System.Int32 idx1, System.Int32 len1, System.String s2, System.Int32 idx2, System.Int32 len2, System.Globalization.CompareOptions options)
    // Offset: 0x44A858C
    int System_Globalization_ISimpleCollator_Compare(::StringW s1, int idx1, int len1, ::StringW s2, int idx2, int len2, ::System::Globalization::CompareOptions options);
...
// Writing MetadataGetter for method: Mono::Globalization::Unicode::SimpleCollator::System_Globalization_ISimpleCollator_Compare
// Il2CppName: System.Globalization.ISimpleCollator.Compare
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (Mono::Globalization::Unicode::SimpleCollator::*)(::StringW, int, int, ::StringW, int, int, ::System::Globalization::CompareOptions)>(&Mono::Globalization::Unicode::SimpleCollator::System_Globalization_ISimpleCollator_Compare)> {
  static const MethodInfo* get() {
    ...
    static auto* options = &::il2cpp_utils::GetClassFromName("System.Globalization", "CompareOptions")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::Globalization::Unicode::SimpleCollator*), "System.Globalization.ISimpleCollator.Compare", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{s1, idx1, len1, s2, idx2, len2, options});
  }
};

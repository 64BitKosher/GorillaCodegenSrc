...
namespace Mono::Xml {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SmallXmlParserException), 144 + sizeof(int)> __Mono_Xml_SmallXmlParserExceptionSizeCheck;
  static_assert(sizeof(SmallXmlParserException) == 0x94);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

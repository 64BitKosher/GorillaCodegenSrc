...
namespace Mono::Net::Security {
  // Forward declaring type: AsyncWriteRequest
...
namespace Mono::Net::Security {
  ...
  class AsyncWriteRequest : public ::Mono::Net::Security::AsyncReadOrWriteRequest {
    ...
    static AsyncWriteRequest* New_ctor(::Mono::Net::Security::MobileAuthenticatedStream* parent, bool sync, ::ArrayW<uint8_t> buffer, int offset, int size) {

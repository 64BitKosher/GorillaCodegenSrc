...
namespace Mono::Security::Interface {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TlsException), 144 + sizeof(::Mono::Security::Interface::Alert*)> __Mono_Security_Interface_TlsExceptionSizeCheck;
  static_assert(sizeof(TlsException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

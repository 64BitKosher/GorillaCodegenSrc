...
namespace Mono::Security::Cryptography {
  ...
  class CryptoConvert_ : public ::Il2CppObject {
    ...
    // static private System.Security.Cryptography.RSAParameters GetParametersFromCapiPublicKeyBlob(System.Byte[] blob, System.Int32 offset)
    // Offset: 0x44AEA94
    static ::System::Security::Cryptography::RSAParameters GetParametersFromCapiPublicKeyBlob(::ArrayW<uint8_t> blob, int offset);
...
// Writing MetadataGetter for method: Mono::Security::Cryptography::CryptoConvert_::GetParametersFromCapiPrivateKeyBlob
// Il2CppName: GetParametersFromCapiPrivateKeyBlob
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::RSAParameters (*)(::ArrayW<uint8_t>, int)>(&Mono::Security::Cryptography::CryptoConvert_::GetParametersFromCapiPrivateKeyBlob)> {
  static const MethodInfo* get() {
    static auto* blob = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    static auto* offset = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::CryptoConvert_*), "GetParametersFromCapiPrivateKeyBlob", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{blob, offset});
  }
};
...
// Writing MetadataGetter for method: Mono::Security::Cryptography::CryptoConvert_::GetParametersFromCapiPublicKeyBlob
// Il2CppName: GetParametersFromCapiPublicKeyBlob
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Security::Cryptography::RSAParameters (*)(::ArrayW<uint8_t>, int)>(&Mono::Security::Cryptography::CryptoConvert_::GetParametersFromCapiPublicKeyBlob)> {
  static const MethodInfo* get() {
    static auto* blob = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    static auto* offset = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::CryptoConvert_*), "GetParametersFromCapiPublicKeyBlob", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{blob, offset});
  }
};

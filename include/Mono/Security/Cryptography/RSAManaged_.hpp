...
namespace Mono::Security::Cryptography {
  ...
  class RSAManaged_ : public ::System::Security::Cryptography::RSA {
    ...
    // Offset: 0x44B5500
    bool get_PublicOnly();
    // public System.Void add_KeyGenerated(Mono.Security.Cryptography.RSAManaged/KeyGeneratedEventHandler value)
    // Offset: 0x44B6C30
    void add_KeyGenerated(::Mono::Security::Cryptography::RSAManaged_::KeyGeneratedEventHandler* value);
    // public System.Void remove_KeyGenerated(Mono.Security.Cryptography.RSAManaged/KeyGeneratedEventHandler value)
    // Offset: 0x44B6CCC
    void remove_KeyGenerated(::Mono::Security::Cryptography::RSAManaged_::KeyGeneratedEventHandler* value);
    // public System.Boolean get_IsCrtPossible()
    // Offset: 0x44B73F4
...
// Writing MetadataGetter for method: Mono::Security::Cryptography::RSAManaged_::get_IsCrtPossible
// Il2CppName: get_IsCrtPossible
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Mono::Security::Cryptography::RSAManaged_::*)()>(&Mono::Security::Cryptography::RSAManaged_::get_IsCrtPossible)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::RSAManaged_*), "get_IsCrtPossible", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: Mono::Security::Cryptography::RSAManaged_::get_KeyExchangeAlgorithm
// Il2CppName: get_KeyExchangeAlgorithm
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Mono::Security::Cryptography::RSAManaged_::*)()>(&Mono::Security::Cryptography::RSAManaged_::get_KeyExchangeAlgorithm)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::RSAManaged_*), "get_KeyExchangeAlgorithm", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Mono::Security::Cryptography::RSAManaged_::get_SignatureAlgorithm
// Il2CppName: get_SignatureAlgorithm
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Mono::Security::Cryptography::RSAManaged_::*)()>(&Mono::Security::Cryptography::RSAManaged_::get_SignatureAlgorithm)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::RSAManaged_*), "get_SignatureAlgorithm", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Mono::Security::Cryptography::RSAManaged_::DecryptValue
// Il2CppName: DecryptValue
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::Cryptography::RSAManaged_::*)(::ArrayW<uint8_t>)>(&Mono::Security::Cryptography::RSAManaged_::DecryptValue)> {
  static const MethodInfo* get() {
    static auto* rgb = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::RSAManaged_*), "DecryptValue", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{rgb});
  }
};

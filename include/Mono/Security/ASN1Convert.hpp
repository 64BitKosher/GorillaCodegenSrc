...
namespace Mono::Security {
  ...
  class ASN1Convert : public ::Il2CppObject {
    public:
    // static public Mono.Security.ASN1 FromDateTime(System.DateTime dt)
    // Offset: 0x446C164
...
// Writing MetadataGetter for method: Mono::Security::ASN1Convert::FromDateTime
// Il2CppName: FromDateTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::Security::ASN1* (*)(::System::DateTime)>(&Mono::Security::ASN1Convert::FromDateTime)> {
  static const MethodInfo* get() {
    static auto* dt = &::il2cpp_utils::GetClassFromName("System", "DateTime")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::ASN1Convert*), "FromDateTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{dt});
  }
};

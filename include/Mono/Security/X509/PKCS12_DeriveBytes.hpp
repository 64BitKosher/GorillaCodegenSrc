...
namespace Mono::Security::X509 {
  ...
  class PKCS12::DeriveBytes : public ::Il2CppObject {
    public:
    // Nested type: ::Mono::Security::X509::PKCS12::DeriveBytes::Purpose
    struct Purpose;
    public:
    ...
    // public System.Byte[] get_Password()
    // Offset: 0x447C338
...
// Writing MetadataGetter for method: Mono::Security::X509::PKCS12::DeriveBytes::get_HashName
// Il2CppName: get_HashName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Mono::Security::X509::PKCS12::DeriveBytes::*)()>(&Mono::Security::X509::PKCS12::DeriveBytes::get_HashName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::X509::PKCS12::DeriveBytes*), "get_HashName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: Mono::Security::X509::PKCS12::DeriveBytes::get_IterationCount
// Il2CppName: get_IterationCount
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (Mono::Security::X509::PKCS12::DeriveBytes::*)()>(&Mono::Security::X509::PKCS12::DeriveBytes::get_IterationCount)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::X509::PKCS12::DeriveBytes*), "get_IterationCount", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: Mono::Security::X509::PKCS12::DeriveBytes::get_Password
// Il2CppName: get_Password
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::X509::PKCS12::DeriveBytes::*)()>(&Mono::Security::X509::PKCS12::DeriveBytes::get_Password)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::X509::PKCS12::DeriveBytes*), "get_Password", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: Mono::Security::X509::PKCS12::DeriveBytes::get_Salt
// Il2CppName: get_Salt
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::X509::PKCS12::DeriveBytes::*)()>(&Mono::Security::X509::PKCS12::DeriveBytes::get_Salt)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::X509::PKCS12::DeriveBytes*), "get_Salt", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

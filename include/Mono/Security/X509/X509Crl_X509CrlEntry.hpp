...
namespace Mono::Security::X509 {
  ...
  class X509Crl::X509CrlEntry : public ::Il2CppObject {
    ...
    // System.Void .ctor(System.Byte[] serialNumber, System.DateTime revocationDate, Mono.Security.X509.X509ExtensionCollection extensions)
    // Offset: 0x44810E0
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static X509Crl::X509CrlEntry* New_ctor(::ArrayW<uint8_t> serialNumber, ::System::DateTime revocationDate, ::Mono::Security::X509::X509ExtensionCollection* extensions) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Mono::Security::X509::X509Crl::X509CrlEntry::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<X509Crl::X509CrlEntry*, creationType>(serialNumber, revocationDate, extensions)));
    }
...
// Writing MetadataGetter for method: Mono::Security::X509::X509Crl::X509CrlEntry::GetBytes
// Il2CppName: GetBytes
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::X509::X509Crl::X509CrlEntry::*)()>(&Mono::Security::X509::X509Crl::X509CrlEntry::GetBytes)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::X509::X509Crl::X509CrlEntry*), "GetBytes", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace Pathfinding {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PathUtilities::$$c__DisplayClass6_0), 56 + sizeof(int)> __Pathfinding_PathUtilities_$$c__DisplayClass6_0SizeCheck;
  static_assert(sizeof(PathUtilities::$$c__DisplayClass6_0) == 0x3C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Pathfinding {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SimpleSmoothModifier), 80 + sizeof(float)> __Pathfinding_SimpleSmoothModifierSizeCheck;
  static_assert(sizeof(SimpleSmoothModifier) == 0x54);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

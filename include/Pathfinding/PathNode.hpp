...
namespace Pathfinding {
  ...
  class PathNode : public ::Il2CppObject {
    ...
    // public System.UInt16 heapIndex
    // Size: 0x2
    // Offset: 0x22
    uint16_t heapIndex;
    // Field size check
    ...
    // Get instance field reference: public System.UInt16 heapIndex
    [[deprecated("Use field access instead!")]] uint16_t& dyn_heapIndex();
    ...
    // Offset: 0x29BBDE4
    uint get_F();
    // public System.Void UpdateG(Pathfinding.Path path)
    // Offset: 0x29B8F24
    void UpdateG(::Pathfinding::Path* path);
...
// Writing MetadataGetter for method: Pathfinding::PathNode::UpdateG
// Il2CppName: UpdateG
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::PathNode::*)(::Pathfinding::Path*)>(&Pathfinding::PathNode::UpdateG)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("Pathfinding", "Path")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::PathNode*), "UpdateG", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path});
  }
};

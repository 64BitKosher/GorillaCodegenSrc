...
namespace Pathfinding::Serialization {
  ...
  class TinyJsonSerializer : public ::Il2CppObject {
    ...
    // private System.Void <.ctor>b__4_7(System.Object v)
    // Offset: 0x2A24DE0
    void $_ctor$b__4_7(::Il2CppObject* v);
...
// Writing MetadataGetter for method: Pathfinding::Serialization::TinyJsonSerializer::$_ctor$b__4_7
// Il2CppName: <.ctor>b__4_7
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::Serialization::TinyJsonSerializer::*)(::Il2CppObject*)>(&Pathfinding::Serialization::TinyJsonSerializer::$_ctor$b__4_7)> {
  static const MethodInfo* get() {
    static auto* v = &::il2cpp_utils::GetClassFromName("System", "Object")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Serialization::TinyJsonSerializer*), "<.ctor>b__4_7", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{v});
  }
};

...
namespace Pathfinding::Ionic::Zip {
  ...
  class ZipInputStream : public ::System::IO::Stream {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: exceptionPending and: CodecBufferSize
    char __padding9[0x1] = {};
  ...
  #pragma pack(pop)
  static check_size<sizeof(ZipInputStream), 100 + sizeof(int)> __Pathfinding_Ionic_Zip_ZipInputStreamSizeCheck;
  static_assert(sizeof(ZipInputStream) == 0x68);
}

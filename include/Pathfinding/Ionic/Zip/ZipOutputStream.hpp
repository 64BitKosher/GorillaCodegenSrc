...
namespace Pathfinding::Ionic::Zip {
  ...
  class ZipOutputStream : public ::System::IO::Stream {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: exceptionPending and: outputCounter
    char __padding9[0x6] = {};
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: needToWriteEntryHeader and: ParallelDeflater
  ...
  #pragma pack(pop)
  static check_size<sizeof(ZipOutputStream), 168 + sizeof(::Pathfinding::Ionic::Zlib::CompressionStrategy)> __Pathfinding_Ionic_Zip_ZipOutputStreamSizeCheck;
  static_assert(sizeof(ZipOutputStream) == 0xAC);
}

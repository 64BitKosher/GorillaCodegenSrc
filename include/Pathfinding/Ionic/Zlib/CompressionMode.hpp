...
DEFINE_IL2CPP_ARG_TYPE(::Pathfinding::Ionic::Zlib::CompressionMode, "Pathfinding.Ionic.Zlib", "CompressionMode");
// Type namespace: Pathfinding.Ionic.Zlib
namespace Pathfinding::Ionic::Zlib {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: Pathfinding.Ionic.Zlib.CompressionMode
  ...
  struct CompressionMode/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Pathfinding.Ionic.Zlib.CompressionMode Compress
    static constexpr const int Compress = 0;
    // Get static field: static public Pathfinding.Ionic.Zlib.CompressionMode Compress
    static ::Pathfinding::Ionic::Zlib::CompressionMode _get_Compress();
    // Set static field: static public Pathfinding.Ionic.Zlib.CompressionMode Compress
    static void _set_Compress(::Pathfinding::Ionic::Zlib::CompressionMode value);
    // static field const value: static public Pathfinding.Ionic.Zlib.CompressionMode Decompress
    static constexpr const int Decompress = 1;
    // Get static field: static public Pathfinding.Ionic.Zlib.CompressionMode Decompress
    static ::Pathfinding::Ionic::Zlib::CompressionMode _get_Decompress();
    // Set static field: static public Pathfinding.Ionic.Zlib.CompressionMode Decompress
    static void _set_Decompress(::Pathfinding::Ionic::Zlib::CompressionMode value);
    // Get instance field reference: public System.Int32 value__
    [[deprecated("Use field access instead!")]] int& dyn_value__();
  }; // Pathfinding.Ionic.Zlib.CompressionMode
  #pragma pack(pop)
  static check_size<sizeof(CompressionMode), 0 + sizeof(int)> __Pathfinding_Ionic_Zlib_CompressionModeSizeCheck;

...
NEED_NO_BOX(::Pathfinding::Ionic::Zlib::InternalConstants);
DEFINE_IL2CPP_ARG_TYPE(::Pathfinding::Ionic::Zlib::InternalConstants*, "Pathfinding.Ionic.Zlib", "InternalConstants");
// Type namespace: Pathfinding.Ionic.Zlib
namespace Pathfinding::Ionic::Zlib {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: Pathfinding.Ionic.Zlib.InternalConstants
...
// Writing MetadataGetter for method: Pathfinding::Ionic::Zlib::InternalConstants::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&Pathfinding::Ionic::Zlib::InternalConstants::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Ionic::Zlib::InternalConstants*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

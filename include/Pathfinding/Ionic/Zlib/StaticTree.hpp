...
NEED_NO_BOX(::Pathfinding::Ionic::Zlib::StaticTree);
DEFINE_IL2CPP_ARG_TYPE(::Pathfinding::Ionic::Zlib::StaticTree*, "Pathfinding.Ionic.Zlib", "StaticTree");
// Type namespace: Pathfinding.Ionic.Zlib
namespace Pathfinding::Ionic::Zlib {
  // Size: 0x2C
  #pragma pack(push, 1)
  // Autogenerated type: Pathfinding.Ionic.Zlib.StaticTree
  ...
  class StaticTree : public ::Il2CppObject {
    ...
    static StaticTree* New_ctor(::ArrayW<int16_t> treeCodes, ::ArrayW<int> extraBits, int extraBase, int elems, int maxLength) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Pathfinding::Ionic::Zlib::StaticTree::.ctor");
  ...
  #pragma pack(pop)
  static check_size<sizeof(StaticTree), 40 + sizeof(int)> __Pathfinding_Ionic_Zlib_StaticTreeSizeCheck;
  static_assert(sizeof(StaticTree) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Pathfinding::Ionic::Zlib::StaticTree::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: Pathfinding::Ionic::Zlib::StaticTree::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&Pathfinding::Ionic::Zlib::StaticTree::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Ionic::Zlib::StaticTree*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

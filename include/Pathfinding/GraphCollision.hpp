...
namespace Pathfinding {
  ...
  class GraphCollision : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    // private UnityEngine.ContactFilter2D contactFilter
    // Size: 0x1C
    // Offset: 0x54
    ::UnityEngine::ContactFilter2D contactFilter;
    // Field size check
    static_assert(sizeof(::UnityEngine::ContactFilter2D) == 0x1C);
    ...
    // Get instance field reference: private UnityEngine.ContactFilter2D contactFilter
    [[deprecated("Use field access instead!")]] ::UnityEngine::ContactFilter2D& dyn_contactFilter();
    ...
    // Get instance field reference: private UnityEngine.RaycastHit[] hitBuffer
    [[deprecated("Use field access instead!")]] ::ArrayW<::UnityEngine::RaycastHit>& dyn_hitBuffer();
    // public System.Void Initialize(Pathfinding.Util.GraphTransform transform, System.Single scale)
    // Offset: 0x29BE55C
    void Initialize(::Pathfinding::Util::GraphTransform* transform, float scale);
    ...
    // public UnityEngine.RaycastHit[] CheckHeightAll(UnityEngine.Vector3 position, out System.Int32 numHits)
    // Offset: 0x29BEEEC
    ::ArrayW<::UnityEngine::RaycastHit> CheckHeightAll(::UnityEngine::Vector3 position, ByRef<int> numHits);
  ...
  #pragma pack(pop)
  static check_size<sizeof(GraphCollision), 120 + sizeof(::ArrayW<::UnityEngine::RaycastHit>)> __Pathfinding_GraphCollisionSizeCheck;
  static_assert(sizeof(GraphCollision) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Pathfinding::GraphCollision::Initialize
// Il2CppName: Initialize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::GraphCollision::*)(::Pathfinding::Util::GraphTransform*, float)>(&Pathfinding::GraphCollision::Initialize)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::GraphCollision*), "Initialize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{transform, scale});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::RaycastHit> (Pathfinding::GraphCollision::*)(::UnityEngine::Vector3, ByRef<int>)>(&Pathfinding::GraphCollision::CheckHeightAll)> {
  static const MethodInfo* get() {
    static auto* position = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* numHits = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::GraphCollision*), "CheckHeightAll", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{position, numHits});
  }
};
...
// Writing MetadataGetter for method: Pathfinding::GraphCollision::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&Pathfinding::GraphCollision::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::GraphCollision*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace Pathfinding {
  ...
  class TargetMover : public ::UnityEngine::MonoBehaviour {
    ...
    // private Pathfinding.IAstarAI[] ais
    // Size: 0x8
    // Offset: 0x30
    ::ArrayW<::Pathfinding::IAstarAI*> ais;
    // Field size check
    static_assert(sizeof(::ArrayW<::Pathfinding::IAstarAI*>) == 0x8);
    ...
    // Get instance field reference: private Pathfinding.IAstarAI[] ais
    [[deprecated("Use field access instead!")]] ::ArrayW<::Pathfinding::IAstarAI*>& dyn_ais();

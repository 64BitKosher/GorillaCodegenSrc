...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::IPathModifier::*)(::Pathfinding::Path*)>(&Pathfinding::IPathModifier::Apply)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::IPathModifier*), "Apply", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::IPathModifier::*)(::Pathfinding::Path*)>(&Pathfinding::IPathModifier::PreProcess)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("Pathfinding", "Path")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::IPathModifier*), "PreProcess", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path});
  }
};

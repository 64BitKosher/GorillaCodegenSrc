...
namespace Pathfinding {
  ...
  class IRaycastableGraph {
    ...
    // public System.Boolean Linecast(UnityEngine.Vector3 start, UnityEngine.Vector3 end, out Pathfinding.GraphHitInfo hit, System.Collections.Generic.List`1<Pathfinding.GraphNode> trace, System.Func`2<Pathfinding.GraphNode,System.Boolean> filter)
    // Offset: 0xFFFFFFFFFFFFFFFF
    bool Linecast(::UnityEngine::Vector3 start, ::UnityEngine::Vector3 end, ByRef<::Pathfinding::GraphHitInfo> hit, ::System::Collections::Generic::List_1<::Pathfinding::GraphNode*>* trace, ::System::Func_2<::Pathfinding::GraphNode*, bool>* filter);
...
// Il2CppName: Linecast
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Pathfinding::IRaycastableGraph::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3, ByRef<::Pathfinding::GraphHitInfo>, ::System::Collections::Generic::List_1<::Pathfinding::GraphNode*>*, ::System::Func_2<::Pathfinding::GraphNode*, bool>*)>(&Pathfinding::IRaycastableGraph::Linecast)> {
  static const MethodInfo* get() {
    static auto* start = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* end = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* hit = &::il2cpp_utils::GetClassFromName("Pathfinding", "GraphHitInfo")->this_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::IRaycastableGraph*), "Linecast", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{start, end, hit, trace, filter});
  }
};

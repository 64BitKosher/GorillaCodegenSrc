...
namespace Pathfinding {
  ...
  class PathUtilities : public ::Il2CppObject {
    ...
    // static public System.Boolean IsPathPossible(Pathfinding.GraphNode node1, Pathfinding.GraphNode node2)
    // Offset: 0x2A09BE8
    static bool IsPathPossible(::Pathfinding::GraphNode* node1, ::Pathfinding::GraphNode* node2);
    ...
    // static public System.Collections.Generic.List`1<Pathfinding.GraphNode> GetReachableNodes(Pathfinding.GraphNode seed, System.Int32 tagMask, System.Func`2<Pathfinding.GraphNode,System.Boolean> filter)
    // Offset: 0x2A09DDC
    static ::System::Collections::Generic::List_1<::Pathfinding::GraphNode*>* GetReachableNodes(::Pathfinding::GraphNode* seed, int tagMask, ::System::Func_2<::Pathfinding::GraphNode*, bool>* filter);
    // static public System.Collections.Generic.List`1<Pathfinding.GraphNode> BFS(Pathfinding.GraphNode seed, System.Int32 depth, System.Int32 tagMask, System.Func`2<Pathfinding.GraphNode,System.Boolean> filter)
    // Offset: 0x2A0A090
    static ::System::Collections::Generic::List_1<::Pathfinding::GraphNode*>* BFS(::Pathfinding::GraphNode* seed, int depth, int tagMask, ::System::Func_2<::Pathfinding::GraphNode*, bool>* filter);
    ...
    // static public System.Void GetPointsAroundPoint(UnityEngine.Vector3 center, Pathfinding.IRaycastableGraph g, System.Collections.Generic.List`1<UnityEngine.Vector3> previousPoints, System.Single radius, System.Single clearanceRadius)
    // Offset: 0x2A0A934
    static void GetPointsAroundPoint(::UnityEngine::Vector3 center, ::Pathfinding::IRaycastableGraph* g, ::System::Collections::Generic::List_1<::UnityEngine::Vector3>* previousPoints, float radius, float clearanceRadius);
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::Pathfinding::GraphNode*, ::Pathfinding::GraphNode*)>(&Pathfinding::PathUtilities::IsPathPossible)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::PathUtilities*), "IsPathPossible", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{node1, node2});
  }
};
// Writing MetadataGetter for method: Pathfinding::PathUtilities::IsPathPossible
// Il2CppName: IsPathPossible
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::Pathfinding::GraphNode*>* (*)(::Pathfinding::GraphNode*, int, ::System::Func_2<::Pathfinding::GraphNode*, bool>*)>(&Pathfinding::PathUtilities::GetReachableNodes)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::PathUtilities*), "GetReachableNodes", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{seed, tagMask, filter});
  }
};
// Writing MetadataGetter for method: Pathfinding::PathUtilities::BFS
// Il2CppName: BFS
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::Pathfinding::GraphNode*>* (*)(::Pathfinding::GraphNode*, int, int, ::System::Func_2<::Pathfinding::GraphNode*, bool>*)>(&Pathfinding::PathUtilities::BFS)> {
  static const MethodInfo* get() {
    static auto* seed = &::il2cpp_utils::GetClassFromName("Pathfinding", "GraphNode")->byval_arg;
    static auto* depth = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* tagMask = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* filter = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System", "Func`2"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("Pathfinding", "GraphNode"), ::il2cpp_utils::GetClassFromName("System", "Boolean")})->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::PathUtilities*), "BFS", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{seed, depth, tagMask, filter});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Vector3, ::Pathfinding::IRaycastableGraph*, ::System::Collections::Generic::List_1<::UnityEngine::Vector3>*, float, float)>(&Pathfinding::PathUtilities::GetPointsAroundPoint)> {
  static const MethodInfo* get() {
    ...
    static auto* radius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* clearanceRadius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::PathUtilities*), "GetPointsAroundPoint", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{center, g, previousPoints, radius, clearanceRadius});
  }
};

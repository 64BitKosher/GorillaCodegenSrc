...
namespace Pathfinding {
  ...
  class Profile : public ::Il2CppObject {
    ...
    // static public System.Void WriteCSV(System.String path, params Pathfinding.Profile[] profiles)
    // Offset: 0x2A0D110
    static void WriteCSV(::StringW path, ::ArrayW<::Pathfinding::Profile*> profiles);
    // public System.Void Run(System.Action action)
    // Offset: 0x2A0D114
...
// Writing MetadataGetter for method: Pathfinding::Profile::WriteCSV
// Il2CppName: WriteCSV
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::StringW, ::ArrayW<::Pathfinding::Profile*>)>(&Pathfinding::Profile::WriteCSV)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* profiles = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Pathfinding", "Profile"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Profile*), "WriteCSV", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path, profiles});
  }
};
// Writing MetadataGetter for method: Pathfinding::Profile::Run
// Il2CppName: Run
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::Profile::*)(::System::Action*)>(&Pathfinding::Profile::Run)> {
  static const MethodInfo* get() {
    static auto* action = &::il2cpp_utils::GetClassFromName("System", "Action")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Profile*), "Run", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{action});
  }
};

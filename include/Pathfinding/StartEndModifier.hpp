...
namespace Pathfinding {
  ...
  class StartEndModifier : public ::Pathfinding::PathModifier {
    ...
    // private System.Action`1<Pathfinding.GraphNode> connectionBufferAddDelegate
    // Size: 0x8
    // Offset: 0x48
    ::System::Action_1<::Pathfinding::GraphNode*>* connectionBufferAddDelegate;
    // Field size check
    static_assert(sizeof(::System::Action_1<::Pathfinding::GraphNode*>*) == 0x8);
    public:
    // Deleting conversion operator: operator ::Pathfinding::Seeker*
    constexpr operator ::Pathfinding::Seeker*() const noexcept = delete;
    ...
    // Get instance field reference: private System.Action`1<Pathfinding.GraphNode> connectionBufferAddDelegate
    [[deprecated("Use field access instead!")]] ::System::Action_1<::Pathfinding::GraphNode*>*& dyn_connectionBufferAddDelegate();
    // private UnityEngine.Vector3 Snap(Pathfinding.ABPath path, Pathfinding.StartEndModifier/Exactness mode, System.Boolean start, out System.Boolean forceAddPoint, out System.Int32 closestConnectionIndex)
    // Offset: 0x29F7AFC
    ::UnityEngine::Vector3 Snap(::Pathfinding::ABPath* path, ::Pathfinding::StartEndModifier::Exactness mode, bool start, ByRef<bool> forceAddPoint, ByRef<int> closestConnectionIndex);
    // protected UnityEngine.Vector3 GetClampedPoint(UnityEngine.Vector3 from, UnityEngine.Vector3 to, Pathfinding.GraphNode hint)
    // Offset: 0x29F7FE8
  ...
  #pragma pack(pop)
  static check_size<sizeof(StartEndModifier), 72 + sizeof(::System::Action_1<::Pathfinding::GraphNode*>*)> __Pathfinding_StartEndModifierSizeCheck;
...
// Il2CppName: Snap
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (Pathfinding::StartEndModifier::*)(::Pathfinding::ABPath*, ::Pathfinding::StartEndModifier::Exactness, bool, ByRef<bool>, ByRef<int>)>(&Pathfinding::StartEndModifier::Snap)> {
  static const MethodInfo* get() {
    ...
    static auto* closestConnectionIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::StartEndModifier*), "Snap", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path, mode, start, forceAddPoint, closestConnectionIndex});
  }
};

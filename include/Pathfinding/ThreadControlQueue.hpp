...
namespace Pathfinding {
  ...
  class ThreadControlQueue : public ::Il2CppObject {
    ...
    // public System.Void PushFront(Pathfinding.Path path)
    // Offset: 0x29B7E64
    void PushFront(::Pathfinding::Path* path);
    // public System.Void Push(Pathfinding.Path path)
    // Offset: 0x29B7FDC
    void Push(::Pathfinding::Path* path);
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::ThreadControlQueue::*)(::Pathfinding::Path*)>(&Pathfinding::ThreadControlQueue::PushFront)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::ThreadControlQueue*), "PushFront", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Pathfinding::ThreadControlQueue::*)(::Pathfinding::Path*)>(&Pathfinding::ThreadControlQueue::Push)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("Pathfinding", "Path")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::ThreadControlQueue*), "Push", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path});
  }
};

...
namespace Cinemachine {
  ...
  class CinemachineBrain::BrainFrame : public ::Il2CppObject {
    ...
    // public System.Single blendStartPosition
    // Size: 0x4
    // Offset: 0x34
    ...
    // Get instance field reference: public System.Single blendStartPosition
    [[deprecated("Use field access instead!")]] float& dyn_blendStartPosition();
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineBrain::BrainFrame), 52 + sizeof(float)> __Cinemachine_CinemachineBrain_BrainFrameSizeCheck;
  static_assert(sizeof(CinemachineBrain::BrainFrame) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

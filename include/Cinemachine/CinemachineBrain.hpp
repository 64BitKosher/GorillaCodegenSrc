...
namespace Cinemachine {
  ...
  class CinemachineBrain : public ::UnityEngine::MonoBehaviour/*, public ::Cinemachine::ICameraOverrideStack*/ {
    public:
    ...
    class BrainFrame;
    // Nested type: ::Cinemachine::CinemachineBrain::$AfterPhysics$d__38
    class $AfterPhysics$d__38;
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Cinemachine.CinemachineBrain/UpdateMethod
    // [TokenAttribute] Offset: FFFFFFFF
    // [DocumentationSortingAttribute] Offset: FFFFFFFF
    struct UpdateMethod/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Cinemachine.CinemachineBrain/UpdateMethod FixedUpdate
      ...
      // static field const value: static public Cinemachine.CinemachineBrain/UpdateMethod LateUpdate
      ...
      // static field const value: static public Cinemachine.CinemachineBrain/UpdateMethod SmartUpdate
      ...
      // static field const value: static public Cinemachine.CinemachineBrain/UpdateMethod ManualUpdate
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Cinemachine.CinemachineBrain/BrainUpdateMethod
    // [TokenAttribute] Offset: FFFFFFFF
    // [DocumentationSortingAttribute] Offset: FFFFFFFF
    struct BrainUpdateMethod/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Cinemachine.CinemachineBrain/BrainUpdateMethod FixedUpdate
      static constexpr const int FixedUpdate = 0;
      ...
      // static field const value: static public Cinemachine.CinemachineBrain/BrainUpdateMethod LateUpdate
      static constexpr const int LateUpdate = 1;
    ...
    // public Cinemachine.CinemachineBrain/BrainUpdateMethod m_BlendUpdateMethod
    // Size: 0x4
    // Offset: 0x34
    ...
    // private UnityEngine.GameObject m_TargetOverride
    // Size: 0x8
    // Offset: 0x58
    ::UnityEngine::GameObject* m_TargetOverride;
    // Field size check
    ...
    // public Cinemachine.CinemachineBrain/VcamActivatedEvent m_CameraActivatedEvent
    // Size: 0x8
    // Offset: 0x68
    ...
    // private System.Int32 m_LastFrameUpdated
    // Size: 0x4
    // Offset: 0x78
    int m_LastFrameUpdated;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // Padding between fields: m_LastFrameUpdated and: mWaitForFixedUpdate
    ...
    // private System.Collections.Generic.List`1<Cinemachine.CinemachineBrain/BrainFrame> mFrameStack
    // Size: 0x8
    // Offset: 0x88
    ...
    public:
    // Creating interface conversion operator: operator ::Cinemachine::ICameraOverrideStack
    operator ::Cinemachine::ICameraOverrideStack() noexcept {
      return *reinterpret_cast<::Cinemachine::ICameraOverrideStack*>(this);
    }
    ...
    // Get instance field reference: public Cinemachine.CinemachineBrain/UpdateMethod m_UpdateMethod
    [[deprecated("Use field access instead!")]] ::Cinemachine::CinemachineBrain::UpdateMethod& dyn_m_UpdateMethod();
    // Get instance field reference: public Cinemachine.CinemachineBrain/BrainUpdateMethod m_BlendUpdateMethod
    ...
    // Get instance field reference: private UnityEngine.GameObject m_TargetOverride
    [[deprecated("Use field access instead!")]] ::UnityEngine::GameObject*& dyn_m_TargetOverride();
    // Get instance field reference: public Cinemachine.CinemachineBrain/BrainEvent m_CameraCutEvent
    [[deprecated("Use field access instead!")]] ::Cinemachine::CinemachineBrain_BrainEvent*& dyn_m_CameraCutEvent();
    // Get instance field reference: public Cinemachine.CinemachineBrain/VcamActivatedEvent m_CameraActivatedEvent
    ...
    // Get instance field reference: private System.Int32 m_LastFrameUpdated
    [[deprecated("Use field access instead!")]] int& dyn_m_LastFrameUpdated();
    ...
    // Get instance field reference: private System.Collections.Generic.List`1<Cinemachine.CinemachineBrain/BrainFrame> mFrameStack
    ...
    // public UnityEngine.GameObject get_ControlledObject()
    // Offset: 0x2A805B0
    ::UnityEngine::GameObject* get_ControlledObject();
    // public System.Void set_ControlledObject(UnityEngine.GameObject value)
    // Offset: 0x2A80630
    void set_ControlledObject(::UnityEngine::GameObject* value);
    ...
    // Offset: 0x2A82E84
    bool IsLiveInBlend(::Cinemachine::ICinemachineCamera* vcam);
    ...
    // public System.Void set_ActiveBlend(Cinemachine.CinemachineBlend value)
    // Offset: 0x2A83024
    void set_ActiveBlend(::Cinemachine::CinemachineBlend* value);
    ...
    // private System.Void PushStateToUnityCamera(ref Cinemachine.CameraState state)
    // Offset: 0x2A83508
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineBrain), 176 + sizeof(::Cinemachine::CameraState)> __Cinemachine_CinemachineBrainSizeCheck;
  static_assert(sizeof(CinemachineBrain) == 0x194);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachineBrain::get_ControlledObject
// Il2CppName: get_ControlledObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::GameObject* (Cinemachine::CinemachineBrain::*)()>(&Cinemachine::CinemachineBrain::get_ControlledObject)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineBrain*), "get_ControlledObject", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Cinemachine::CinemachineBrain::set_ControlledObject
// Il2CppName: set_ControlledObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Cinemachine::CinemachineBrain::*)(::UnityEngine::GameObject*)>(&Cinemachine::CinemachineBrain::set_ControlledObject)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "GameObject")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineBrain*), "set_ControlledObject", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: Cinemachine::CinemachineBrain::Awake
// Il2CppName: Awake
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Cinemachine::CinemachineBrain::*)()>(&Cinemachine::CinemachineBrain::Awake)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineBrain*), "Awake", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: Cinemachine::CinemachineBrain::IsLiveInBlend
// Il2CppName: IsLiveInBlend
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Cinemachine::CinemachineBrain::*)(::Cinemachine::ICinemachineCamera*)>(&Cinemachine::CinemachineBrain::IsLiveInBlend)> {
  static const MethodInfo* get() {
    static auto* vcam = &::il2cpp_utils::GetClassFromName("Cinemachine", "ICinemachineCamera")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineBrain*), "IsLiveInBlend", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{vcam});
  }
};
...
// Writing MetadataGetter for method: Cinemachine::CinemachineBrain::set_ActiveBlend
// Il2CppName: set_ActiveBlend
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Cinemachine::CinemachineBrain::*)(::Cinemachine::CinemachineBlend*)>(&Cinemachine::CinemachineBrain::set_ActiveBlend)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("Cinemachine", "CinemachineBlend")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineBrain*), "set_ActiveBlend", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

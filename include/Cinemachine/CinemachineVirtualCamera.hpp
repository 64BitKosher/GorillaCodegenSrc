...
namespace Cinemachine {
  ...
  class CinemachineVirtualCamera : public ::Cinemachine::CinemachineVirtualCameraBase {
    ...
    // Padding between fields: m_LegacyBlendHint and: m_State
    char __padding4[0x4] = {};
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineVirtualCamera), 520 + sizeof(::Cinemachine::CinemachineVirtualCameraBase*)> __Cinemachine_CinemachineVirtualCameraSizeCheck;
  static_assert(sizeof(CinemachineVirtualCamera) == 0x210);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachineVirtualCamera::RequiresUserInput
// Il2CppName: RequiresUserInput
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Cinemachine::CinemachineVirtualCamera::*)()>(&Cinemachine::CinemachineVirtualCamera::RequiresUserInput)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineVirtualCamera*), "RequiresUserInput", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Cinemachine::CinemachineVirtualCamera::OnBeforeSerialize
// Il2CppName: OnBeforeSerialize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Cinemachine::CinemachineVirtualCamera::*)()>(&Cinemachine::CinemachineVirtualCamera::OnBeforeSerialize)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineVirtualCamera*), "OnBeforeSerialize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

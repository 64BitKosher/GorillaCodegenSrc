...
namespace Cinemachine {
  ...
  class CinemachineConfiner : public ::Cinemachine::CinemachineExtension {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Cinemachine.CinemachineConfiner/Mode
    // [TokenAttribute] Offset: FFFFFFFF
    struct Mode/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Cinemachine.CinemachineConfiner/Mode Confine2D
      ...
      // static field const value: static public Cinemachine.CinemachineConfiner/Mode Confine3D
    ...
    static_assert(sizeof(int) == 0x4);
    public:
    // Get instance field reference: public Cinemachine.CinemachineConfiner/Mode m_ConfineMode
    ...
    // private UnityEngine.Vector3 ConfineScreenEdges(ref Cinemachine.CameraState state)
    // Offset: 0x2A8A4F8
    ::UnityEngine::Vector3 ConfineScreenEdges(ByRef<::Cinemachine::CameraState> state);
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineConfiner), 96 + sizeof(int)> __Cinemachine_CinemachineConfinerSizeCheck;
  static_assert(sizeof(CinemachineConfiner) == 0x64);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (Cinemachine::CinemachineConfiner::*)(ByRef<::Cinemachine::CameraState>)>(&Cinemachine::CinemachineConfiner::ConfineScreenEdges)> {
  static const MethodInfo* get() {
    static auto* state = &::il2cpp_utils::GetClassFromName("Cinemachine", "CameraState")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineConfiner*), "ConfineScreenEdges", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{state});
  }
};

...
namespace Cinemachine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineEmbeddedAssetPropertyAttribute), 20 + sizeof(bool)> __Cinemachine_CinemachineEmbeddedAssetPropertyAttributeSizeCheck;
  static_assert(sizeof(CinemachineEmbeddedAssetPropertyAttribute) == 0x15);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

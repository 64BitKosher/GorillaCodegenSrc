...
namespace Cinemachine {
  // Size: 0x38
  #pragma pack(push, 1)
  // Autogenerated type: Cinemachine.CinemachineStoryboard/CanvasInfo
  ...
  class CinemachineStoryboard::CanvasInfo : public ::Il2CppObject {
    ...
    // public UnityEngine.Canvas mCanvasComponent
    // Size: 0x8
    // Offset: 0x18
    ::UnityEngine::Canvas* mCanvasComponent;
    // Field size check
    ...
    // Get instance field reference: public UnityEngine.Canvas mCanvasComponent
    [[deprecated("Use field access instead!")]] ::UnityEngine::Canvas*& dyn_mCanvasComponent();
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineStoryboard::CanvasInfo), 48 + sizeof(::UnityEngine::UI::RawImage*)> __Cinemachine_CinemachineStoryboard_CanvasInfoSizeCheck;
  static_assert(sizeof(CinemachineStoryboard::CanvasInfo) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

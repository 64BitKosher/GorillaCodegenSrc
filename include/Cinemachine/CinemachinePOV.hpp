...
namespace Cinemachine {
  ...
  class CinemachinePOV : public ::Cinemachine::CinemachineComponentBase {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Cinemachine.CinemachinePOV/RecenterTargetMode
    // [TokenAttribute] Offset: FFFFFFFF
    struct RecenterTargetMode/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Cinemachine.CinemachinePOV/RecenterTargetMode None
      ...
      // static field const value: static public Cinemachine.CinemachinePOV/RecenterTargetMode FollowTargetForward
      ...
      // static field const value: static public Cinemachine.CinemachinePOV/RecenterTargetMode LookAtTargetForward
    ...
    // Padding between fields: m_ApplyBeforeBody and: m_PreviousCameraRotation
    char __padding5[0x3] = {};
    // private UnityEngine.Quaternion m_PreviousCameraRotation
    // Size: 0x10
    // Offset: 0x154
    ...
    public:
    // Get instance field reference: public Cinemachine.CinemachinePOV/RecenterTargetMode m_RecenterTarget
    ...
    // Get instance field reference: public Cinemachine.AxisState/Recentering m_VerticalRecentering
    ...
    // Get instance field reference: public Cinemachine.AxisState/Recentering m_HorizontalRecentering
    ...
    // Get instance field reference: private UnityEngine.Quaternion m_PreviousCameraRotation
    [[deprecated("Use field access instead!")]] ::UnityEngine::Quaternion& dyn_m_PreviousCameraRotation();
    ...
    // static private System.Single NormalizeAngle(System.Single angle)
    // Offset: 0x2AA3AAC
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachinePOV), 340 + sizeof(::UnityEngine::Quaternion)> __Cinemachine_CinemachinePOVSizeCheck;
  static_assert(sizeof(CinemachinePOV) == 0x164);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachinePOV::NormalizeAngle
// Il2CppName: NormalizeAngle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)(float)>(&Cinemachine::CinemachinePOV::NormalizeAngle)> {
  static const MethodInfo* get() {
    static auto* angle = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachinePOV*), "NormalizeAngle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{angle});
  }
};
...
// Writing MetadataGetter for method: Cinemachine::CinemachinePOV::get_RequiresUserInput
// Il2CppName: get_RequiresUserInput
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Cinemachine::CinemachinePOV::*)()>(&Cinemachine::CinemachinePOV::get_RequiresUserInput)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachinePOV*), "get_RequiresUserInput", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

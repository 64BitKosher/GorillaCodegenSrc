...
namespace Cinemachine {
  ...
  class CinemachineComposer : public ::Cinemachine::CinemachineComponentBase {
    ...
    // Autogenerated type: Cinemachine.CinemachineComposer/FovCache
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    // private Cinemachine.CinemachineComposer/FovCache mCache
    // Size: 0x50
    // Offset: 0xB0
    ...
    // Get instance field reference: private Cinemachine.CinemachineComposer/FovCache mCache
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineComposer), 176 + sizeof(::Cinemachine::CinemachineComposer::FovCache)> __Cinemachine_CinemachineComposerSizeCheck;
  static_assert(sizeof(CinemachineComposer) == 0x100);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

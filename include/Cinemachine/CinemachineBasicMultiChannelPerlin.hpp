...
namespace Cinemachine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineBasicMultiChannelPerlin), 76 + sizeof(::UnityEngine::Vector3)> __Cinemachine_CinemachineBasicMultiChannelPerlinSizeCheck;
  static_assert(sizeof(CinemachineBasicMultiChannelPerlin) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

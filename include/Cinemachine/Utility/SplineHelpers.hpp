...
namespace Cinemachine::Utility {
  ...
  class SplineHelpers : public ::Il2CppObject {
    ...
    // static public System.Void BezierTangentWeights3(UnityEngine.Vector3 p0, UnityEngine.Vector3 p1, UnityEngine.Vector3 p2, UnityEngine.Vector3 p3, out UnityEngine.Vector3 w0, out UnityEngine.Vector3 w1, out UnityEngine.Vector3 w2)
    // Offset: 0x2ACE394
    static void BezierTangentWeights3(::UnityEngine::Vector3 p0, ::UnityEngine::Vector3 p1, ::UnityEngine::Vector3 p2, ::UnityEngine::Vector3 p3, ByRef<::UnityEngine::Vector3> w0, ByRef<::UnityEngine::Vector3> w1, ByRef<::UnityEngine::Vector3> w2);
...
// Writing MetadataGetter for method: Cinemachine::Utility::SplineHelpers::BezierTangentWeights3
// Il2CppName: BezierTangentWeights3
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ByRef<::UnityEngine::Vector3>, ByRef<::UnityEngine::Vector3>, ByRef<::UnityEngine::Vector3>)>(&Cinemachine::Utility::SplineHelpers::BezierTangentWeights3)> {
  static const MethodInfo* get() {
    static auto* p0 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* p1 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* p2 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* p3 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* w0 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->this_arg;
    static auto* w1 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->this_arg;
    static auto* w2 = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::Utility::SplineHelpers*), "BezierTangentWeights3", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{p0, p1, p2, p3, w0, w1, w2});
  }
};

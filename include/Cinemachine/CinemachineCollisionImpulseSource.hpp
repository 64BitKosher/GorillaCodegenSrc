...
namespace Cinemachine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineCollisionImpulseSource), 80 + sizeof(::UnityEngine::Rigidbody2D*)> __Cinemachine_CinemachineCollisionImpulseSourceSizeCheck;
  static_assert(sizeof(CinemachineCollisionImpulseSource) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Cinemachine {
  ...
  class CinemachinePathBase : public ::UnityEngine::MonoBehaviour {
    ...
    // Get instance field reference: public Cinemachine.CinemachinePathBase/Appearance m_Appearance
    ...
    // public UnityEngine.Vector3 EvaluateLocalPosition(System.Single pos)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::UnityEngine::Vector3 EvaluateLocalPosition(float pos);
    // public UnityEngine.Vector3 EvaluateLocalTangent(System.Single pos)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::UnityEngine::Vector3 EvaluateLocalTangent(float pos);
    // public UnityEngine.Quaternion EvaluateLocalOrientation(System.Single pos)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ...
    // public System.Single StandardizeUnit(System.Single pos, Cinemachine.CinemachinePathBase/PositionUnits units)
    // Offset: 0x2AAE8A4
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachinePathBase), 76 + sizeof(float)> __Cinemachine_CinemachinePathBaseSizeCheck;
  static_assert(sizeof(CinemachinePathBase) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachinePathBase::EvaluateLocalPosition
// Il2CppName: EvaluateLocalPosition
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (Cinemachine::CinemachinePathBase::*)(float)>(&Cinemachine::CinemachinePathBase::EvaluateLocalPosition)> {
  static const MethodInfo* get() {
    static auto* pos = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachinePathBase*), "EvaluateLocalPosition", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pos});
  }
};
// Writing MetadataGetter for method: Cinemachine::CinemachinePathBase::EvaluateLocalTangent
// Il2CppName: EvaluateLocalTangent
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (Cinemachine::CinemachinePathBase::*)(float)>(&Cinemachine::CinemachinePathBase::EvaluateLocalTangent)> {
  static const MethodInfo* get() {
    static auto* pos = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachinePathBase*), "EvaluateLocalTangent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pos});
  }
};
// Writing MetadataGetter for method: Cinemachine::CinemachinePathBase::EvaluateLocalOrientation
// Il2CppName: EvaluateLocalOrientation
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Quaternion (Cinemachine::CinemachinePathBase::*)(float)>(&Cinemachine::CinemachinePathBase::EvaluateLocalOrientation)> {
  static const MethodInfo* get() {
    static auto* pos = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachinePathBase*), "EvaluateLocalOrientation", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pos});
  }
};

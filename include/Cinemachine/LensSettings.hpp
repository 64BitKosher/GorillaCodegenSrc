...
namespace Cinemachine {
  ...
  struct LensSettings/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public System.Single FocusDistance
  ...
  #pragma pack(pop)
  static check_size<sizeof(LensSettings), 49 + sizeof(bool)> __Cinemachine_LensSettingsSizeCheck;
  static_assert(sizeof(LensSettings) == 0x32);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

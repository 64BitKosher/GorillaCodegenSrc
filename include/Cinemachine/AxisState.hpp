...
namespace Cinemachine {
  ...
  struct AxisState/*, public ::System::ValueType*/ {
    ...
    struct Recentering/*, public ::System::ValueType*/ {
      ...
      constexpr Recentering(bool m_enabled_ = {}, float m_WaitTime_ = {}, float m_RecenteringTime_ = {}, float m_LastUpdateTime_ = {}, float mLastAxisInputTime_ = {}, float mRecenteringVelocity_ = {}, int m_LegacyHeadingDefinition_ = {}, int m_LegacyVelocityFilterStrength_ = {}) noexcept : m_enabled{m_enabled_}, m_WaitTime{m_WaitTime_}, m_RecenteringTime{m_RecenteringTime_}, m_LastUpdateTime{m_LastUpdateTime_}, mLastAxisInputTime{mLastAxisInputTime_}, mRecenteringVelocity{mRecenteringVelocity_}, m_LegacyHeadingDefinition{m_LegacyHeadingDefinition_}, m_LegacyVelocityFilterStrength{m_LegacyVelocityFilterStrength_} {}
    ...
    #pragma pack(pop)
    static check_size<sizeof(AxisState::Recentering), 28 + sizeof(int)> __Cinemachine_AxisState_RecenteringSizeCheck;
    static_assert(sizeof(AxisState::Recentering) == 0x20);
    public:
    ...
    constexpr AxisState(float Value_ = {}, ::Cinemachine::AxisState::SpeedMode m_SpeedMode_ = {}, float m_MaxSpeed_ = {}, float m_AccelTime_ = {}, float m_DecelTime_ = {}, ::StringW m_InputAxisName_ = {}, float m_InputAxisValue_ = {}, bool m_InvertInput_ = {}, float m_MinValue_ = {}, float m_MaxValue_ = {}, bool m_Wrap_ = {}, ::Cinemachine::AxisState::Recentering m_Recentering_ = {}, float m_CurrentSpeed_ = {}, float m_LastUpdateTime_ = {}, int m_LastUpdateFrame_ = {}, ::Cinemachine::AxisState::IInputAxisProvider* m_InputAxisProvider_ = {}, int m_InputAxisIndex_ = {}, bool ValueRangeLocked_ = {}, bool HasRecentering_ = {}) noexcept : Value{Value_}, m_SpeedMode{m_SpeedMode_}, m_MaxSpeed{m_MaxSpeed_}, m_AccelTime{m_AccelTime_}, m_DecelTime{m_DecelTime_}, m_InputAxisName{m_InputAxisName_}, m_InputAxisValue{m_InputAxisValue_}, m_InvertInput{m_InvertInput_}, m_MinValue{m_MinValue_}, m_MaxValue{m_MaxValue_}, m_Wrap{m_Wrap_}, m_Recentering{m_Recentering_}, m_CurrentSpeed{m_CurrentSpeed_}, m_LastUpdateTime{m_LastUpdateTime_}, m_LastUpdateFrame{m_LastUpdateFrame_}, m_InputAxisProvider{m_InputAxisProvider_}, m_InputAxisIndex{m_InputAxisIndex_}, ValueRangeLocked{ValueRangeLocked_}, HasRecentering{HasRecentering_} {}
    // Creating interface conversion operator: operator ::System::ValueType
    operator ::System::ValueType() noexcept {
      return *reinterpret_cast<::System::ValueType*>(this);
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(AxisState), 109 + sizeof(bool)> __Cinemachine_AxisStateSizeCheck;
  static_assert(sizeof(AxisState) == 0x6E);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

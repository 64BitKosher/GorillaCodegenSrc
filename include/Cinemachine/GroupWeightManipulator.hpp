...
namespace Cinemachine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GroupWeightManipulator), 64 + sizeof(::Cinemachine::CinemachineTargetGroup*)> __Cinemachine_GroupWeightManipulatorSizeCheck;
  static_assert(sizeof(GroupWeightManipulator) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

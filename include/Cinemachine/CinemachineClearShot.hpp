...
namespace Cinemachine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineClearShot), 520 + sizeof(::Cinemachine::ICinemachineCamera*)> __Cinemachine_CinemachineClearShotSizeCheck;
  static_assert(sizeof(CinemachineClearShot) == 0x210);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachineClearShot::get_ActiveBlend
// Il2CppName: get_ActiveBlend
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Cinemachine::CinemachineBlend* (Cinemachine::CinemachineClearShot::*)()>(&Cinemachine::CinemachineClearShot::get_ActiveBlend)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineClearShot*), "get_ActiveBlend", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

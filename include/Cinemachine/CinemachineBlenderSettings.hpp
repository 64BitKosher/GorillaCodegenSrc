...
namespace Cinemachine {
  ...
  class CinemachineBlenderSettings : public ::UnityEngine::ScriptableObject {
    ...
    // Autogenerated type: Cinemachine.CinemachineBlenderSettings/CustomBlend
    // [TokenAttribute] Offset: FFFFFFFF
    // [DocumentationSortingAttribute] Offset: FFFFFFFF
    ...
    // Get instance field reference: public Cinemachine.CinemachineBlenderSettings/CustomBlend[] m_CustomBlends

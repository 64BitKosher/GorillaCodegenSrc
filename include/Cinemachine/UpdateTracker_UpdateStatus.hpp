...
namespace Cinemachine {
  // Size: 0x68
  #pragma pack(push, 1)
  // Autogenerated type: Cinemachine.UpdateTracker/UpdateStatus
  ...
  class UpdateTracker::UpdateStatus : public ::Il2CppObject {
    ...
    // private Cinemachine.UpdateTracker/UpdateClock <PreferredUpdate>k__BackingField
    // Size: 0x4
    // Offset: 0x64
    ...
    // Get instance field reference: private Cinemachine.UpdateTracker/UpdateClock <PreferredUpdate>k__BackingField
    [[deprecated("Use field access instead!")]] ::Cinemachine::UpdateTracker::UpdateClock& dyn_$PreferredUpdate$k__BackingField();
    // public Cinemachine.UpdateTracker/UpdateClock get_PreferredUpdate()
    // Offset: 0x2AB671C

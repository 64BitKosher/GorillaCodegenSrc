...
namespace Cinemachine {
  ...
  class CinemachineInputProvider : public ::UnityEngine::MonoBehaviour/*, public ::Cinemachine::AxisState::IInputAxisProvider*/ {
    public:
    // Nested type: ::Cinemachine::CinemachineInputProvider::$$c__DisplayClass7_0
    ...
    // public System.Boolean AutoEnableInputs
    // Size: 0x1
    // Offset: 0x24
    bool AutoEnableInputs;
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: AutoEnableInputs and: XYAxis
    char __padding1[0x3] = {};
    ...
    // Get instance field reference: public System.Boolean AutoEnableInputs
    [[deprecated("Use field access instead!")]] bool& dyn_AutoEnableInputs();
    ...
    // static UnityEngine.InputSystem.InputAction <ResolveForPlayer>g__GetFirstMatch|7_0(in UnityEngine.InputSystem.Users.InputUser user, UnityEngine.InputSystem.InputActionReference aRef)
    // Offset: 0x2AB6BA8
    static ::UnityEngine::InputSystem::InputAction* $ResolveForPlayer$g__GetFirstMatch_7_0(ByRef<::UnityEngine::InputSystem::Users::InputUser> user, ::UnityEngine::InputSystem::InputActionReference* aRef);
  }; // Cinemachine.CinemachineInputProvider
  #pragma pack(pop)
  static check_size<sizeof(CinemachineInputProvider), 56 + sizeof(::ArrayW<::UnityEngine::InputSystem::InputAction*>)> __Cinemachine_CinemachineInputProviderSizeCheck;
  static_assert(sizeof(CinemachineInputProvider) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachineInputProvider::$ResolveForPlayer$g__GetFirstMatch_7_0
// Il2CppName: <ResolveForPlayer>g__GetFirstMatch|7_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::InputAction* (*)(ByRef<::UnityEngine::InputSystem::Users::InputUser>, ::UnityEngine::InputSystem::InputActionReference*)>(&Cinemachine::CinemachineInputProvider::$ResolveForPlayer$g__GetFirstMatch_7_0)> {
  static const MethodInfo* get() {
    static auto* user = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem.Users", "InputUser")->this_arg;
    static auto* aRef = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputActionReference")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineInputProvider*), "<ResolveForPlayer>g__GetFirstMatch|7_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{user, aRef});
  }
};

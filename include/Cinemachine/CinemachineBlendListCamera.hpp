...
namespace Cinemachine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineBlendListCamera), 464 + sizeof(::Cinemachine::CinemachineBlend*)> __Cinemachine_CinemachineBlendListCameraSizeCheck;
  static_assert(sizeof(CinemachineBlendListCamera) == 0x1D8);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Cinemachine::CinemachineBlendListCamera::Reset
// Il2CppName: Reset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Cinemachine::CinemachineBlendListCamera::*)()>(&Cinemachine::CinemachineBlendListCamera::Reset)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineBlendListCamera*), "Reset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

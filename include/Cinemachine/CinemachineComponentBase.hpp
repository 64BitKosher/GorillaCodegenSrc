...
namespace Cinemachine {
  ...
  class CinemachineComponentBase : public ::UnityEngine::MonoBehaviour {
    ...
    // public Cinemachine.CinemachineCore/Stage get_Stage()
    // Offset: 0xFFFFFFFFFFFFFFFF
    ...
    // public System.Boolean OnTransitionFromCamera(Cinemachine.ICinemachineCamera fromCam, UnityEngine.Vector3 worldUp, System.Single deltaTime, ref Cinemachine.CinemachineVirtualCameraBase/TransitionParams transitionParams)
    // Offset: 0x2AAB894
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineComponentBase), 32 + sizeof(::Cinemachine::CinemachineVirtualCameraBase*)> __Cinemachine_CinemachineComponentBaseSizeCheck;
  static_assert(sizeof(CinemachineComponentBase) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachineComponentBase::get_RequiresUserInput
// Il2CppName: get_RequiresUserInput
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Cinemachine::CinemachineComponentBase::*)()>(&Cinemachine::CinemachineComponentBase::get_RequiresUserInput)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineComponentBase*), "get_RequiresUserInput", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace Cinemachine {
  ...
  class CinemachineCollider : public ::Cinemachine::CinemachineExtension {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Cinemachine.CinemachineCollider/ResolutionStrategy
    // [TokenAttribute] Offset: FFFFFFFF
    struct ResolutionStrategy/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Cinemachine.CinemachineCollider/ResolutionStrategy PullCameraForward
      ...
      // static field const value: static public Cinemachine.CinemachineCollider/ResolutionStrategy PreserveCameraHeight
      ...
      // static field const value: static public Cinemachine.CinemachineCollider/ResolutionStrategy PreserveCameraDistance
    ...
    public:
    // static field const value: static private System.Single k_PrecisionSlush
    static constexpr const float k_PrecisionSlush = 0.001;
    // Get static field: static private System.Single k_PrecisionSlush
    static float _get_k_PrecisionSlush();
    // Set static field: static private System.Single k_PrecisionSlush
    static void _set_k_PrecisionSlush(float value);
    // static field const value: static private System.Single k_AngleThreshold
    static constexpr const float k_AngleThreshold = 0.1;
    // Get static field: static private System.Single k_AngleThreshold
    static float _get_k_AngleThreshold();
    // Set static field: static private System.Single k_AngleThreshold
    static void _set_k_AngleThreshold(float value);
    // Get static field: static private UnityEngine.Collider[] s_ColliderBuffer
    static ::ArrayW<::UnityEngine::Collider*> _get_s_ColliderBuffer();
    // Set static field: static private UnityEngine.Collider[] s_ColliderBuffer
    static void _set_s_ColliderBuffer(::ArrayW<::UnityEngine::Collider*> value);
    ...
    // Get instance field reference: public Cinemachine.CinemachineCollider/ResolutionStrategy m_Strategy
    ...
    // private UnityEngine.Vector3 PreserveLineOfSight(ref Cinemachine.CameraState state, ref Cinemachine.CinemachineCollider/VcamExtraState extra)
    // Offset: 0x2A8695C
    ::UnityEngine::Vector3 PreserveLineOfSight(ByRef<::Cinemachine::CameraState> state, ByRef<::Cinemachine::CinemachineCollider::VcamExtraState*> extra);
    ...
    // static private System.Single ClampRayToBounds(UnityEngine.Ray ray, System.Single distance, UnityEngine.Bounds bounds)
    // Offset: 0x2A89398
    static float ClampRayToBounds(::UnityEngine::Ray ray, float distance, ::UnityEngine::Bounds bounds);
    ...
    // static private System.Boolean IsTargetOffscreen(Cinemachine.CameraState state)
    // Offset: 0x2A87924
    static bool IsTargetOffscreen(::Cinemachine::CameraState state);
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineCollider), 112 + sizeof(::ArrayW<::UnityEngine::RaycastHit>)> __Cinemachine_CinemachineColliderSizeCheck;
...
// Writing MetadataGetter for method: Cinemachine::CinemachineCollider::PreserveLineOfSight
// Il2CppName: PreserveLineOfSight
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (Cinemachine::CinemachineCollider::*)(ByRef<::Cinemachine::CameraState>, ByRef<::Cinemachine::CinemachineCollider::VcamExtraState*>)>(&Cinemachine::CinemachineCollider::PreserveLineOfSight)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineCollider*), "PreserveLineOfSight", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{state, extra});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)(::UnityEngine::Ray, float, ::UnityEngine::Bounds)>(&Cinemachine::CinemachineCollider::ClampRayToBounds)> {
  static const MethodInfo* get() {
    static auto* ray = &::il2cpp_utils::GetClassFromName("UnityEngine", "Ray")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (Cinemachine::CinemachineCollider::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&Cinemachine::CinemachineCollider::RespectCameraRadius)> {
  static const MethodInfo* get() {
    static auto* cameraPos = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* lookAtPos = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineCollider*), "RespectCameraRadius", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{cameraPos, lookAtPos});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::Cinemachine::CameraState)>(&Cinemachine::CinemachineCollider::IsTargetOffscreen)> {
  static const MethodInfo* get() {
    static auto* state = &::il2cpp_utils::GetClassFromName("Cinemachine", "CameraState")->byval_arg;
...
// Writing MetadataGetter for method: Cinemachine::CinemachineCollider::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&Cinemachine::CinemachineCollider::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineCollider*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace Cinemachine {
  ...
  class CinemachineStateDrivenCamera : public ::Cinemachine::CinemachineVirtualCameraBase {
    ...
    // Autogenerated type: Cinemachine.CinemachineStateDrivenCamera/Instruction
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    #pragma pack(push, 1)
    // WARNING Layout: Sequential may not be correctly taken into account!
    // Autogenerated type: Cinemachine.CinemachineStateDrivenCamera/ParentHash
    // [TokenAttribute] Offset: FFFFFFFF
    // [DocumentationSortingAttribute] Offset: FFFFFFFF
    ...
    #pragma pack(push, 1)
    // WARNING Layout: Sequential may not be correctly taken into account!
    // Autogenerated type: Cinemachine.CinemachineStateDrivenCamera/HashPair
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    // Cinemachine.CinemachineStateDrivenCamera/ParentHash[] m_ParentHash
    // Size: 0x8
    // Offset: 0xF0
    ...
    // private Cinemachine.ICinemachineCamera m_TransitioningFrom
    // Size: 0x8
    // Offset: 0x100
    ::Cinemachine::ICinemachineCamera* m_TransitioningFrom;
    // Field size check
    static_assert(sizeof(::Cinemachine::ICinemachineCamera*) == 0x8);
    ...
    // private System.Collections.Generic.Dictionary`2<UnityEngine.AnimationClip,System.Collections.Generic.List`1<Cinemachine.CinemachineStateDrivenCamera/HashPair>> mHashCache
    // Size: 0x8
    // Offset: 0x1F0
    ...
    // Get instance field reference: public Cinemachine.CinemachineStateDrivenCamera/Instruction[] m_Instructions
    ...
    // Get instance field reference: Cinemachine.CinemachineStateDrivenCamera/ParentHash[] m_ParentHash
    ...
    // Get instance field reference: private Cinemachine.ICinemachineCamera m_TransitioningFrom
    [[deprecated("Use field access instead!")]] ::Cinemachine::ICinemachineCamera*& dyn_m_TransitioningFrom();
    ...
    // Get instance field reference: private System.Collections.Generic.Dictionary`2<UnityEngine.AnimationClip,System.Collections.Generic.List`1<Cinemachine.CinemachineStateDrivenCamera/HashPair>> mHashCache
    ...
    // Get instance field reference: private Cinemachine.CinemachineStateDrivenCamera/Instruction mActiveInstruction
    ...
    // Get instance field reference: private Cinemachine.CinemachineStateDrivenCamera/Instruction mPendingInstruction
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineStateDrivenCamera), 592 + sizeof(::System::Collections::Generic::List_1<::UnityEngine::AnimatorClipInfo>*)> __Cinemachine_CinemachineStateDrivenCameraSizeCheck;
  static_assert(sizeof(CinemachineStateDrivenCamera) == 0x258);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: Cinemachine::CinemachineStateDrivenCamera::get_ActiveBlend
// Il2CppName: get_ActiveBlend
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Cinemachine::CinemachineBlend* (Cinemachine::CinemachineStateDrivenCamera::*)()>(&Cinemachine::CinemachineStateDrivenCamera::get_ActiveBlend)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Cinemachine::CinemachineStateDrivenCamera*), "get_ActiveBlend", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

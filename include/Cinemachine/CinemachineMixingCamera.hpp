...
namespace Cinemachine {
  ...
  class CinemachineMixingCamera : public ::Cinemachine::CinemachineVirtualCameraBase {
    public:
    // Writing base type padding for base size: 0xA2 to desired offset: 0xA4
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineMixingCamera), 464 + sizeof(::System::Collections::Generic::Dictionary_2<::Cinemachine::CinemachineVirtualCameraBase*, int>*)> __Cinemachine_CinemachineMixingCameraSizeCheck;
  static_assert(sizeof(CinemachineMixingCamera) == 0x1D8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

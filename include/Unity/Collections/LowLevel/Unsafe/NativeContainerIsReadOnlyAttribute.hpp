...
namespace Unity::Collections::LowLevel::Unsafe {
  ...
  class NativeContainerIsReadOnlyAttribute : public ::System::Attribute {
    ...
    static NativeContainerIsReadOnlyAttribute* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Unity::Collections::LowLevel::Unsafe::NativeContainerIsReadOnlyAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NativeContainerIsReadOnlyAttribute*, creationType>()));
    }
  }; // Unity.Collections.LowLevel.Unsafe.NativeContainerIsReadOnlyAttribute
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Unity::Collections::LowLevel::Unsafe::NativeContainerIsReadOnlyAttribute::New_ctor
// Il2CppName: .ctor

...
namespace Unity::Collections {
  ...
  struct Allocator/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Unity.Collections.Allocator FirstUserIndex
    static constexpr const int FirstUserIndex = 64;
    // Get static field: static public Unity.Collections.Allocator FirstUserIndex
    static ::Unity::Collections::Allocator _get_FirstUserIndex();
    // Set static field: static public Unity.Collections.Allocator FirstUserIndex
    static void _set_FirstUserIndex(::Unity::Collections::Allocator value);

...
namespace Unity::XR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OpenVRHMD), 504 + sizeof(::UnityEngine::InputSystem::Controls::Vector3Control*)> __Unity_XR_OpenVR_OpenVRHMDSizeCheck;
  static_assert(sizeof(OpenVRHMD) == 0x200);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

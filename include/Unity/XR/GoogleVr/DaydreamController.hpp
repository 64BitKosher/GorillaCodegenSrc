...
namespace Unity::XR::GoogleVr {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DaydreamController), 480 + sizeof(::UnityEngine::InputSystem::Controls::Vector3Control*)> __Unity_XR_GoogleVr_DaydreamControllerSizeCheck;
  static_assert(sizeof(DaydreamController) == 0x1E8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

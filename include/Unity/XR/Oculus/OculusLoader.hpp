...
namespace Unity::XR::Oculus {
  ...
  class OculusLoader : public ::UnityEngine::XR::Management::XRLoaderHelper {
    ...
    // static private Unity.XR.Oculus.OculusLoader/DeviceSupportedResult IsDeviceSupported()
    // Offset: 0x54484D8
    ...
    // private System.Boolean CheckUnityVersionCompatibility()
    // Offset: 0x54489B4
...
// Writing MetadataGetter for method: Unity::XR::Oculus::OculusLoader::CheckUnityVersionCompatibility
// Il2CppName: CheckUnityVersionCompatibility
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Unity::XR::Oculus::OculusLoader::*)()>(&Unity::XR::Oculus::OculusLoader::CheckUnityVersionCompatibility)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Unity::XR::Oculus::OculusLoader*), "CheckUnityVersionCompatibility", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

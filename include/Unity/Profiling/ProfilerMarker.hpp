...
namespace Unity::Profiling {
  ...
  struct ProfilerMarker/*, public ::System::ValueType*/ {
    ...
    // public System.Void .ctor(Unity.Profiling.ProfilerCategory category, System.String name)
    // Offset: 0x54782C0
    ProfilerMarker(::Unity::Profiling::ProfilerCategory category, ::StringW name);

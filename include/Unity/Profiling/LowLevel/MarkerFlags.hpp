...
namespace Unity::Profiling::LowLevel {
  ...
  struct MarkerFlags/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Unity.Profiling.LowLevel.MarkerFlags AvailabilityNonDevelopment
    static constexpr const uint16_t AvailabilityNonDevelopment = 8u;
    // Get static field: static public Unity.Profiling.LowLevel.MarkerFlags AvailabilityNonDevelopment
    static ::Unity::Profiling::LowLevel::MarkerFlags _get_AvailabilityNonDevelopment();
    // Set static field: static public Unity.Profiling.LowLevel.MarkerFlags AvailabilityNonDevelopment
    static void _set_AvailabilityNonDevelopment(::Unity::Profiling::LowLevel::MarkerFlags value);
    ...
    // static field const value: static public Unity.Profiling.LowLevel.MarkerFlags SampleGPU
    static constexpr const uint16_t SampleGPU = 256u;
    // Get static field: static public Unity.Profiling.LowLevel.MarkerFlags SampleGPU
    static ::Unity::Profiling::LowLevel::MarkerFlags _get_SampleGPU();
    // Set static field: static public Unity.Profiling.LowLevel.MarkerFlags SampleGPU
    static void _set_SampleGPU(::Unity::Profiling::LowLevel::MarkerFlags value);

...
// Writing MetadataGetter for method: Newtonsoft::Json::Serialization::DefaultContractResolver::set_NamingStrategy
// Il2CppName: set_NamingStrategy
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Serialization::DefaultContractResolver::*)(::Newtonsoft::Json::Serialization::NamingStrategy*)>(&Newtonsoft::Json::Serialization::DefaultContractResolver::set_NamingStrategy)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("Newtonsoft.Json.Serialization", "NamingStrategy")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::Serialization::DefaultContractResolver*), "set_NamingStrategy", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

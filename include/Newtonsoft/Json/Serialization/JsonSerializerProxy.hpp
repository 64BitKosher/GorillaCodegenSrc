...
namespace Newtonsoft::Json::Serialization {
  ...
  class JsonSerializerProxy : public ::Newtonsoft::Json::JsonSerializer {
    ...
    // public override System.Void set_Formatting(Newtonsoft.Json.Formatting value)
    // Offset: 0x47389F8
    // Implemented from: Newtonsoft.Json.JsonSerializer
    // Base method: System.Void JsonSerializer::set_Formatting(Newtonsoft.Json.Formatting value)
...
// Writing MetadataGetter for method: Newtonsoft::Json::Serialization::JsonSerializerProxy::set_Formatting
// Il2CppName: set_Formatting
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Serialization::JsonSerializerProxy::*)(::Newtonsoft::Json::Formatting)>(&Newtonsoft::Json::Serialization::JsonSerializerProxy::set_Formatting)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("Newtonsoft.Json", "Formatting")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::Serialization::JsonSerializerProxy*), "set_Formatting", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

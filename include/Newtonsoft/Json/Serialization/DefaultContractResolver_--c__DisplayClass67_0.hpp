...
namespace Newtonsoft::Json::Serialization {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: Newtonsoft.Json.Serialization.DefaultContractResolver/<>c__DisplayClass67_0
  ...
  }; // Newtonsoft.Json.Serialization.DefaultContractResolver/<>c__DisplayClass67_0
  #pragma pack(pop)

...
namespace Newtonsoft::Json::Linq {
  // Forward declaring type: LineInfoHandling
...
namespace Newtonsoft::Json::Linq {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: Newtonsoft.Json.Linq.LineInfoHandling
  // [TokenAttribute] Offset: FFFFFFFF
  struct LineInfoHandling/*, public ::System::Enum*/ {
    public:
    public:
    ...
    public:
    // Creating value type constructor for type: LineInfoHandling
    constexpr LineInfoHandling(int value_ = {}) noexcept : value{value_} {}
    ...
    // static field const value: static public Newtonsoft.Json.Linq.LineInfoHandling Ignore
    static constexpr const int Ignore = 0;
    // Get static field: static public Newtonsoft.Json.Linq.LineInfoHandling Ignore
    static ::Newtonsoft::Json::Linq::LineInfoHandling _get_Ignore();
    // Set static field: static public Newtonsoft.Json.Linq.LineInfoHandling Ignore
    static void _set_Ignore(::Newtonsoft::Json::Linq::LineInfoHandling value);
    // static field const value: static public Newtonsoft.Json.Linq.LineInfoHandling Load
    static constexpr const int Load = 1;
    // Get static field: static public Newtonsoft.Json.Linq.LineInfoHandling Load
    static ::Newtonsoft::Json::Linq::LineInfoHandling _get_Load();
  ...
  static_assert(sizeof(LineInfoHandling) == 0x4);
}

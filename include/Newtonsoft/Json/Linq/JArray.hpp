...
namespace Newtonsoft::Json::Linq {
  ...
  #pragma pack(pop)
  static check_size<sizeof(JArray), 88 + sizeof(::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JToken*>*)> __Newtonsoft_Json_Linq_JArraySizeCheck;
  static_assert(sizeof(JArray) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Newtonsoft::Json::Linq {
  ...
  class JProperty : public ::Newtonsoft::Json::Linq::JContainer {
    ...
    class JPropertyList;
    public:
    // private readonly Newtonsoft.Json.Linq.JProperty/JPropertyList _content
    // Size: 0x8
    // Offset: 0x58
    ...
    public:
    // Get instance field reference: private readonly Newtonsoft.Json.Linq.JProperty/JPropertyList _content
  ...
  #pragma pack(pop)
  static check_size<sizeof(JProperty), 96 + sizeof(::StringW)> __Newtonsoft_Json_Linq_JPropertySizeCheck;
  static_assert(sizeof(JProperty) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Newtonsoft::Json::Linq::JProperty::*)(int, ::Newtonsoft::Json::Linq::JToken*, bool)>(&Newtonsoft::Json::Linq::JProperty::InsertItem)> {
  static const MethodInfo* get() {
    static auto* index = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* item = &::il2cpp_utils::GetClassFromName("Newtonsoft.Json.Linq", "JToken")->byval_arg;

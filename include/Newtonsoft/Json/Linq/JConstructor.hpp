...
namespace Newtonsoft::Json::Linq {
  ...
  #pragma pack(pop)
  static check_size<sizeof(JConstructor), 96 + sizeof(::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JToken*>*)> __Newtonsoft_Json_Linq_JConstructorSizeCheck;
  static_assert(sizeof(JConstructor) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
// Writing MetadataGetter for method: Newtonsoft::Json::JsonSerializerSettings::set_MissingMemberHandling
// Il2CppName: set_MissingMemberHandling
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::JsonSerializerSettings::*)(::Newtonsoft::Json::MissingMemberHandling)>(&Newtonsoft::Json::JsonSerializerSettings::set_MissingMemberHandling)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("Newtonsoft.Json", "MissingMemberHandling")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::JsonSerializerSettings*), "set_MissingMemberHandling", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: Newtonsoft::Json::JsonSerializerSettings::set_ConstructorHandling
// Il2CppName: set_ConstructorHandling
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::JsonSerializerSettings::*)(::Newtonsoft::Json::ConstructorHandling)>(&Newtonsoft::Json::JsonSerializerSettings::set_ConstructorHandling)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("Newtonsoft.Json", "ConstructorHandling")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::JsonSerializerSettings*), "set_ConstructorHandling", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: Newtonsoft::Json::JsonSerializerSettings::set_ContractResolver
// Il2CppName: set_ContractResolver
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::JsonSerializerSettings::*)(::Newtonsoft::Json::Serialization::IContractResolver*)>(&Newtonsoft::Json::JsonSerializerSettings::set_ContractResolver)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("Newtonsoft.Json.Serialization", "IContractResolver")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::JsonSerializerSettings*), "set_ContractResolver", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

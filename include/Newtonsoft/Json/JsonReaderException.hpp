...
namespace Newtonsoft::Json {
  ...
  #pragma pack(pop)
  static check_size<sizeof(JsonReaderException), 152 + sizeof(::StringW)> __Newtonsoft_Json_JsonReaderExceptionSizeCheck;
  static_assert(sizeof(JsonReaderException) == 0xA0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

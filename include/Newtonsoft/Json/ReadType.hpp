...
namespace Newtonsoft::Json {
  ...
  struct ReadType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Newtonsoft.Json.ReadType ReadAsInt64
    static constexpr const int ReadAsInt64 = 2;
    // Get static field: static public Newtonsoft.Json.ReadType ReadAsInt64
    static ::Newtonsoft::Json::ReadType _get_ReadAsInt64();
    // Set static field: static public Newtonsoft.Json.ReadType ReadAsInt64
    static void _set_ReadAsInt64(::Newtonsoft::Json::ReadType value);
    // static field const value: static public Newtonsoft.Json.ReadType ReadAsBytes
    static constexpr const int ReadAsBytes = 3;
    ...
    static constexpr const int ReadAsString = 4;
    ...
    static constexpr const int ReadAsDecimal = 5;
    ...
    static constexpr const int ReadAsDateTime = 6;
    ...
    static constexpr const int ReadAsDateTimeOffset = 7;
    ...
    static constexpr const int ReadAsDouble = 8;
    ...
    static constexpr const int ReadAsBoolean = 9;

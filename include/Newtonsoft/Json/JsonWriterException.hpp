...
namespace Newtonsoft::Json {
  ...
  #pragma pack(pop)
  static check_size<sizeof(JsonWriterException), 144 + sizeof(::StringW)> __Newtonsoft_Json_JsonWriterExceptionSizeCheck;
  static_assert(sizeof(JsonWriterException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

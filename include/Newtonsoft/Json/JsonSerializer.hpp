...
// Writing MetadataGetter for method: Newtonsoft::Json::JsonSerializer::set_Formatting
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::JsonSerializer::*)(::Newtonsoft::Json::Formatting)>(&Newtonsoft::Json::JsonSerializer::set_Formatting)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::JsonSerializer*), "set_Formatting", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

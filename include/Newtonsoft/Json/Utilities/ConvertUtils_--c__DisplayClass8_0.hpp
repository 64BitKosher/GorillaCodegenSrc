...
NEED_NO_BOX(::Newtonsoft::Json::Utilities::ConvertUtils::$$c__DisplayClass8_0);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Utilities::ConvertUtils::$$c__DisplayClass8_0*, "Newtonsoft.Json.Utilities", "ConvertUtils/<>c__DisplayClass8_0");
// Type namespace: Newtonsoft.Json.Utilities
namespace Newtonsoft::Json::Utilities {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: Newtonsoft.Json.Utilities.ConvertUtils/<>c__DisplayClass8_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  class ConvertUtils::$$c__DisplayClass8_0 : public ::Il2CppObject {
    public:
    public:
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (Newtonsoft::Json::Utilities::ConvertUtils::$$c__DisplayClass8_0::*)(::Il2CppObject*)>(&Newtonsoft::Json::Utilities::ConvertUtils::$$c__DisplayClass8_0::$CreateCastConverter$b__0)> {

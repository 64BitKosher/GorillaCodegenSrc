...
namespace Newtonsoft::Json::Utilities {
  ...
  class StringUtils : public ::Il2CppObject {
    public:
    // Nested type: ::Newtonsoft::Json::Utilities::StringUtils::SeparatedCaseState
    struct SeparatedCaseState;
    ...
    // static public System.String ToSnakeCase(System.String s)
    // Offset: 0x471544C
    static ::StringW ToSnakeCase(::StringW s);
    // static public System.String ToKebabCase(System.String s)
    // Offset: 0x471573C
    static ::StringW ToKebabCase(::StringW s);
    // static private System.String ToSeparatedCase(System.String s, System.Char separator)
    // Offset: 0x4715454
    static ::StringW ToSeparatedCase(::StringW s, ::Il2CppChar separator);
...
// Writing MetadataGetter for method: Newtonsoft::Json::Utilities::StringUtils::ToSnakeCase
// Il2CppName: ToSnakeCase
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::StringW)>(&Newtonsoft::Json::Utilities::StringUtils::ToSnakeCase)> {
  static const MethodInfo* get() {
    static auto* s = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::Utilities::StringUtils*), "ToSnakeCase", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{s});
  }
};
// Writing MetadataGetter for method: Newtonsoft::Json::Utilities::StringUtils::ToKebabCase
// Il2CppName: ToKebabCase
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::StringW)>(&Newtonsoft::Json::Utilities::StringUtils::ToKebabCase)> {
  static const MethodInfo* get() {
    static auto* s = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::Utilities::StringUtils*), "ToKebabCase", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{s});
  }
};
// Writing MetadataGetter for method: Newtonsoft::Json::Utilities::StringUtils::ToSeparatedCase
// Il2CppName: ToSeparatedCase
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::StringW, ::Il2CppChar)>(&Newtonsoft::Json::Utilities::StringUtils::ToSeparatedCase)> {
  static const MethodInfo* get() {
    static auto* s = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* separator = &::il2cpp_utils::GetClassFromName("System", "Char")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::Utilities::StringUtils*), "ToSeparatedCase", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{s, separator});
  }
};

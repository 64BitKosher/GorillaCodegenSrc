...
namespace Newtonsoft::Json::Utilities {
  ...
  // Autogenerated type: Newtonsoft.Json.Utilities.FSharpUtils/<>c__DisplayClass55_0`2
  ...
  }; // Newtonsoft.Json.Utilities.FSharpUtils/<>c__DisplayClass55_0`2
  // Could not write size check! Type: Newtonsoft.Json.Utilities.FSharpUtils/<>c__DisplayClass55_0`2 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

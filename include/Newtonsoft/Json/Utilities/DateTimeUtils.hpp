...
namespace Newtonsoft::Json::Utilities {
  ...
  class DateTimeUtils : public ::Il2CppObject {
    ...
    // static private System.Int64 UniversalTicksToJavaScriptTicks(System.Int64 universalTicks)
    // Offset: 0x4704E90
    static int64_t UniversalTicksToJavaScriptTicks(int64_t universalTicks);
...
// Writing MetadataGetter for method: Newtonsoft::Json::Utilities::DateTimeUtils::UniversalTicksToJavaScriptTicks
// Il2CppName: UniversalTicksToJavaScriptTicks
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int64_t (*)(int64_t)>(&Newtonsoft::Json::Utilities::DateTimeUtils::UniversalTicksToJavaScriptTicks)> {
  static const MethodInfo* get() {
    static auto* universalTicks = &::il2cpp_utils::GetClassFromName("System", "Int64")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::Utilities::DateTimeUtils*), "UniversalTicksToJavaScriptTicks", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{universalTicks});
  }
};

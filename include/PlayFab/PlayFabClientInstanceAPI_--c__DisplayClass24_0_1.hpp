...
namespace PlayFab {
  ...
  // Autogenerated type: PlayFab.PlayFabClientInstanceAPI/<>c__DisplayClass24_0`1
  ...
  }; // PlayFab.PlayFabClientInstanceAPI/<>c__DisplayClass24_0`1
  // Could not write size check! Type: PlayFab.PlayFabClientInstanceAPI/<>c__DisplayClass24_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

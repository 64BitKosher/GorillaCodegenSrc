...
NEED_NO_BOX(::PlayFab::MultiplayerModels::ListQosServersResponse);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::MultiplayerModels::ListQosServersResponse*, "PlayFab.MultiplayerModels", "ListQosServersResponse");
// Type namespace: PlayFab.MultiplayerModels
namespace PlayFab::MultiplayerModels {
  // Size: 0x38
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.MultiplayerModels.ListQosServersResponse
  // [TokenAttribute] Offset: FFFFFFFF
  class ListQosServersResponse : public ::PlayFab::SharedModels::PlayFabResultCommon {
    public:
    public:
    ...
    static ListQosServersResponse* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::MultiplayerModels::ListQosServersResponse::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ListQosServersResponse*, creationType>()));
    }
  }; // PlayFab.MultiplayerModels.ListQosServersResponse
  #pragma pack(pop)
  static check_size<sizeof(ListQosServersResponse), 48 + sizeof(::StringW)> __PlayFab_MultiplayerModels_ListQosServersResponseSizeCheck;
  static_assert(sizeof(ListQosServersResponse) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::MultiplayerModels::ListQosServersResponse::New_ctor
// Il2CppName: .ctor

...
NEED_NO_BOX(::PlayFab::MultiplayerModels::GetBuildResponse);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::MultiplayerModels::GetBuildResponse*, "PlayFab.MultiplayerModels", "GetBuildResponse");
// Type namespace: PlayFab.MultiplayerModels
namespace PlayFab::MultiplayerModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.MultiplayerModels.GetBuildResponse
  // [TokenAttribute] Offset: FFFFFFFF
  class GetBuildResponse : public ::PlayFab::SharedModels::PlayFabResultCommon {
    public:
    public:
    ...
    // Get instance field reference: public System.String BuildStatus
    [[deprecated("Use field access instead!")]] ::StringW& dyn_BuildStatus();
    ...
    static GetBuildResponse* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::MultiplayerModels::GetBuildResponse::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<GetBuildResponse*, creationType>()));
    }
  }; // PlayFab.MultiplayerModels.GetBuildResponse
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::MultiplayerModels::GetBuildResponse::New_ctor
// Il2CppName: .ctor

...
NEED_NO_BOX(::PlayFab::MultiplayerModels::CreateBuildWithManagedContainerRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::MultiplayerModels::CreateBuildWithManagedContainerRequest*, "PlayFab.MultiplayerModels", "CreateBuildWithManagedContainerRequest");
// Type namespace: PlayFab.MultiplayerModels
namespace PlayFab::MultiplayerModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.MultiplayerModels.CreateBuildWithManagedContainerRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class CreateBuildWithManagedContainerRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static CreateBuildWithManagedContainerRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::MultiplayerModels::CreateBuildWithManagedContainerRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CreateBuildWithManagedContainerRequest*, creationType>()));
    }
  }; // PlayFab.MultiplayerModels.CreateBuildWithManagedContainerRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::MultiplayerModels::CreateBuildWithManagedContainerRequest::New_ctor
// Il2CppName: .ctor

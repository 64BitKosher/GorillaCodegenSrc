...
NEED_NO_BOX(::PlayFab::ExperimentationModels::TreatmentAssignment);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ExperimentationModels::TreatmentAssignment*, "PlayFab.ExperimentationModels", "TreatmentAssignment");
// Type namespace: PlayFab.ExperimentationModels
namespace PlayFab::ExperimentationModels {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.ExperimentationModels.TreatmentAssignment
  ...
  class TreatmentAssignment : public ::PlayFab::SharedModels::PlayFabBaseModel {
    ...
    static TreatmentAssignment* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ExperimentationModels::TreatmentAssignment::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<TreatmentAssignment*, creationType>()));
    }
  }; // PlayFab.ExperimentationModels.TreatmentAssignment
  #pragma pack(pop)
  static check_size<sizeof(TreatmentAssignment), 24 + sizeof(::System::Collections::Generic::List_1<::StringW>*)> __PlayFab_ExperimentationModels_TreatmentAssignmentSizeCheck;
  static_assert(sizeof(TreatmentAssignment) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ExperimentationModels::TreatmentAssignment::New_ctor
// Il2CppName: .ctor

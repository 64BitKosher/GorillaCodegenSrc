...
NEED_NO_BOX(::PlayFab::ExperimentationModels::CreateExperimentRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ExperimentationModels::CreateExperimentRequest*, "PlayFab.ExperimentationModels", "CreateExperimentRequest");
// Type namespace: PlayFab.ExperimentationModels
namespace PlayFab::ExperimentationModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ExperimentationModels.CreateExperimentRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class CreateExperimentRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static CreateExperimentRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ExperimentationModels::CreateExperimentRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CreateExperimentRequest*, creationType>()));
    }
  }; // PlayFab.ExperimentationModels.CreateExperimentRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ExperimentationModels::CreateExperimentRequest::New_ctor
// Il2CppName: .ctor

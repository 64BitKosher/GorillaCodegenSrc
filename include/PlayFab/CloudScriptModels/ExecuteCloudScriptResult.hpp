...
NEED_NO_BOX(::PlayFab::CloudScriptModels::ExecuteCloudScriptResult);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::CloudScriptModels::ExecuteCloudScriptResult*, "PlayFab.CloudScriptModels", "ExecuteCloudScriptResult");
// Type namespace: PlayFab.CloudScriptModels
namespace PlayFab::CloudScriptModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.CloudScriptModels.ExecuteCloudScriptResult
  ...
  class ExecuteCloudScriptResult : public ::PlayFab::SharedModels::PlayFabResultCommon {
    ...
    // public PlayFab.CloudScriptModels.ScriptExecutionError Error
    // Size: 0x8
    // Offset: 0x28
    ::PlayFab::CloudScriptModels::ScriptExecutionError* Error;
    // Field size check
    static_assert(sizeof(::PlayFab::CloudScriptModels::ScriptExecutionError*) == 0x8);
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // public System.Collections.Generic.List`1<PlayFab.CloudScriptModels.LogStatement> Logs
    // Size: 0x8
    // Offset: 0x50
    ::System::Collections::Generic::List_1<::PlayFab::CloudScriptModels::LogStatement*>* Logs;
    // Field size check
    static_assert(sizeof(::System::Collections::Generic::List_1<::PlayFab::CloudScriptModels::LogStatement*>*) == 0x8);
    ...
    // Get instance field reference: public PlayFab.CloudScriptModels.ScriptExecutionError Error
    [[deprecated("Use field access instead!")]] ::PlayFab::CloudScriptModels::ScriptExecutionError*& dyn_Error();
    ...
    // Get instance field reference: public System.Collections.Generic.List`1<PlayFab.CloudScriptModels.LogStatement> Logs
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<::PlayFab::CloudScriptModels::LogStatement*>*& dyn_Logs();
    ...
    static ExecuteCloudScriptResult* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::CloudScriptModels::ExecuteCloudScriptResult::.ctor");
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::CloudScriptModels::ExecuteCloudScriptResult::New_ctor
// Il2CppName: .ctor

...
namespace PlayFab::Internal {
  ...
  class PlayFabUnityHttp : public ::Il2CppObject/*, public ::PlayFab::ITransportPlugin*/ {
    public:
    // Nested type: ::PlayFab::Internal::PlayFabUnityHttp::$Post$d__13
    class $Post$d__13;
    // Nested type: ::PlayFab::Internal::PlayFabUnityHttp::$SimpleCallCoroutine$d__11
    class $SimpleCallCoroutine$d__11;
    public:
  ...
  #pragma pack(pop)
  static check_size<sizeof(PlayFabUnityHttp), 24 + sizeof(int)> __PlayFab_Internal_PlayFabUnityHttpSizeCheck;
  static_assert(sizeof(PlayFabUnityHttp) == 0x1C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

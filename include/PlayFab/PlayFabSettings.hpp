...
namespace PlayFab {
  ...
  class PlayFabSettings : public ::Il2CppObject {
    ...
    // Get static field: static public PlayFab.PlayFabAuthenticationContext staticPlayer
    static ::PlayFab::PlayFabAuthenticationContext* _get_staticPlayer();
    // Set static field: static public PlayFab.PlayFabAuthenticationContext staticPlayer

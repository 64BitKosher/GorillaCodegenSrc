...
namespace PlayFab::Json {
  ...
  class PlayFabSimpleJson : public ::Il2CppObject {
    ...
    // static private PlayFab.Json.PlayFabSimpleJson/TokenType LookAhead(System.String json, System.Int32 index)
    // Offset: 0x4AFF6B4
    static ::PlayFab::Json::PlayFabSimpleJson::TokenType LookAhead(::StringW json, int index);
    // static private PlayFab.Json.PlayFabSimpleJson/TokenType NextToken(System.String json, ref System.Int32 index)
    // Offset: 0x4AFF3AC

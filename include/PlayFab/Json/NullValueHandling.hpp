...
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::Json::NullValueHandling, "PlayFab.Json", "NullValueHandling");
// Type namespace: PlayFab.Json
namespace PlayFab::Json {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.Json.NullValueHandling
  ...
  struct NullValueHandling/*, public ::System::Enum*/ {
    ...
    // static field const value: static public PlayFab.Json.NullValueHandling Include
    static constexpr const int Include = 0;
    // Get static field: static public PlayFab.Json.NullValueHandling Include
    static ::PlayFab::Json::NullValueHandling _get_Include();
    // Set static field: static public PlayFab.Json.NullValueHandling Include
    static void _set_Include(::PlayFab::Json::NullValueHandling value);
    // static field const value: static public PlayFab.Json.NullValueHandling Ignore
    static constexpr const int Ignore = 1;
    // Get static field: static public PlayFab.Json.NullValueHandling Ignore
    static ::PlayFab::Json::NullValueHandling _get_Ignore();
    // Set static field: static public PlayFab.Json.NullValueHandling Ignore
    static void _set_Ignore(::PlayFab::Json::NullValueHandling value);
    // Get instance field reference: public System.Int32 value__
    [[deprecated("Use field access instead!")]] int& dyn_value__();
  }; // PlayFab.Json.NullValueHandling
  #pragma pack(pop)
  static check_size<sizeof(NullValueHandling), 0 + sizeof(int)> __PlayFab_Json_NullValueHandlingSizeCheck;

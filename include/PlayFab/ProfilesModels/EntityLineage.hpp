...
NEED_NO_BOX(::PlayFab::ProfilesModels::EntityLineage);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ProfilesModels::EntityLineage*, "PlayFab.ProfilesModels", "EntityLineage");
// Type namespace: PlayFab.ProfilesModels
namespace PlayFab::ProfilesModels {
  // Size: 0x40
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.ProfilesModels.EntityLineage
  ...
  class EntityLineage : public ::PlayFab::SharedModels::PlayFabBaseModel {
    ...
    static EntityLineage* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ProfilesModels::EntityLineage::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<EntityLineage*, creationType>()));
    }
  }; // PlayFab.ProfilesModels.EntityLineage
  #pragma pack(pop)
  static check_size<sizeof(EntityLineage), 56 + sizeof(::StringW)> __PlayFab_ProfilesModels_EntityLineageSizeCheck;
  static_assert(sizeof(EntityLineage) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ProfilesModels::EntityLineage::New_ctor
// Il2CppName: .ctor

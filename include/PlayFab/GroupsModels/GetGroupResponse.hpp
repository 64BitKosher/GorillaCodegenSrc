...
NEED_NO_BOX(::PlayFab::GroupsModels::GetGroupResponse);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::GroupsModels::GetGroupResponse*, "PlayFab.GroupsModels", "GetGroupResponse");
// Type namespace: PlayFab.GroupsModels
namespace PlayFab::GroupsModels {
  // Size: 0x58
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.GroupsModels.GetGroupResponse
  // [TokenAttribute] Offset: FFFFFFFF
  class GetGroupResponse : public ::PlayFab::SharedModels::PlayFabResultCommon {
    public:
    public:
    ...
    static GetGroupResponse* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::GroupsModels::GetGroupResponse::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<GetGroupResponse*, creationType>()));
    }
  }; // PlayFab.GroupsModels.GetGroupResponse
  #pragma pack(pop)
  static check_size<sizeof(GetGroupResponse), 80 + sizeof(::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>*)> __PlayFab_GroupsModels_GetGroupResponseSizeCheck;
  static_assert(sizeof(GetGroupResponse) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::GroupsModels::GetGroupResponse::New_ctor
// Il2CppName: .ctor

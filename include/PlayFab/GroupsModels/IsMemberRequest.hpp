...
NEED_NO_BOX(::PlayFab::GroupsModels::IsMemberRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::GroupsModels::IsMemberRequest*, "PlayFab.GroupsModels", "IsMemberRequest");
// Type namespace: PlayFab.GroupsModels
namespace PlayFab::GroupsModels {
  // Size: 0x30
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.GroupsModels.IsMemberRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class IsMemberRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static IsMemberRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::GroupsModels::IsMemberRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<IsMemberRequest*, creationType>()));
    }
  }; // PlayFab.GroupsModels.IsMemberRequest
  #pragma pack(pop)
  static check_size<sizeof(IsMemberRequest), 40 + sizeof(::StringW)> __PlayFab_GroupsModels_IsMemberRequestSizeCheck;
  static_assert(sizeof(IsMemberRequest) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::GroupsModels::IsMemberRequest::New_ctor
// Il2CppName: .ctor

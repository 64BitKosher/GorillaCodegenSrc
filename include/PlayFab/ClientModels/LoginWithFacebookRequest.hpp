...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithFacebookRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithFacebookRequest*, "PlayFab.ClientModels", "LoginWithFacebookRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithFacebookRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithFacebookRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithFacebookRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithFacebookRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithFacebookRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithFacebookRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithFacebookRequest::New_ctor
// Il2CppName: .ctor

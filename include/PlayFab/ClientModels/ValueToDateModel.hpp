...
NEED_NO_BOX(::PlayFab::ClientModels::ValueToDateModel);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::ValueToDateModel*, "PlayFab.ClientModels", "ValueToDateModel");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.ClientModels.ValueToDateModel
  ...
  class ValueToDateModel : public ::PlayFab::SharedModels::PlayFabBaseModel {
    ...
    static ValueToDateModel* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::ValueToDateModel::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ValueToDateModel*, creationType>()));
    }
  }; // PlayFab.ClientModels.ValueToDateModel
  #pragma pack(pop)
  static check_size<sizeof(ValueToDateModel), 32 + sizeof(::StringW)> __PlayFab_ClientModels_ValueToDateModelSizeCheck;
  static_assert(sizeof(ValueToDateModel) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::ValueToDateModel::New_ctor
// Il2CppName: .ctor

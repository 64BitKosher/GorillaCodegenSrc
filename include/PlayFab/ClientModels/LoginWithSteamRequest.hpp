...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithSteamRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithSteamRequest*, "PlayFab.ClientModels", "LoginWithSteamRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithSteamRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithSteamRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithSteamRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithSteamRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithSteamRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithSteamRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithSteamRequest::New_ctor
// Il2CppName: .ctor

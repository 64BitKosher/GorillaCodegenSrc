...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithNintendoSwitchDeviceIdRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithNintendoSwitchDeviceIdRequest*, "PlayFab.ClientModels", "LoginWithNintendoSwitchDeviceIdRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithNintendoSwitchDeviceIdRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithNintendoSwitchDeviceIdRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithNintendoSwitchDeviceIdRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithNintendoSwitchDeviceIdRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithNintendoSwitchDeviceIdRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithNintendoSwitchDeviceIdRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithNintendoSwitchDeviceIdRequest::New_ctor
// Il2CppName: .ctor

...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithNintendoAccountRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithNintendoAccountRequest*, "PlayFab.ClientModels", "LoginWithNintendoAccountRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithNintendoAccountRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithNintendoAccountRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithNintendoAccountRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithNintendoAccountRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithNintendoAccountRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithNintendoAccountRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithNintendoAccountRequest::New_ctor
// Il2CppName: .ctor

...
namespace LitJson {
  ...
  // Autogenerated type: LitJson.JsonMapper/<>c__DisplayClass37_0`1
  ...
  }; // LitJson.JsonMapper/<>c__DisplayClass37_0`1
  // Could not write size check! Type: LitJson.JsonMapper/<>c__DisplayClass37_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

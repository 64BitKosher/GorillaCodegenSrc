...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportInputHandlerHMD), 80 + sizeof(bool)> __GlobalNamespace_TeleportInputHandlerHMDSizeCheck;
  static_assert(sizeof(TeleportInputHandlerHMD) == 0x51);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

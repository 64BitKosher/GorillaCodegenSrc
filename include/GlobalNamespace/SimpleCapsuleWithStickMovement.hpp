...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SimpleCapsuleWithStickMovement), 80 + sizeof(::System::Action*)> __GlobalNamespace_SimpleCapsuleWithStickMovementSizeCheck;
  static_assert(sizeof(SimpleCapsuleWithStickMovement) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

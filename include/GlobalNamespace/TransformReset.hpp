...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TransformReset), 40 + sizeof(::ArrayW<::GlobalNamespace::TransformReset::OriginalGameObjectTransform>)> __GlobalNamespace_TransformResetSizeCheck;
  static_assert(sizeof(TransformReset) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PositionVolumeModifier), 32 + sizeof(::GlobalNamespace::TimeOfDayDependentAudio*)> __GlobalNamespace_PositionVolumeModifierSizeCheck;
  static_assert(sizeof(PositionVolumeModifier) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

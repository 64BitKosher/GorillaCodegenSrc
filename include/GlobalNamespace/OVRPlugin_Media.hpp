...
// Writing MetadataGetter for method: GlobalNamespace::OVRPlugin::Media::IsCastingToRemoteClient
// Il2CppName: IsCastingToRemoteClient
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&GlobalNamespace::OVRPlugin::Media::IsCastingToRemoteClient)> {
  static const MethodInfo* get() {

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRHeadsetEmulator), 96 + sizeof(::UnityEngine::CursorLockMode)> __GlobalNamespace_OVRHeadsetEmulatorSizeCheck;
  static_assert(sizeof(OVRHeadsetEmulator) == 0x64);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

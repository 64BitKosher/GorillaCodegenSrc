...
namespace GlobalNamespace {
  ...
  struct OVRMaterialData/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRTextureData) == 0x20);
    // public UnityEngine.Color baseColorFactor
    // Size: 0x10
    // Offset: 0x30
    ...
    constexpr OVRMaterialData(::UnityEngine::Shader* shader_ = {}, int textureId_ = {}, ::GlobalNamespace::OVRTextureData texture_ = {}, ::UnityEngine::Color baseColorFactor_ = {}) noexcept : shader{shader_}, textureId{textureId_}, texture{texture_}, baseColorFactor{baseColorFactor_} {}
    ...
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::OVRTextureData& dyn_texture();
    // Get instance field reference: public UnityEngine.Color baseColorFactor
    [[deprecated("Use field access instead!")]] ::UnityEngine::Color& dyn_baseColorFactor();
  }; // OVRMaterialData
  #pragma pack(pop)
  static check_size<sizeof(OVRMaterialData), 48 + sizeof(::UnityEngine::Color)> __GlobalNamespace_OVRMaterialDataSizeCheck;
  static_assert(sizeof(OVRMaterialData) == 0x40);
}

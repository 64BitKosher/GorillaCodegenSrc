...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportOrientationHandlerThumbstick), 116 + sizeof(::UnityEngine::Vector2)> __GlobalNamespace_TeleportOrientationHandlerThumbstickSizeCheck;
  static_assert(sizeof(TeleportOrientationHandlerThumbstick) == 0x7C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

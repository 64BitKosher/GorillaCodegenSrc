...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LocomotionController), 48 + sizeof(::GlobalNamespace::SimpleCapsuleWithStickMovement*)> __GlobalNamespace_LocomotionControllerSizeCheck;
  static_assert(sizeof(LocomotionController) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

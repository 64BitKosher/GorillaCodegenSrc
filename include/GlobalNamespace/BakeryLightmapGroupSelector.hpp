...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BakeryLightmapGroupSelector), 44 + sizeof(int)> __GlobalNamespace_BakeryLightmapGroupSelectorSizeCheck;
  static_assert(sizeof(BakeryLightmapGroupSelector) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

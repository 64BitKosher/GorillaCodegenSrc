...
namespace GlobalNamespace {
  ...
  class OculusSpatializerUnity : public ::UnityEngine::MonoBehaviour {
    ...
    // Get instance field reference: private UnityEngine.ParticleSystem/Particle[] particles
  ...
  #pragma pack(pop)
  static check_size<sizeof(OculusSpatializerUnity), 128 + sizeof(::ArrayW<::UnityEngine::ParticleSystem::Particle>)> __GlobalNamespace_OculusSpatializerUnitySizeCheck;
  static_assert(sizeof(OculusSpatializerUnity) == 0x88);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ONSPPropagationGeometry), 48 + sizeof(::System::IntPtr)> __GlobalNamespace_ONSPPropagationGeometrySizeCheck;
  static_assert(sizeof(ONSPPropagationGeometry) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

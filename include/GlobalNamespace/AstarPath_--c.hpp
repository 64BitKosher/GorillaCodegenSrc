...
namespace GlobalNamespace {
  ...
  class AstarPath::$$c : public ::Il2CppObject {
    ...
    static ::System::Action_1<::Pathfinding::Path*>* _get_$$9__124_0();
    // Set static field: static public System.Action`1<Pathfinding.Path> <>9__124_0
    static void _set_$$9__124_0(::System::Action_1<::Pathfinding::Path*>* value);
    ...
    // System.Void <InitializePathProcessor>b__124_0(Pathfinding.Path path)
    // Offset: 0x2986B3C
    void $InitializePathProcessor$b__124_0(::Pathfinding::Path* path);
  }; // AstarPath/<>c
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::AstarPath::$$c::$InitializePathProcessor$b__124_0
// Il2CppName: <InitializePathProcessor>b__124_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::AstarPath::$$c::*)(::Pathfinding::Path*)>(&GlobalNamespace::AstarPath::$$c::$InitializePathProcessor$b__124_0)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("Pathfinding", "Path")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::AstarPath::$$c*), "<InitializePathProcessor>b__124_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path});
  }
};

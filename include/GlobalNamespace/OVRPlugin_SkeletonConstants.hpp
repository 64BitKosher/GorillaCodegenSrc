...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::SkeletonConstants/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/SkeletonConstants MaxBodyBones
    static constexpr const int MaxBodyBones = 70;
    // Get static field: static public OVRPlugin/SkeletonConstants MaxBodyBones
    static ::GlobalNamespace::OVRPlugin::SkeletonConstants _get_MaxBodyBones();
    // Set static field: static public OVRPlugin/SkeletonConstants MaxBodyBones
    static void _set_MaxBodyBones(::GlobalNamespace::OVRPlugin::SkeletonConstants value);
    // static field const value: static public OVRPlugin/SkeletonConstants MaxBones
    static constexpr const int MaxBones = 70;
    ...
    // static field const value: static public OVRPlugin/SkeletonConstants MaxNumMicrogestures
    static constexpr const int MaxNumMicrogestures = 5;
    // Get static field: static public OVRPlugin/SkeletonConstants MaxNumMicrogestures
    static ::GlobalNamespace::OVRPlugin::SkeletonConstants _get_MaxNumMicrogestures();
    // Set static field: static public OVRPlugin/SkeletonConstants MaxNumMicrogestures
    static void _set_MaxNumMicrogestures(::GlobalNamespace::OVRPlugin::SkeletonConstants value);

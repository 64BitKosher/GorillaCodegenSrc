...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaCameraSceneTrigger), 48 + sizeof(::GlobalNamespace::GorillaCameraTriggerIndex*)> __GlobalNamespace_GorillaCameraSceneTriggerSizeCheck;
  static_assert(sizeof(GorillaCameraSceneTrigger) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimeOfDayDependentAudio), 164 + sizeof(bool)> __GlobalNamespace_TimeOfDayDependentAudioSizeCheck;
  static_assert(sizeof(TimeOfDayDependentAudio) == 0xA5);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

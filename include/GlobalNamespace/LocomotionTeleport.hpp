...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LocomotionTeleport), 200 + sizeof(::System::Action_3<::UnityEngine::Transform*, ::UnityEngine::Vector3, ::UnityEngine::Quaternion>*)> __GlobalNamespace_LocomotionTeleportSizeCheck;
  static_assert(sizeof(LocomotionTeleport) == 0xD0);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

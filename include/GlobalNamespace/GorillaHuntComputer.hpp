...
namespace GlobalNamespace {
  ...
  class GorillaHuntComputer : public ::UnityEngine::MonoBehaviour {
    ...
    // public GorillaNetworking.CosmeticsController/CosmeticItem GetPrioritizedItemForHand(VRRig targetRig, System.Boolean forLeftHand)
    // Offset: 0x270A4B8
    ::GorillaNetworking::CosmeticsController::CosmeticItem GetPrioritizedItemForHand(::GlobalNamespace::VRRig* targetRig, bool forLeftHand);
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaHuntComputer), 120 + sizeof(::GorillaNetworking::CosmeticsController::CosmeticItem)> __GlobalNamespace_GorillaHuntComputerSizeCheck;
  static_assert(sizeof(GorillaHuntComputer) == 0xF1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::GorillaHuntComputer::GetPrioritizedItemForHand
// Il2CppName: GetPrioritizedItemForHand
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GorillaNetworking::CosmeticsController::CosmeticItem (GlobalNamespace::GorillaHuntComputer::*)(::GlobalNamespace::VRRig*, bool)>(&GlobalNamespace::GorillaHuntComputer::GetPrioritizedItemForHand)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::GorillaHuntComputer*), "GetPrioritizedItemForHand", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{targetRig, forLeftHand});
  }
};

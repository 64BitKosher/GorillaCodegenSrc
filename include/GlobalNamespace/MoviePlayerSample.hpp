...
namespace GlobalNamespace {
  ...
  class MoviePlayerSample : public ::UnityEngine::MonoBehaviour {
    ...
    struct VideoStereo;
    // Nested type: ::GlobalNamespace::MoviePlayerSample::$$c__DisplayClass34_0
    class $$c__DisplayClass34_0;
    // Nested type: ::GlobalNamespace::MoviePlayerSample::$Start$d__33
    class $Start$d__33;
    // Size: 0x4
    #pragma pack(push, 1)
    ...
    // public System.Boolean AutoDetectStereoLayout
    // Size: 0x1
    // Offset: 0x84
    ...
    // Get instance field reference: public System.Boolean AutoDetectStereoLayout
    [[deprecated("Use field access instead!")]] bool& dyn_AutoDetectStereoLayout();
  ...
  #pragma pack(pop)
  static check_size<sizeof(MoviePlayerSample), 144 + sizeof(bool)> __GlobalNamespace_MoviePlayerSampleSizeCheck;
  static_assert(sizeof(MoviePlayerSample) == 0x91);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

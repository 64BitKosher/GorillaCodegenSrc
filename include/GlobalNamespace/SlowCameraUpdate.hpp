...
namespace GlobalNamespace {
  ...
  class SlowCameraUpdate : public ::UnityEngine::MonoBehaviour {
    public:
    // Nested type: ::GlobalNamespace::SlowCameraUpdate::$UpdateMirror$d__6
    class $UpdateMirror$d__6;
    public:
  ...
  #pragma pack(pop)
  static check_size<sizeof(SlowCameraUpdate), 44 + sizeof(float)> __GlobalNamespace_SlowCameraUpdateSizeCheck;
  static_assert(sizeof(SlowCameraUpdate) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

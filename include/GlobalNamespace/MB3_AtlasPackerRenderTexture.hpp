...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_AtlasPackerRenderTexture), 128 + sizeof(::UnityEngine::Material*)> __GlobalNamespace_MB3_AtlasPackerRenderTextureSizeCheck;
  static_assert(sizeof(MB3_AtlasPackerRenderTexture) == 0x88);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

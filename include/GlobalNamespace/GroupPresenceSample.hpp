...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GroupPresenceSample), 100 + sizeof(bool)> __GlobalNamespace_GroupPresenceSampleSizeCheck;
  static_assert(sizeof(GroupPresenceSample) == 0x65);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

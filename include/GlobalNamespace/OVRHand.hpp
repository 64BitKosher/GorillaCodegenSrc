...
namespace GlobalNamespace {
  ...
  class OVRHand : public ::UnityEngine::MonoBehaviour/*, public ::GlobalNamespace::OVRSkeleton::IOVRSkeletonDataProvider, public ::GlobalNamespace::OVRSkeletonRenderer::IOVRSkeletonRendererDataProvider, public ::GlobalNamespace::OVRMesh::IOVRMeshDataProvider, public ::GlobalNamespace::OVRMeshRenderer::IOVRMeshRendererDataProvider*/ {
    ...
    // Padding between fields: m_showState and: pointerPoseGO
    char __padding2[0x4] = {};
    ...
    // Get instance field reference: OVRHand/Hand HandType
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRHand), 208 + sizeof(bool)> __GlobalNamespace_OVRHandSizeCheck;
  static_assert(sizeof(OVRHand) == 0xD1);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::OVRHand::OVRSkeleton_IOVRSkeletonDataProvider_get_enabled
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::OVRHand::*)()>(&GlobalNamespace::OVRHand::OVRSkeleton_IOVRSkeletonDataProvider_get_enabled)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRHand*), "OVRSkeleton.IOVRSkeletonDataProvider.get_enabled", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LipSyncDemo_SetCurrentTarget), 48 + sizeof(bool)> __GlobalNamespace_LipSyncDemo_SetCurrentTargetSizeCheck;
  static_assert(sizeof(LipSyncDemo_SetCurrentTarget) == 0x31);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

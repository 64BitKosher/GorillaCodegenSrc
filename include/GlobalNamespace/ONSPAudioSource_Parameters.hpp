...
namespace GlobalNamespace {
  ...
  struct ONSPAudioSource::Parameters/*, public ::System::Enum*/ {
    ...
    static constexpr const int P_AMBISTAT = 6;
    ...
    static constexpr const int P_READONLY_GLOBAL_RFL_ENABLED = 7;
    ...
    static constexpr const int P_READONLY_NUM_VOICES = 8;
    ...
    static constexpr const int P_SENDLEVEL = 9;
    ...
    static constexpr const int P_NUM = 10;

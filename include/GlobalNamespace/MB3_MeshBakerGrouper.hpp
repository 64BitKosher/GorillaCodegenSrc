...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_MeshBakerGrouper), 112 + sizeof(::DigitalOpus::MB::Core::MB3_MeshCombinerSettingsData*)> __GlobalNamespace_MB3_MeshBakerGrouperSizeCheck;
  static_assert(sizeof(MB3_MeshBakerGrouper) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

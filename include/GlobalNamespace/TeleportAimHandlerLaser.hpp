...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportAimHandlerLaser), 44 + sizeof(float)> __GlobalNamespace_TeleportAimHandlerLaserSizeCheck;
  static_assert(sizeof(TeleportAimHandlerLaser) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

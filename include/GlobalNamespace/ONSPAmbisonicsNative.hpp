...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ONSPAmbisonicsNative), 40 + sizeof(::GlobalNamespace::ONSPAmbisonicsNative::ovrAmbisonicsNativeStatus)> __GlobalNamespace_ONSPAmbisonicsNativeSizeCheck;
  static_assert(sizeof(ONSPAmbisonicsNative) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

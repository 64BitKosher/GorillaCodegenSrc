...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaLevelScreen), 56 + sizeof(::UnityEngine::UI::Text*)> __GlobalNamespace_GorillaLevelScreenSizeCheck;
  static_assert(sizeof(GorillaLevelScreen) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

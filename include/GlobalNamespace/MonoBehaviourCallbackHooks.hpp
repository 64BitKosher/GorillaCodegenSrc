...
namespace GlobalNamespace {
  ...
  class MonoBehaviourCallbackHooks : public ::UnityEngine::ResourceManagement::Util::ComponentSingleton_1<::GlobalNamespace::MonoBehaviourCallbackHooks*> {
    ...
    // System.Action`1<System.Single> m_OnLateUpdateDelegate
    // Size: 0x8
    // Offset: 0x28
    ::System::Action_1<float>* m_OnLateUpdateDelegate;
    // Field size check
    static_assert(sizeof(::System::Action_1<float>*) == 0x8);
    public:
    ...
    // Get instance field reference: System.Action`1<System.Single> m_OnLateUpdateDelegate
    [[deprecated("Use field access instead!")]] ::System::Action_1<float>*& dyn_m_OnLateUpdateDelegate();
    ...
    // System.Void add_OnLateUpdateDelegate(System.Action`1<System.Single> value)
    // Offset: 0x5324630
    void add_OnLateUpdateDelegate(::System::Action_1<float>* value);
    // System.Void remove_OnLateUpdateDelegate(System.Action`1<System.Single> value)
    // Offset: 0x53246D8
    void remove_OnLateUpdateDelegate(::System::Action_1<float>* value);
    // System.Void Update()
    // Offset: 0x53247C0
    void Update();
...
// Writing MetadataGetter for method: GlobalNamespace::MonoBehaviourCallbackHooks::add_OnLateUpdateDelegate
// Il2CppName: add_OnLateUpdateDelegate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MonoBehaviourCallbackHooks::*)(::System::Action_1<float>*)>(&GlobalNamespace::MonoBehaviourCallbackHooks::add_OnLateUpdateDelegate)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System", "Action`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Single")})->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MonoBehaviourCallbackHooks*), "add_OnLateUpdateDelegate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::MonoBehaviourCallbackHooks::remove_OnLateUpdateDelegate
// Il2CppName: remove_OnLateUpdateDelegate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MonoBehaviourCallbackHooks::*)(::System::Action_1<float>*)>(&GlobalNamespace::MonoBehaviourCallbackHooks::remove_OnLateUpdateDelegate)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System", "Action`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Single")})->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MonoBehaviourCallbackHooks*), "remove_OnLateUpdateDelegate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: GlobalNamespace::MonoBehaviourCallbackHooks::LateUpdate
// Il2CppName: LateUpdate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MonoBehaviourCallbackHooks::*)()>(&GlobalNamespace::MonoBehaviourCallbackHooks::LateUpdate)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MonoBehaviourCallbackHooks*), "LateUpdate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

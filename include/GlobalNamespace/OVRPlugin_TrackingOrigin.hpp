...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::TrackingOrigin/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/TrackingOrigin View
    static constexpr const int View = 4;
    // Get static field: static public OVRPlugin/TrackingOrigin View
    static ::GlobalNamespace::OVRPlugin::TrackingOrigin _get_View();
    // Set static field: static public OVRPlugin/TrackingOrigin View
    static void _set_View(::GlobalNamespace::OVRPlugin::TrackingOrigin value);

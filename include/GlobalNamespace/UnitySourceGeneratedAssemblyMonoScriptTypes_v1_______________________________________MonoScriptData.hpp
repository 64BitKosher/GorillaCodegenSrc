...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::UnitySourceGeneratedAssemblyMonoScriptTypes_v1______________________________________::MonoScriptData, "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1/MonoScriptData");
// Type namespace: 
namespace GlobalNamespace {
  ...
  struct UnitySourceGeneratedAssemblyMonoScriptTypes_v1______________________________________::MonoScriptData/*, public ::System::ValueType*/ {
    public:
    public:
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnitySourceGeneratedAssemblyMonoScriptTypes_v1______________________________________::MonoScriptData), 24 + sizeof(bool)> __GlobalNamespace_UnitySourceGeneratedAssemblyMonoScriptTypes_v1_______________________________________MonoScriptDataSizeCheck;
  static_assert(sizeof(UnitySourceGeneratedAssemblyMonoScriptTypes_v1______________________________________::MonoScriptData) == 0x19);
}

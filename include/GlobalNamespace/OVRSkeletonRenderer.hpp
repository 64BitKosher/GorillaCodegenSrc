...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRSkeletonRenderer), 143 + sizeof(bool)> __GlobalNamespace_OVRSkeletonRendererSizeCheck;
  static_assert(sizeof(OVRSkeletonRenderer) == 0x90);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

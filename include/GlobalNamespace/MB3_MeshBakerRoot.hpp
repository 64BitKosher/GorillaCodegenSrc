...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_MeshBakerRoot), 32 + sizeof(::UnityEngine::Vector3)> __GlobalNamespace_MB3_MeshBakerRootSizeCheck;
  static_assert(sizeof(MB3_MeshBakerRoot) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HandedInputSelector), 40 + sizeof(::UnityEngine::EventSystems::OVRInputModule*)> __GlobalNamespace_HandedInputSelectorSizeCheck;
  static_assert(sizeof(HandedInputSelector) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

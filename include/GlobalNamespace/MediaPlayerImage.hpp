...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MediaPlayerImage), 272 + sizeof(::GlobalNamespace::MediaPlayerImage::ButtonType)> __GlobalNamespace_MediaPlayerImageSizeCheck;
  static_assert(sizeof(MediaPlayerImage) == 0x114);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace GlobalNamespace {
  ...
  class OVRPlugin::OVRP_1_21_0 : public ::Il2CppObject {
    ...
    // static public OVRPlugin/Result ovrp_GetTiledMultiResLevel(out OVRPlugin/FoveatedRenderingLevel level)
    // Offset: 0x490FA84
    static ::GlobalNamespace::OVRPlugin::Result ovrp_GetTiledMultiResLevel(ByRef<::GlobalNamespace::OVRPlugin::FoveatedRenderingLevel> level);
    // static public OVRPlugin/Result ovrp_SetTiledMultiResLevel(OVRPlugin/FoveatedRenderingLevel level)
    // Offset: 0x490FB00
    static ::GlobalNamespace::OVRPlugin::Result ovrp_SetTiledMultiResLevel(::GlobalNamespace::OVRPlugin::FoveatedRenderingLevel level);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::OVRPlugin::Result (*)(ByRef<::GlobalNamespace::OVRPlugin::FoveatedRenderingLevel>)>(&GlobalNamespace::OVRPlugin::OVRP_1_21_0::ovrp_GetTiledMultiResLevel)> {
  static const MethodInfo* get() {
    static auto* level = &::il2cpp_utils::GetClassFromName("", "OVRPlugin/FoveatedRenderingLevel")->this_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::OVRPlugin::Result (*)(::GlobalNamespace::OVRPlugin::FoveatedRenderingLevel)>(&GlobalNamespace::OVRPlugin::OVRP_1_21_0::ovrp_SetTiledMultiResLevel)> {
  static const MethodInfo* get() {
    static auto* level = &::il2cpp_utils::GetClassFromName("", "OVRPlugin/FoveatedRenderingLevel")->byval_arg;

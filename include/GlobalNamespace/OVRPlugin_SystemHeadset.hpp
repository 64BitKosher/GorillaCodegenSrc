...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::SystemHeadset/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/SystemHeadset Meta_Quest_Pro
    static constexpr const int Meta_Quest_Pro = 10;
    // Get static field: static public OVRPlugin/SystemHeadset Meta_Quest_Pro
    static ::GlobalNamespace::OVRPlugin::SystemHeadset _get_Meta_Quest_Pro();
    // Set static field: static public OVRPlugin/SystemHeadset Meta_Quest_Pro
    static void _set_Meta_Quest_Pro(::GlobalNamespace::OVRPlugin::SystemHeadset value);
    // static field const value: static public OVRPlugin/SystemHeadset Meta_Quest_3
    static constexpr const int Meta_Quest_3 = 11;
    // Get static field: static public OVRPlugin/SystemHeadset Meta_Quest_3
    static ::GlobalNamespace::OVRPlugin::SystemHeadset _get_Meta_Quest_3();
    // Set static field: static public OVRPlugin/SystemHeadset Meta_Quest_3
    static void _set_Meta_Quest_3(::GlobalNamespace::OVRPlugin::SystemHeadset value);
    ...
    // static field const value: static public OVRPlugin/SystemHeadset Meta_Link_Quest_Pro
    static constexpr const int Meta_Link_Quest_Pro = 4103;
    // Get static field: static public OVRPlugin/SystemHeadset Meta_Link_Quest_Pro
    static ::GlobalNamespace::OVRPlugin::SystemHeadset _get_Meta_Link_Quest_Pro();
    // Set static field: static public OVRPlugin/SystemHeadset Meta_Link_Quest_Pro
    static void _set_Meta_Link_Quest_Pro(::GlobalNamespace::OVRPlugin::SystemHeadset value);
    // static field const value: static public OVRPlugin/SystemHeadset Meta_Link_Quest_3
    static constexpr const int Meta_Link_Quest_3 = 4104;
    // Get static field: static public OVRPlugin/SystemHeadset Meta_Link_Quest_3
    static ::GlobalNamespace::OVRPlugin::SystemHeadset _get_Meta_Link_Quest_3();
    // Set static field: static public OVRPlugin/SystemHeadset Meta_Link_Quest_3
    static void _set_Meta_Link_Quest_3(::GlobalNamespace::OVRPlugin::SystemHeadset value);

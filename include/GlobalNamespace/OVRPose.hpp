...
// Writing MetadataGetter for method: GlobalNamespace::OVRPose::Rotate180AlongX
// Il2CppName: Rotate180AlongX
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::OVRPose (GlobalNamespace::OVRPose::*)()>(&GlobalNamespace::OVRPose::Rotate180AlongX)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRPose), "Rotate180AlongX", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

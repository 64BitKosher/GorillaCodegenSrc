...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LocomotionSampleSupport), 40 + sizeof(bool)> __GlobalNamespace_LocomotionSampleSupportSizeCheck;
  static_assert(sizeof(LocomotionSampleSupport) == 0x29);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

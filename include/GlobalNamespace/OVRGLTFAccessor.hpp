...
namespace GlobalNamespace {
  ...
  class OVRGLTFAccessor : public ::Il2CppObject {
    ...
    // public System.Void ReadAsFloat(OVRBinaryChunk chunk, ref System.Single[] data, System.Int32 offset)
    // Offset: 0x48BB104
    void ReadAsFloat(::GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<float>> data, int offset);
    ...
    // public System.Byte[] ReadAsTexture(OVRBinaryChunk chunk)
    // Offset: 0x48BC568
    ::ArrayW<uint8_t> ReadAsTexture(::GlobalNamespace::OVRBinaryChunk chunk);
...
// Writing MetadataGetter for method: GlobalNamespace::OVRGLTFAccessor::ReadAsFloat
// Il2CppName: ReadAsFloat
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRGLTFAccessor::*)(::GlobalNamespace::OVRBinaryChunk, ByRef<::ArrayW<float>>, int)>(&GlobalNamespace::OVRGLTFAccessor::ReadAsFloat)> {
  static const MethodInfo* get() {
    static auto* chunk = &::il2cpp_utils::GetClassFromName("", "OVRBinaryChunk")->byval_arg;
    static auto* data = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Single"), 1)->this_arg;
    static auto* offset = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRGLTFAccessor*), "ReadAsFloat", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{chunk, data, offset});
  }
};
...
// Writing MetadataGetter for method: GlobalNamespace::OVRGLTFAccessor::ReadAsTexture
// Il2CppName: ReadAsTexture
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (GlobalNamespace::OVRGLTFAccessor::*)(::GlobalNamespace::OVRBinaryChunk)>(&GlobalNamespace::OVRGLTFAccessor::ReadAsTexture)> {
  static const MethodInfo* get() {
    static auto* chunk = &::il2cpp_utils::GetClassFromName("", "OVRBinaryChunk")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRGLTFAccessor*), "ReadAsTexture", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{chunk});
  }
};

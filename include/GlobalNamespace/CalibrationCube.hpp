...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CalibrationCube), 136 + sizeof(::System::Collections::Generic::List_1<::StringW>*)> __GlobalNamespace_CalibrationCubeSizeCheck;
  static_assert(sizeof(CalibrationCube) == 0x90);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

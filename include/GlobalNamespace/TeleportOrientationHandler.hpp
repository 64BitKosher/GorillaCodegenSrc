...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportOrientationHandler), 64 + sizeof(::GlobalNamespace::LocomotionTeleport::AimData*)> __GlobalNamespace_TeleportOrientationHandlerSizeCheck;
  static_assert(sizeof(TeleportOrientationHandler) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ButtonDownListener), 32 + sizeof(::System::Action*)> __GlobalNamespace_ButtonDownListenerSizeCheck;
  static_assert(sizeof(ButtonDownListener) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

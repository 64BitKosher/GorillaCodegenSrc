...
namespace GlobalNamespace {
  ...
  class CinemachineMixer : public ::UnityEngine::Playables::PlayableBehaviour {
    ...
    public:
    // private Cinemachine.ICameraOverrideStack m_BrainOverrideStack
    // Size: 0x8
    // Offset: 0x10
    ::Cinemachine::ICameraOverrideStack* m_BrainOverrideStack;
    // Field size check
    static_assert(sizeof(::Cinemachine::ICameraOverrideStack*) == 0x8);
    // private System.Int32 m_BrainOverrideId
    // Size: 0x4
    // Offset: 0x18
    int m_BrainOverrideId;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // private System.Boolean m_PreviewPlay
    // Size: 0x1
    // Offset: 0x1C
    bool m_PreviewPlay;
    // Field size check
    ...
    // Get instance field reference: private Cinemachine.ICameraOverrideStack m_BrainOverrideStack
    [[deprecated("Use field access instead!")]] ::Cinemachine::ICameraOverrideStack*& dyn_m_BrainOverrideStack();
    // Get instance field reference: private System.Int32 m_BrainOverrideId
    [[deprecated("Use field access instead!")]] int& dyn_m_BrainOverrideId();
    // Get instance field reference: private System.Boolean m_PreviewPlay
    [[deprecated("Use field access instead!")]] bool& dyn_m_PreviewPlay();

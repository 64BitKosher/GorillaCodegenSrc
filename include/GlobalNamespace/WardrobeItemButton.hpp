...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WardrobeItemButton), 120 + sizeof(::GorillaNetworking::CosmeticsController::CosmeticItem)> __GlobalNamespace_WardrobeItemButtonSizeCheck;
  static_assert(sizeof(WardrobeItemButton) == 0xF1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

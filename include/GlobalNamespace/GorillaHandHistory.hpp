...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaHandHistory), 56 + sizeof(::UnityEngine::Vector3)> __GlobalNamespace_GorillaHandHistorySizeCheck;
  static_assert(sizeof(GorillaHandHistory) == 0x44);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

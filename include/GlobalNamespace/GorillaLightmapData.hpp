...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaLightmapData), 64 + sizeof(bool)> __GlobalNamespace_GorillaLightmapDataSizeCheck;
  static_assert(sizeof(GorillaLightmapData) == 0x41);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

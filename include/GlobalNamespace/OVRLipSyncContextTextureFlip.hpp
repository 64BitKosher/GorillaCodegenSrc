...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRLipSyncContextTextureFlip), 64 + sizeof(::GlobalNamespace::OVRLipSync::Frame*)> __GlobalNamespace_OVRLipSyncContextTextureFlipSizeCheck;
  static_assert(sizeof(OVRLipSyncContextTextureFlip) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

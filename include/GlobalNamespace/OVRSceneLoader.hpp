...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRSceneLoader), 104 + sizeof(::GlobalNamespace::OVRSceneLoader::SceneInfo)> __GlobalNamespace_OVRSceneLoaderSizeCheck;
  static_assert(sizeof(OVRSceneLoader) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaCameraTriggerIndex), 40 + sizeof(::GlobalNamespace::GorillaCameraSceneTrigger*)> __GlobalNamespace_GorillaCameraTriggerIndexSizeCheck;
  static_assert(sizeof(GorillaCameraTriggerIndex) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

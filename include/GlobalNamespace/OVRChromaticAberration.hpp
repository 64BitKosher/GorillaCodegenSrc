...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRChromaticAberration), 36 + sizeof(bool)> __GlobalNamespace_OVRChromaticAberrationSizeCheck;
  static_assert(sizeof(OVRChromaticAberration) == 0x25);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

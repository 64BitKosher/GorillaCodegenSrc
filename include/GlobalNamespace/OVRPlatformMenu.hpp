...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlatformMenu), 40 + sizeof(::System::Func_1<bool>*)> __GlobalNamespace_OVRPlatformMenuSizeCheck;
  static_assert(sizeof(OVRPlatformMenu) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

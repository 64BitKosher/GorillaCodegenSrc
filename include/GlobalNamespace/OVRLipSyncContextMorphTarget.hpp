...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRLipSyncContextMorphTarget), 88 + sizeof(::GlobalNamespace::OVRLipSyncContextBase*)> __GlobalNamespace_OVRLipSyncContextMorphTargetSizeCheck;
  static_assert(sizeof(OVRLipSyncContextMorphTarget) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

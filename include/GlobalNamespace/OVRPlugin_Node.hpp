...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::Node/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/Node TrackedKeyboard
    static constexpr const int TrackedKeyboard = 11;
    // Get static field: static public OVRPlugin/Node TrackedKeyboard
    static ::GlobalNamespace::OVRPlugin::Node _get_TrackedKeyboard();
    // Set static field: static public OVRPlugin/Node TrackedKeyboard
    static void _set_TrackedKeyboard(::GlobalNamespace::OVRPlugin::Node value);
    // static field const value: static public OVRPlugin/Node ControllerLeft
    static constexpr const int ControllerLeft = 12;
    // Get static field: static public OVRPlugin/Node ControllerLeft
    static ::GlobalNamespace::OVRPlugin::Node _get_ControllerLeft();
    // Set static field: static public OVRPlugin/Node ControllerLeft
    static void _set_ControllerLeft(::GlobalNamespace::OVRPlugin::Node value);
    // static field const value: static public OVRPlugin/Node ControllerRight
    static constexpr const int ControllerRight = 13;
    // Get static field: static public OVRPlugin/Node ControllerRight
    static ::GlobalNamespace::OVRPlugin::Node _get_ControllerRight();
    // Set static field: static public OVRPlugin/Node ControllerRight
    static void _set_ControllerRight(::GlobalNamespace::OVRPlugin::Node value);

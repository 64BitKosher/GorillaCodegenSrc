...
namespace GlobalNamespace {
  ...
  class OculusXRPlugin : public ::Il2CppObject {
    ...
    // static public System.Void SetDepthSubmission(System.Boolean enable)
    // Offset: 0x493E12C
    static void SetDepthSubmission(bool enable);
  }; // OculusXRPlugin
  #pragma pack(pop)
}
...
// Writing MetadataGetter for method: GlobalNamespace::OculusXRPlugin::SetDepthSubmission
// Il2CppName: SetDepthSubmission
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(bool)>(&GlobalNamespace::OculusXRPlugin::SetDepthSubmission)> {
  static const MethodInfo* get() {
    static auto* enable = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OculusXRPlugin*), "SetDepthSubmission", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{enable});
  }
};

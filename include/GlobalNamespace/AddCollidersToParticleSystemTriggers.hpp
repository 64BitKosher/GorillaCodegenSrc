...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AddCollidersToParticleSystemTriggers), 52 + sizeof(int)> __GlobalNamespace_AddCollidersToParticleSystemTriggersSizeCheck;
  static_assert(sizeof(AddCollidersToParticleSystemTriggers) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRLipSyncContextBase), 60 + sizeof(int)> __GlobalNamespace_OVRLipSyncContextBaseSizeCheck;
  static_assert(sizeof(OVRLipSyncContextBase) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

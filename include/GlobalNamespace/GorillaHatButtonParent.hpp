...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaHatButtonParent), 104 + sizeof(::GlobalNamespace::GorillaLevelScreen*)> __GlobalNamespace_GorillaHatButtonParentSizeCheck;
  static_assert(sizeof(GorillaHatButtonParent) == 0x70);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HeightVolume), 72 + sizeof(bool)> __GlobalNamespace_HeightVolumeSizeCheck;
  static_assert(sizeof(HeightVolume) == 0x49);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::HeightVolume::Awake
// Il2CppName: Awake
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::HeightVolume::*)()>(&GlobalNamespace::HeightVolume::Awake)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::HeightVolume*), "Awake", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

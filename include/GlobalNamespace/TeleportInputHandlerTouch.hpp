...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportInputHandlerTouch), 140 + sizeof(float)> __GlobalNamespace_TeleportInputHandlerTouchSizeCheck;
  static_assert(sizeof(TeleportInputHandlerTouch) == 0x90);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

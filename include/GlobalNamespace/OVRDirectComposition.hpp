...
namespace GlobalNamespace {
  ...
  class OVRDirectComposition : public ::Il2CppObject {
    public:
    // public System.Void .ctor()
    // Offset: 0x48AA9E0
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static OVRDirectComposition* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRDirectComposition::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OVRDirectComposition*, creationType>()));
    }

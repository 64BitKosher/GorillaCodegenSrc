...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaThrowingRock), 408 + sizeof(::GlobalNamespace::VRRig*)> __GlobalNamespace_GorillaThrowingRockSizeCheck;
  static_assert(sizeof(GorillaThrowingRock) == 0x1A0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

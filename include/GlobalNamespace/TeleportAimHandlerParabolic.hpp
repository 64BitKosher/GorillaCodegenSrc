...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportAimHandlerParabolic), 60 + sizeof(float)> __GlobalNamespace_TeleportAimHandlerParabolicSizeCheck;
  static_assert(sizeof(TeleportAimHandlerParabolic) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  class NativeVideoPlayer : public ::Il2CppObject {
    ...
    struct PlabackState;
    // Nested type: ::GlobalNamespace::NativeVideoPlayer::StereoMode
    struct StereoMode;
    ...
    // static public NativeVideoPlayer/StereoMode get_VideoStereoMode()
    // Offset: 0x2927880
    static ::GlobalNamespace::NativeVideoPlayer::StereoMode get_VideoStereoMode();
    // static public System.Int32 get_VideoWidth()
    // Offset: 0x292796C
    static int get_VideoWidth();
    // static public System.Int32 get_VideoHeight()
    // Offset: 0x2927A58
    static int get_VideoHeight();
...
// Writing MetadataGetter for method: GlobalNamespace::NativeVideoPlayer::get_VideoStereoMode
// Il2CppName: get_VideoStereoMode
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::NativeVideoPlayer::StereoMode (*)()>(&GlobalNamespace::NativeVideoPlayer::get_VideoStereoMode)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::NativeVideoPlayer*), "get_VideoStereoMode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::NativeVideoPlayer::get_VideoWidth
// Il2CppName: get_VideoWidth
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)()>(&GlobalNamespace::NativeVideoPlayer::get_VideoWidth)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::NativeVideoPlayer*), "get_VideoWidth", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::NativeVideoPlayer::get_VideoHeight
// Il2CppName: get_VideoHeight
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)()>(&GlobalNamespace::NativeVideoPlayer::get_VideoHeight)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::NativeVideoPlayer*), "get_VideoHeight", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

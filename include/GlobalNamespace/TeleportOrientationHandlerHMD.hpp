...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportOrientationHandlerHMD), 88 + sizeof(::UnityEngine::Quaternion)> __GlobalNamespace_TeleportOrientationHandlerHMDSizeCheck;
  static_assert(sizeof(TeleportOrientationHandlerHMD) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

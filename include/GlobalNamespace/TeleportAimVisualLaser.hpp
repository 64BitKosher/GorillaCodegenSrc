...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportAimVisualLaser), 88 + sizeof(::ArrayW<::UnityEngine::Vector3>)> __GlobalNamespace_TeleportAimVisualLaserSizeCheck;
  static_assert(sizeof(TeleportAimVisualLaser) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

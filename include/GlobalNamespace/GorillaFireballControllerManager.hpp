...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaFireballControllerManager), 76 + sizeof(float)> __GlobalNamespace_GorillaFireballControllerManagerSizeCheck;
  static_assert(sizeof(GorillaFireballControllerManager) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

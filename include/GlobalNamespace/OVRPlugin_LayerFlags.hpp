...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::LayerFlags/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/LayerFlags BicubicFiltering
    static constexpr const int BicubicFiltering = 16384;
    // Get static field: static public OVRPlugin/LayerFlags BicubicFiltering
    static ::GlobalNamespace::OVRPlugin::LayerFlags _get_BicubicFiltering();
    // Set static field: static public OVRPlugin/LayerFlags BicubicFiltering
    static void _set_BicubicFiltering(::GlobalNamespace::OVRPlugin::LayerFlags value);

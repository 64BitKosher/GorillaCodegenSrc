...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CheckoutCartButton), 272 + sizeof(::UnityEngine::UI::Text*)> __GlobalNamespace_CheckoutCartButtonSizeCheck;
  static_assert(sizeof(CheckoutCartButton) == 0x118);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PurchaseItemButton), 112 + sizeof(::StringW)> __GlobalNamespace_PurchaseItemButtonSizeCheck;
  static_assert(sizeof(PurchaseItemButton) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

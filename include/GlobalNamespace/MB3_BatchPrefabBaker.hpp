...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_BatchPrefabBaker), 48 + sizeof(::StringW)> __GlobalNamespace_MB3_BatchPrefabBakerSizeCheck;
  static_assert(sizeof(MB3_BatchPrefabBaker) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

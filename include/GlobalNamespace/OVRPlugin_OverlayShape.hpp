...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::OverlayShape/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/OverlayShape ReconstructionPassthrough
    ...
    static ::GlobalNamespace::OVRPlugin::OverlayShape _get_ReconstructionPassthrough();
    // Set static field: static public OVRPlugin/OverlayShape ReconstructionPassthrough
    static void _set_ReconstructionPassthrough(::GlobalNamespace::OVRPlugin::OverlayShape value);
    // static field const value: static public OVRPlugin/OverlayShape SurfaceProjectedPassthrough
    ...
    static ::GlobalNamespace::OVRPlugin::OverlayShape _get_SurfaceProjectedPassthrough();
    // Set static field: static public OVRPlugin/OverlayShape SurfaceProjectedPassthrough
    static void _set_SurfaceProjectedPassthrough(::GlobalNamespace::OVRPlugin::OverlayShape value);
    ...
    // static field const value: static public OVRPlugin/OverlayShape KeyboardHandsPassthrough
    ...
    static ::GlobalNamespace::OVRPlugin::OverlayShape _get_KeyboardHandsPassthrough();
    // Set static field: static public OVRPlugin/OverlayShape KeyboardHandsPassthrough
    static void _set_KeyboardHandsPassthrough(::GlobalNamespace::OVRPlugin::OverlayShape value);
    // static field const value: static public OVRPlugin/OverlayShape KeyboardMaskedHandsPassthrough
    ...
    static ::GlobalNamespace::OVRPlugin::OverlayShape _get_KeyboardMaskedHandsPassthrough();
    // Set static field: static public OVRPlugin/OverlayShape KeyboardMaskedHandsPassthrough
    static void _set_KeyboardMaskedHandsPassthrough(::GlobalNamespace::OVRPlugin::OverlayShape value);

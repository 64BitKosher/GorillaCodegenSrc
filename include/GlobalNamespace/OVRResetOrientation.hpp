...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRResetOrientation), 32 + sizeof(::GlobalNamespace::OVRInput::RawButton)> __GlobalNamespace_OVRResetOrientationSizeCheck;
  static_assert(sizeof(OVRResetOrientation) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

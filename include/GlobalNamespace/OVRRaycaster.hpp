...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRRaycaster), 96 + sizeof(::System::Collections::Generic::List_1<::GlobalNamespace::OVRRaycaster::RaycastHit>*)> __GlobalNamespace_OVRRaycasterSizeCheck;
  static_assert(sizeof(OVRRaycaster) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace GlobalNamespace {
  ...
  class OVRHaptics::OVRHapticsOutput : public ::Il2CppObject {
    ...
    // private System.Int32 PrevSampleRateHz
    // Size: 0x4
    // Offset: 0x48
    int PrevSampleRateHz;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    public:
    ...
    // Get instance field reference: private System.Int32 PrevSampleRateHz
    [[deprecated("Use field access instead!")]] int& dyn_PrevSampleRateHz();
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRHaptics::OVRHapticsOutput), 72 + sizeof(int)> __GlobalNamespace_OVRHaptics_OVRHapticsOutputSizeCheck;
  static_assert(sizeof(OVRHaptics::OVRHapticsOutput) == 0x4C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

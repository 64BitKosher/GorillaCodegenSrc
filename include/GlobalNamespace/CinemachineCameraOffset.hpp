...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CinemachineCameraOffset), 64 + sizeof(bool)> __GlobalNamespace_CinemachineCameraOffsetSizeCheck;
  static_assert(sizeof(CinemachineCameraOffset) == 0x41);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

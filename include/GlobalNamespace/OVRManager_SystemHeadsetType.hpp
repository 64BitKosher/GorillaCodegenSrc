...
namespace GlobalNamespace {
  ...
  struct OVRManager_SystemHeadsetType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRManager/SystemHeadsetType Meta_Quest_Pro
    static constexpr const int Meta_Quest_Pro = 10;
    // Get static field: static public OVRManager/SystemHeadsetType Meta_Quest_Pro
    static ::GlobalNamespace::OVRManager_SystemHeadsetType _get_Meta_Quest_Pro();
    // Set static field: static public OVRManager/SystemHeadsetType Meta_Quest_Pro
    static void _set_Meta_Quest_Pro(::GlobalNamespace::OVRManager_SystemHeadsetType value);
    // static field const value: static public OVRManager/SystemHeadsetType Meta_Quest_3
    static constexpr const int Meta_Quest_3 = 11;
    // Get static field: static public OVRManager/SystemHeadsetType Meta_Quest_3
    static ::GlobalNamespace::OVRManager_SystemHeadsetType _get_Meta_Quest_3();
    // Set static field: static public OVRManager/SystemHeadsetType Meta_Quest_3
    static void _set_Meta_Quest_3(::GlobalNamespace::OVRManager_SystemHeadsetType value);
    ...
    // static field const value: static public OVRManager/SystemHeadsetType Meta_Link_Quest_Pro
    ...
    static ::GlobalNamespace::OVRManager_SystemHeadsetType _get_Meta_Link_Quest_Pro();
    // Set static field: static public OVRManager/SystemHeadsetType Meta_Link_Quest_Pro
    static void _set_Meta_Link_Quest_Pro(::GlobalNamespace::OVRManager_SystemHeadsetType value);
    // static field const value: static public OVRManager/SystemHeadsetType Meta_Link_Quest_3
    ...
    static ::GlobalNamespace::OVRManager_SystemHeadsetType _get_Meta_Link_Quest_3();
    // Set static field: static public OVRManager/SystemHeadsetType Meta_Link_Quest_3
    static void _set_Meta_Link_Quest_3(::GlobalNamespace::OVRManager_SystemHeadsetType value);

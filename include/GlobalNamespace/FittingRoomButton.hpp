...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FittingRoomButton), 272 + sizeof(::UnityEngine::UI::Text*)> __GlobalNamespace_FittingRoomButtonSizeCheck;
  static_assert(sizeof(FittingRoomButton) == 0x118);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

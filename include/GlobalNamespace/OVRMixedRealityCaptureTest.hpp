...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRMixedRealityCaptureTest), 48 + sizeof(::GlobalNamespace::OVRPlugin::Fovf)> __GlobalNamespace_OVRMixedRealityCaptureTestSizeCheck;
  static_assert(sizeof(OVRMixedRealityCaptureTest) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

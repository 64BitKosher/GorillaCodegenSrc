...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EnableSwitch), 32 + sizeof(::ArrayW<::UnityEngine::GameObject*>)> __GlobalNamespace_EnableSwitchSizeCheck;
  static_assert(sizeof(EnableSwitch) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportTransitionBlink), 56 + sizeof(::UnityEngine::AnimationCurve*)> __GlobalNamespace_TeleportTransitionBlinkSizeCheck;
  static_assert(sizeof(TeleportTransitionBlink) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

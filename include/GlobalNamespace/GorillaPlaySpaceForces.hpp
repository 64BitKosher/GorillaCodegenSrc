...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaPlaySpaceForces), 152 + sizeof(::UnityEngine::Transform*)> __GlobalNamespace_GorillaPlaySpaceForcesSizeCheck;
  static_assert(sizeof(GorillaPlaySpaceForces) == 0xA0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

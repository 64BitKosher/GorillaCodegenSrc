...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InspectorCommentAttribute), 24 + sizeof(::StringW)> __GlobalNamespace_InspectorCommentAttributeSizeCheck;
  static_assert(sizeof(InspectorCommentAttribute) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRLipSyncDebugConsole), 60 + sizeof(float)> __GlobalNamespace_OVRLipSyncDebugConsoleSizeCheck;
  static_assert(sizeof(OVRLipSyncDebugConsole) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

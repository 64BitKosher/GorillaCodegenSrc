...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::OverlayFlag/*, public ::System::Enum*/ {
    ...
    // static field const value: static public OVRPlugin/OverlayFlag EfficientSuperSample
    static constexpr const int EfficientSuperSample = 16;
    // Get static field: static public OVRPlugin/OverlayFlag EfficientSuperSample
    static ::GlobalNamespace::OVRPlugin::OverlayFlag _get_EfficientSuperSample();
    // Set static field: static public OVRPlugin/OverlayFlag EfficientSuperSample
    static void _set_EfficientSuperSample(::GlobalNamespace::OVRPlugin::OverlayFlag value);
    // static field const value: static public OVRPlugin/OverlayFlag EfficientSharpen
    static constexpr const int EfficientSharpen = 32;
    // Get static field: static public OVRPlugin/OverlayFlag EfficientSharpen
    static ::GlobalNamespace::OVRPlugin::OverlayFlag _get_EfficientSharpen();
    // Set static field: static public OVRPlugin/OverlayFlag EfficientSharpen
    static void _set_EfficientSharpen(::GlobalNamespace::OVRPlugin::OverlayFlag value);
    // static field const value: static public OVRPlugin/OverlayFlag BicubicFiltering
    static constexpr const int BicubicFiltering = 64;
    // Get static field: static public OVRPlugin/OverlayFlag BicubicFiltering
    static ::GlobalNamespace::OVRPlugin::OverlayFlag _get_BicubicFiltering();
    // Set static field: static public OVRPlugin/OverlayFlag BicubicFiltering
    static void _set_BicubicFiltering(::GlobalNamespace::OVRPlugin::OverlayFlag value);
    // static field const value: static public OVRPlugin/OverlayFlag ExpensiveSharpen
    static constexpr const int ExpensiveSharpen = 128;
    // Get static field: static public OVRPlugin/OverlayFlag ExpensiveSharpen
    static ::GlobalNamespace::OVRPlugin::OverlayFlag _get_ExpensiveSharpen();
    // Set static field: static public OVRPlugin/OverlayFlag ExpensiveSharpen
    static void _set_ExpensiveSharpen(::GlobalNamespace::OVRPlugin::OverlayFlag value);
    // static field const value: static public OVRPlugin/OverlayFlag SecureContent
    static constexpr const int SecureContent = 256;
    // Get static field: static public OVRPlugin/OverlayFlag SecureContent
    static ::GlobalNamespace::OVRPlugin::OverlayFlag _get_SecureContent();
    // Set static field: static public OVRPlugin/OverlayFlag SecureContent
    static void _set_SecureContent(::GlobalNamespace::OVRPlugin::OverlayFlag value);
    ...
    // static field const value: static public OVRPlugin/OverlayFlag AutoFiltering
    static constexpr const int AutoFiltering = 1024;
    // Get static field: static public OVRPlugin/OverlayFlag AutoFiltering
    static ::GlobalNamespace::OVRPlugin::OverlayFlag _get_AutoFiltering();
    // Set static field: static public OVRPlugin/OverlayFlag AutoFiltering
    static void _set_AutoFiltering(::GlobalNamespace::OVRPlugin::OverlayFlag value);

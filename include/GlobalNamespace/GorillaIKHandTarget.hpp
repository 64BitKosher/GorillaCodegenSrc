...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaIKHandTarget), 56 + sizeof(::UnityEngine::XR::Interaction::Toolkit::XRController*)> __GlobalNamespace_GorillaIKHandTargetSizeCheck;
  static_assert(sizeof(GorillaIKHandTarget) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HandsActiveChecker), 56 + sizeof(::UnityEngine::Transform*)> __GlobalNamespace_HandsActiveCheckerSizeCheck;
  static_assert(sizeof(HandsActiveChecker) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

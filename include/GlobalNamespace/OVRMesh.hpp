...
namespace GlobalNamespace {
  ...
  class OVRMesh : public ::UnityEngine::MonoBehaviour {
    ...
    // System.Void SetMeshType(OVRMesh/MeshType type)
    // Offset: 0x494CE84
    void SetMeshType(::GlobalNamespace::OVRMesh::MeshType type);
    ...
    // private System.Void TransformOvrpMesh(OVRPlugin/Mesh ovrpMesh, UnityEngine.Mesh mesh)
    // Offset: 0x494D074
    void TransformOvrpMesh(::GlobalNamespace::OVRPlugin::Mesh* ovrpMesh, ::UnityEngine::Mesh* mesh);
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRMesh), 56 + sizeof(bool)> __GlobalNamespace_OVRMeshSizeCheck;
  static_assert(sizeof(OVRMesh) == 0x39);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::OVRMesh::SetMeshType
// Il2CppName: SetMeshType
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRMesh::*)(::GlobalNamespace::OVRMesh::MeshType)>(&GlobalNamespace::OVRMesh::SetMeshType)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("", "OVRMesh/MeshType")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRMesh*), "SetMeshType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
...
// Writing MetadataGetter for method: GlobalNamespace::OVRMesh::TransformOvrpMesh
// Il2CppName: TransformOvrpMesh
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRMesh::*)(::GlobalNamespace::OVRPlugin::Mesh*, ::UnityEngine::Mesh*)>(&GlobalNamespace::OVRMesh::TransformOvrpMesh)> {
  static const MethodInfo* get() {
    static auto* ovrpMesh = &::il2cpp_utils::GetClassFromName("", "OVRPlugin/Mesh")->byval_arg;
    static auto* mesh = &::il2cpp_utils::GetClassFromName("UnityEngine", "Mesh")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRMesh*), "TransformOvrpMesh", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ovrpMesh, mesh});
  }
};

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MoviePlayerSampleControls), 172 + sizeof(::GlobalNamespace::MoviePlayerSampleControls::PlaybackState)> __GlobalNamespace_MoviePlayerSampleControlsSizeCheck;
  static_assert(sizeof(MoviePlayerSampleControls) == 0xB0);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_MeshBaker), 96 + sizeof(::DigitalOpus::MB::Core::MB3_MeshCombinerSingle*)> __GlobalNamespace_MB3_MeshBakerSizeCheck;
  static_assert(sizeof(MB3_MeshBaker) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

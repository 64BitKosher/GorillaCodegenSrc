...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportInputHandler), 56 + sizeof(::System::Action*)> __GlobalNamespace_TeleportInputHandlerSizeCheck;
  static_assert(sizeof(TeleportInputHandler) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

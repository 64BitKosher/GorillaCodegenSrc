...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaBodyPhysics), 56 + sizeof(::UnityEngine::Transform*)> __GlobalNamespace_GorillaBodyPhysicsSizeCheck;
  static_assert(sizeof(GorillaBodyPhysics) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

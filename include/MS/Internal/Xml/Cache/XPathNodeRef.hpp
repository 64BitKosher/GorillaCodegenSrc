...
namespace MS::Internal::Xml::Cache {
  ...
  struct XPathNodeRef/*, public ::System::ValueType*/ {
    public:
    public:
    // private MS.Internal.Xml.Cache.XPathNode[] _page
    // Size: 0x8
    // Offset: 0x0
    ...
    // Get instance field reference: private MS.Internal.Xml.Cache.XPathNode[] _page
    [[deprecated("Use field access instead!")]] ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>& dyn__page();

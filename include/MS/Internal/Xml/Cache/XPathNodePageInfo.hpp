...
namespace MS::Internal::Xml::Cache {
  ...
  class XPathNodePageInfo : public ::Il2CppObject {
    public:
    public:
    // private System.Int32 _pageNum
    // Size: 0x4
    // Offset: 0x10
    int pageNum;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // private System.Int32 _nodeCount
    // Size: 0x4
    // Offset: 0x14
    int nodeCount;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // private MS.Internal.Xml.Cache.XPathNode[] _pageNext
    // Size: 0x8
    // Offset: 0x18
    ...
    public:
    // Get instance field reference: private System.Int32 _pageNum
    [[deprecated("Use field access instead!")]] int& dyn__pageNum();
    // Get instance field reference: private System.Int32 _nodeCount
    [[deprecated("Use field access instead!")]] int& dyn__nodeCount();
    // Get instance field reference: private MS.Internal.Xml.Cache.XPathNode[] _pageNext
    [[deprecated("Use field access instead!")]] ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>& dyn__pageNext();

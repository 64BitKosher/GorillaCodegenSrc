...
namespace MS::Internal::Xml::Cache {
  ...
  struct XPathNode/*, public ::System::ValueType*/ {
    public:
    public:
    // private MS.Internal.Xml.Cache.XPathNodeInfoAtom _info
    // Size: 0x8
    // Offset: 0x0
    ::MS::Internal::Xml::Cache::XPathNodeInfoAtom* info;
    // Field size check
    static_assert(sizeof(::MS::Internal::Xml::Cache::XPathNodeInfoAtom*) == 0x8);
    // private System.UInt16 _idxSibling
    // Size: 0x2
    // Offset: 0x8
    uint16_t idxSibling;
    // Field size check
    static_assert(sizeof(uint16_t) == 0x2);
    // private System.UInt16 _idxParent
    // Size: 0x2
    // Offset: 0xA
    uint16_t idxParent;
    // Field size check
    static_assert(sizeof(uint16_t) == 0x2);
    // private System.UInt16 _idxSimilar
    // Size: 0x2
    // Offset: 0xC
    uint16_t idxSimilar;
    // Field size check
    static_assert(sizeof(uint16_t) == 0x2);
    // private System.UInt16 _posOffset
    // Size: 0x2
    // Offset: 0xE
    uint16_t posOffset;
    // Field size check
    static_assert(sizeof(uint16_t) == 0x2);
    // private System.UInt32 _props
    // Size: 0x4
    // Offset: 0x10
    uint props;
    // Field size check
    ...
    // Get instance field reference: private MS.Internal.Xml.Cache.XPathNodeInfoAtom _info
    [[deprecated("Use field access instead!")]] ::MS::Internal::Xml::Cache::XPathNodeInfoAtom*& dyn__info();
    // Get instance field reference: private System.UInt16 _idxSibling
    [[deprecated("Use field access instead!")]] uint16_t& dyn__idxSibling();
    // Get instance field reference: private System.UInt16 _idxParent
    [[deprecated("Use field access instead!")]] uint16_t& dyn__idxParent();
    // Get instance field reference: private System.UInt16 _idxSimilar
    [[deprecated("Use field access instead!")]] uint16_t& dyn__idxSimilar();
    // Get instance field reference: private System.UInt16 _posOffset
    [[deprecated("Use field access instead!")]] uint16_t& dyn__posOffset();
    // Get instance field reference: private System.UInt32 _props
    [[deprecated("Use field access instead!")]] uint& dyn__props();

...
namespace MS::Internal::Xml::XPath {
  ...
  class Filter : public ::MS::Internal::Xml::XPath::AstNode {
    ...
    // private MS.Internal.Xml.XPath.AstNode _condition
    // Size: 0x8
    // Offset: 0x18
    ...
    // Get instance field reference: private MS.Internal.Xml.XPath.AstNode _condition
    [[deprecated("Use field access instead!")]] ::MS::Internal::Xml::XPath::AstNode*& dyn__condition();

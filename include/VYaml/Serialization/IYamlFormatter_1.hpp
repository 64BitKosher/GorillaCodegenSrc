...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::VYaml::Serialization::IYamlFormatter_1, "VYaml.Serialization", "IYamlFormatter`1");
// Type namespace: VYaml.Serialization
namespace VYaml::Serialization {
  // WARNING Size may be invalid!
  // Autogenerated type: VYaml.Serialization.IYamlFormatter`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [NullableContextAttribute] Offset: FFFFFFFF
  template<typename T>
  class IYamlFormatter_1/*, public ::VYaml::Serialization::IYamlFormatter*/ {
    public:
    // Creating interface conversion operator: operator ::VYaml::Serialization::IYamlFormatter
    operator ::VYaml::Serialization::IYamlFormatter() noexcept {
      return *reinterpret_cast<::VYaml::Serialization::IYamlFormatter*>(this);
    }
    ...
    void Serialize(ByRef<::VYaml::Emitter::Utf8YamlEmitter> emitter, T value, ::VYaml::Serialization::YamlSerializationContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("::VYaml::Serialization::IYamlFormatter_1::Serialize");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::VYaml::Serialization::IYamlFormatter_1<T>*), -1));
    ...
    T Deserialize(ByRef<::VYaml::Parser::YamlParser> parser, ::VYaml::Serialization::YamlDeserializationContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("::VYaml::Serialization::IYamlFormatter_1::Deserialize");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::VYaml::Serialization::IYamlFormatter_1<T>*), -1));
      return ::il2cpp_utils::RunMethodRethrow<T, false>(this, ___internal__method, byref(parser), context);
    }
  }; // VYaml.Serialization.IYamlFormatter`1
  // Could not write size check! Type: VYaml.Serialization.IYamlFormatter`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

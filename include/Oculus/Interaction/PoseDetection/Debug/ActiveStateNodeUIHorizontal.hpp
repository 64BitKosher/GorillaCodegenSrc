...
namespace Oculus::Interaction::PoseDetection::Debug {
  // Forward declaring type: ActiveStateNodeUIHorizontal
  class ActiveStateNodeUIHorizontal;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(::Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal);
DEFINE_IL2CPP_ARG_TYPE(::Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal*, "Oculus.Interaction.PoseDetection.Debug", "ActiveStateNodeUIHorizontal");
// Type namespace: Oculus.Interaction.PoseDetection.Debug
namespace Oculus::Interaction::PoseDetection::Debug {
  // Size: 0x6A
  #pragma pack(push, 1)
  // Autogenerated type: Oculus.Interaction.PoseDetection.Debug.ActiveStateNodeUIHorizontal
  // [TokenAttribute] Offset: FFFFFFFF
  class ActiveStateNodeUIHorizontal : public ::UnityEngine::MonoBehaviour/*, public ::Oculus::Interaction::DebugTree::INodeUI_1<::Oculus::Interaction::IActiveState*>*/ {
    public:
    public:
    ...
    static ActiveStateNodeUIHorizontal* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ActiveStateNodeUIHorizontal*, creationType>()));
    }
  }; // Oculus.Interaction.PoseDetection.Debug.ActiveStateNodeUIHorizontal
  #pragma pack(pop)
  static check_size<sizeof(ActiveStateNodeUIHorizontal), 105 + sizeof(bool)> __Oculus_Interaction_PoseDetection_Debug_ActiveStateNodeUIHorizontalSizeCheck;
  static_assert(sizeof(ActiveStateNodeUIHorizontal) == 0x6A);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::get_ChildArea
// Il2CppName: get_ChildArea
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::RectTransform* (Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::*)()>(&Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::get_ChildArea)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal*), "get_ChildArea", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::Bind
// Il2CppName: Bind
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::*)(::Oculus::Interaction::DebugTree::ITreeNode_1<::Oculus::Interaction::IActiveState*>*, bool, bool)>(&Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::Bind)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal*), "Bind", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{node, isRoot, isDuplicate});
  }
};
// Writing MetadataGetter for method: Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::Start
// Il2CppName: Start
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::*)()>(&Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::Start)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal*), "Start", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::Update
// Il2CppName: Update
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::*)()>(&Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::Update)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal*), "Update", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::GetLabelText
// Il2CppName: GetLabelText
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::*)(::Oculus::Interaction::DebugTree::ITreeNode_1<::Oculus::Interaction::IActiveState*>*)>(&Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::GetLabelText)> {
  static const MethodInfo* get() {
    static auto* node = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("Oculus.Interaction.DebugTree", "ITreeNode`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("Oculus.Interaction", "IActiveState")})->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal*), "GetLabelText", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{node});
  }
};
// Writing MetadataGetter for method: Oculus::Interaction::PoseDetection::Debug::ActiveStateNodeUIHorizontal::New_ctor
// Il2CppName: .ctor

...
namespace Oculus::Platform {
  ...
  class StandalonePlatform : public ::Il2CppObject {
    ...
    // public Oculus.Platform.Request`1<Oculus.Platform.Models.PlatformInitialize> AsyncInitializeWithAccessTokenAndOptions(System.String appId, System.String accessToken, System.Collections.Generic.Dictionary`2<Oculus.Platform.InitConfigOptions,System.Boolean> initConfigOptions)
    // Offset: 0x4878630
...
// Writing MetadataGetter for method: Oculus::Platform::StandalonePlatform::AsyncInitializeWithAccessTokenAndOptions
// Il2CppName: AsyncInitializeWithAccessTokenAndOptions
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* (Oculus::Platform::StandalonePlatform::*)(::StringW, ::StringW, ::System::Collections::Generic::Dictionary_2<::Oculus::Platform::InitConfigOptions, bool>*)>(&Oculus::Platform::StandalonePlatform::AsyncInitializeWithAccessTokenAndOptions)> {
  static const MethodInfo* get() {
    static auto* appId = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* accessToken = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* initConfigOptions = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "Dictionary`2"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("Oculus.Platform", "InitConfigOptions"), ::il2cpp_utils::GetClassFromName("System", "Boolean")})->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Oculus::Platform::StandalonePlatform*), "AsyncInitializeWithAccessTokenAndOptions", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{appId, accessToken, initConfigOptions});
  }
};

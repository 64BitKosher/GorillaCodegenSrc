...
namespace Oculus::Platform::Samples::SimplePlatformSample {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DataEntry), 32 + sizeof(::UnityEngine::UI::Text*)> __Oculus_Platform_Samples_SimplePlatformSample_DataEntrySizeCheck;
  static_assert(sizeof(DataEntry) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

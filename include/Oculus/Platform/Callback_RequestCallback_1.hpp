...
namespace Oculus::Platform {
  ...
  class Callback::RequestCallback_1 : public ::Oculus::Platform::Callback::RequestCallback {
    ...
    [[deprecated("Use field access instead!")]] typename ::Oculus::Platform::Message_1<T>::Callback*& dyn_callback() {
    ...
    void HandleMessage(::Oculus::Platform::Message* msg) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::Oculus::Platform::Callback::RequestCallback*), -1));

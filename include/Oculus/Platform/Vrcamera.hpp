...
namespace Oculus::Platform {
  // Forward declaring type: Vrcamera
  class Vrcamera;
}
...
namespace Oculus::Platform {
  ...
  class Vrcamera : public ::Il2CppObject {
    public:
    // static public System.Void SetGetDataChannelMessageUpdateNotificationCallback(Oculus.Platform.Message`1/Callback<System.String> callback)
    // Offset: 0x4882F30
    static void SetGetDataChannelMessageUpdateNotificationCallback(typename ::Oculus::Platform::Message_1<::StringW>::Callback* callback);
...
// Writing MetadataGetter for method: Oculus::Platform::Vrcamera::SetGetDataChannelMessageUpdateNotificationCallback
// Il2CppName: SetGetDataChannelMessageUpdateNotificationCallback

...
namespace Oculus::Platform::Models {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ChallengeEntry), 64 + sizeof(::Oculus::Platform::Models::User*)> __Oculus_Platform_Models_ChallengeEntrySizeCheck;
  static_assert(sizeof(ChallengeEntry) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

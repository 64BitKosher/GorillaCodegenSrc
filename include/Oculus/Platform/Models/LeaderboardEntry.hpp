...
namespace Oculus::Platform::Models {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LeaderboardEntry), 80 + sizeof(::Oculus::Platform::Models::User*)> __Oculus_Platform_Models_LeaderboardEntrySizeCheck;
  static_assert(sizeof(LeaderboardEntry) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Oculus::Platform::Models {
  ...
  class Purchase : public ::Il2CppObject {
    public:
    public:
    // public readonly System.String DeveloperPayload
    // Size: 0x8
    // Offset: 0x10
    ::StringW DeveloperPayload;
    // Field size check
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // public readonly System.String ReportingId
    // Size: 0x8
    // Offset: 0x30
    ::StringW ReportingId;
    // Field size check
    ...
    static_assert(sizeof(::StringW) == 0x8);
    public:
    // Get instance field reference: public readonly System.String DeveloperPayload
    [[deprecated("Use field access instead!")]] ::StringW& dyn_DeveloperPayload();
    ...
    // Get instance field reference: public readonly System.String ReportingId
    [[deprecated("Use field access instead!")]] ::StringW& dyn_ReportingId();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Purchase), 56 + sizeof(::StringW)> __Oculus_Platform_Models_PurchaseSizeCheck;
  static_assert(sizeof(Purchase) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Oculus::Platform::Models {
  ...
  class ApplicationVersion : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // public readonly System.Int64 ReleaseDate
    // Size: 0x8
    // Offset: 0x30
    int64_t ReleaseDate;
    // Field size check
    static_assert(sizeof(int64_t) == 0x8);
    // public readonly System.String Size
    // Size: 0x8
    // Offset: 0x38
    ::StringW Size;
    // Field size check
    ...
    // Get instance field reference: public readonly System.Int64 ReleaseDate
    [[deprecated("Use field access instead!")]] int64_t& dyn_ReleaseDate();
    // Get instance field reference: public readonly System.String Size
    [[deprecated("Use field access instead!")]] ::StringW& dyn_Size();
  ...
  #pragma pack(pop)
  static check_size<sizeof(ApplicationVersion), 56 + sizeof(::StringW)> __Oculus_Platform_Models_ApplicationVersionSizeCheck;
  static_assert(sizeof(ApplicationVersion) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

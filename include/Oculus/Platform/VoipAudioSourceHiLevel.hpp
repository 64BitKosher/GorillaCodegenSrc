...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(VoipAudioSourceHiLevel), 56 + sizeof(::Oculus::Platform::IVoipPCMSource*)> __Oculus_Platform_VoipAudioSourceHiLevelSizeCheck;
  static_assert(sizeof(VoipAudioSourceHiLevel) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace Oculus::Platform {
  ...
  class GroupPresence : public ::Il2CppObject {
    ...
    // static public Oculus.Platform.Request SetDeeplinkMessageOverride(System.String deeplink_message)
    // Offset: 0x4880180
    ...
    // static public System.Void SetInvitationsSentNotificationCallback(Oculus.Platform.Message`1/Callback<Oculus.Platform.Models.LaunchInvitePanelFlowResult> callback)
    // Offset: 0x484FD3C
    ...
    // static public System.Void SetJoinIntentReceivedNotificationCallback(Oculus.Platform.Message`1/Callback<Oculus.Platform.Models.GroupPresenceJoinIntent> callback)
    // Offset: 0x484FC54
    ...
    // static public System.Void SetLeaveIntentReceivedNotificationCallback(Oculus.Platform.Message`1/Callback<Oculus.Platform.Models.GroupPresenceLeaveIntent> callback)
    // Offset: 0x484FCC8
...
// Writing MetadataGetter for method: Oculus::Platform::GroupPresence::SetDeeplinkMessageOverride
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request* (*)(::StringW)>(&Oculus::Platform::GroupPresence::SetDeeplinkMessageOverride)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Oculus::Platform::GroupPresence*), "SetDeeplinkMessageOverride", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{deeplink_message});
  }
};

...
namespace Oculus::Platform {
  ...
  class Core : public ::Il2CppObject {
    ...
    // static public Oculus.Platform.Request`1<Oculus.Platform.Models.PlatformInitialize> AsyncInitialize(System.String accessToken, System.Collections.Generic.Dictionary`2<Oculus.Platform.InitConfigOptions,System.Boolean> initConfigOptions, System.String appId)
    // Offset: 0x4878398
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* (*)(::StringW, ::System::Collections::Generic::Dictionary_2<::Oculus::Platform::InitConfigOptions, bool>*, ::StringW)>(&Oculus::Platform::Core::AsyncInitialize)> {
  static const MethodInfo* get() {
    ...
    static auto* appId = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Oculus::Platform::Core*), "AsyncInitialize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{accessToken, initConfigOptions, appId});
  }
};

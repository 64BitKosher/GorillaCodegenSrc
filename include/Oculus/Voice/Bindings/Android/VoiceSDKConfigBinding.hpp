...
namespace Oculus::Voice::Bindings::Android {
  ...
  class VoiceSDKConfigBinding : public ::Il2CppObject {
    public:
    public:
    // private Meta.WitAi.Configuration.WitRuntimeConfiguration configuration
    // Size: 0x8
    // Offset: 0x10
    ::Meta::WitAi::Configuration::WitRuntimeConfiguration* configuration;
    // Field size check
    static_assert(sizeof(::Meta::WitAi::Configuration::WitRuntimeConfiguration*) == 0x8);
    public:
    // Creating conversion operator: operator ::Meta::WitAi::Configuration::WitRuntimeConfiguration*
    constexpr operator ::Meta::WitAi::Configuration::WitRuntimeConfiguration*() const noexcept {
      return configuration;
    }
    // Get instance field reference: private Meta.WitAi.Configuration.WitRuntimeConfiguration configuration
    [[deprecated("Use field access instead!")]] ::Meta::WitAi::Configuration::WitRuntimeConfiguration*& dyn_configuration();
    // public System.Void .ctor(Meta.WitAi.Configuration.WitRuntimeConfiguration config)
    // Offset: 0x5723CE0
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static VoiceSDKConfigBinding* New_ctor(::Meta::WitAi::Configuration::WitRuntimeConfiguration* config) {
  ...
  #pragma pack(pop)
  static check_size<sizeof(VoiceSDKConfigBinding), 16 + sizeof(::Meta::WitAi::Configuration::WitRuntimeConfiguration*)> __Oculus_Voice_Bindings_Android_VoiceSDKConfigBindingSizeCheck;

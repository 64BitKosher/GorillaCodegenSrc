...
namespace Oculus::Voice::Core::Utilities {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ArrayElementTitleAttribute), 32 + sizeof(::StringW)> __Oculus_Voice_Core_Utilities_ArrayElementTitleAttributeSizeCheck;
  static_assert(sizeof(ArrayElementTitleAttribute) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

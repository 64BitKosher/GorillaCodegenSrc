...
// Il2CppName: Connect
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Voice::Core::Bindings::Android::AndroidServiceConnection::*)(::StringW)>(&Oculus::Voice::Core::Bindings::Android::AndroidServiceConnection::Connect)> {
  static const MethodInfo* get() {
    static auto* version = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Oculus::Voice::Core::Bindings::Android::AndroidServiceConnection*), "Connect", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{version});
  }
};

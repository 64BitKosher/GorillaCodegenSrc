...
namespace UnityEngine {
  ...
  struct Color/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Color>, public ::System::IFormattable*/ {
    public:
    public:
    ...
    // public UnityEngine.Color get_gamma()
    // Offset: 0x54B4D40
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::Color::*)(::StringW, ::System::IFormatProvider*)>(&UnityEngine::Color::ToString)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Color), "ToString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{format, formatProvider});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Color::get_gamma
// Il2CppName: get_gamma
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (UnityEngine::Color::*)()>(&UnityEngine::Color::get_gamma)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Color), "get_gamma", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

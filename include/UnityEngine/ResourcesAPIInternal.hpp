...
// Writing MetadataGetter for method: UnityEngine::ResourcesAPIInternal::LoadAll
// Il2CppName: LoadAll
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Object*> (*)(::StringW, ::System::Type*)>(&UnityEngine::ResourcesAPIInternal::LoadAll)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* systemTypeInstance = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourcesAPIInternal*), "LoadAll", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path, systemTypeInstance});
  }
};
// Writing MetadataGetter for method: UnityEngine::ResourcesAPIInternal::LoadAsyncInternal
// Il2CppName: LoadAsyncInternal
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ResourceRequest* (*)(::StringW, ::System::Type*)>(&UnityEngine::ResourcesAPIInternal::LoadAsyncInternal)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourcesAPIInternal*), "LoadAsyncInternal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path, type});
  }
};
// Writing MetadataGetter for method: UnityEngine::ResourcesAPIInternal::UnloadAsset
// Il2CppName: UnloadAsset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Object*)>(&UnityEngine::ResourcesAPIInternal::UnloadAsset)> {
  static const MethodInfo* get() {
    static auto* assetToUnload = &::il2cpp_utils::GetClassFromName("UnityEngine", "Object")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourcesAPIInternal*), "UnloadAsset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{assetToUnload});
  }
};

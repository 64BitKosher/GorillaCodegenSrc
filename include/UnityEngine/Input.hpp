...
namespace UnityEngine {
  ...
  class Input : public ::Il2CppObject {
    ...
    // static public System.String[] GetJoystickNames()
    // Offset: 0x5519738
    static ::ArrayW<::StringW> GetJoystickNames();
    // static public UnityEngine.Touch GetTouch(System.Int32 index)
    // Offset: 0x5519760
    static ::UnityEngine::Touch GetTouch(int index);
    // static public UnityEngine.PenData GetLastPenContactEvent()
    // Offset: 0x5519814
    static ::UnityEngine::PenData GetLastPenContactEvent();
    // static public System.Void ClearLastPenContactEvent()
    // Offset: 0x55198B4
    static void ClearLastPenContactEvent();
    ...
    // static public System.Boolean get_anyKey()
    // Offset: 0x5519A08
    ...
    // static private System.Void GetLastPenContactEvent_Injected(out UnityEngine.PenData ret)
    // Offset: 0x5519878
    static void GetLastPenContactEvent_Injected(ByRef<::UnityEngine::PenData> ret);
...
// Writing MetadataGetter for method: UnityEngine::Input::GetJoystickNames
// Il2CppName: GetJoystickNames
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::StringW> (*)()>(&UnityEngine::Input::GetJoystickNames)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "GetJoystickNames", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Input::GetLastPenContactEvent
// Il2CppName: GetLastPenContactEvent
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::PenData (*)()>(&UnityEngine::Input::GetLastPenContactEvent)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "GetLastPenContactEvent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Input::ClearLastPenContactEvent
// Il2CppName: ClearLastPenContactEvent
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&UnityEngine::Input::ClearLastPenContactEvent)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "ClearLastPenContactEvent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Input::get_anyKey
// Il2CppName: get_anyKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&UnityEngine::Input::get_anyKey)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "get_anyKey", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Input::CheckDisabled
// Il2CppName: CheckDisabled
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&UnityEngine::Input::CheckDisabled)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "CheckDisabled", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Input::GetLastPenContactEvent_Injected
// Il2CppName: GetLastPenContactEvent_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<::UnityEngine::PenData>)>(&UnityEngine::Input::GetLastPenContactEvent_Injected)> {
  static const MethodInfo* get() {
    static auto* ret = &::il2cpp_utils::GetClassFromName("UnityEngine", "PenData")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "GetLastPenContactEvent_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ret});
  }
};

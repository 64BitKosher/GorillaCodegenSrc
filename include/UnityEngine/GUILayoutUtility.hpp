...
namespace UnityEngine {
  ...
  class GUILayoutUtility : public ::Il2CppObject {
    ...
    // Get static field: static private System.Int32 <unbalancedgroupscount>k__BackingField
    static int _get_$unbalancedgroupscount$k__BackingField();
    // Set static field: static private System.Int32 <unbalancedgroupscount>k__BackingField
    static void _set_$unbalancedgroupscount$k__BackingField(int value);
    ...
    // static System.Int32 get_unbalancedgroupscount()
    // Offset: 0x550475C
    static int get_unbalancedgroupscount();
    // static System.Void set_unbalancedgroupscount(System.Int32 value)
    // Offset: 0x55047B4
    static void set_unbalancedgroupscount(int value);
    ...
    // static System.Void BeginContainer(UnityEngine.GUILayoutUtility/LayoutCache cache)
    // Offset: 0x5504C50
    ...
    // Offset: 0x5503AE4
    static ::UnityEngine::GUILayoutGroup* BeginLayoutArea(::UnityEngine::GUIStyle* style, ::System::Type* layoutType);
    // static System.Void EndLayoutArea()
    // Offset: 0x5503EE8
    static void EndLayoutArea();
    ...
    // static public UnityEngine.Rect GetLastRect()
    // Offset: 0x55061F8
...
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::get_unbalancedgroupscount
// Il2CppName: get_unbalancedgroupscount
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)()>(&UnityEngine::GUILayoutUtility::get_unbalancedgroupscount)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility*), "get_unbalancedgroupscount", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::set_unbalancedgroupscount
// Il2CppName: set_unbalancedgroupscount
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(int)>(&UnityEngine::GUILayoutUtility::set_unbalancedgroupscount)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility*), "set_unbalancedgroupscount", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::EndLayoutArea
// Il2CppName: EndLayoutArea
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&UnityEngine::GUILayoutUtility::EndLayoutArea)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility*), "EndLayoutArea", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::GetLastRect
// Il2CppName: GetLastRect
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rect (*)()>(&UnityEngine::GUILayoutUtility::GetLastRect)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility*), "GetLastRect", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

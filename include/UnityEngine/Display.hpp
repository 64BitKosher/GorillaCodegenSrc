...
namespace UnityEngine {
  ...
  class Display : public ::Il2CppObject {
    ...
    static int _get_m_ActiveEditorGameViewTarget();
    // Set static field: static private System.Int32 m_ActiveEditorGameViewTarget
    static void _set_m_ActiveEditorGameViewTarget(int value);
    ...
    // public System.Boolean get_requiresSrgbBlitToBackbuffer()
    // Offset: 0x5489208
    ...
    // static System.Void RecreateDisplayList(System.IntPtr[] nativeDisplay)
    // Offset: 0x5489430
    ...
    // static private System.Boolean RequiresSrgbBlitToBackbufferImpl(System.IntPtr nativeDisplay)
    // Offset: 0x5489280
    static bool RequiresSrgbBlitToBackbufferImpl(::System::IntPtr nativeDisplay);
...
// Writing MetadataGetter for method: UnityEngine::Display::get_requiresSrgbBlitToBackbuffer
// Il2CppName: get_requiresSrgbBlitToBackbuffer
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Display::*)()>(&UnityEngine::Display::get_requiresSrgbBlitToBackbuffer)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Display*), "get_requiresSrgbBlitToBackbuffer", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Display::RequiresSrgbBlitToBackbufferImpl
// Il2CppName: RequiresSrgbBlitToBackbufferImpl
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::System::IntPtr)>(&UnityEngine::Display::RequiresSrgbBlitToBackbufferImpl)> {
  static const MethodInfo* get() {
    static auto* nativeDisplay = &::il2cpp_utils::GetClassFromName("System", "IntPtr")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Display*), "RequiresSrgbBlitToBackbufferImpl", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{nativeDisplay});
  }
};

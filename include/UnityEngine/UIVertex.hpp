...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UIVertex), 92 + sizeof(::UnityEngine::Vector4)> __UnityEngine_UIVertexSizeCheck;
  static_assert(sizeof(UIVertex) == 0x6C);
}

...
namespace UnityEngine {
  // Size: 0x38
  #pragma pack(push, 1)
  // Autogenerated type: UnityEngine.GUILayout/LayoutedWindow
  ...
  class GUILayout::LayoutedWindow : public ::Il2CppObject {
    ...
    public:
    // Get instance field reference: private readonly UnityEngine.GUI/WindowFunction m_Func
    ...
    // System.Void .ctor(UnityEngine.GUI/WindowFunction f, UnityEngine.Rect screenRect, UnityEngine.GUIContent content, UnityEngine.GUILayoutOption[] options, UnityEngine.GUIStyle style)
    // Offset: 0x55042B4

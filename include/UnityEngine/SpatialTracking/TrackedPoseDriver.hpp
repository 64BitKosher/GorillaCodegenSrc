...
namespace UnityEngine::SpatialTracking {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrackedPoseDriver), 60 + sizeof(::UnityEngine::Pose)> __UnityEngine_SpatialTracking_TrackedPoseDriverSizeCheck;
  static_assert(sizeof(TrackedPoseDriver) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace UnityEngine {
  ...
  class AssetBundle : public ::UnityEngine::Object {
    ...
    // static UnityEngine.AssetBundle[] GetAllLoadedAssetBundles_Native()
    // Offset: 0x54711FC
    static ::ArrayW<::UnityEngine::AssetBundle*> GetAllLoadedAssetBundles_Native();
    // static public System.Collections.Generic.IEnumerable`1<UnityEngine.AssetBundle> GetAllLoadedAssetBundles()
    // Offset: 0x5471224
    ...
    // public UnityEngine.AssetBundleUnloadOperation UnloadAsync(System.Boolean unloadAllLoadedObjects)
    // Offset: 0x5471AE8
    ::UnityEngine::AssetBundleUnloadOperation* UnloadAsync(bool unloadAllLoadedObjects);
...
// Writing MetadataGetter for method: UnityEngine::AssetBundle::GetAllLoadedAssetBundles_Native
// Il2CppName: GetAllLoadedAssetBundles_Native
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::AssetBundle*> (*)()>(&UnityEngine::AssetBundle::GetAllLoadedAssetBundles_Native)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AssetBundle*), "GetAllLoadedAssetBundles_Native", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::AssetBundle::GetAllLoadedAssetBundles
// Il2CppName: GetAllLoadedAssetBundles
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::UnityEngine::AssetBundle*>* (*)()>(&UnityEngine::AssetBundle::GetAllLoadedAssetBundles)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AssetBundle*), "GetAllLoadedAssetBundles", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::AssetBundleRequest* (UnityEngine::AssetBundle::*)()>(&UnityEngine::AssetBundle::LoadAllAssetsAsync)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AssetBundle*), "LoadAllAssetsAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::AssetBundle::LoadAllAssetsAsync
// Il2CppName: LoadAllAssetsAsync
...
// Writing MetadataGetter for method: UnityEngine::AssetBundle::UnloadAsync
// Il2CppName: UnloadAsync
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::AssetBundleUnloadOperation* (UnityEngine::AssetBundle::*)(bool)>(&UnityEngine::AssetBundle::UnloadAsync)> {
  static const MethodInfo* get() {
    static auto* unloadAllLoadedObjects = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AssetBundle*), "UnloadAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{unloadAllLoadedObjects});
  }
};

...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PointLight), 76 + sizeof(::UnityEngine::Experimental::GlobalIllumination::FalloffType)> __UnityEngine_Experimental_GlobalIllumination_PointLightSizeCheck;
  static_assert(sizeof(PointLight) == 0x4D);
}

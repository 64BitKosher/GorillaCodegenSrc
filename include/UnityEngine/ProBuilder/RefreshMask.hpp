...
namespace UnityEngine::ProBuilder {
  ...
  struct RefreshMask/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.ProBuilder.RefreshMask Bounds
    static constexpr const int Bounds = 22;
    // Get static field: static public UnityEngine.ProBuilder.RefreshMask Bounds
    static ::UnityEngine::ProBuilder::RefreshMask _get_Bounds();
    // Set static field: static public UnityEngine.ProBuilder.RefreshMask Bounds
    static void _set_Bounds(::UnityEngine::ProBuilder::RefreshMask value);

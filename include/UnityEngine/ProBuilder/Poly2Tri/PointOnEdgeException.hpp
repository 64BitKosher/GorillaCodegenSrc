...
namespace UnityEngine::ProBuilder::Poly2Tri {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PointOnEdgeException), 160 + sizeof(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*)> __UnityEngine_ProBuilder_Poly2Tri_PointOnEdgeExceptionSizeCheck;

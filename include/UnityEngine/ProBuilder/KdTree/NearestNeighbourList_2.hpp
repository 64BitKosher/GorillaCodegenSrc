...
namespace UnityEngine::ProBuilder::KdTree {
  ...
  class NearestNeighbourList_2 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::ProBuilder::KdTree::PriorityQueue_2<TItem, TDistance>*& dyn_queue() {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::ProBuilder::KdTree::ITypeMath_1<TDistance>*& dyn_distanceMath() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn_maxCapacity() {
    ...
    int get_MaxCapacity() {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem, TDistance>*), -1)));

...
namespace UnityEngine::ProBuilder {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BezierShape), 64 + sizeof(::UnityEngine::ProBuilder::ProBuilderMesh*)> __UnityEngine_ProBuilder_BezierShapeSizeCheck;
  static_assert(sizeof(BezierShape) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

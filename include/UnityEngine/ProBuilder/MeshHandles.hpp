...
namespace UnityEngine::ProBuilder {
  ...
  class MeshHandles : public ::Il2CppObject {
    ...
    // static System.Void CreateFaceMeshFromFaces(UnityEngine.ProBuilder.ProBuilderMesh mesh, System.Collections.Generic.IList`1<UnityEngine.ProBuilder.Face> faces, UnityEngine.Mesh target)
    // Offset: 0x51B2A28
...
// Writing MetadataGetter for method: UnityEngine::ProBuilder::MeshHandles::CreateFaceMeshFromFaces
// Il2CppName: CreateFaceMeshFromFaces
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::ProBuilder::ProBuilderMesh*, ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Face*>*, ::UnityEngine::Mesh*)>(&UnityEngine::ProBuilder::MeshHandles::CreateFaceMeshFromFaces)> {
  static const MethodInfo* get() {
    ...
    static auto* target = &::il2cpp_utils::GetClassFromName("UnityEngine", "Mesh")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::MeshHandles*), "CreateFaceMeshFromFaces", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{mesh, faces, target});
  }
};

...
namespace UnityEngine::ProBuilder {
  ...
  class Math : public ::Il2CppObject {
    ...
    // static UnityEngine.Vector2 PointInEllipseCircumference(System.Single xRadius, System.Single yRadius, System.Single angleInDegrees, UnityEngine.Vector2 origin, out UnityEngine.Vector2 tangent)
    // Offset: 0x51AEA90
    static ::UnityEngine::Vector2 PointInEllipseCircumference(float xRadius, float yRadius, float angleInDegrees, ::UnityEngine::Vector2 origin, ByRef<::UnityEngine::Vector2> tangent);
    // static UnityEngine.Vector2 PointInEllipseCircumferenceWithConstantAngle(System.Single xRadius, System.Single yRadius, System.Single angleInDegrees, UnityEngine.Vector2 origin, out UnityEngine.Vector2 tangent)
    // Offset: 0x51AEBB8
    static ::UnityEngine::Vector2 PointInEllipseCircumferenceWithConstantAngle(float xRadius, float yRadius, float angleInDegrees, ::UnityEngine::Vector2 origin, ByRef<::UnityEngine::Vector2> tangent);
    ...
    // static public UnityEngine.Vector4 Average(System.Collections.Generic.IList`1<UnityEngine.Vector4> array, System.Collections.Generic.IList`1<System.Int32> indexes)
    // Offset: 0x51B1C70
    static ::UnityEngine::Vector4 Average(::System::Collections::Generic::IList_1<::UnityEngine::Vector4>* array, ::System::Collections::Generic::IList_1<int>* indexes);
...
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::PointInEllipseCircumference
// Il2CppName: PointInEllipseCircumference
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (*)(float, float, float, ::UnityEngine::Vector2, ByRef<::UnityEngine::Vector2>)>(&UnityEngine::ProBuilder::Math::PointInEllipseCircumference)> {
  static const MethodInfo* get() {
    static auto* xRadius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* yRadius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* angleInDegrees = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* origin = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* tangent = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "PointInEllipseCircumference", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{xRadius, yRadius, angleInDegrees, origin, tangent});
  }
};
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::PointInEllipseCircumferenceWithConstantAngle
// Il2CppName: PointInEllipseCircumferenceWithConstantAngle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (*)(float, float, float, ::UnityEngine::Vector2, ByRef<::UnityEngine::Vector2>)>(&UnityEngine::ProBuilder::Math::PointInEllipseCircumferenceWithConstantAngle)> {
  static const MethodInfo* get() {
    static auto* xRadius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* yRadius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* angleInDegrees = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* origin = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* tangent = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "PointInEllipseCircumferenceWithConstantAngle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{xRadius, yRadius, angleInDegrees, origin, tangent});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector4 (*)(::System::Collections::Generic::IList_1<::UnityEngine::Vector4>*, ::System::Collections::Generic::IList_1<int>*)>(&UnityEngine::ProBuilder::Math::Average)> {
  static const MethodInfo* get() {
    static auto* array = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "IList`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("UnityEngine", "Vector4")})->byval_arg;
    static auto* indexes = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "IList`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Int32")})->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "Average", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{array, indexes});
  }
};
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::InvertScaleVector
// Il2CppName: InvertScaleVector
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (*)(::UnityEngine::Vector3)>(&UnityEngine::ProBuilder::Math::InvertScaleVector)> {
  static const MethodInfo* get() {
    static auto* scaleVector = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "InvertScaleVector", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{scaleVector});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::Sign
// Il2CppName: Sign
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (*)(::UnityEngine::Vector3)>(&UnityEngine::ProBuilder::Math::Sign)> {
  static const MethodInfo* get() {
    static auto* v = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "Sign", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{v});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::FixNaN
// Il2CppName: FixNaN
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector4 (*)(::UnityEngine::Vector4)>(&UnityEngine::ProBuilder::Math::FixNaN)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector4")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "FixNaN", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::EnsureUnitVector
// Il2CppName: EnsureUnitVector
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (*)(::UnityEngine::Vector2)>(&UnityEngine::ProBuilder::Math::EnsureUnitVector)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::Math*), "EnsureUnitVector", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::ProBuilder::Math::EnsureUnitVector
// Il2CppName: EnsureUnitVector

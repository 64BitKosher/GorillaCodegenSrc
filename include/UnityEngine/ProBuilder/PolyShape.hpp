...
namespace UnityEngine::ProBuilder {
  ...
  // [ProGridsConditionalSnapAttribute] Offset: FFFFFFFF
  ...
  class PolyShape : public ::UnityEngine::MonoBehaviour {
    ...
    // Get instance field reference: private UnityEngine.ProBuilder.PolyShape/PolyEditMode m_EditMode
  ...
  #pragma pack(pop)
  static check_size<sizeof(PolyShape), 57 + sizeof(bool)> __UnityEngine_ProBuilder_PolyShapeSizeCheck;
  static_assert(sizeof(PolyShape) == 0x3A);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

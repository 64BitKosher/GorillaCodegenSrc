...
namespace UnityEngine::ProBuilder {
  ...
  class MeshHandles::$$c : public ::Il2CppObject {
    ...
    static ::System::Func_2<::UnityEngine::ProBuilder::Face*, ::System::Collections::Generic::IEnumerable_1<int>*>* _get_$$9__10_0();
    ...
    static void _set_$$9__10_0(::System::Func_2<::UnityEngine::ProBuilder::Face*, ::System::Collections::Generic::IEnumerable_1<int>*>* value);
    ...
    // System.Collections.Generic.IEnumerable`1<System.Int32> <CreateFaceMeshFromFaces>b__10_0(UnityEngine.ProBuilder.Face x)
    // Offset: 0x51B5F88
    ::System::Collections::Generic::IEnumerable_1<int>* $CreateFaceMeshFromFaces$b__10_0(::UnityEngine::ProBuilder::Face* x);
...
// Writing MetadataGetter for method: UnityEngine::ProBuilder::MeshHandles::$$c::$CreateFaceMeshFromFaces$b__10_0
// Il2CppName: <CreateFaceMeshFromFaces>b__10_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<int>* (UnityEngine::ProBuilder::MeshHandles::$$c::*)(::UnityEngine::ProBuilder::Face*)>(&UnityEngine::ProBuilder::MeshHandles::$$c::$CreateFaceMeshFromFaces$b__10_0)> {
  static const MethodInfo* get() {
    static auto* x = &::il2cpp_utils::GetClassFromName("UnityEngine.ProBuilder", "Face")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::MeshHandles::$$c*), "<CreateFaceMeshFromFaces>b__10_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{x});
  }
};

...
namespace UnityEngine {
  ...
  class TextAreaAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static TextAreaAttribute* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::TextAreaAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<TextAreaAttribute*, creationType>()));
    }
  }; // UnityEngine.TextAreaAttribute
  #pragma pack(pop)
  static check_size<sizeof(TextAreaAttribute), 24 + sizeof(int)> __UnityEngine_TextAreaAttributeSizeCheck;
  static_assert(sizeof(TextAreaAttribute) == 0x1C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

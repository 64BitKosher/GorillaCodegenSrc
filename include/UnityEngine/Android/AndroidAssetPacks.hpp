...
namespace UnityEngine::Android {
  ...
  class AndroidAssetPacks : public ::Il2CppObject {
    ...
    static ::UnityEngine::AndroidJavaObject* _get_s_JavaPlayAssetDeliveryWrapper();
    // Set static field: static private UnityEngine.AndroidJavaObject s_JavaPlayAssetDeliveryWrapper
    static void _set_s_JavaPlayAssetDeliveryWrapper(::UnityEngine::AndroidJavaObject* value);

...
namespace UnityEngine::Android {
  // Size: 0x40
  #pragma pack(push, 1)
  // Autogenerated type: UnityEngine.Android.AndroidAssetPacks/AssetPackManagerStatusQueryCallback
  ...
  class AndroidAssetPacks::AssetPackManagerStatusQueryCallback : public ::UnityEngine::AndroidJavaProxy {
    ...
    // public System.Void .ctor(System.Action`2<System.UInt64,UnityEngine.Android.AndroidAssetPackState[]> callback, System.String[] assetPacks)
    // Offset: 0x5461E74
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static AndroidAssetPacks::AssetPackManagerStatusQueryCallback* New_ctor(::System::Action_2<uint64_t, ::ArrayW<::UnityEngine::Android::AndroidAssetPackState*>>* callback, ::ArrayW<::StringW> assetPacks) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Android::AndroidAssetPacks::AssetPackManagerStatusQueryCallback::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<AndroidAssetPacks::AssetPackManagerStatusQueryCallback*, creationType>(callback, assetPacks)));
    }
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::Android::AndroidAssetPacks::AssetPackManagerStatusQueryCallback::New_ctor
// Il2CppName: .ctor

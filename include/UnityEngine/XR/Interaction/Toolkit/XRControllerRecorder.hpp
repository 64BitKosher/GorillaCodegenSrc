...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  class XRControllerRecorder : public ::UnityEngine::MonoBehaviour {
    ...
    // public UnityEngine.XR.Interaction.Toolkit.XRControllerRecording get_recording()
    // Offset: 0x53D51F8
    ::UnityEngine::XR::Interaction::Toolkit::XRControllerRecording* get_recording();
    // public System.Void set_recording(UnityEngine.XR.Interaction.Toolkit.XRControllerRecording value)
    // Offset: 0x53D5200
  ...
  #pragma pack(pop)
  static check_size<sizeof(XRControllerRecorder), 85 + sizeof(bool)> __UnityEngine_XR_Interaction_Toolkit_XRControllerRecorderSizeCheck;
  static_assert(sizeof(XRControllerRecorder) == 0x56);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

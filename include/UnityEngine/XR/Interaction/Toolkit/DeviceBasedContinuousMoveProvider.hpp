...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DeviceBasedContinuousMoveProvider), 140 + sizeof(float)> __UnityEngine_XR_Interaction_Toolkit_DeviceBasedContinuousMoveProviderSizeCheck;
  static_assert(sizeof(DeviceBasedContinuousMoveProvider) == 0x90);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

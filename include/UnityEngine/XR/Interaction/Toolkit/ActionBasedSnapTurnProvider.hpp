...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ActionBasedSnapTurnProvider), 128 + sizeof(::UnityEngine::InputSystem::InputActionProperty)> __UnityEngine_XR_Interaction_Toolkit_ActionBasedSnapTurnProviderSizeCheck;
  static_assert(sizeof(ActionBasedSnapTurnProvider) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

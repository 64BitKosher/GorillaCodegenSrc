...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  class DeviceBasedSnapTurnProvider : public ::UnityEngine::XR::Interaction::Toolkit::SnapTurnProviderBase {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes
    // [TokenAttribute] Offset: FFFFFFFF
    struct InputAxes/*, public ::System::Enum*/ {
      ...
      // static field const value: static public UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes Primary2DAxis
      ...
      // static field const value: static public UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes Secondary2DAxis
    ...
    public:
    // private UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes m_TurnUsage
    // Size: 0x4
    // Offset: 0x64
    ...
    // Get instance field reference: private UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes m_TurnUsage
    ...
    // public UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes get_turnUsage()
    // Offset: 0x540E484
    ::UnityEngine::XR::Interaction::Toolkit::DeviceBasedSnapTurnProvider::InputAxes get_turnUsage();
    // public System.Void set_turnUsage(UnityEngine.XR.Interaction.Toolkit.DeviceBasedSnapTurnProvider/InputAxes value)
    // Offset: 0x540E48C
  ...
  #pragma pack(pop)
  static check_size<sizeof(DeviceBasedSnapTurnProvider), 112 + sizeof(float)> __UnityEngine_XR_Interaction_Toolkit_DeviceBasedSnapTurnProviderSizeCheck;
  static_assert(sizeof(DeviceBasedSnapTurnProvider) == 0x74);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

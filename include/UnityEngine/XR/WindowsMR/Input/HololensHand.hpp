...
namespace UnityEngine::XR::WindowsMR::Input {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HololensHand), 424 + sizeof(::UnityEngine::InputSystem::Controls::Vector3Control*)> __UnityEngine_XR_WindowsMR_Input_HololensHandSizeCheck;
  static_assert(sizeof(HololensHand) == 0x1B0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

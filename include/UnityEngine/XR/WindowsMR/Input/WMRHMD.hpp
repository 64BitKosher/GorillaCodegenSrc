...
namespace UnityEngine::XR::WindowsMR::Input {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WMRHMD), 448 + sizeof(::UnityEngine::InputSystem::Controls::ButtonControl*)> __UnityEngine_XR_WindowsMR_Input_WMRHMDSizeCheck;
  static_assert(sizeof(WMRHMD) == 0x1C8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace UnityEngine::XR::WindowsMR::Input {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WMRSpatialController), 528 + sizeof(::UnityEngine::InputSystem::Controls::QuaternionControl*)> __UnityEngine_XR_WindowsMR_Input_WMRSpatialControllerSizeCheck;
  static_assert(sizeof(WMRSpatialController) == 0x218);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

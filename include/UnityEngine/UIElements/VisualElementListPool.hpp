...
namespace UnityEngine::UIElements {
  ...
  class VisualElementListPool : public ::Il2CppObject {
    public:
    // Nested type: ::UnityEngine::UIElements::VisualElementListPool::$$c
    class $$c;
    ...
    // static public System.Collections.Generic.List`1<UnityEngine.UIElements.VisualElement> Copy(System.Collections.Generic.List`1<UnityEngine.UIElements.VisualElement> elements)
    // Offset: 0x55C0D68
...
// Writing MetadataGetter for method: UnityEngine::UIElements::VisualElementListPool::Copy
// Il2CppName: Copy
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* (*)(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>*)>(&UnityEngine::UIElements::VisualElementListPool::Copy)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::VisualElementListPool*), "Copy", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{elements});
  }
};

...
NEED_NO_BOX(::UnityEngine::UIElements::Vector2IntField::UxmlTraits);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::Vector2IntField::UxmlTraits*, "UnityEngine.UIElements", "Vector2IntField/UxmlTraits");
// Type namespace: UnityEngine.UIElements
namespace UnityEngine::UIElements {
  // WARNING Size may be invalid!
  // Autogenerated type: UnityEngine.UIElements.Vector2IntField/UxmlTraits
  // [TokenAttribute] Offset: FFFFFFFF
  class Vector2IntField::UxmlTraits : public ::UnityEngine::UIElements::BaseField_1<::UnityEngine::Vector2Int>::UxmlTraits {
    public:
    public:
    ...
    static Vector2IntField::UxmlTraits* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UIElements::Vector2IntField::UxmlTraits::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Vector2IntField::UxmlTraits*, creationType>()));
    }
  }; // UnityEngine.UIElements.Vector2IntField/UxmlTraits
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::UIElements::Vector2IntField::UxmlTraits::Init
// Il2CppName: Init
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::Vector2IntField::UxmlTraits::*)(::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::IUxmlAttributes*, ::UnityEngine::UIElements::CreationContext)>(&UnityEngine::UIElements::Vector2IntField::UxmlTraits::Init)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::Vector2IntField::UxmlTraits*), "Init", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ve, bag, cc});
  }
};
// Writing MetadataGetter for method: UnityEngine::UIElements::Vector2IntField::UxmlTraits::New_ctor
// Il2CppName: .ctor

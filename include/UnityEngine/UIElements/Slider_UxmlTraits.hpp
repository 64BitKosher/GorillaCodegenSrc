...
NEED_NO_BOX(::UnityEngine::UIElements::Slider::UxmlTraits);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::Slider::UxmlTraits*, "UnityEngine.UIElements", "Slider/UxmlTraits");
// Type namespace: UnityEngine.UIElements
namespace UnityEngine::UIElements {
  // WARNING Size may be invalid!
  // Autogenerated type: UnityEngine.UIElements.Slider/UxmlTraits
  // [TokenAttribute] Offset: FFFFFFFF
  class Slider::UxmlTraits : public ::UnityEngine::UIElements::BaseFieldTraits_2<float, ::UnityEngine::UIElements::UxmlFloatAttributeDescription*> {
    public:
    public:
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UIElements::UxmlFloatAttributeDescription*) == 0x8);
    // private UnityEngine.UIElements.UxmlFloatAttributeDescription m_PageSize
    // Size: 0x8
    // Offset: 0x98
    ::UnityEngine::UIElements::UxmlFloatAttributeDescription* m_PageSize;
    // Field size check
    static_assert(sizeof(::UnityEngine::UIElements::UxmlFloatAttributeDescription*) == 0x8);
    ...
    // Get instance field reference: private UnityEngine.UIElements.UxmlFloatAttributeDescription m_PageSize
    [[deprecated("Use field access instead!")]] ::UnityEngine::UIElements::UxmlFloatAttributeDescription*& dyn_m_PageSize();
    ...
    static Slider::UxmlTraits* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UIElements::Slider::UxmlTraits::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Slider::UxmlTraits*, creationType>()));
    }
  }; // UnityEngine.UIElements.Slider/UxmlTraits
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::UIElements::Slider::UxmlTraits::Init
// Il2CppName: Init
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::Slider::UxmlTraits::*)(::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::IUxmlAttributes*, ::UnityEngine::UIElements::CreationContext)>(&UnityEngine::UIElements::Slider::UxmlTraits::Init)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::Slider::UxmlTraits*), "Init", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ve, bag, cc});
  }
};
// Writing MetadataGetter for method: UnityEngine::UIElements::Slider::UxmlTraits::New_ctor
// Il2CppName: .ctor

...
namespace UnityEngine::UIElements {
  ...
  template<typename T>
  class PointerCaptureEventBase_1 : public ::UnityEngine::UIElements::EventBase_1<T>/*, public ::UnityEngine::UIElements::IPointerCaptureEventInternal*/ {
    public:
    public:
    ...
    public:
    // Creating interface conversion operator: operator ::UnityEngine::UIElements::IPointerCaptureEventInternal
    operator ::UnityEngine::UIElements::IPointerCaptureEventInternal() noexcept {
      return *reinterpret_cast<::UnityEngine::UIElements::IPointerCaptureEventInternal*>(this);
    }
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    int get_pointerId() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UIElements::PointerCaptureEventBase_1::get_pointerId");

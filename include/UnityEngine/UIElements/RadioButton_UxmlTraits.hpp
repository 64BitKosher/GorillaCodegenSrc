...
NEED_NO_BOX(::UnityEngine::UIElements::RadioButton::UxmlTraits);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::RadioButton::UxmlTraits*, "UnityEngine.UIElements", "RadioButton/UxmlTraits");
// Type namespace: UnityEngine.UIElements
namespace UnityEngine::UIElements {
  // WARNING Size may be invalid!
  // Autogenerated type: UnityEngine.UIElements.RadioButton/UxmlTraits
  // [TokenAttribute] Offset: FFFFFFFF
  class RadioButton::UxmlTraits : public ::UnityEngine::UIElements::BaseFieldTraits_2<bool, ::UnityEngine::UIElements::UxmlBoolAttributeDescription*> {
    public:
    public:
    ...
    static RadioButton::UxmlTraits* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UIElements::RadioButton::UxmlTraits::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<RadioButton::UxmlTraits*, creationType>()));
    }
  }; // UnityEngine.UIElements.RadioButton/UxmlTraits
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::UIElements::RadioButton::UxmlTraits::Init
// Il2CppName: Init
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::RadioButton::UxmlTraits::*)(::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::IUxmlAttributes*, ::UnityEngine::UIElements::CreationContext)>(&UnityEngine::UIElements::RadioButton::UxmlTraits::Init)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::RadioButton::UxmlTraits*), "Init", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ve, bag, cc});
  }
};
// Writing MetadataGetter for method: UnityEngine::UIElements::RadioButton::UxmlTraits::New_ctor
// Il2CppName: .ctor

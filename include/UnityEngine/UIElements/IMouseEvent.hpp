...
namespace UnityEngine::UIElements {
  ...
  class IMouseEvent {
    ...
    // public UnityEngine.Vector2 get_localMousePosition()
    // Offset: 0xFFFFFFFFFFFFFFFF
...
// Writing MetadataGetter for method: UnityEngine::UIElements::IMouseEvent::get_localMousePosition
// Il2CppName: get_localMousePosition
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (UnityEngine::UIElements::IMouseEvent::*)()>(&UnityEngine::UIElements::IMouseEvent::get_localMousePosition)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::IMouseEvent*), "get_localMousePosition", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::UIElements::IMouseEvent::get_shiftKey
// Il2CppName: get_shiftKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::UIElements::IMouseEvent::*)()>(&UnityEngine::UIElements::IMouseEvent::get_shiftKey)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::IMouseEvent*), "get_shiftKey", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::UIElements::IMouseEvent::get_ctrlKey
// Il2CppName: get_ctrlKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::UIElements::IMouseEvent::*)()>(&UnityEngine::UIElements::IMouseEvent::get_ctrlKey)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::IMouseEvent*), "get_ctrlKey", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::UIElements::IMouseEvent::get_commandKey
// Il2CppName: get_commandKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::UIElements::IMouseEvent::*)()>(&UnityEngine::UIElements::IMouseEvent::get_commandKey)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::IMouseEvent*), "get_commandKey", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::UIElements::IMouseEvent::get_altKey
// Il2CppName: get_altKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::UIElements::IMouseEvent::*)()>(&UnityEngine::UIElements::IMouseEvent::get_altKey)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::IMouseEvent*), "get_altKey", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace UnityEngine::UIElements::Internal {
  // Forward declaring type: MultiColumnHeaderColumnResizePreview
...
namespace UnityEngine::UIElements::Internal {
  ...
  // Autogenerated type: UnityEngine.UIElements.Internal.MultiColumnHeaderColumnResizePreview
  // [TokenAttribute] Offset: FFFFFFFF
  class MultiColumnHeaderColumnResizePreview : public ::UnityEngine::UIElements::VisualElement {
    public:
    ...
    static MultiColumnHeaderColumnResizePreview* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MultiColumnHeaderColumnResizePreview*, creationType>()));
    }
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

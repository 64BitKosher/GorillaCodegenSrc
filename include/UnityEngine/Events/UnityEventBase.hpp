...
// Writing MetadataGetter for method: UnityEngine::Events::UnityEventBase::RemoveAllListeners
// Il2CppName: RemoveAllListeners
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Events::UnityEventBase::*)()>(&UnityEngine::Events::UnityEventBase::RemoveAllListeners)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Events::UnityEventBase*), "RemoveAllListeners", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

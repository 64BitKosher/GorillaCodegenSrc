...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Reflection::MethodInfo* (UnityEngine::Events::UnityEvent::*)(::StringW, ::System::Type*)>(&UnityEngine::Events::UnityEvent::FindMethod_Impl)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Events::UnityEvent*), "FindMethod_Impl", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{name, targetObjType});
  }
};
// Writing MetadataGetter for method: UnityEngine::Events::UnityEvent::GetDelegate
// Il2CppName: GetDelegate

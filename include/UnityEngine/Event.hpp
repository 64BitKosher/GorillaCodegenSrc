...
namespace UnityEngine {
  ...
  class Event : public ::Il2CppObject {
    ...
    // static System.Int32 GetDoubleClickTime()
    // Offset: 0x54F91AC
    ...
    // private System.Void set_delta_Injected(ref UnityEngine.Vector2 value)
    // Offset: 0x54F895C
    void set_delta_Injected(ByRef<::UnityEngine::Vector2> value);
    // private System.Void get_tilt_Injected(out UnityEngine.Vector2 ret)
    // Offset: 0x54F8B5C
    void get_tilt_Injected(ByRef<::UnityEngine::Vector2> ret);
...
// Writing MetadataGetter for method: UnityEngine::Event::set_delta
// Il2CppName: set_delta
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Event::*)(::UnityEngine::Vector2)>(&UnityEngine::Event::set_delta)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "set_delta", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Event::get_twist
// Il2CppName: get_twist
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (UnityEngine::Event::*)()>(&UnityEngine::Event::get_twist)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "get_twist", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Event::get_tilt
// Il2CppName: get_tilt
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (UnityEngine::Event::*)()>(&UnityEngine::Event::get_tilt)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "get_tilt", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Event::get_penStatus
// Il2CppName: get_penStatus
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::PenStatus (UnityEngine::Event::*)()>(&UnityEngine::Event::get_penStatus)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "get_penStatus", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Event::GetDoubleClickTime
// Il2CppName: GetDoubleClickTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)()>(&UnityEngine::Event::GetDoubleClickTime)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "GetDoubleClickTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Event::set_delta_Injected
// Il2CppName: set_delta_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Event::*)(ByRef<::UnityEngine::Vector2>)>(&UnityEngine::Event::set_delta_Injected)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "set_delta_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::Event::get_tilt_Injected
// Il2CppName: get_tilt_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Event::*)(ByRef<::UnityEngine::Vector2>)>(&UnityEngine::Event::get_tilt_Injected)> {
  static const MethodInfo* get() {
    static auto* ret = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Event*), "get_tilt_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ret});
  }
};

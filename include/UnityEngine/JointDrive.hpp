...
namespace UnityEngine {
  ...
  struct JointDrive/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // private System.Int32 m_UseAcceleration
    // Size: 0x4
    // Offset: 0xC
    int m_UseAcceleration;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    public:
    // Creating value type constructor for type: JointDrive
    constexpr JointDrive(float m_PositionSpring_ = {}, float m_PositionDamper_ = {}, float m_MaximumForce_ = {}, int m_UseAcceleration_ = {}) noexcept : m_PositionSpring{m_PositionSpring_}, m_PositionDamper{m_PositionDamper_}, m_MaximumForce{m_MaximumForce_}, m_UseAcceleration{m_UseAcceleration_} {}
    ...
    // Get instance field reference: private System.Int32 m_UseAcceleration
    [[deprecated("Use field access instead!")]] int& dyn_m_UseAcceleration();
  }; // UnityEngine.JointDrive
  #pragma pack(pop)
  static check_size<sizeof(JointDrive), 12 + sizeof(int)> __UnityEngine_JointDriveSizeCheck;
  static_assert(sizeof(JointDrive) == 0x10);
}

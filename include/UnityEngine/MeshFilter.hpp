...
namespace UnityEngine {
  ...
  class MeshFilter : public ::UnityEngine::Component {
    ...
    static MeshFilter* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::MeshFilter::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MeshFilter*, creationType>()));
    }
...
// Writing MetadataGetter for method: UnityEngine::MeshFilter::New_ctor
// Il2CppName: .ctor

...
namespace UnityEngine {
  ...
  class TerrainData : public ::UnityEngine::Object {
    ...
    // public UnityEngine.Vector3 get_heightmapScale()
    // Offset: 0x553EC2C
    ...
    // Offset: 0x553EFF8
    static void _cctor();
    // private System.Void get_heightmapScale_Injected(out UnityEngine.Vector3 ret)
    // Offset: 0x553EC88
    void get_heightmapScale_Injected(ByRef<::UnityEngine::Vector3> ret);
...
// Writing MetadataGetter for method: UnityEngine::TerrainData::get_heightmapScale
// Il2CppName: get_heightmapScale
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (UnityEngine::TerrainData::*)()>(&UnityEngine::TerrainData::get_heightmapScale)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::TerrainData*), "get_heightmapScale", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::TerrainData::get_heightmapScale_Injected
// Il2CppName: get_heightmapScale_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::TerrainData::*)(ByRef<::UnityEngine::Vector3>)>(&UnityEngine::TerrainData::get_heightmapScale_Injected)> {
  static const MethodInfo* get() {
    static auto* ret = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::TerrainData*), "get_heightmapScale_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ret});
  }
};

...
namespace UnityEngine {
  ...
  struct AnimatorStateInfo/*, public ::System::ValueType*/ {
    ...
    // Offset: 0x5464E3C
    bool IsName(::StringW name);
    // public System.Int32 get_fullPathHash()
    // Offset: 0x5464EE8
...
// Writing MetadataGetter for method: UnityEngine::AnimatorStateInfo::IsName
// Il2CppName: IsName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::AnimatorStateInfo::*)(::StringW)>(&UnityEngine::AnimatorStateInfo::IsName)> {
  static const MethodInfo* get() {
    static auto* name = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AnimatorStateInfo), "IsName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{name});
  }
};
// Writing MetadataGetter for method: UnityEngine::AnimatorStateInfo::get_fullPathHash
// Il2CppName: get_fullPathHash
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::AnimatorStateInfo::*)()>(&UnityEngine::AnimatorStateInfo::get_fullPathHash)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AnimatorStateInfo), "get_fullPathHash", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace UnityEngine::Timeline {
  ...
  class TimelineAsset : public ::UnityEngine::Playables::PlayableAsset/*, public ::UnityEngine::ISerializationCallbackReceiver, public ::UnityEngine::Timeline::ITimelineClipAsset, public ::UnityEngine::Timeline::IPropertyPreview*/ {
    ...
    // private UnityEngine.Timeline.TrackAsset[] m_CacheFlattenedTracks
    // Size: 0x8
    // Offset: 0x40
    ::ArrayW<::UnityEngine::Timeline::TrackAsset*> m_CacheFlattenedTracks;
    // Field size check
    static_assert(sizeof(::ArrayW<::UnityEngine::Timeline::TrackAsset*>) == 0x8);
    ...
    // Get instance field reference: private UnityEngine.Timeline.TrackAsset[] m_CacheFlattenedTracks
    [[deprecated("Use field access instead!")]] ::ArrayW<::UnityEngine::Timeline::TrackAsset*>& dyn_m_CacheFlattenedTracks();
    // Get instance field reference: private UnityEngine.Timeline.TimelineAsset/EditorSettings m_EditorSettings
    [[deprecated("Use field access instead!")]] ::UnityEngine::Timeline::TimelineAsset::EditorSettings*& dyn_m_EditorSettings();
    // Get instance field reference: private UnityEngine.Timeline.TimelineAsset/DurationMode m_DurationMode
    ...
    // static private System.Double GetValidFrameRate(System.Double frameRate)
    // Offset: 0x53B4810
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<double (*)(double)>(&UnityEngine::Timeline::TimelineAsset::GetValidFrameRate)> {
  static const MethodInfo* get() {

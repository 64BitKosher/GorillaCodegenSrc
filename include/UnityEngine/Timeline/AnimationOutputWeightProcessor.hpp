...
namespace UnityEngine::Timeline {
  ...
  class AnimationOutputWeightProcessor : public ::Il2CppObject/*, public ::UnityEngine::Timeline::ITimelineEvaluateCallback*/ {
    ...
    // Get instance field reference: private readonly System.Collections.Generic.List`1<UnityEngine.Timeline.AnimationOutputWeightProcessor/WeightInfo> m_Mixers

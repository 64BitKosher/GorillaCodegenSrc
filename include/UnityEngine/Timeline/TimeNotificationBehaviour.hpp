...
namespace UnityEngine::Timeline {
  ...
  class TimeNotificationBehaviour : public ::UnityEngine::Playables::PlayableBehaviour {
    ...
    public:
    // Get instance field reference: private readonly System.Collections.Generic.List`1<UnityEngine.Timeline.TimeNotificationBehaviour/NotificationEntry> m_Notifications

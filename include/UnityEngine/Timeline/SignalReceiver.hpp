...
namespace UnityEngine::Timeline {
  ...
  class SignalReceiver : public ::UnityEngine::MonoBehaviour/*, public ::UnityEngine::Playables::INotificationReceiver*/ {
    ...
    // Get instance field reference: private UnityEngine.Timeline.SignalReceiver/EventKeyValue m_Events
  ...
  #pragma pack(pop)
  static check_size<sizeof(SignalReceiver), 32 + sizeof(::UnityEngine::Timeline::SignalReceiver::EventKeyValue*)> __UnityEngine_Timeline_SignalReceiverSizeCheck;
  static_assert(sizeof(SignalReceiver) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

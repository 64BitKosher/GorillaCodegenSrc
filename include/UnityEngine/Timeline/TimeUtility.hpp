...
namespace UnityEngine::Timeline {
  ...
  class TimeUtility : public ::Il2CppObject {
    ...
    static double _get_kFrameRateRounding();
    // Set static field: static public readonly System.Double kFrameRateRounding
    static void _set_kFrameRateRounding(double value);
    ...
    // static public System.Int32 PreviousFrame(System.Double time, System.Double frameRate)
    // Offset: 0x53CE514
    static int PreviousFrame(double time, double frameRate);
    // static public System.Int32 NextFrame(System.Double time, System.Double frameRate)
    // Offset: 0x53CE5B4
    static int NextFrame(double time, double frameRate);
    // static public System.Double PreviousFrameTime(System.Double time, System.Double frameRate)
    // Offset: 0x53CE620
    static double PreviousFrameTime(double time, double frameRate);
    // static public System.Double NextFrameTime(System.Double time, System.Double frameRate)
    // Offset: 0x53CE68C
    static double NextFrameTime(double time, double frameRate);
    ...
    // static public System.Double ParseTimeSeconds(System.String timeCode, System.Double frameRate, System.Double defaultValue)
    // Offset: 0x53CF2F0
    static double ParseTimeSeconds(::StringW timeCode, double frameRate, double defaultValue);
    ...
    // static public UnityEngine.Playables.FrameRate GetClosestFrameRate(System.Double frameRate)
    // Offset: 0x53CF7D4
    static ::UnityEngine::Playables::FrameRate GetClosestFrameRate(double frameRate);
    // static public UnityEngine.Playables.FrameRate ToFrameRate(UnityEngine.Timeline.StandardFrameRates enumValue)
    // Offset: 0x53CF8C0
    static ::UnityEngine::Playables::FrameRate ToFrameRate(::UnityEngine::Timeline::StandardFrameRates enumValue);
    // static System.Boolean ToStandardFrameRate(UnityEngine.Playables.FrameRate rate, out UnityEngine.Timeline.StandardFrameRates standard)
    // Offset: 0x53CFA60
...
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::PreviousFrame
// Il2CppName: PreviousFrame
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(double, double)>(&UnityEngine::Timeline::TimeUtility::PreviousFrame)> {
  static const MethodInfo* get() {
    static auto* time = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    static auto* frameRate = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "PreviousFrame", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{time, frameRate});
  }
};
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::NextFrame
// Il2CppName: NextFrame
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(double, double)>(&UnityEngine::Timeline::TimeUtility::NextFrame)> {
  static const MethodInfo* get() {
    static auto* time = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    static auto* frameRate = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "NextFrame", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{time, frameRate});
  }
};
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::PreviousFrameTime
// Il2CppName: PreviousFrameTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<double (*)(double, double)>(&UnityEngine::Timeline::TimeUtility::PreviousFrameTime)> {
  static const MethodInfo* get() {
    static auto* time = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    static auto* frameRate = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "PreviousFrameTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{time, frameRate});
  }
};
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::NextFrameTime
// Il2CppName: NextFrameTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<double (*)(double, double)>(&UnityEngine::Timeline::TimeUtility::NextFrameTime)> {
  static const MethodInfo* get() {
    static auto* time = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    static auto* frameRate = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "NextFrameTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{time, frameRate});
  }
};
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::OnFrameBoundary
// Il2CppName: OnFrameBoundary
...
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::ParseTimeSeconds
// Il2CppName: ParseTimeSeconds
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<double (*)(::StringW, double, double)>(&UnityEngine::Timeline::TimeUtility::ParseTimeSeconds)> {
  static const MethodInfo* get() {
    static auto* timeCode = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* frameRate = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    static auto* defaultValue = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "ParseTimeSeconds", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{timeCode, frameRate, defaultValue});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::GetClosestFrameRate
// Il2CppName: GetClosestFrameRate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Playables::FrameRate (*)(double)>(&UnityEngine::Timeline::TimeUtility::GetClosestFrameRate)> {
  static const MethodInfo* get() {
    static auto* frameRate = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "GetClosestFrameRate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{frameRate});
  }
};
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::ToFrameRate
// Il2CppName: ToFrameRate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Playables::FrameRate (*)(::UnityEngine::Timeline::StandardFrameRates)>(&UnityEngine::Timeline::TimeUtility::ToFrameRate)> {
  static const MethodInfo* get() {
    static auto* enumValue = &::il2cpp_utils::GetClassFromName("UnityEngine.Timeline", "StandardFrameRates")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "ToFrameRate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{enumValue});
  }
};
// Writing MetadataGetter for method: UnityEngine::Timeline::TimeUtility::ToStandardFrameRate
// Il2CppName: ToStandardFrameRate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::Playables::FrameRate, ByRef<::UnityEngine::Timeline::StandardFrameRates>)>(&UnityEngine::Timeline::TimeUtility::ToStandardFrameRate)> {
  static const MethodInfo* get() {
    static auto* rate = &::il2cpp_utils::GetClassFromName("UnityEngine.Playables", "FrameRate")->byval_arg;
    static auto* standard = &::il2cpp_utils::GetClassFromName("UnityEngine.Timeline", "StandardFrameRates")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimeUtility*), "ToStandardFrameRate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{rate, standard});
  }
};

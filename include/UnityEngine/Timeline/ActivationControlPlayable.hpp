...
namespace UnityEngine::Timeline {
  ...
  class ActivationControlPlayable : public ::UnityEngine::Playables::PlayableBehaviour {
    ...
    // Get instance field reference: public UnityEngine.Timeline.ActivationControlPlayable/PostPlaybackState postPlayback
    [[deprecated("Use field access instead!")]] ::UnityEngine::Timeline::ActivationControlPlayable::PostPlaybackState& dyn_postPlayback();
    // Get instance field reference: private UnityEngine.Timeline.ActivationControlPlayable/InitialState m_InitialState

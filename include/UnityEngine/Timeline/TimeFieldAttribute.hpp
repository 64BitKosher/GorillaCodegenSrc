...
namespace UnityEngine::Timeline {
  ...
  class TimeFieldAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    // Get instance field reference: private readonly UnityEngine.Timeline.TimeFieldAttribute/UseEditMode <useEditMode>k__BackingField
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimeFieldAttribute), 20 + sizeof(::UnityEngine::Timeline::TimeFieldAttribute::UseEditMode)> __UnityEngine_Timeline_TimeFieldAttributeSizeCheck;
  static_assert(sizeof(TimeFieldAttribute) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

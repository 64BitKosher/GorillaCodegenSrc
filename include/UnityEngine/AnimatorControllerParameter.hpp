...
namespace UnityEngine {
  ...
  class AnimatorControllerParameter : public ::Il2CppObject {
    ...
    // Offset: 0x546A410
    ::StringW get_name();
    // public System.Int32 get_nameHash()
    // Offset: 0x546A418
    int get_nameHash();
    // public UnityEngine.AnimatorControllerParameterType get_type()
    // Offset: 0x546A454
...
// Writing MetadataGetter for method: UnityEngine::AnimatorControllerParameter::get_nameHash
// Il2CppName: get_nameHash
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::AnimatorControllerParameter::*)()>(&UnityEngine::AnimatorControllerParameter::get_nameHash)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AnimatorControllerParameter*), "get_nameHash", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::AnimatorControllerParameter::get_type
// Il2CppName: get_type
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::AnimatorControllerParameterType (UnityEngine::AnimatorControllerParameter::*)()>(&UnityEngine::AnimatorControllerParameter::get_type)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AnimatorControllerParameter*), "get_type", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

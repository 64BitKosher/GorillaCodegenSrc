...
namespace UnityEngine::Playables {
  ...
  class PlayableExtensions : public ::Il2CppObject {
    ...
    // static public System.Void ConnectInput(U playable, System.Int32 inputIndex, V sourcePlayable, System.Int32 sourceOutputIndex, System.Single weight)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class U, class V>
    static void ConnectInput(U playable, int inputIndex, V sourcePlayable, int sourceOutputIndex, float weight) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayable> && std::is_convertible_v<U, ::System::ValueType*>);
      static_assert(std::is_convertible_v<std::remove_pointer_t<V>, ::UnityEngine::Playables::IPlayable> && std::is_convertible_v<V, ::System::ValueType*>);
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Playables::PlayableExtensions::ConnectInput");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.Playables", "PlayableExtensions", "ConnectInput", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<V>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(playable), ::il2cpp_utils::ExtractType(inputIndex), ::il2cpp_utils::ExtractType(sourcePlayable), ::il2cpp_utils::ExtractType(sourceOutputIndex), ::il2cpp_utils::ExtractType(weight)})));
      static auto* ___generic__method = THROW_UNLESS((::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<V>::get()})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, playable, inputIndex, sourcePlayable, sourceOutputIndex, weight);
    }
    // static public System.Int32 AddInput(U playable, V sourcePlayable, System.Int32 sourceOutputIndex, System.Single weight)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class U, class V>
    static int AddInput(U playable, V sourcePlayable, int sourceOutputIndex, float weight) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayable> && std::is_convertible_v<U, ::System::ValueType*>);
      static_assert(std::is_convertible_v<std::remove_pointer_t<V>, ::UnityEngine::Playables::IPlayable> && std::is_convertible_v<V, ::System::ValueType*>);
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Playables::PlayableExtensions::AddInput");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.Playables", "PlayableExtensions", "AddInput", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<V>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(playable), ::il2cpp_utils::ExtractType(sourcePlayable), ::il2cpp_utils::ExtractType(sourceOutputIndex), ::il2cpp_utils::ExtractType(weight)})));
      static auto* ___generic__method = THROW_UNLESS((::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<V>::get()})));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, playable, sourcePlayable, sourceOutputIndex, weight);
    }
...
// Cannot write MetadataGetter for generic methods!
// Writing MetadataGetter for method: UnityEngine::Playables::PlayableExtensions::ConnectInput
// Il2CppName: ConnectInput
// Cannot write MetadataGetter for generic methods!
// Writing MetadataGetter for method: UnityEngine::Playables::PlayableExtensions::AddInput
// Il2CppName: AddInput
// Cannot write MetadataGetter for generic methods!

...
namespace UnityEngine::Playables {
  ...
  class PlayableOutputExtensions : public ::Il2CppObject {
    ...
    // static public System.Void SetSourcePlayable(U output, V value)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class U, class V>
    static void SetSourcePlayable(U output, V value) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayableOutput> && std::is_convertible_v<U, ::System::ValueType*>);
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.Playables", "PlayableOutputExtensions", "SetSourcePlayable", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<V>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(output), ::il2cpp_utils::ExtractType(value)})));

...
namespace UnityEngine {
  ...
  class ScriptableObject : public ::UnityEngine::Object {
    public:
    // static public UnityEngine.ScriptableObject CreateInstance(System.String className)
    // Offset: 0x54C7904
    static ::UnityEngine::ScriptableObject* CreateInstance(::StringW className);
    ...
    // static private UnityEngine.ScriptableObject CreateScriptableObjectInstanceFromName(System.String className)
    // Offset: 0x54C7940
    static ::UnityEngine::ScriptableObject* CreateScriptableObjectInstanceFromName(::StringW className);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ScriptableObject* (*)(::StringW)>(&UnityEngine::ScriptableObject::CreateInstance)> {
  static const MethodInfo* get() {
    static auto* className = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ScriptableObject*), "CreateInstance", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{className});
  }
};
// Writing MetadataGetter for method: UnityEngine::ScriptableObject::CreateInstance
// Il2CppName: CreateInstance
...
// Writing MetadataGetter for method: UnityEngine::ScriptableObject::CreateScriptableObjectInstanceFromName
// Il2CppName: CreateScriptableObjectInstanceFromName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ScriptableObject* (*)(::StringW)>(&UnityEngine::ScriptableObject::CreateScriptableObjectInstanceFromName)> {
  static const MethodInfo* get() {
    static auto* className = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ScriptableObject*), "CreateScriptableObjectInstanceFromName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{className});
  }
};

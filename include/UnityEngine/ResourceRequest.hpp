...
namespace UnityEngine {
  ...
  class ResourceRequest : public ::UnityEngine::AsyncOperation {
    ...
    // protected UnityEngine.Object GetResult()
    // Offset: 0x54C08FC
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::ResourceRequest::GetResult
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Object* (UnityEngine::ResourceRequest::*)()>(&UnityEngine::ResourceRequest::GetResult)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourceRequest*), "GetResult", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

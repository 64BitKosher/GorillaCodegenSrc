...
namespace UnityEngine::AddressableAssets {
  ...
  class DynamicResourceLocator : public ::Il2CppObject/*, public ::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*/ {
    ...
    // public System.Collections.Generic.IEnumerable`1<UnityEngine.ResourceManagement.ResourceLocations.IResourceLocation> get_AllLocations()
    // Offset: 0x505BF1C
    ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>* get_AllLocations();
...
// Writing MetadataGetter for method: UnityEngine::AddressableAssets::DynamicResourceLocator::get_AllLocations
// Il2CppName: get_AllLocations
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>* (UnityEngine::AddressableAssets::DynamicResourceLocator::*)()>(&UnityEngine::AddressableAssets::DynamicResourceLocator::get_AllLocations)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AddressableAssets::DynamicResourceLocator*), "get_AllLocations", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

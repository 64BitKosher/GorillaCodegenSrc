...
namespace UnityEngine::AddressableAssets {
  ...
  class AssetReference : public ::Il2CppObject/*, public ::UnityEngine::AddressableAssets::IKeyEvaluator*/ {
    public:
    public:
    // protected internal System.String m_AssetGUID
    // Size: 0x8
    // Offset: 0x10
    ::StringW m_AssetGUID;
    // Field size check
    ...
    // Get instance field reference: protected internal System.String m_AssetGUID
    ...
    // System.Void set_OperationHandle(UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle value)
    // Offset: 0x5058358
    ...
    ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject> LoadAssetAsync() {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::UnityEngine::AddressableAssets::AssetReference*), -1));
...
// Writing MetadataGetter for method: UnityEngine::AddressableAssets::AssetReference::set_OperationHandle
// Il2CppName: set_OperationHandle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::AddressableAssets::AssetReference::*)(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle)>(&UnityEngine::AddressableAssets::AssetReference::set_OperationHandle)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine.ResourceManagement.AsyncOperations", "AsyncOperationHandle")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AddressableAssets::AssetReference*), "set_OperationHandle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

...
namespace UnityEngine::AddressableAssets {
  // Forward declaring type: AssetReferenceTexture3D
...
namespace UnityEngine::AddressableAssets {
  ...
  class AssetReferenceTexture3D : public ::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityEngine::Texture3D*> {
    ...
    static AssetReferenceTexture3D* New_ctor(::StringW guid) {
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::AddressableAssets::AssetReferenceTexture3D::New_ctor
// Il2CppName: .ctor

...
namespace UnityEngine::AddressableAssets {
  ...
  class CheckCatalogsOperation : public ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<::System::Collections::Generic::List_1<::StringW>*> {
    ...
    // public UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1<System.Collections.Generic.List`1<System.String>> Start(System.Collections.Generic.List`1<UnityEngine.AddressableAssets.ResourceLocatorInfo> locatorInfos)
    // Offset: 0x50555C0
    ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::List_1<::StringW>*> Start(::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::ResourceLocatorInfo*>* locatorInfos);
    // static System.Collections.Generic.List`1<System.String> ProcessDependentOpResults(System.Collections.Generic.IList`1<UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle> results, System.Collections.Generic.List`1<UnityEngine.AddressableAssets.ResourceLocatorInfo> locatorInfos, System.Collections.Generic.List`1<System.String> localHashes, out System.String errorString, out System.Boolean success)
    // Offset: 0x5058FC4
...
// Il2CppName: Start
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::List_1<::StringW>*> (UnityEngine::AddressableAssets::CheckCatalogsOperation::*)(::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::ResourceLocatorInfo*>*)>(&UnityEngine::AddressableAssets::CheckCatalogsOperation::Start)> {
  static const MethodInfo* get() {
    static auto* locatorInfos = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("UnityEngine.AddressableAssets", "ResourceLocatorInfo")})->byval_arg;
...
// Writing MetadataGetter for method: UnityEngine::AddressableAssets::CheckCatalogsOperation::ProcessDependentOpResults
// Il2CppName: ProcessDependentOpResults
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::StringW>* (*)(::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*, ::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::ResourceLocatorInfo*>*, ::System::Collections::Generic::List_1<::StringW>*, ByRef<::StringW>, ByRef<bool>)>(&UnityEngine::AddressableAssets::CheckCatalogsOperation::ProcessDependentOpResults)> {
  static const MethodInfo* get() {
    static auto* results = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "IList`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("UnityEngine.ResourceManagement.AsyncOperations", "AsyncOperationHandle")})->byval_arg;
    static auto* locatorInfos = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("UnityEngine.AddressableAssets", "ResourceLocatorInfo")})->byval_arg;
    static auto* localHashes = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "String")})->byval_arg;
    static auto* errorString = &::il2cpp_utils::GetClassFromName("System", "String")->this_arg;
    static auto* success = &::il2cpp_utils::GetClassFromName("System", "Boolean")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AddressableAssets::CheckCatalogsOperation*), "ProcessDependentOpResults", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{results, locatorInfos, localHashes, errorString, success});
  }
};

...
namespace UnityEngine::AddressableAssets::ResourceProviders {
  ...
  class ContentCatalogProvider::InternalOp : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // System.String m_LocalHashValue
    // Size: 0x8
    // Offset: 0x20
    ...
    // private System.Boolean m_Retried
    // Size: 0x1
    // Offset: 0x70
    bool m_Retried;
    // Field size check
    ...
    static_assert(sizeof(bool) == 0x1);
    public:
    // static field const value: static private System.String kCatalogExt
    static constexpr const char* kCatalogExt = ".json";
    // Get static field: static private System.String kCatalogExt
    static ::StringW _get_kCatalogExt();
    // Set static field: static private System.String kCatalogExt
    static void _set_kCatalogExt(::StringW value);
    ...
    // Get instance field reference: System.String m_LocalHashValue
    ...
    // Get instance field reference: private UnityEngine.AddressableAssets.ResourceProviders.ContentCatalogProvider/InternalOp/BundledCatalog m_BundledCatalog
    ...
    // Get instance field reference: private System.Boolean m_Retried
    [[deprecated("Use field access instead!")]] bool& dyn_m_Retried();
    ...
    // Offset: 0x505F0B4
    void Release();
    // System.Boolean CanLoadCatalogFromBundle(System.String idToLoad, UnityEngine.ResourceManagement.ResourceLocations.IResourceLocation location)
    // Offset: 0x505FBD8
    ...
    // System.Void LoadCatalog(System.String idToLoad, System.Boolean loadCatalogFromLocalBundle)
    // Offset: 0x505FC9C
    ...
    // private System.Void <LoadCatalog>b__14_0(UnityEngine.AddressableAssets.ResourceLocators.ContentCatalogData ccd)
    // Offset: 0x5061380
    void $LoadCatalog$b__14_0(::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData* ccd);
...
// Writing MetadataGetter for method: UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::CanLoadCatalogFromBundle
// Il2CppName: CanLoadCatalogFromBundle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::*)(::StringW, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*)>(&UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::CanLoadCatalogFromBundle)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp*), "CanLoadCatalogFromBundle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{idToLoad, location});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::*)(::StringW, bool)>(&UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::LoadCatalog)> {
  static const MethodInfo* get() {
    static auto* idToLoad = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* loadCatalogFromLocalBundle = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp*), "LoadCatalog", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{idToLoad, loadCatalogFromLocalBundle});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::$LoadCatalog$b__14_0
// Il2CppName: <LoadCatalog>b__14_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::*)(::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*)>(&UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp::$LoadCatalog$b__14_0)> {
  static const MethodInfo* get() {
    static auto* ccd = &::il2cpp_utils::GetClassFromName("UnityEngine.AddressableAssets.ResourceLocators", "ContentCatalogData")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp*), "<LoadCatalog>b__14_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ccd});
  }
};

...
namespace UnityEngine::AddressableAssets::ResourceProviders {
  ...
  class ContentCatalogProvider : public ::UnityEngine::ResourceManagement::ResourceProviders::ResourceProviderBase {
    ...
    [[deprecated("Use field access instead!")]] bool& dyn_DisableCatalogUpdateOnStart();
    // Get instance field reference: public System.Boolean IsLocalCatalogInBundle
    [[deprecated("Use field access instead!")]] bool& dyn_IsLocalCatalogInBundle();
    // Get instance field reference: System.Collections.Generic.Dictionary`2<UnityEngine.ResourceManagement.ResourceLocations.IResourceLocation,UnityEngine.AddressableAssets.ResourceProviders.ContentCatalogProvider/InternalOp> m_LocationToCatalogLoadOpMap
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*, ::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider::InternalOp*>*& dyn_m_LocationToCatalogLoadOpMap();

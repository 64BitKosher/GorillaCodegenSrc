...
namespace UnityEngine {
  ...
  class SphereCollider : public ::UnityEngine::Collider {
    ...
    static SphereCollider* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::SphereCollider::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SphereCollider*, creationType>()));
    }
...
// Writing MetadataGetter for method: UnityEngine::SphereCollider::New_ctor
// Il2CppName: .ctor

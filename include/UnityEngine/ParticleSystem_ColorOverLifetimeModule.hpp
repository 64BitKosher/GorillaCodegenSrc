...
namespace UnityEngine {
  ...
  struct ParticleSystem::ColorOverLifetimeModule/*, public ::System::ValueType*/ {
    ...
    // static private System.Void set_color_Injected(ref UnityEngine.ParticleSystem/ColorOverLifetimeModule _unity_self, ref UnityEngine.ParticleSystem/MinMaxGradient value)
    // Offset: 0x5520FB8
    static void set_color_Injected(ByRef<::UnityEngine::ParticleSystem::ColorOverLifetimeModule> _unity_self, ByRef<::UnityEngine::ParticleSystem::MinMaxGradient> value);
...
// Writing MetadataGetter for method: UnityEngine::ParticleSystem::ColorOverLifetimeModule::set_color_Injected
// Il2CppName: set_color_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<::UnityEngine::ParticleSystem::ColorOverLifetimeModule>, ByRef<::UnityEngine::ParticleSystem::MinMaxGradient>)>(&UnityEngine::ParticleSystem::ColorOverLifetimeModule::set_color_Injected)> {
  static const MethodInfo* get() {
    static auto* _unity_self = &::il2cpp_utils::GetClassFromName("UnityEngine", "ParticleSystem/ColorOverLifetimeModule")->this_arg;
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "ParticleSystem/MinMaxGradient")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ParticleSystem::ColorOverLifetimeModule), "set_color_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{_unity_self, value});
  }
};

...
namespace UnityEngine::InputSystem::Interactions {
  ...
  class MultiTapInteraction : public ::Il2CppObject/*, public ::UnityEngine::InputSystem::IInputInteraction_1<float>*/ {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: UnityEngine.InputSystem.Interactions.MultiTapInteraction/TapPhase
    // [TokenAttribute] Offset: FFFFFFFF
    struct TapPhase/*, public ::System::Enum*/ {
      ...
      // static field const value: static public UnityEngine.InputSystem.Interactions.MultiTapInteraction/TapPhase None
      ...
      // static field const value: static public UnityEngine.InputSystem.Interactions.MultiTapInteraction/TapPhase WaitingForNextRelease
      ...
      // static field const value: static public UnityEngine.InputSystem.Interactions.MultiTapInteraction/TapPhase WaitingForNextPress
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // private UnityEngine.InputSystem.Interactions.MultiTapInteraction/TapPhase m_CurrentTapPhase
    // Size: 0x4
    // Offset: 0x20
    ...
    // Get instance field reference: private UnityEngine.InputSystem.Interactions.MultiTapInteraction/TapPhase m_CurrentTapPhase
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Interactions::MultiTapInteraction::get_releasePointOrDefault
// Il2CppName: get_releasePointOrDefault
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (UnityEngine::InputSystem::Interactions::MultiTapInteraction::*)()>(&UnityEngine::InputSystem::Interactions::MultiTapInteraction::get_releasePointOrDefault)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Interactions::MultiTapInteraction*), "get_releasePointOrDefault", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

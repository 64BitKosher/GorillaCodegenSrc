...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  class InputState : public ::Il2CppObject {
    ...
    // static public System.Void Change(UnityEngine.InputSystem.InputControl control, ref TState state, UnityEngine.InputSystem.LowLevel.InputUpdateType updateType, UnityEngine.InputSystem.LowLevel.InputEventPtr eventPtr)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class TState>
    static void Change_(::UnityEngine::InputSystem::InputControl* control, ByRef<TState> state, ::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType, ::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr) {
      static_assert(std::is_convertible_v<TState, ::System::ValueType*>);
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::InputSystem::LowLevel::InputState::Change");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.InputSystem.LowLevel", "InputState", "Change", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TState>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(control), ::il2cpp_utils::ExtractType(state), ::il2cpp_utils::ExtractType(updateType), ::il2cpp_utils::ExtractType(eventPtr)})));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TState>::get()}));
      ::il2cpp_utils::RunMethodRethrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, control, byref(state), updateType, eventPtr);
    }
    ...
    // static public System.Void AddChangeMonitor(UnityEngine.InputSystem.InputControl control, UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor monitor, System.Int64 monitorIndex, System.UInt32 groupIndex)
    // Offset: 0x515492C
    static void AddChangeMonitor(::UnityEngine::InputSystem::InputControl* control, ::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor* monitor, int64_t monitorIndex, uint groupIndex);
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::InputState::Change_
// Il2CppName: Change
// Cannot write MetadataGetter for generic methods!
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::InputSystem::InputControl*, ::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor*, int64_t, uint)>(&UnityEngine::InputSystem::LowLevel::InputState::AddChangeMonitor)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::InputState*), "AddChangeMonitor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{control, monitor, monitorIndex, groupIndex});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::InputState::AddChangeMonitor
// Il2CppName: AddChangeMonitor

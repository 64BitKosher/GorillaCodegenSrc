...
namespace UnityEngine::InputSystem::LowLevel {
  // Forward declaring type: RequestResetCommand
...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  // Autogenerated type: UnityEngine.InputSystem.LowLevel.RequestResetCommand
  // [TokenAttribute] Offset: FFFFFFFF
  struct RequestResetCommand/*, public ::System::ValueType, public ::UnityEngine::InputSystem::LowLevel::IInputDeviceCommandInfo*/ {
    public:
    public:
    ...
    public:
    // Creating value type constructor for type: RequestResetCommand
    constexpr RequestResetCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand_ = {}) noexcept : baseCommand{baseCommand_} {}
    ...
    // static public UnityEngine.InputSystem.LowLevel.RequestResetCommand Create()
    // Offset: 0x514AC48
    static ::UnityEngine::InputSystem::LowLevel::RequestResetCommand Create();
  }; // UnityEngine.InputSystem.LowLevel.RequestResetCommand
  #pragma pack(pop)
  static check_size<sizeof(RequestResetCommand), 0 + sizeof(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand)> __UnityEngine_InputSystem_LowLevel_RequestResetCommandSizeCheck;
  static_assert(sizeof(RequestResetCommand) == 0x8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::RequestResetCommand::get_Type
// Il2CppName: get_Type
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&UnityEngine::InputSystem::LowLevel::RequestResetCommand::get_Type)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::RequestResetCommand), "get_Type", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::RequestResetCommand::get_typeStatic
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::LowLevel::RequestResetCommand::*)()>(&UnityEngine::InputSystem::LowLevel::RequestResetCommand::get_typeStatic)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::RequestResetCommand), "get_typeStatic", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::RequestResetCommand::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::LowLevel::RequestResetCommand (*)()>(&UnityEngine::InputSystem::LowLevel::RequestResetCommand::Create)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::RequestResetCommand), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

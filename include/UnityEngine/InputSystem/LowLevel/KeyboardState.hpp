...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  struct KeyboardState/*, public ::System::ValueType, public ::UnityEngine::InputSystem::LowLevel::IInputStateTypeInfo*/ {
    ...
    #pragma pack(push, 1)
    // WARNING Layout: Sequential may not be correctly taken into account!
    // Autogenerated type: UnityEngine.InputSystem.LowLevel.KeyboardState/<keys>e__FixedBuffer
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    public:
    // public UnityEngine.InputSystem.LowLevel.KeyboardState/<keys>e__FixedBuffer keys
    // Size: 0x1
    // Offset: 0x0
    ...
    // Get instance field reference: public UnityEngine.InputSystem.LowLevel.KeyboardState/<keys>e__FixedBuffer keys

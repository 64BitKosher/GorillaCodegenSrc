...
namespace UnityEngine::InputSystem::LowLevel {
  // Forward declaring type: AttitudeState
...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  // Autogenerated type: UnityEngine.InputSystem.LowLevel.AttitudeState
  // [TokenAttribute] Offset: FFFFFFFF
  struct AttitudeState/*, public ::System::ValueType, public ::UnityEngine::InputSystem::LowLevel::IInputStateTypeInfo*/ {
    public:
    public:
    ...
    public:
    // Creating value type constructor for type: AttitudeState
    constexpr AttitudeState(::UnityEngine::Quaternion attitude_ = {}) noexcept : attitude{attitude_} {}
    ...
    // Get instance field reference: public UnityEngine.Quaternion attitude
    [[deprecated("Use field access instead!")]] ::UnityEngine::Quaternion& dyn_attitude();
  ...
  #pragma pack(pop)
  static check_size<sizeof(AttitudeState), 0 + sizeof(::UnityEngine::Quaternion)> __UnityEngine_InputSystem_LowLevel_AttitudeStateSizeCheck;
  static_assert(sizeof(AttitudeState) == 0x10);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::AttitudeState::get_kFormat
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&UnityEngine::InputSystem::LowLevel::AttitudeState::get_kFormat)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::AttitudeState), "get_kFormat", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::AttitudeState::get_format
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::LowLevel::AttitudeState::*)()>(&UnityEngine::InputSystem::LowLevel::AttitudeState::get_format)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::AttitudeState), "get_format", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

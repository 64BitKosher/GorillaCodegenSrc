...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  struct InputEventBuffer/*, public ::System::ValueType, public ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>, public ::System::IDisposable, public ::System::ICloneable*/ {
    public:
    ...
    // public System.Void .ctor(Unity.Collections.NativeArray`1<System.Byte> buffer, System.Int32 eventCount, System.Int32 sizeInBytes, System.Boolean transferNativeArrayOwnership)
    // Offset: 0x514D1A4
    InputEventBuffer(::Unity::Collections::NativeArray_1<uint8_t> buffer, int eventCount, int sizeInBytes, bool transferNativeArrayOwnership);
    // public System.Void AppendEvent(UnityEngine.InputSystem.LowLevel.InputEvent* eventPtr, System.Int32 capacityIncrementInBytes, Unity.Collections.Allocator allocator)
    // Offset: 0x514D2C4
    void AppendEvent(::UnityEngine::InputSystem::LowLevel::InputEvent* eventPtr, int capacityIncrementInBytes, ::Unity::Collections::Allocator allocator);
    // public UnityEngine.InputSystem.LowLevel.InputEvent* AllocateEvent(System.Int32 sizeInBytes, System.Int32 capacityIncrementInBytes, Unity.Collections.Allocator allocator)
    // Offset: 0x514D340
    ::UnityEngine::InputSystem::LowLevel::InputEvent* AllocateEvent(int sizeInBytes, int capacityIncrementInBytes, ::Unity::Collections::Allocator allocator);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::LowLevel::InputEventBuffer::*)(::UnityEngine::InputSystem::LowLevel::InputEvent*, int, ::Unity::Collections::Allocator)>(&UnityEngine::InputSystem::LowLevel::InputEventBuffer::AppendEvent)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::InputEventBuffer), "AppendEvent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{eventPtr, capacityIncrementInBytes, allocator});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::LowLevel::InputEvent* (UnityEngine::InputSystem::LowLevel::InputEventBuffer::*)(int, int, ::Unity::Collections::Allocator)>(&UnityEngine::InputSystem::LowLevel::InputEventBuffer::AllocateEvent)> {
  static const MethodInfo* get() {
    static auto* sizeInBytes = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* capacityIncrementInBytes = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* allocator = &::il2cpp_utils::GetClassFromName("Unity.Collections", "Allocator")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::InputEventBuffer), "AllocateEvent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{sizeInBytes, capacityIncrementInBytes, allocator});
  }
};

...
namespace UnityEngine::InputSystem::OnScreen {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OnScreenButton), 56 + sizeof(::StringW)> __UnityEngine_InputSystem_OnScreen_OnScreenButtonSizeCheck;
  static_assert(sizeof(OnScreenButton) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

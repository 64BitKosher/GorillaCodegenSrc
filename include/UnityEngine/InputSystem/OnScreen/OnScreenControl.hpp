...
namespace UnityEngine::InputSystem::OnScreen {
  ...
  class OnScreenControl : public ::UnityEngine::MonoBehaviour {
    ...
    // protected System.Void SentDefaultValueToControl()
    // Offset: 0x513A730
  ...
  #pragma pack(pop)
  static check_size<sizeof(OnScreenControl), 48 + sizeof(::UnityEngine::InputSystem::LowLevel::InputEventPtr)> __UnityEngine_InputSystem_OnScreen_OnScreenControlSizeCheck;
  static_assert(sizeof(OnScreenControl) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::OnScreen::OnScreenControl::SentDefaultValueToControl
// Il2CppName: SentDefaultValueToControl
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::OnScreen::OnScreenControl::*)()>(&UnityEngine::InputSystem::OnScreen::OnScreenControl::SentDefaultValueToControl)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::OnScreen::OnScreenControl*), "SentDefaultValueToControl", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

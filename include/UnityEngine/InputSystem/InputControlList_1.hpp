...
namespace UnityEngine::InputSystem {
  ...
  struct InputControlList_1/*, public ::System::ValueType, public ::System::Collections::Generic::IList_1<TControl>, public ::System::Collections::Generic::IReadOnlyList_1<TControl>, public ::System::IDisposable*/ {
    ...
    // WARNING Size may be invalid!
    // WARNING Layout: Sequential may not be correctly taken into account!
    // Autogenerated type: UnityEngine.InputSystem.InputControlList`1/Enumerator
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    }; // UnityEngine.InputSystem.InputControlList`1/Enumerator
    // Could not write size check! Type: UnityEngine.InputSystem.InputControlList`1/Enumerator is generic, or has no fields that are valid for size checks!
    public:
    ...
    void Resize(int size) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::InputSystem::InputControlList_1::Resize");
    ...
    // public System.Int32 IndexOf(TControl item, System.Int32 startIndex, System.Int32 count)
    // Offset: 0xFFFFFFFFFFFFFFFF
    int IndexOf(TControl item, int startIndex, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::InputSystem::InputControlList_1::IndexOf");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(*this, "IndexOf", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(item), ::il2cpp_utils::ExtractType(startIndex), ::il2cpp_utils::ExtractType(count)})));
      return ::il2cpp_utils::RunMethodRethrow<int, false>(this, ___internal__method, item, startIndex, count);
    }
    ...
    // public System.Boolean Contains(TControl item, System.Int32 startIndex, System.Int32 count)
    // Offset: 0xFFFFFFFFFFFFFFFF
    bool Contains(TControl item, int startIndex, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::InputSystem::InputControlList_1::Contains");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(*this, "Contains", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(item), ::il2cpp_utils::ExtractType(startIndex), ::il2cpp_utils::ExtractType(count)})));
      return ::il2cpp_utils::RunMethodRethrow<bool, false>(this, ___internal__method, item, startIndex, count);
    }

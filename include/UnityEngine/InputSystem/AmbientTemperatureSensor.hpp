...
namespace UnityEngine::InputSystem {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AmbientTemperatureSensor), 368 + sizeof(::UnityEngine::InputSystem::Controls::AxisControl*)> __UnityEngine_InputSystem_AmbientTemperatureSensorSizeCheck;
  static_assert(sizeof(AmbientTemperatureSensor) == 0x178);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

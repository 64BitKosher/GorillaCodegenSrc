...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers::ModifiersArePressed
// Il2CppName: ModifiersArePressed
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers::*)(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>)>(&UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers::ModifiersArePressed)> {
  static const MethodInfo* get() {
    static auto* context = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputBindingCompositeContext")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers*), "ModifiersArePressed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{context});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers::FinishSetup
// Il2CppName: FinishSetup
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers::*)(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>)>(&UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers::FinishSetup)> {
  static const MethodInfo* get() {
    static auto* context = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputBindingCompositeContext")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers*), "FinishSetup", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{context});
  }
};

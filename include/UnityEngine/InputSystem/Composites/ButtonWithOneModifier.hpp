...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Composites::ButtonWithOneModifier::ModifierIsPressed
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::InputSystem::Composites::ButtonWithOneModifier::*)(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>)>(&UnityEngine::InputSystem::Composites::ButtonWithOneModifier::ModifierIsPressed)> {
  static const MethodInfo* get() {
    static auto* context = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputBindingCompositeContext")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Composites::ButtonWithOneModifier*), "ModifierIsPressed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{context});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Composites::ButtonWithOneModifier::FinishSetup
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Composites::ButtonWithOneModifier::*)(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>)>(&UnityEngine::InputSystem::Composites::ButtonWithOneModifier::FinishSetup)> {
  static const MethodInfo* get() {
    static auto* context = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputBindingCompositeContext")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Composites::ButtonWithOneModifier*), "FinishSetup", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{context});
  }
};

...
namespace UnityEngine::InputSystem {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrackedDevice), 392 + sizeof(::UnityEngine::InputSystem::Controls::QuaternionControl*)> __UnityEngine_InputSystem_TrackedDeviceSizeCheck;
  static_assert(sizeof(TrackedDevice) == 0x190);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

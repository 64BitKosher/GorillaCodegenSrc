...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Controls::QuaternionControl::CalculateOptimizedControlDataType
// Il2CppName: CalculateOptimizedControlDataType
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::Controls::QuaternionControl::*)()>(&UnityEngine::InputSystem::Controls::QuaternionControl::CalculateOptimizedControlDataType)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Controls::QuaternionControl*), "CalculateOptimizedControlDataType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

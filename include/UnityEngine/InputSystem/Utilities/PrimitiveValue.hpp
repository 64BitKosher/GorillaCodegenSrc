...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::InputSystem::Utilities::PrimitiveValue::get_valuePtr
// Il2CppName: get_valuePtr
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint8_t* (UnityEngine::InputSystem::Utilities::PrimitiveValue::*)()>(&UnityEngine::InputSystem::Utilities::PrimitiveValue::get_valuePtr)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Utilities::PrimitiveValue), "get_valuePtr", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

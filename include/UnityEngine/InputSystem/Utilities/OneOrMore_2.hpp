...
namespace UnityEngine::InputSystem::Utilities {
  ...
  struct OneOrMore_2/*, public ::System::ValueType, public ::System::Collections::Generic::IReadOnlyList_1<TValue>*/ {
    ...
    class Enumerator;
    // WARNING Size may be invalid!
    // Autogenerated type: UnityEngine.InputSystem.Utilities.OneOrMore`2/Enumerator
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    }; // UnityEngine.InputSystem.Utilities.OneOrMore`2/Enumerator
    // Could not write size check! Type: UnityEngine.InputSystem.Utilities.OneOrMore`2/Enumerator is generic, or has no fields that are valid for size checks!
    public:

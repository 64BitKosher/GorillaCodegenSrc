...
namespace UnityEngine::InputSystem::Utilities {
  ...
  struct NameAndParameters/*, public ::System::ValueType*/ {
    ...
    // static private UnityEngine.InputSystem.Utilities.NameAndParameters ParseNameAndParameters(System.String text, ref System.Int32 index, System.Boolean nameOnly)
    // Offset: 0x5176B14
    static ::UnityEngine::InputSystem::Utilities::NameAndParameters ParseNameAndParameters(::StringW text, ByRef<int> index, bool nameOnly);
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Utilities::NameAndParameters::ParseName
// Il2CppName: ParseName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::StringW)>(&UnityEngine::InputSystem::Utilities::NameAndParameters::ParseName)> {
  static const MethodInfo* get() {
    static auto* text = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Utilities::NameAndParameters), "ParseName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{text});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::NameAndParameters (*)(::StringW, ByRef<int>, bool)>(&UnityEngine::InputSystem::Utilities::NameAndParameters::ParseNameAndParameters)> {
  static const MethodInfo* get() {
    static auto* text = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* index = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    static auto* nameOnly = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Utilities::NameAndParameters), "ParseNameAndParameters", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{text, index, nameOnly});
  }
};

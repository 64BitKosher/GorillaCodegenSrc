...
namespace UnityEngine::InputSystem {
  ...
  class InputProcessor : public ::Il2CppObject {
    public:
    // Nested type: ::UnityEngine::InputSystem::InputProcessor::CachingPolicy
    ...
    // Offset: 0x50C4408
    static ::System::Type* GetValueTypeFromType(::System::Type* processorType);
    // public UnityEngine.InputSystem.InputProcessor/CachingPolicy get_cachingPolicy()
    // Offset: 0x50C44F8
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputProcessor::get_cachingPolicy
// Il2CppName: get_cachingPolicy
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::InputProcessor::CachingPolicy (UnityEngine::InputSystem::InputProcessor::*)()>(&UnityEngine::InputSystem::InputProcessor::get_cachingPolicy)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputProcessor*), "get_cachingPolicy", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

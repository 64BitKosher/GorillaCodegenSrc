...
namespace UnityEngine::InputSystem {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AttitudeSensor), 368 + sizeof(::UnityEngine::InputSystem::Controls::QuaternionControl*)> __UnityEngine_InputSystem_AttitudeSensorSizeCheck;
  static_assert(sizeof(AttitudeSensor) == 0x178);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

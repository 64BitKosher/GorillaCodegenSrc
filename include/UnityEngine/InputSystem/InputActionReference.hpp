...
namespace UnityEngine::InputSystem {
  ...
  class InputActionReference : public ::UnityEngine::ScriptableObject {
    ...
    // static private System.String GetDisplayName(UnityEngine.InputSystem.InputAction action)
    // Offset: 0x50A0440
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputActionReference::GetDisplayName
// Il2CppName: GetDisplayName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::UnityEngine::InputSystem::InputAction*)>(&UnityEngine::InputSystem::InputActionReference::GetDisplayName)> {
  static const MethodInfo* get() {
    static auto* action = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputAction")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputActionReference*), "GetDisplayName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{action});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputActionReference::ToDisplayName
// Il2CppName: ToDisplayName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::InputSystem::InputActionReference::*)()>(&UnityEngine::InputSystem::InputActionReference::ToDisplayName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputActionReference*), "ToDisplayName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

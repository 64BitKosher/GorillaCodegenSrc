...
namespace UnityEngine::InputSystem {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GravitySensor), 368 + sizeof(::UnityEngine::InputSystem::Controls::Vector3Control*)> __UnityEngine_InputSystem_GravitySensorSizeCheck;
  static_assert(sizeof(GravitySensor) == 0x178);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace UnityEngine::InputSystem::Processors {
  ...
  class NormalizeProcessor : public ::UnityEngine::InputSystem::InputProcessor_1<float> {
    ...
    // Offset: 0x515AE44
    static float Denormalize(float value, float min, float max, float zero);
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Processors::NormalizeProcessor::Denormalize
// Il2CppName: Denormalize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)(float, float, float, float)>(&UnityEngine::InputSystem::Processors::NormalizeProcessor::Denormalize)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* min = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* max = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* zero = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Processors::NormalizeProcessor*), "Denormalize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value, min, max, zero});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::Processors::NormalizeProcessor::ToString
// Il2CppName: ToString
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::InputSystem::Processors::NormalizeProcessor::*)()>(&UnityEngine::InputSystem::Processors::NormalizeProcessor::ToString)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Processors::NormalizeProcessor*), "ToString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

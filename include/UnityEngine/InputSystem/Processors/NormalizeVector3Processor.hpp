...
// Writing MetadataGetter for method: UnityEngine::InputSystem::Processors::NormalizeVector3Processor::ToString
// Il2CppName: ToString
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::InputSystem::Processors::NormalizeVector3Processor::*)()>(&UnityEngine::InputSystem::Processors::NormalizeVector3Processor::ToString)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::Processors::NormalizeVector3Processor*), "ToString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace UnityEngine::InputSystem::XR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XRHMD), 440 + sizeof(::UnityEngine::InputSystem::Controls::QuaternionControl*)> __UnityEngine_InputSystem_XR_XRHMDSizeCheck;
  static_assert(sizeof(XRHMD) == 0x1C0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace UnityEngine::InputSystem {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Gyroscope), 368 + sizeof(::UnityEngine::InputSystem::Controls::Vector3Control*)> __UnityEngine_InputSystem_GyroscopeSizeCheck;
  static_assert(sizeof(Gyroscope) == 0x178);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

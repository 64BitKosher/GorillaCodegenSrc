...
namespace UnityEngine::InputSystem::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BaseInputOverride), 32 + sizeof(::StringW)> __UnityEngine_InputSystem_UI_BaseInputOverrideSizeCheck;
  static_assert(sizeof(BaseInputOverride) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace UnityEngine::InputSystem::Android::LowLevel {
  ...
  struct AndroidSensorState/*, public ::System::ValueType, public ::UnityEngine::InputSystem::LowLevel::IInputStateTypeInfo*/ {
    ...
    #pragma pack(push, 1)
    // WARNING Layout: Sequential may not be correctly taken into account!
    // Autogenerated type: UnityEngine.InputSystem.Android.LowLevel.AndroidSensorState/<data>e__FixedBuffer
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    public:
    // public UnityEngine.InputSystem.Android.LowLevel.AndroidSensorState/<data>e__FixedBuffer data
    // Size: 0x4
    // Offset: 0x0
    ...
    // Get instance field reference: public UnityEngine.InputSystem.Android.LowLevel.AndroidSensorState/<data>e__FixedBuffer data

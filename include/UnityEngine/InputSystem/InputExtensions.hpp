...
namespace UnityEngine::InputSystem {
  ...
  class InputExtensions : public ::Il2CppObject {
    public:
    // static public System.Boolean IsInProgress(UnityEngine.InputSystem.InputActionPhase phase)
    // Offset: 0x510C4FC
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputExtensions::IsInProgress
// Il2CppName: IsInProgress
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::InputSystem::InputActionPhase)>(&UnityEngine::InputSystem::InputExtensions::IsInProgress)> {
  static const MethodInfo* get() {
    static auto* phase = &::il2cpp_utils::GetClassFromName("UnityEngine.InputSystem", "InputActionPhase")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputExtensions*), "IsInProgress", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{phase});
  }
};

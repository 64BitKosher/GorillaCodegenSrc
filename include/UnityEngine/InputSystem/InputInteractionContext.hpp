...
namespace UnityEngine::InputSystem {
  ...
  struct InputInteractionContext/*, public ::System::ValueType*/ {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: UnityEngine.InputSystem.InputInteractionContext/Flags
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    struct Flags/*, public ::System::Enum*/ {
      ...
      // static field const value: static public UnityEngine.InputSystem.InputInteractionContext/Flags TimerHasExpired
      static constexpr const int TimerHasExpired = 2;
      // Get static field: static public UnityEngine.InputSystem.InputInteractionContext/Flags TimerHasExpired
      static ::UnityEngine::InputSystem::InputInteractionContext::Flags _get_TimerHasExpired();
      // Set static field: static public UnityEngine.InputSystem.InputInteractionContext/Flags TimerHasExpired
    ...
    ::UnityEngine::InputSystem::InputActionState::TriggerState m_TriggerState;
    // Field size check
    static_assert(sizeof(::UnityEngine::InputSystem::InputActionState::TriggerState) == 0x30);
    public:
    ...
    // Get instance field reference: UnityEngine.InputSystem.InputInteractionContext/Flags m_Flags
    [[deprecated("Use field access instead!")]] ::UnityEngine::InputSystem::InputInteractionContext::Flags& dyn_m_Flags();
    // Get instance field reference: UnityEngine.InputSystem.InputActionState/TriggerState m_TriggerState
    ...
    // Offset: 0x50B6D28
    bool get_isStarted();
    // public System.Single ComputeMagnitude()
    // Offset: 0x50B6D38
    ...
    // public System.Void SetTotalTimeoutCompletionTime(System.Single seconds)
    // Offset: 0x50B6EE8
  ...
  #pragma pack(pop)
  static check_size<sizeof(InputInteractionContext), 12 + sizeof(::UnityEngine::InputSystem::InputActionState::TriggerState)> __UnityEngine_InputSystem_InputInteractionContextSizeCheck;
  static_assert(sizeof(InputInteractionContext) == 0x3C);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputInteractionContext::ComputeMagnitude
// Il2CppName: ComputeMagnitude
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (UnityEngine::InputSystem::InputInteractionContext::*)()>(&UnityEngine::InputSystem::InputInteractionContext::ComputeMagnitude)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputInteractionContext), "ComputeMagnitude", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputInteractionContext::SetTotalTimeoutCompletionTime
// Il2CppName: SetTotalTimeoutCompletionTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::InputInteractionContext::*)(float)>(&UnityEngine::InputSystem::InputInteractionContext::SetTotalTimeoutCompletionTime)> {
  static const MethodInfo* get() {
    static auto* seconds = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputInteractionContext), "SetTotalTimeoutCompletionTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{seconds});
  }
};

...
namespace UnityEngine::InputSystem {
  ...
  // Autogenerated type: UnityEngine.InputSystem.InputActionSetupExtensions/CompositeSyntax
  ...
  struct InputActionSetupExtensions::CompositeSyntax/*, public ::System::ValueType*/ {
    ...
    // private System.Int32 m_BindingIndexInMap
    // Size: 0x4
    // Offset: 0x10
    ...
    constexpr CompositeSyntax(::UnityEngine::InputSystem::InputAction* m_Action_ = {}, ::UnityEngine::InputSystem::InputActionMap* m_ActionMap_ = {}, int m_BindingIndexInMap_ = {}) noexcept : m_Action{m_Action_}, m_ActionMap{m_ActionMap_}, m_BindingIndexInMap{m_BindingIndexInMap_} {}
    ...
    // Get instance field reference: private System.Int32 m_BindingIndexInMap
    ...
    // public UnityEngine.InputSystem.InputActionSetupExtensions/CompositeSyntax With(System.String name, System.String binding, System.String groups, System.String processors)
    // Offset: 0x50A4E54
    ::UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax With(::StringW name, ::StringW binding, ::StringW groups, ::StringW processors);
...
// Writing MetadataGetter for method: UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax::get_bindingIndex
// Il2CppName: get_bindingIndex
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax::*)()>(&UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax::get_bindingIndex)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax), "get_bindingIndex", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Il2CppName: With
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax (UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax::*)(::StringW, ::StringW, ::StringW, ::StringW)>(&UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax::With)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::InputActionSetupExtensions::CompositeSyntax), "With", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{name, binding, groups, processors});
  }
};

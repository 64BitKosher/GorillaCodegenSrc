...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Text), 256 + sizeof(::ArrayW<::UnityEngine::UIVertex>)> __UnityEngine_UI_TextSizeCheck;
  static_assert(sizeof(Text) == 0x108);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: UnityEngine::UI::Text::AssignDefaultFontIfNecessary
// Il2CppName: AssignDefaultFontIfNecessary
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Text::*)()>(&UnityEngine::UI::Text::AssignDefaultFontIfNecessary)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Text*), "AssignDefaultFontIfNecessary", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

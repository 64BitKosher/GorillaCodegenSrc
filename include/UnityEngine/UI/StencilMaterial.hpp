...
namespace UnityEngine::UI {
  ...
  class StencilMaterial : public ::Il2CppObject {
    ...
    // static private System.Void LogWarningWhenNotInBatchmode(System.String warning, UnityEngine.Object context)
    // Offset: 0x56F1050
...
// Writing MetadataGetter for method: UnityEngine::UI::StencilMaterial::LogWarningWhenNotInBatchmode
// Il2CppName: LogWarningWhenNotInBatchmode
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::StringW, ::UnityEngine::Object*)>(&UnityEngine::UI::StencilMaterial::LogWarningWhenNotInBatchmode)> {
  static const MethodInfo* get() {
    static auto* warning = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* context = &::il2cpp_utils::GetClassFromName("UnityEngine", "Object")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::StencilMaterial*), "LogWarningWhenNotInBatchmode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{warning, context});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::StencilMaterial::Add
// Il2CppName: Add

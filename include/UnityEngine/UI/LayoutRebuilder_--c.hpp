...
namespace UnityEngine::UI {
  ...
  class LayoutRebuilder::$$c : public ::Il2CppObject {
    ...
    // UnityEngine.UI.LayoutRebuilder <.cctor>b__5_0()
    // Offset: 0x56E13BC
    ::UnityEngine::UI::LayoutRebuilder* $_cctor$b__5_0();
    // System.Void <.cctor>b__5_1(UnityEngine.UI.LayoutRebuilder x)
    // Offset: 0x56E1410
    void $_cctor$b__5_1(::UnityEngine::UI::LayoutRebuilder* x);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UI::LayoutRebuilder* (UnityEngine::UI::LayoutRebuilder::$$c::*)()>(&UnityEngine::UI::LayoutRebuilder::$$c::$_cctor$b__5_0)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::LayoutRebuilder::$$c*), "<.cctor>b__5_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::LayoutRebuilder::$$c::$_cctor$b__5_1
// Il2CppName: <.cctor>b__5_1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::LayoutRebuilder::$$c::*)(::UnityEngine::UI::LayoutRebuilder*)>(&UnityEngine::UI::LayoutRebuilder::$$c::$_cctor$b__5_1)> {
  static const MethodInfo* get() {
    static auto* x = &::il2cpp_utils::GetClassFromName("UnityEngine.UI", "LayoutRebuilder")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::LayoutRebuilder::$$c*), "<.cctor>b__5_1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{x});
  }
};

...
namespace UnityEngine::UI {
  ...
  class ContentSizeFitter : public ::UnityEngine::EventSystems::UIBehaviour/*, public ::UnityEngine::UI::ILayoutSelfController*/ {
    ...
    // Get instance field reference: protected UnityEngine.UI.ContentSizeFitter/FitMode m_HorizontalFit
    [[deprecated("Use field access instead!")]] ::UnityEngine::UI::ContentSizeFitter::FitMode& dyn_m_HorizontalFit();
    // Get instance field reference: protected UnityEngine.UI.ContentSizeFitter/FitMode m_VerticalFit

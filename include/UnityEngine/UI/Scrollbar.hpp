...
namespace UnityEngine::UI {
  ...
  class Scrollbar : public ::UnityEngine::UI::Selectable/*, public ::UnityEngine::EventSystems::IBeginDragHandler, public ::UnityEngine::EventSystems::IDragHandler, public ::UnityEngine::EventSystems::IInitializePotentialDragHandler, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    // Get instance field reference: private UnityEngine.UI.Scrollbar/Direction m_Direction
    ...
    // Get instance field reference: private UnityEngine.UI.Scrollbar/ScrollEvent m_OnValueChanged
  ...
  #pragma pack(pop)
  static check_size<sizeof(Scrollbar), 321 + sizeof(bool)> __UnityEngine_UI_ScrollbarSizeCheck;
  static_assert(sizeof(Scrollbar) == 0x142);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace UnityEngine::UI {
  ...
  class Graphic : public ::UnityEngine::EventSystems::UIBehaviour/*, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // private System.Boolean m_RaycastTargetCache
    // Size: 0x1
    // Offset: 0x3B
    ...
    // Get instance field reference: private System.Boolean m_RaycastTargetCache
    [[deprecated("Use field access instead!")]] bool& dyn_m_RaycastTargetCache();
    ...
    // public System.Void SetRaycastDirty()
    // Offset: 0x558477C
  ...
  #pragma pack(pop)
  static check_size<sizeof(Graphic), 160 + sizeof(bool)> __UnityEngine_UI_GraphicSizeCheck;
  static_assert(sizeof(Graphic) == 0xA1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: UnityEngine::UI::Graphic::SetRaycastDirty
// Il2CppName: SetRaycastDirty
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Graphic::*)()>(&UnityEngine::UI::Graphic::SetRaycastDirty)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Graphic*), "SetRaycastDirty", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

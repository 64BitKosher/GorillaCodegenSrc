...
namespace UnityEngine::UI {
  ...
  class MaskableGraphic : public ::UnityEngine::UI::Graphic/*, public ::UnityEngine::UI::IClippable, public ::UnityEngine::UI::IMaskable, public ::UnityEngine::UI::IMaterialModifier*/ {
    ...
    // Get instance field reference: private UnityEngine.UI.MaskableGraphic/CullStateChangedEvent m_OnCullStateChanged
  ...
  #pragma pack(pop)
  static check_size<sizeof(MaskableGraphic), 208 + sizeof(::ArrayW<::UnityEngine::Vector3>)> __UnityEngine_UI_MaskableGraphicSizeCheck;
  static_assert(sizeof(MaskableGraphic) == 0xD8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

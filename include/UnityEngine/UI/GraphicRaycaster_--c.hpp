...
namespace UnityEngine::UI {
  ...
  class GraphicRaycaster::$$c : public ::Il2CppObject {
    ...
    static ::System::Comparison_1<::UnityEngine::UI::Graphic*>* _get_$$9__27_0();
...
// Writing MetadataGetter for method: UnityEngine::UI::GraphicRaycaster::$$c::$Raycast$b__27_0
// Il2CppName: <Raycast>b__27_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::UI::GraphicRaycaster::$$c::*)(::UnityEngine::UI::Graphic*, ::UnityEngine::UI::Graphic*)>(&UnityEngine::UI::GraphicRaycaster::$$c::$Raycast$b__27_0)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::GraphicRaycaster::$$c*), "<Raycast>b__27_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{g1, g2});
  }
};

...
namespace UnityEngine::UI {
  ...
  class Image : public ::UnityEngine::UI::MaskableGraphic/*, public ::UnityEngine::ISerializationCallbackReceiver, public ::UnityEngine::UI::ILayoutElement, public ::UnityEngine::ICanvasRaycastFilter*/ {
    ...
    // Get instance field reference: private UnityEngine.UI.Image/Type m_Type
    ...
    // Get instance field reference: private UnityEngine.UI.Image/FillMethod m_FillMethod
    ...
    // private System.Void <set_sprite>g__ResetAlphaHitThresholdIfNeeded|11_0()
    // Offset: 0x55893C0
    void $set_sprite$g__ResetAlphaHitThresholdIfNeeded_11_0();
    // private System.Boolean <set_sprite>g__SpriteSupportsAlphaHitTest|11_1()
    // Offset: 0x558E0F8
    bool $set_sprite$g__SpriteSupportsAlphaHitTest_11_1();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Image), 268 + sizeof(float)> __UnityEngine_UI_ImageSizeCheck;
  static_assert(sizeof(Image) == 0x110);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: UnityEngine::UI::Image::$set_sprite$g__ResetAlphaHitThresholdIfNeeded_11_0
// Il2CppName: <set_sprite>g__ResetAlphaHitThresholdIfNeeded|11_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Image::*)()>(&UnityEngine::UI::Image::$set_sprite$g__ResetAlphaHitThresholdIfNeeded_11_0)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Image*), "<set_sprite>g__ResetAlphaHitThresholdIfNeeded|11_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::Image::$set_sprite$g__SpriteSupportsAlphaHitTest_11_1
// Il2CppName: <set_sprite>g__SpriteSupportsAlphaHitTest|11_1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::UI::Image::*)()>(&UnityEngine::UI::Image::$set_sprite$g__SpriteSupportsAlphaHitTest_11_1)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Image*), "<set_sprite>g__SpriteSupportsAlphaHitTest|11_1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace UnityEngine::UI {
  ...
  class GridLayoutGroup : public ::UnityEngine::UI::LayoutGroup {
    ...
    static_assert(sizeof(int) == 0x4);
    public:
    // Get instance field reference: protected UnityEngine.UI.GridLayoutGroup/Corner m_StartCorner
    [[deprecated("Use field access instead!")]] ::UnityEngine::UI::GridLayoutGroup::Corner& dyn_m_StartCorner();
    // Get instance field reference: protected UnityEngine.UI.GridLayoutGroup/Axis m_StartAxis
    ...
    // Get instance field reference: protected UnityEngine.UI.GridLayoutGroup/Constraint m_Constraint
  ...
  #pragma pack(pop)
  static check_size<sizeof(GridLayoutGroup), 124 + sizeof(int)> __UnityEngine_UI_GridLayoutGroupSizeCheck;
  static_assert(sizeof(GridLayoutGroup) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

...
namespace UnityEngine::UI {
  ...
  class LayoutRebuilder : public ::Il2CppObject/*, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    static ::UnityEngine::Pool::ObjectPool_1<::UnityEngine::UI::LayoutRebuilder*>* _get_s_Rebuilders();
    // Set static field: static private UnityEngine.Pool.ObjectPool`1<UnityEngine.UI.LayoutRebuilder> s_Rebuilders
    static void _set_s_Rebuilders(::UnityEngine::Pool::ObjectPool_1<::UnityEngine::UI::LayoutRebuilder*>* value);

...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BaseMeshEffect), 32 + sizeof(::UnityEngine::UI::Graphic*)> __UnityEngine_UI_BaseMeshEffectSizeCheck;
  static_assert(sizeof(BaseMeshEffect) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

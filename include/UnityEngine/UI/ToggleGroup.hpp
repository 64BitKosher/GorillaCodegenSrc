...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ToggleGroup), 40 + sizeof(::System::Collections::Generic::List_1<::UnityEngine::UI::Toggle*>*)> __UnityEngine_UI_ToggleGroupSizeCheck;
  static_assert(sizeof(ToggleGroup) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

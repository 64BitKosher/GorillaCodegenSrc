...
namespace UnityEngine::UI {
  ...
  class ClipperRegistry : public ::Il2CppObject {
    ...
    // static public System.Void Disable(UnityEngine.UI.IClipper c)
    // Offset: 0x557B6C0
...
// Writing MetadataGetter for method: UnityEngine::UI::ClipperRegistry::Disable
// Il2CppName: Disable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::UI::IClipper*)>(&UnityEngine::UI::ClipperRegistry::Disable)> {
  static const MethodInfo* get() {
    static auto* c = &::il2cpp_utils::GetClassFromName("UnityEngine.UI", "IClipper")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::ClipperRegistry*), "Disable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{c});
  }
};

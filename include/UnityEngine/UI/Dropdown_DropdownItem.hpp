...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Dropdown::DropdownItem), 56 + sizeof(::UnityEngine::UI::Toggle*)> __UnityEngine_UI_Dropdown_DropdownItemSizeCheck;
  static_assert(sizeof(Dropdown::DropdownItem) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

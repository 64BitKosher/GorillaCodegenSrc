...
namespace UnityEngine::UI {
  ...
  class HorizontalOrVerticalLayoutGroup : public ::UnityEngine::UI::LayoutGroup {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // protected System.Boolean m_ReverseArrangement
    // Size: 0x1
    // Offset: 0x6A
    ...
    // public System.Boolean get_reverseArrangement()
    // Offset: 0x56DEDC0
    bool get_reverseArrangement();
    // public System.Void set_reverseArrangement(System.Boolean value)
    // Offset: 0x56DEDC8
  ...
  #pragma pack(pop)
  static check_size<sizeof(HorizontalOrVerticalLayoutGroup), 106 + sizeof(bool)> __UnityEngine_UI_HorizontalOrVerticalLayoutGroupSizeCheck;
  static_assert(sizeof(HorizontalOrVerticalLayoutGroup) == 0x6B);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: UnityEngine::UI::HorizontalOrVerticalLayoutGroup::get_reverseArrangement
// Il2CppName: get_reverseArrangement
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::UI::HorizontalOrVerticalLayoutGroup::*)()>(&UnityEngine::UI::HorizontalOrVerticalLayoutGroup::get_reverseArrangement)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::HorizontalOrVerticalLayoutGroup*), "get_reverseArrangement", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::HorizontalOrVerticalLayoutGroup::set_reverseArrangement
// Il2CppName: set_reverseArrangement
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::HorizontalOrVerticalLayoutGroup::*)(bool)>(&UnityEngine::UI::HorizontalOrVerticalLayoutGroup::set_reverseArrangement)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::HorizontalOrVerticalLayoutGroup*), "set_reverseArrangement", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

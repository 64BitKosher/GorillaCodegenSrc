...
namespace UnityEngine::UI::CoroutineTween {
  ...
  class TweenRunner_1 : public ::Il2CppObject {
    ...
    class $Start$d__2 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public ::System::Collections::Generic::IEnumerator_1<::Il2CppObject*>*/ {
      ...
      [[deprecated("Use field access instead!")]] T& dyn_tweenInfo() {
      ...
      void System_IDisposable_Dispose() {
        ...
        auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(typename ::UnityEngine::UI::CoroutineTween::TweenRunner_1<T>::$Start$d__2*), -1));
    ...
    // Could not write size check! Type: UnityEngine.UI.CoroutineTween.TweenRunner`1/<Start>d__2 is generic, or has no fields that are valid for size checks!
    public:
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::MonoBehaviour*& dyn_m_CoroutineContainer() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::IEnumerator*& dyn_m_Tween() {

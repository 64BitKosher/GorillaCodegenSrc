...
namespace UnityEngine::UI {
  ...
  class GraphicRegistry : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<::UnityEngine::Canvas*, ::UnityEngine::UI::Collections::IndexedSet_1<::UnityEngine::UI::Graphic*>*>*& dyn_m_RaycastableGraphics();
    ...
    // static public System.Void DisableGraphicForCanvas(UnityEngine.Canvas c, UnityEngine.UI.Graphic graphic)
    // Offset: 0x55858AC
    static void DisableGraphicForCanvas(::UnityEngine::Canvas* c, ::UnityEngine::UI::Graphic* graphic);
    // static public System.Void DisableRaycastGraphicForCanvas(UnityEngine.Canvas c, UnityEngine.UI.Graphic graphic)
    // Offset: 0x55890EC
...
// Writing MetadataGetter for method: UnityEngine::UI::GraphicRegistry::DisableGraphicForCanvas
// Il2CppName: DisableGraphicForCanvas
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Canvas*, ::UnityEngine::UI::Graphic*)>(&UnityEngine::UI::GraphicRegistry::DisableGraphicForCanvas)> {
  static const MethodInfo* get() {
    static auto* c = &::il2cpp_utils::GetClassFromName("UnityEngine", "Canvas")->byval_arg;
    static auto* graphic = &::il2cpp_utils::GetClassFromName("UnityEngine.UI", "Graphic")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::GraphicRegistry*), "DisableGraphicForCanvas", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{c, graphic});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::GraphicRegistry::DisableRaycastGraphicForCanvas
// Il2CppName: DisableRaycastGraphicForCanvas
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Canvas*, ::UnityEngine::UI::Graphic*)>(&UnityEngine::UI::GraphicRegistry::DisableRaycastGraphicForCanvas)> {
  static const MethodInfo* get() {
    static auto* c = &::il2cpp_utils::GetClassFromName("UnityEngine", "Canvas")->byval_arg;
    static auto* graphic = &::il2cpp_utils::GetClassFromName("UnityEngine.UI", "Graphic")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::GraphicRegistry*), "DisableRaycastGraphicForCanvas", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{c, graphic});
  }
};

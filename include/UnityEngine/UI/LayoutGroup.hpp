...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LayoutGroup), 88 + sizeof(::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>*)> __UnityEngine_UI_LayoutGroupSizeCheck;
  static_assert(sizeof(LayoutGroup) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

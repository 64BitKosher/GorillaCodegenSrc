...
namespace UnityEngine::SceneManagement {
  ...
  struct LoadSceneParameters/*, public ::System::ValueType*/ {
    ...
    // public System.Void .ctor(UnityEngine.SceneManagement.LoadSceneMode mode, UnityEngine.SceneManagement.LocalPhysicsMode physicsMode)
    // Offset: 0x54DCD7C
    // ABORTED: conflicts with another method.  LoadSceneParameters(::UnityEngine::SceneManagement::LoadSceneMode mode, ::UnityEngine::SceneManagement::LocalPhysicsMode physicsMode);

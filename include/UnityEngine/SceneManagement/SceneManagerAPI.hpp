...
namespace UnityEngine::SceneManagement {
  ...
  class SceneManagerAPI : public ::Il2CppObject {
    ...
    // protected internal System.Int32 GetNumScenesInBuildSettings()
    // Offset: 0x54DB69C
    int GetNumScenesInBuildSettings();
    // protected internal UnityEngine.SceneManagement.Scene GetSceneByBuildIndex(System.Int32 buildIndex)
    // Offset: 0x54DB6C4
    ::UnityEngine::SceneManagement::Scene GetSceneByBuildIndex(int buildIndex);
    ...
    // protected internal UnityEngine.AsyncOperation UnloadSceneAsyncByNameOrIndex(System.String sceneName, System.Int32 sceneBuildIndex, System.Boolean immediately, UnityEngine.SceneManagement.UnloadSceneOptions options, out System.Boolean outSuccess)
    // Offset: 0x54DB770
    ::UnityEngine::AsyncOperation* UnloadSceneAsyncByNameOrIndex(::StringW sceneName, int sceneBuildIndex, bool immediately, ::UnityEngine::SceneManagement::UnloadSceneOptions options, ByRef<bool> outSuccess);
...
// Writing MetadataGetter for method: UnityEngine::SceneManagement::SceneManagerAPI::GetNumScenesInBuildSettings
// Il2CppName: GetNumScenesInBuildSettings
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::SceneManagement::SceneManagerAPI::*)()>(&UnityEngine::SceneManagement::SceneManagerAPI::GetNumScenesInBuildSettings)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::SceneManagement::SceneManagerAPI*), "GetNumScenesInBuildSettings", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::SceneManagement::SceneManagerAPI::GetSceneByBuildIndex
// Il2CppName: GetSceneByBuildIndex
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::SceneManagement::Scene (UnityEngine::SceneManagement::SceneManagerAPI::*)(int)>(&UnityEngine::SceneManagement::SceneManagerAPI::GetSceneByBuildIndex)> {
  static const MethodInfo* get() {
    static auto* buildIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::SceneManagement::SceneManagerAPI*), "GetSceneByBuildIndex", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{buildIndex});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::SceneManagement::SceneManagerAPI::UnloadSceneAsyncByNameOrIndex
// Il2CppName: UnloadSceneAsyncByNameOrIndex
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::AsyncOperation* (UnityEngine::SceneManagement::SceneManagerAPI::*)(::StringW, int, bool, ::UnityEngine::SceneManagement::UnloadSceneOptions, ByRef<bool>)>(&UnityEngine::SceneManagement::SceneManagerAPI::UnloadSceneAsyncByNameOrIndex)> {
  static const MethodInfo* get() {
    static auto* sceneName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* sceneBuildIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::SceneManagement::SceneManagerAPI*), "UnloadSceneAsyncByNameOrIndex", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{sceneName, sceneBuildIndex, immediately, options, outSuccess});
  }
};

...
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::LayoutCache::ResetCursor
// Il2CppName: ResetCursor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::GUILayoutUtility::LayoutCache::*)()>(&UnityEngine::GUILayoutUtility::LayoutCache::ResetCursor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility::LayoutCache*), "ResetCursor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

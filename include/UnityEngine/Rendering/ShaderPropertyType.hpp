...
namespace UnityEngine::Rendering {
  ...
  struct ShaderPropertyType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.Rendering.ShaderPropertyType Int
    static constexpr const int Int = 5;
    // Get static field: static public UnityEngine.Rendering.ShaderPropertyType Int
    static ::UnityEngine::Rendering::ShaderPropertyType _get_Int();
    // Set static field: static public UnityEngine.Rendering.ShaderPropertyType Int
    static void _set_Int(::UnityEngine::Rendering::ShaderPropertyType value);

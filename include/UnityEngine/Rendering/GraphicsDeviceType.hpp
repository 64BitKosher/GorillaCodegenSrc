...
namespace UnityEngine::Rendering {
  ...
  struct GraphicsDeviceType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.Rendering.GraphicsDeviceType PlayStation5NGGC
    static constexpr const int PlayStation5NGGC = 27;
    // Get static field: static public UnityEngine.Rendering.GraphicsDeviceType PlayStation5NGGC
    static ::UnityEngine::Rendering::GraphicsDeviceType _get_PlayStation5NGGC();
    // Set static field: static public UnityEngine.Rendering.GraphicsDeviceType PlayStation5NGGC
    static void _set_PlayStation5NGGC(::UnityEngine::Rendering::GraphicsDeviceType value);

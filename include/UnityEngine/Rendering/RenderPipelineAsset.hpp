...
namespace UnityEngine::Rendering {
  ...
  class RenderPipelineAsset : public ::UnityEngine::ScriptableObject {
    ...
    // public UnityEngine.Material get_default2DMaskMaterial()
    // Offset: 0x54E8C7C
    ...
    // public System.String get_renderPipelineShaderTag()
    // Offset: 0x54E8C9C
    ::StringW get_renderPipelineShaderTag();
...
// Writing MetadataGetter for method: UnityEngine::Rendering::RenderPipelineAsset::get_prefixedRenderingLayerMaskNames
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::StringW> (UnityEngine::Rendering::RenderPipelineAsset::*)()>(&UnityEngine::Rendering::RenderPipelineAsset::get_prefixedRenderingLayerMaskNames)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rendering::RenderPipelineAsset*), "get_prefixedRenderingLayerMaskNames", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Rendering::RenderPipelineAsset::get_default2DMaskMaterial
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Material* (UnityEngine::Rendering::RenderPipelineAsset::*)()>(&UnityEngine::Rendering::RenderPipelineAsset::get_default2DMaskMaterial)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rendering::RenderPipelineAsset*), "get_default2DMaskMaterial", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Rendering::RenderPipelineAsset::get_renderPipelineShaderTag
// Il2CppName: get_renderPipelineShaderTag
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::Rendering::RenderPipelineAsset::*)()>(&UnityEngine::Rendering::RenderPipelineAsset::get_renderPipelineShaderTag)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rendering::RenderPipelineAsset*), "get_renderPipelineShaderTag", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

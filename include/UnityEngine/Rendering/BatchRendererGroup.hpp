...
namespace UnityEngine::Rendering {
  ...
  class BatchRendererGroup : public ::Il2CppObject {
    ...
    // Get instance field reference: private UnityEngine.Rendering.BatchRendererGroup/OnPerformCulling m_PerformCulling
    [[deprecated("Use field access instead!")]] ::UnityEngine::Rendering::BatchRendererGroup::OnPerformCulling*& dyn_m_PerformCulling();
    // static private System.Void InvokeOnPerformCulling(UnityEngine.Rendering.BatchRendererGroup group, ref UnityEngine.Rendering.BatchRendererCullingOutput context, ref UnityEngine.Rendering.LODParameters lodParameters, System.IntPtr userContext)
    // Offset: 0x54EF928
    static void InvokeOnPerformCulling(::UnityEngine::Rendering::BatchRendererGroup* group, ByRef<::UnityEngine::Rendering::BatchRendererCullingOutput> context, ByRef<::UnityEngine::Rendering::LODParameters> lodParameters, ::System::IntPtr userContext);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Rendering::BatchRendererGroup*, ByRef<::UnityEngine::Rendering::BatchRendererCullingOutput>, ByRef<::UnityEngine::Rendering::LODParameters>, ::System::IntPtr)>(&UnityEngine::Rendering::BatchRendererGroup::InvokeOnPerformCulling)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rendering::BatchRendererGroup*), "InvokeOnPerformCulling", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{group, context, lodParameters, userContext});
  }
};

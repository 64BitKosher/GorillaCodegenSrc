...
NEED_NO_BOX(::UnityEngine::Rendering::Universal::ScriptableRenderer::EndXRPassData);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::ScriptableRenderer::EndXRPassData*, "UnityEngine.Rendering.Universal", "ScriptableRenderer/EndXRPassData");
// Type namespace: UnityEngine.Rendering.Universal
namespace UnityEngine::Rendering::Universal {
  // WARNING Size may be invalid!
  // Autogenerated type: UnityEngine.Rendering.Universal.ScriptableRenderer/EndXRPassData
  // [TokenAttribute] Offset: FFFFFFFF
  class ScriptableRenderer::EndXRPassData : public ::Il2CppObject {
    public:
    public:
    ...
    static ScriptableRenderer::EndXRPassData* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Rendering::Universal::ScriptableRenderer::EndXRPassData::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ScriptableRenderer::EndXRPassData*, creationType>()));
    }
  }; // UnityEngine.Rendering.Universal.ScriptableRenderer/EndXRPassData
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::Rendering::Universal::ScriptableRenderer::EndXRPassData::New_ctor
// Il2CppName: .ctor

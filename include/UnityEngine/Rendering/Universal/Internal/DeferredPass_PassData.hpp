...
NEED_NO_BOX(::UnityEngine::Rendering::Universal::Internal::DeferredPass::PassData);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::Internal::DeferredPass::PassData*, "UnityEngine.Rendering.Universal.Internal", "DeferredPass/PassData");
// Type namespace: UnityEngine.Rendering.Universal.Internal
namespace UnityEngine::Rendering::Universal::Internal {
  // WARNING Size may be invalid!
  // Autogenerated type: UnityEngine.Rendering.Universal.Internal.DeferredPass/PassData
  // [TokenAttribute] Offset: FFFFFFFF
  class DeferredPass::PassData : public ::Il2CppObject {
    public:
    public:
    ...
    static DeferredPass::PassData* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Rendering::Universal::Internal::DeferredPass::PassData::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<DeferredPass::PassData*, creationType>()));
    }
  }; // UnityEngine.Rendering.Universal.Internal.DeferredPass/PassData
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::Rendering::Universal::Internal::DeferredPass::PassData::New_ctor
// Il2CppName: .ctor

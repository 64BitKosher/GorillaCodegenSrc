...
namespace UnityEngine::Assertions {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AssertionException), 144 + sizeof(::StringW)> __UnityEngine_Assertions_AssertionExceptionSizeCheck;
  static_assert(sizeof(AssertionException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

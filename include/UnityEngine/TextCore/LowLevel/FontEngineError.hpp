...
namespace UnityEngine::TextCore::LowLevel {
  ...
  struct FontEngineError/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.TextCore.LowLevel.FontEngineError OpenTypeLayoutLookup_Mismatch
    static constexpr const int OpenTypeLayoutLookup_Mismatch = 116;
    // Get static field: static public UnityEngine.TextCore.LowLevel.FontEngineError OpenTypeLayoutLookup_Mismatch
    static ::UnityEngine::TextCore::LowLevel::FontEngineError _get_OpenTypeLayoutLookup_Mismatch();
    // Set static field: static public UnityEngine.TextCore.LowLevel.FontEngineError OpenTypeLayoutLookup_Mismatch
    static void _set_OpenTypeLayoutLookup_Mismatch(::UnityEngine::TextCore::LowLevel::FontEngineError value);

...
namespace UnityEngine::TextCore::LowLevel {
  ...
  struct GlyphLoadFlags/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.TextCore.LowLevel.GlyphLoadFlags LOAD_COLOR
    static constexpr const int LOAD_COLOR = 1048576;
    // Get static field: static public UnityEngine.TextCore.LowLevel.GlyphLoadFlags LOAD_COLOR
    static ::UnityEngine::TextCore::LowLevel::GlyphLoadFlags _get_LOAD_COLOR();
    // Set static field: static public UnityEngine.TextCore.LowLevel.GlyphLoadFlags LOAD_COLOR
    static void _set_LOAD_COLOR(::UnityEngine::TextCore::LowLevel::GlyphLoadFlags value);

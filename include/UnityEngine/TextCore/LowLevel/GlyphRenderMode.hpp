...
namespace UnityEngine::TextCore::LowLevel {
  ...
  struct GlyphRenderMode/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.TextCore.LowLevel.GlyphRenderMode COLOR_HINTED
    static constexpr const int COLOR_HINTED = 69656;
    // Get static field: static public UnityEngine.TextCore.LowLevel.GlyphRenderMode COLOR_HINTED
    static ::UnityEngine::TextCore::LowLevel::GlyphRenderMode _get_COLOR_HINTED();
    // Set static field: static public UnityEngine.TextCore.LowLevel.GlyphRenderMode COLOR_HINTED
    static void _set_COLOR_HINTED(::UnityEngine::TextCore::LowLevel::GlyphRenderMode value);
    // static field const value: static public UnityEngine.TextCore.LowLevel.GlyphRenderMode COLOR
    static constexpr const int COLOR = 69652;
    // Get static field: static public UnityEngine.TextCore.LowLevel.GlyphRenderMode COLOR
    static ::UnityEngine::TextCore::LowLevel::GlyphRenderMode _get_COLOR();
    // Set static field: static public UnityEngine.TextCore.LowLevel.GlyphRenderMode COLOR
    static void _set_COLOR(::UnityEngine::TextCore::LowLevel::GlyphRenderMode value);

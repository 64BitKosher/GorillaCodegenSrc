...
namespace UnityEngine::TextCore {
  ...
  class Glyph : public ::Il2CppObject {
    ...
    // Get instance field reference: private UnityEngine.TextCore.GlyphClassDefinitionType m_ClassDefinitionType
    [[deprecated("Use field access instead!")]] ::UnityEngine::TextCore::GlyphClassDefinitionType& dyn_m_ClassDefinitionType();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Glyph), 64 + sizeof(::UnityEngine::TextCore::GlyphClassDefinitionType)> __UnityEngine_TextCore_GlyphSizeCheck;
  static_assert(sizeof(Glyph) == 0x44);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

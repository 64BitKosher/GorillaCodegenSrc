...
namespace UnityEngine {
  ...
  struct TerrainData::BoundaryValueType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.TerrainData/BoundaryValueType MaxCoveragePerRes
    static constexpr const int MaxCoveragePerRes = 4;
    // Get static field: static public UnityEngine.TerrainData/BoundaryValueType MaxCoveragePerRes
    static ::UnityEngine::TerrainData::BoundaryValueType _get_MaxCoveragePerRes();
    // Set static field: static public UnityEngine.TerrainData/BoundaryValueType MaxCoveragePerRes
    static void _set_MaxCoveragePerRes(::UnityEngine::TerrainData::BoundaryValueType value);

...
namespace UnityEngine {
  ...
  struct PropertyName/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::PropertyName>*/ {
    ...
    // static public System.Boolean IsNullOrEmpty(UnityEngine.PropertyName prop)
    // Offset: 0x54C01BC
...
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: UnityEngine::PropertyName::IsNullOrEmpty
// Il2CppName: IsNullOrEmpty
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::PropertyName)>(&UnityEngine::PropertyName::IsNullOrEmpty)> {
  static const MethodInfo* get() {
    static auto* prop = &::il2cpp_utils::GetClassFromName("UnityEngine", "PropertyName")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::PropertyName), "IsNullOrEmpty", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{prop});
  }
};

...
namespace UnityEngine::EventSystems {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPointerEventData), 408 + sizeof(::UnityEngine::Vector2)> __UnityEngine_EventSystems_OVRPointerEventDataSizeCheck;
  static_assert(sizeof(OVRPointerEventData) == 0x1A0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

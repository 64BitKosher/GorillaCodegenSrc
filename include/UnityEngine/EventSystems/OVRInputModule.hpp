...
namespace UnityEngine::EventSystems {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInputModule), 240 + sizeof(::UnityEngine::EventSystems::PointerInputModule::MouseState*)> __UnityEngine_EventSystems_OVRInputModuleSizeCheck;
  static_assert(sizeof(OVRInputModule) == 0xF8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

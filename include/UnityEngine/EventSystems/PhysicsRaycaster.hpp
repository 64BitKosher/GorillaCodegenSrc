...
namespace UnityEngine::EventSystems {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhysicsRaycaster), 64 + sizeof(::ArrayW<::UnityEngine::RaycastHit>)> __UnityEngine_EventSystems_PhysicsRaycasterSizeCheck;
  static_assert(sizeof(PhysicsRaycaster) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

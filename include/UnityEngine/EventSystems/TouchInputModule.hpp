...
namespace UnityEngine::EventSystems {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TouchInputModule), 128 + sizeof(bool)> __UnityEngine_EventSystems_TouchInputModuleSizeCheck;
  static_assert(sizeof(TouchInputModule) == 0x81);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

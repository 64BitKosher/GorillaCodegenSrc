...
namespace UnityEngine::EventSystems {
  ...
  class PointerInputModule : public ::UnityEngine::EventSystems::BaseInputModule {
    ...
    // Get instance field reference: private readonly UnityEngine.EventSystems.PointerInputModule/MouseState m_MouseState
  ...
  #pragma pack(pop)
  static check_size<sizeof(PointerInputModule), 96 + sizeof(::UnityEngine::EventSystems::PointerInputModule::MouseState*)> __UnityEngine_EventSystems_PointerInputModuleSizeCheck;
  static_assert(sizeof(PointerInputModule) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

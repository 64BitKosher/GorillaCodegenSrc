...
namespace UnityEngine::EventSystems {
  // Size: 0x0
  #pragma pack(push, 1)
  // Autogenerated type: UnityEngine.EventSystems.IPointerMoveHandler
  // [TokenAttribute] Offset: FFFFFFFF
  class IPointerMoveHandler/*, public ::UnityEngine::EventSystems::IEventSystemHandler*/ {
    public:
...
// Writing MetadataGetter for method: UnityEngine::EventSystems::IPointerMoveHandler::OnPointerMove
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::EventSystems::IPointerMoveHandler::*)(::UnityEngine::EventSystems::PointerEventData*)>(&UnityEngine::EventSystems::IPointerMoveHandler::OnPointerMove)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::EventSystems::IPointerMoveHandler*), "OnPointerMove", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{eventData});
  }
};

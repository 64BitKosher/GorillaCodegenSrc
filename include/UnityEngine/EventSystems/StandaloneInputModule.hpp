...
namespace UnityEngine::EventSystems {
  ...
  #pragma pack(pop)
  static check_size<sizeof(StandaloneInputModule), 192 + sizeof(bool)> __UnityEngine_EventSystems_StandaloneInputModuleSizeCheck;
  static_assert(sizeof(StandaloneInputModule) == 0xC1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

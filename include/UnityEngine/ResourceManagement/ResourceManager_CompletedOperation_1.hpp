...
namespace UnityEngine::ResourceManagement {
  ...
  // Autogenerated type: UnityEngine.ResourceManagement.ResourceManager/CompletedOperation`1
  ...
  class ResourceManager::CompletedOperation_1 : public ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<TObject> {
    ...
    [[deprecated("Use field access instead!")]] bool& dyn_m_Success() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Exception*& dyn_m_Exception() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::ResourceManagement::ResourceManager::CompletedOperation_1::dyn_m_Exception");
      auto ___internal__instance = this;
    ...
    // public System.Void Init(TObject result, System.Boolean success, System.Exception exception, System.Boolean releaseDependenciesOnFailure)
    // Offset: 0xFFFFFFFFFFFFFFFF
    void Init(TObject result, bool success, ::System::Exception* exception, bool releaseDependenciesOnFailure) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::ResourceManagement::ResourceManager::CompletedOperation_1::Init");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Init", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(result), ::il2cpp_utils::ExtractType(success), ::il2cpp_utils::ExtractType(exception), ::il2cpp_utils::ExtractType(releaseDependenciesOnFailure)})));
  ...
  }; // UnityEngine.ResourceManagement.ResourceManager/CompletedOperation`1
  // Could not write size check! Type: UnityEngine.ResourceManagement.ResourceManager/CompletedOperation`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

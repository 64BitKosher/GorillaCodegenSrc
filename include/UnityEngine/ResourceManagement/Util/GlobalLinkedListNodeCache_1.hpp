...
namespace UnityEngine::ResourceManagement::Util {
  ...
  class GlobalLinkedListNodeCache_1 : public ::Il2CppObject {
    ...
    // static public System.Boolean get_CacheExists()
    // Offset: 0xFFFFFFFFFFFFFFFF
    static bool get_CacheExists() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1::get_CacheExists");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalLinkedListNodeCache_1<T>*>::get(), "get_CacheExists", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
      return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method);
    }
    // static public System.Void SetCacheSize(System.Int32 length)
    // Offset: 0xFFFFFFFFFFFFFFFF
    static void SetCacheSize(int length) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1::SetCacheSize");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalLinkedListNodeCache_1<T>*>::get(), "SetCacheSize", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(length)})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, length);
    }

...
namespace UnityEngine::ResourceManagement::Util {
  ...
  class LinkedListNodeCache_1 : public ::Il2CppObject {
    ...
    // System.Void set_CachedNodeCount(System.Int32 value)
    // Offset: 0xFFFFFFFFFFFFFFFF
    void set_CachedNodeCount(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1::set_CachedNodeCount");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "set_CachedNodeCount", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(value)})));

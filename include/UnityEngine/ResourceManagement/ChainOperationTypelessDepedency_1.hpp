...
namespace UnityEngine::ResourceManagement {
  // Forward declaring type: ChainOperationTypelessDepedency`1<TObject>
...
namespace UnityEngine::ResourceManagement {
  ...
  class ChainOperationTypelessDepedency_1 : public ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<TObject> {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle& dyn_m_DepOp() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Func_2<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle, ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>*& dyn_m_Callback() {
    ...
    // UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1<TObject> get_WrappedOp()
    // Offset: 0xFFFFFFFFFFFFFFFF
    ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject> get_WrappedOp() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::ResourceManagement::ChainOperationTypelessDepedency_1::get_WrappedOp");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "get_WrappedOp", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));

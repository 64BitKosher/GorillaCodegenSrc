...
namespace UnityEngine {
  ...
  class Animator : public ::UnityEngine::Behaviour {
    ...
    // Offset: 0x5468004
    ::UnityEngine::AnimatorControllerParameter* GetParameterInternal(int index);
    ...
    // public UnityEngine.Transform get_avatarRoot()
    // Offset: 0x54691F8
    ...
    // public System.Boolean get_keepAnimatorStateOnDisable()
    // Offset: 0x546A1A4
    bool get_keepAnimatorStateOnDisable();
    // public System.Void set_keepAnimatorStateOnDisable(System.Boolean value)
    // Offset: 0x546A224
    void set_keepAnimatorStateOnDisable(bool value);
    // public System.Boolean get_writeDefaultValuesOnDisable()
    // Offset: 0x546A268
    bool get_writeDefaultValuesOnDisable();
    // public System.Void set_writeDefaultValuesOnDisable(System.Boolean value)
    // Offset: 0x546A2A4
...
// Writing MetadataGetter for method: UnityEngine::Animator::GetParameterInternal
// Il2CppName: GetParameterInternal
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::AnimatorControllerParameter* (UnityEngine::Animator::*)(int)>(&UnityEngine::Animator::GetParameterInternal)> {
  static const MethodInfo* get() {
    static auto* index = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animator*), "GetParameterInternal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{index});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Animator::get_keepAnimatorStateOnDisable
// Il2CppName: get_keepAnimatorStateOnDisable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Animator::*)()>(&UnityEngine::Animator::get_keepAnimatorStateOnDisable)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animator*), "get_keepAnimatorStateOnDisable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Animator::set_keepAnimatorStateOnDisable
// Il2CppName: set_keepAnimatorStateOnDisable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Animator::*)(bool)>(&UnityEngine::Animator::set_keepAnimatorStateOnDisable)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animator*), "set_keepAnimatorStateOnDisable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::Animator::get_writeDefaultValuesOnDisable
// Il2CppName: get_writeDefaultValuesOnDisable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Animator::*)()>(&UnityEngine::Animator::get_writeDefaultValuesOnDisable)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animator*), "get_writeDefaultValuesOnDisable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Animator::set_writeDefaultValuesOnDisable
// Il2CppName: set_writeDefaultValuesOnDisable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Animator::*)(bool)>(&UnityEngine::Animator::set_writeDefaultValuesOnDisable)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animator*), "set_writeDefaultValuesOnDisable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

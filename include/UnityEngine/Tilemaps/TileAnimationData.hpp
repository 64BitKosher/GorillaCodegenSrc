...
namespace UnityEngine::Tilemaps {
  ...
  struct TileAnimationData/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Tilemaps::TileAnimationFlags) == 0x4);
    public:
    // Creating value type constructor for type: TileAnimationData
    constexpr TileAnimationData(::ArrayW<::UnityEngine::Sprite*> m_AnimatedSprites_ = ::ArrayW<::UnityEngine::Sprite*>(static_cast<void*>(nullptr)), float m_AnimationSpeed_ = {}, float m_AnimationStartTime_ = {}, ::UnityEngine::Tilemaps::TileAnimationFlags m_Flags_ = {}) noexcept : m_AnimatedSprites{m_AnimatedSprites_}, m_AnimationSpeed{m_AnimationSpeed_}, m_AnimationStartTime{m_AnimationStartTime_}, m_Flags{m_Flags_} {}
    ...
    // Get instance field reference: private UnityEngine.Tilemaps.TileAnimationFlags m_Flags
    [[deprecated("Use field access instead!")]] ::UnityEngine::Tilemaps::TileAnimationFlags& dyn_m_Flags();
  }; // UnityEngine.Tilemaps.TileAnimationData
  #pragma pack(pop)
  static check_size<sizeof(TileAnimationData), 16 + sizeof(::UnityEngine::Tilemaps::TileAnimationFlags)> __UnityEngine_Tilemaps_TileAnimationDataSizeCheck;
  static_assert(sizeof(TileAnimationData) == 0x14);
}

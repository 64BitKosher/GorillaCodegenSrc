...
namespace UnityEngine::Tilemaps {
  ...
  struct TileFlags/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.Tilemaps.TileFlags KeepGameObjectRuntimeOnly
    static constexpr const int KeepGameObjectRuntimeOnly = 8;
    // Get static field: static public UnityEngine.Tilemaps.TileFlags KeepGameObjectRuntimeOnly
    static ::UnityEngine::Tilemaps::TileFlags _get_KeepGameObjectRuntimeOnly();
    // Set static field: static public UnityEngine.Tilemaps.TileFlags KeepGameObjectRuntimeOnly
    static void _set_KeepGameObjectRuntimeOnly(::UnityEngine::Tilemaps::TileFlags value);

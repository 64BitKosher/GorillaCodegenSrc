...
namespace UnityEngine {
  ...
  // [AssetFileNameExtensionAttribute] Offset: FFFFFFFF
  ...
  static_assert(sizeof(GUISkin) == 0xF0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: UnityEngine::GUISkin::get_sliderMixed
// Il2CppName: get_sliderMixed
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::GUIStyle* (UnityEngine::GUISkin::*)()>(&UnityEngine::GUISkin::get_sliderMixed)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUISkin*), "get_sliderMixed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::GUISkin::set_sliderMixed
// Il2CppName: set_sliderMixed
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::GUISkin::*)(::UnityEngine::GUIStyle*)>(&UnityEngine::GUISkin::set_sliderMixed)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "GUIStyle")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUISkin*), "set_sliderMixed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

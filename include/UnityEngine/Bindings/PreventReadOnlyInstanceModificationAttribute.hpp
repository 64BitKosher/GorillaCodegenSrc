...
namespace UnityEngine::Bindings {
  // Forward declaring type: PreventReadOnlyInstanceModificationAttribute
...
namespace UnityEngine::Bindings {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: UnityEngine.Bindings.PreventReadOnlyInstanceModificationAttribute
  // [TokenAttribute] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: FFFFFFFF
  class PreventReadOnlyInstanceModificationAttribute : public ::System::Attribute {
    public:
    ...
    static PreventReadOnlyInstanceModificationAttribute* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<PreventReadOnlyInstanceModificationAttribute*, creationType>()));
    }
  }; // UnityEngine.Bindings.PreventReadOnlyInstanceModificationAttribute
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::Bindings::PreventReadOnlyInstanceModificationAttribute::New_ctor
// Il2CppName: .ctor

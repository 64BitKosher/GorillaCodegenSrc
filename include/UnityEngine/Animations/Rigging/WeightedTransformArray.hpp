...
namespace UnityEngine::Animations::Rigging {
  ...
  struct WeightedTransformArray/*, public ::System::ValueType, public ::System::Collections::Generic::IList_1<::UnityEngine::Animations::Rigging::WeightedTransform>, public ::System::Collections::IList*/ {
    ...
    // static public System.Void OnValidate(ref UnityEngine.Animations.Rigging.WeightedTransformArray array, System.Single min, System.Single max)
    // Offset: 0x50749E4
    static void OnValidate(ByRef<::UnityEngine::Animations::Rigging::WeightedTransformArray> array, float min, float max);
...
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::WeightedTransformArray::OnValidate
// Il2CppName: OnValidate
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<::UnityEngine::Animations::Rigging::WeightedTransformArray>, float, float)>(&UnityEngine::Animations::Rigging::WeightedTransformArray::OnValidate)> {
  static const MethodInfo* get() {
    static auto* array = &::il2cpp_utils::GetClassFromName("UnityEngine.Animations.Rigging", "WeightedTransformArray")->this_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::WeightedTransformArray), "OnValidate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{array, min, max});
  }
};

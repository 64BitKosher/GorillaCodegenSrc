...
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::IRigConstraint::get_component
// Il2CppName: get_component
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Component* (UnityEngine::Animations::Rigging::IRigConstraint::*)()>(&UnityEngine::Animations::Rigging::IRigConstraint::get_component)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::IRigConstraint*), "get_component", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

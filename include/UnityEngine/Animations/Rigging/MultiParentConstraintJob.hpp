...
namespace UnityEngine::Animations::Rigging {
  // Forward declaring type: MultiParentConstraintJob
  struct MultiParentConstraintJob;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Animations::Rigging::MultiParentConstraintJob, "UnityEngine.Animations.Rigging", "MultiParentConstraintJob");
// Type namespace: UnityEngine.Animations.Rigging
namespace UnityEngine::Animations::Rigging {
  // WARNING Size may be invalid!
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: UnityEngine.Animations.Rigging.MultiParentConstraintJob
  // [TokenAttribute] Offset: FFFFFFFF
  // [BurstCompileAttribute] Offset: FFFFFFFF
  struct MultiParentConstraintJob/*, public ::System::ValueType, public ::UnityEngine::Animations::Rigging::IWeightedAnimationJob*/ {
    public:
    public:
    ...
    // public Unity.Collections.NativeArray`1<UnityEngine.Animations.Rigging.AffineTransform> sourceOffsets
    // Size: 0xFFFFFFFF
    // Offset: 0x48
    ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::Rigging::AffineTransform> sourceOffsets;
    // public Unity.Collections.NativeArray`1<System.Single> weightBuffer
    // Size: 0xFFFFFFFF
    // Offset: 0x58
    ::Unity::Collections::NativeArray_1<float> weightBuffer;
    // public UnityEngine.Vector3 positionAxesMask
    // Size: 0xC
    // Offset: 0x68
    ::UnityEngine::Vector3 positionAxesMask;
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    // public UnityEngine.Vector3 rotationAxesMask
    // Size: 0xC
    // Offset: 0x74
    ::UnityEngine::Vector3 rotationAxesMask;
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    ...
    public:
    // Creating value type constructor for type: MultiParentConstraintJob
    constexpr MultiParentConstraintJob(::UnityEngine::Animations::Rigging::ReadWriteTransformHandle driven_ = {}, ::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle drivenParent_ = {}, ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle> sourceTransforms_ = {}, ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::PropertyStreamHandle> sourceWeights_ = {}, ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::Rigging::AffineTransform> sourceOffsets_ = {}, ::Unity::Collections::NativeArray_1<float> weightBuffer_ = {}, ::UnityEngine::Vector3 positionAxesMask_ = {}, ::UnityEngine::Vector3 rotationAxesMask_ = {}, ::UnityEngine::Animations::Rigging::FloatProperty jobWeight_ = {}) noexcept : driven{driven_}, drivenParent{drivenParent_}, sourceTransforms{sourceTransforms_}, sourceWeights{sourceWeights_}, sourceOffsets{sourceOffsets_}, weightBuffer{weightBuffer_}, positionAxesMask{positionAxesMask_}, rotationAxesMask{rotationAxesMask_}, jobWeight{jobWeight_} {}
    ...
    // Get instance field reference: public Unity.Collections.NativeArray`1<UnityEngine.Animations.Rigging.AffineTransform> sourceOffsets
    [[deprecated("Use field access instead!")]] ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::Rigging::AffineTransform>& dyn_sourceOffsets();
    ...
    // Get instance field reference: public UnityEngine.Vector3 positionAxesMask
    [[deprecated("Use field access instead!")]] ::UnityEngine::Vector3& dyn_positionAxesMask();
    // Get instance field reference: public UnityEngine.Vector3 rotationAxesMask
    [[deprecated("Use field access instead!")]] ::UnityEngine::Vector3& dyn_rotationAxesMask();
...
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::MultiParentConstraintJob::get_jobWeight
// Il2CppName: get_jobWeight
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Animations::Rigging::FloatProperty (UnityEngine::Animations::Rigging::MultiParentConstraintJob::*)()>(&UnityEngine::Animations::Rigging::MultiParentConstraintJob::get_jobWeight)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::MultiParentConstraintJob), "get_jobWeight", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::MultiParentConstraintJob::set_jobWeight
// Il2CppName: set_jobWeight
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Animations::Rigging::MultiParentConstraintJob::*)(::UnityEngine::Animations::Rigging::FloatProperty)>(&UnityEngine::Animations::Rigging::MultiParentConstraintJob::set_jobWeight)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine.Animations.Rigging", "FloatProperty")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::MultiParentConstraintJob), "set_jobWeight", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::MultiParentConstraintJob::ProcessRootMotion
// Il2CppName: ProcessRootMotion
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Animations::Rigging::MultiParentConstraintJob::*)(::UnityEngine::Animations::AnimationStream)>(&UnityEngine::Animations::Rigging::MultiParentConstraintJob::ProcessRootMotion)> {
  static const MethodInfo* get() {
    static auto* stream = &::il2cpp_utils::GetClassFromName("UnityEngine.Animations", "AnimationStream")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::MultiParentConstraintJob), "ProcessRootMotion", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stream});
  }
};
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::MultiParentConstraintJob::ProcessAnimation
// Il2CppName: ProcessAnimation
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Animations::Rigging::MultiParentConstraintJob::*)(::UnityEngine::Animations::AnimationStream)>(&UnityEngine::Animations::Rigging::MultiParentConstraintJob::ProcessAnimation)> {
  static const MethodInfo* get() {
    static auto* stream = &::il2cpp_utils::GetClassFromName("UnityEngine.Animations", "AnimationStream")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::MultiParentConstraintJob), "ProcessAnimation", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stream});
  }
};

...
namespace UnityEngine::Animations::Rigging {
  ...
  struct MultiAimConstraintJob/*, public ::System::ValueType, public ::UnityEngine::Animations::Rigging::IWeightedAnimationJob*/ {
    public:
    // Nested type: ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType
    struct WorldUpType;
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType
    // [TokenAttribute] Offset: FFFFFFFF
    struct WorldUpType/*, public ::System::Enum*/ {
      ...
      // static field const value: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType None
      static constexpr const int None = 0;
      // Get static field: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType None
      static ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType _get_None();
      // Set static field: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType None
      static void _set_None(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType value);
      // static field const value: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType SceneUp
      ...
      static ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType _get_SceneUp();
      // Set static field: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType SceneUp
      static void _set_SceneUp(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType value);
      // static field const value: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType ObjectUp
      ...
      static ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType _get_ObjectUp();
      // Set static field: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType ObjectUp
      static void _set_ObjectUp(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType value);
      // static field const value: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType ObjectRotationUp
      ...
      static ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType _get_ObjectRotationUp();
      // Set static field: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType ObjectRotationUp
      static void _set_ObjectRotationUp(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType value);
      // static field const value: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType Vector
      ...
      static ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType _get_Vector();
      // Set static field: static public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType Vector
      static void _set_Vector(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType value);
      // Get instance field reference: public System.Int32 value__
      [[deprecated("Use field access instead!")]] int& dyn_value__();
    }; // UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType
    #pragma pack(pop)
    static check_size<sizeof(MultiAimConstraintJob::WorldUpType), 0 + sizeof(int)> __UnityEngine_Animations_Rigging_MultiAimConstraintJob_WorldUpTypeSizeCheck;
    static_assert(sizeof(MultiAimConstraintJob::WorldUpType) == 0x4);
    public:
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    // public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType worldUpType
    // Size: 0x4
    // Offset: 0xB0
    ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType worldUpType;
    // Field size check
    static_assert(sizeof(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType) == 0x4);
    // public UnityEngine.Vector3 worldUpAxis
    // Size: 0xC
    // Offset: 0xB4
    ::UnityEngine::Vector3 worldUpAxis;
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    // public UnityEngine.Animations.Rigging.ReadOnlyTransformHandle worldUpObject
    // Size: 0x15
    // Offset: 0xC0
    ::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle worldUpObject;
    // Field size check
    static_assert(sizeof(::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle) == 0x15);
    ...
    constexpr MultiAimConstraintJob(::UnityEngine::Animations::Rigging::ReadWriteTransformHandle driven_ = {}, ::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle drivenParent_ = {}, ::UnityEngine::Animations::Rigging::Vector3Property drivenOffset_ = {}, ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle> sourceTransforms_ = {}, ::Unity::Collections::NativeArray_1<::UnityEngine::Animations::PropertyStreamHandle> sourceWeights_ = {}, ::Unity::Collections::NativeArray_1<::UnityEngine::Quaternion> sourceOffsets_ = {}, ::Unity::Collections::NativeArray_1<float> weightBuffer_ = {}, ::UnityEngine::Vector3 aimAxis_ = {}, ::UnityEngine::Vector3 upAxis_ = {}, ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType worldUpType_ = {}, ::UnityEngine::Vector3 worldUpAxis_ = {}, ::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle worldUpObject_ = {}, ::UnityEngine::Vector3 axesMask_ = {}, ::UnityEngine::Animations::Rigging::FloatProperty minLimit_ = {}, ::UnityEngine::Animations::Rigging::FloatProperty maxLimit_ = {}, ::UnityEngine::Animations::Rigging::FloatProperty jobWeight_ = {}) noexcept : driven{driven_}, drivenParent{drivenParent_}, drivenOffset{drivenOffset_}, sourceTransforms{sourceTransforms_}, sourceWeights{sourceWeights_}, sourceOffsets{sourceOffsets_}, weightBuffer{weightBuffer_}, aimAxis{aimAxis_}, upAxis{upAxis_}, worldUpType{worldUpType_}, worldUpAxis{worldUpAxis_}, worldUpObject{worldUpObject_}, axesMask{axesMask_}, minLimit{minLimit_}, maxLimit{maxLimit_}, jobWeight{jobWeight_} {}
    ...
    // Get instance field reference: public UnityEngine.Vector3 upAxis
    [[deprecated("Use field access instead!")]] ::UnityEngine::Vector3& dyn_upAxis();
    // Get instance field reference: public UnityEngine.Animations.Rigging.MultiAimConstraintJob/WorldUpType worldUpType
    [[deprecated("Use field access instead!")]] ::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType& dyn_worldUpType();
    // Get instance field reference: public UnityEngine.Vector3 worldUpAxis
    [[deprecated("Use field access instead!")]] ::UnityEngine::Vector3& dyn_worldUpAxis();
    // Get instance field reference: public UnityEngine.Animations.Rigging.ReadOnlyTransformHandle worldUpObject
    [[deprecated("Use field access instead!")]] ::UnityEngine::Animations::Rigging::ReadOnlyTransformHandle& dyn_worldUpObject();
...
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Animations::Rigging::MultiAimConstraintJob::WorldUpType, "UnityEngine.Animations.Rigging", "MultiAimConstraintJob/WorldUpType");
...
// Writing MetadataGetter for method: UnityEngine::Animations::Rigging::MultiAimConstraintJob::ComputeWorldUpVector
// Il2CppName: ComputeWorldUpVector
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (UnityEngine::Animations::Rigging::MultiAimConstraintJob::*)(::UnityEngine::Animations::AnimationStream)>(&UnityEngine::Animations::Rigging::MultiAimConstraintJob::ComputeWorldUpVector)> {
  static const MethodInfo* get() {
    static auto* stream = &::il2cpp_utils::GetClassFromName("UnityEngine.Animations", "AnimationStream")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::Rigging::MultiAimConstraintJob), "ComputeWorldUpVector", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stream});
  }
};

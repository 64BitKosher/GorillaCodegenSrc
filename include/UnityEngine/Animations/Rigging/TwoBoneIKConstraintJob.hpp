...
namespace UnityEngine::Animations::Rigging {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TwoBoneIKConstraintJob), 160 + sizeof(::UnityEngine::Animations::Rigging::FloatProperty)> __UnityEngine_Animations_Rigging_TwoBoneIKConstraintJobSizeCheck;
  static_assert(sizeof(TwoBoneIKConstraintJob) == 0xB0);
}

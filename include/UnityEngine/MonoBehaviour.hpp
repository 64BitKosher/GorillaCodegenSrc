...
namespace UnityEngine {
  ...
  class MonoBehaviour : public ::UnityEngine::Behaviour {
    ...
    // Get instance field reference: private System.Threading.CancellationTokenSource m_CancellationTokenSource
    [[deprecated("Use field access instead!")]] ::System::Threading::CancellationTokenSource*& dyn_m_CancellationTokenSource();
    // public System.Threading.CancellationToken get_destroyCancellationToken()
    // Offset: 0x54C6BA0
    ::System::Threading::CancellationToken get_destroyCancellationToken();
    // private System.Void RaiseCancellation()
    // Offset: 0x54C6C84
    ...
    // private System.Void OnCancellationTokenCreated()
    // Offset: 0x54C6C48
  ...
  #pragma pack(pop)
  static check_size<sizeof(MonoBehaviour), 24 + sizeof(::System::Threading::CancellationTokenSource*)> __UnityEngine_MonoBehaviourSizeCheck;
  static_assert(sizeof(MonoBehaviour) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::MonoBehaviour::get_destroyCancellationToken
// Il2CppName: get_destroyCancellationToken
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::CancellationToken (UnityEngine::MonoBehaviour::*)()>(&UnityEngine::MonoBehaviour::get_destroyCancellationToken)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::MonoBehaviour*), "get_destroyCancellationToken", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::MonoBehaviour::RaiseCancellation
// Il2CppName: RaiseCancellation
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::MonoBehaviour::*)()>(&UnityEngine::MonoBehaviour::RaiseCancellation)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::MonoBehaviour*), "RaiseCancellation", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::MonoBehaviour::OnCancellationTokenCreated
// Il2CppName: OnCancellationTokenCreated
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::MonoBehaviour::*)()>(&UnityEngine::MonoBehaviour::OnCancellationTokenCreated)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::MonoBehaviour*), "OnCancellationTokenCreated", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
namespace UnityEngine {
  ...
  class ResourcesAPI : public ::Il2CppObject {
    ...
    // protected internal UnityEngine.Object[] LoadAll(System.String path, System.Type systemTypeInstance)
    // Offset: 0x54C0CE0
    ::ArrayW<::UnityEngine::Object*> LoadAll(::StringW path, ::System::Type* systemTypeInstance);
    // protected internal UnityEngine.ResourceRequest LoadAsync(System.String path, System.Type systemTypeInstance)
    // Offset: 0x54C0D24
    ::UnityEngine::ResourceRequest* LoadAsync(::StringW path, ::System::Type* systemTypeInstance);
    // protected internal System.Void UnloadAsset(UnityEngine.Object assetToUnload)
    // Offset: 0x54C0D98
...
// Writing MetadataGetter for method: UnityEngine::ResourcesAPI::LoadAll
// Il2CppName: LoadAll
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Object*> (UnityEngine::ResourcesAPI::*)(::StringW, ::System::Type*)>(&UnityEngine::ResourcesAPI::LoadAll)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* systemTypeInstance = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourcesAPI*), "LoadAll", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path, systemTypeInstance});
  }
};
// Writing MetadataGetter for method: UnityEngine::ResourcesAPI::LoadAsync
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ResourceRequest* (UnityEngine::ResourcesAPI::*)(::StringW, ::System::Type*)>(&UnityEngine::ResourcesAPI::LoadAsync)> {
  static const MethodInfo* get() {
    static auto* path = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* systemTypeInstance = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourcesAPI*), "LoadAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{path, systemTypeInstance});
  }
};
// Writing MetadataGetter for method: UnityEngine::ResourcesAPI::UnloadAsset
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ResourcesAPI::*)(::UnityEngine::Object*)>(&UnityEngine::ResourcesAPI::UnloadAsset)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ResourcesAPI*), "UnloadAsset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{assetToUnload});
  }
};

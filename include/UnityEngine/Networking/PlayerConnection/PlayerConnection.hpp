...
namespace UnityEngine::Networking::PlayerConnection {
  ...
  class PlayerConnection : public ::UnityEngine::ScriptableObject/*, public ::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection*/ {
    public:
    ...
    public:
    // Creating interface conversion operator: operator ::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection
    operator ::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection() noexcept {
      return *reinterpret_cast<::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection*>(this);
    }

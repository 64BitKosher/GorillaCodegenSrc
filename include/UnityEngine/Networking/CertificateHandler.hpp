...
namespace UnityEngine::Networking {
  ...
  class CertificateHandler : public ::Il2CppObject/*, public ::System::IDisposable*/ {
    public:
    public:
    // System.IntPtr m_Ptr
    // Size: 0x8
    ...
    // static private System.IntPtr Create(UnityEngine.Networking.CertificateHandler obj)
    // Offset: 0x570BE1C
    ...
    static CertificateHandler* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Networking::CertificateHandler::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CertificateHandler*, creationType>()));
    }
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::Networking::CertificateHandler::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IntPtr (*)(::UnityEngine::Networking::CertificateHandler*)>(&UnityEngine::Networking::CertificateHandler::Create)> {
  static const MethodInfo* get() {
    static auto* obj = &::il2cpp_utils::GetClassFromName("UnityEngine.Networking", "CertificateHandler")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Networking::CertificateHandler*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{obj});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Networking::CertificateHandler::New_ctor
// Il2CppName: .ctor
...
// Writing MetadataGetter for method: UnityEngine::Networking::CertificateHandler::Finalize
// Il2CppName: Finalize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Networking::CertificateHandler::*)()>(&UnityEngine::Networking::CertificateHandler::Finalize)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Networking::CertificateHandler*), "Finalize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

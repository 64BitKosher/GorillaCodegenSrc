...
namespace UnityEngine::Networking {
  ...
  class DownloadHandlerAssetBundle : public ::UnityEngine::Networking::DownloadHandler {
    ...
    // public System.Boolean get_autoLoadAssetBundle()
    // Offset: 0x5708C38
    bool get_autoLoadAssetBundle();
    // public System.Void set_autoLoadAssetBundle(System.Boolean value)
    // Offset: 0x5708C74
    void set_autoLoadAssetBundle(bool value);
    // public System.Boolean get_isDownloadComplete()
    // Offset: 0x5708CB8
...
// Writing MetadataGetter for method: UnityEngine::Networking::DownloadHandlerAssetBundle::get_autoLoadAssetBundle
// Il2CppName: get_autoLoadAssetBundle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Networking::DownloadHandlerAssetBundle::*)()>(&UnityEngine::Networking::DownloadHandlerAssetBundle::get_autoLoadAssetBundle)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Networking::DownloadHandlerAssetBundle*), "get_autoLoadAssetBundle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Networking::DownloadHandlerAssetBundle::set_autoLoadAssetBundle
// Il2CppName: set_autoLoadAssetBundle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Networking::DownloadHandlerAssetBundle::*)(bool)>(&UnityEngine::Networking::DownloadHandlerAssetBundle::set_autoLoadAssetBundle)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Networking::DownloadHandlerAssetBundle*), "set_autoLoadAssetBundle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::Networking::DownloadHandlerAssetBundle::get_isDownloadComplete
// Il2CppName: get_isDownloadComplete
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Networking::DownloadHandlerAssetBundle::*)()>(&UnityEngine::Networking::DownloadHandlerAssetBundle::get_isDownloadComplete)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Networking::DownloadHandlerAssetBundle*), "get_isDownloadComplete", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

...
// Including type: UnityEngine.RefreshRate
...
namespace UnityEngine {
  ...
  struct Resolution/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // private UnityEngine.RefreshRate m_RefreshRate
    // Size: 0x8
    // Offset: 0x8
    ::UnityEngine::RefreshRate m_RefreshRate;
    // Field size check
    static_assert(sizeof(::UnityEngine::RefreshRate) == 0x8);
    public:
    // Creating value type constructor for type: Resolution
    constexpr Resolution(int m_Width_ = {}, int m_Height_ = {}, ::UnityEngine::RefreshRate m_RefreshRate_ = {}) noexcept : m_Width{m_Width_}, m_Height{m_Height_}, m_RefreshRate{m_RefreshRate_} {}
    ...
    // Get instance field reference: private UnityEngine.RefreshRate m_RefreshRate
    [[deprecated("Use field access instead!")]] ::UnityEngine::RefreshRate& dyn_m_RefreshRate();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Resolution), 8 + sizeof(::UnityEngine::RefreshRate)> __UnityEngine_ResolutionSizeCheck;
  static_assert(sizeof(Resolution) == 0x10);
}

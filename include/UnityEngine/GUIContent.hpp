...
namespace UnityEngine {
  ...
  class GUIContent : public ::Il2CppObject {
    ...
    // Get instance field reference: private System.Action OnTextChanged
    [[deprecated("Use field access instead!")]] ::System::Action*& dyn_OnTextChanged();
  ...
  #pragma pack(pop)
  static check_size<sizeof(GUIContent), 40 + sizeof(::System::Action*)> __UnityEngine_GUIContentSizeCheck;
  static_assert(sizeof(GUIContent) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: UnityEngine::GUIContent::ToString
// Il2CppName: ToString
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::GUIContent::*)()>(&UnityEngine::GUIContent::ToString)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUIContent*), "ToString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

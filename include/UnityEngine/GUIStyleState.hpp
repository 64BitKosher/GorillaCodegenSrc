...
namespace UnityEngine {
  ...
  class GUIStyleState : public ::Il2CppObject {
    ...
    // public UnityEngine.Texture2D get_background()
    // Offset: 0x5508834
    ::UnityEngine::Texture2D* get_background();
    // public System.Void set_background(UnityEngine.Texture2D value)
    // Offset: 0x5508870
    void set_background(::UnityEngine::Texture2D* value);
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::GUIStyleState::get_background
// Il2CppName: get_background
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Texture2D* (UnityEngine::GUIStyleState::*)()>(&UnityEngine::GUIStyleState::get_background)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUIStyleState*), "get_background", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::GUIStyleState::set_background
// Il2CppName: set_background
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::GUIStyleState::*)(::UnityEngine::Texture2D*)>(&UnityEngine::GUIStyleState::set_background)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("UnityEngine", "Texture2D")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUIStyleState*), "set_background", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};

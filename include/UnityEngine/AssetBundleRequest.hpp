...
namespace UnityEngine {
  ...
  class AssetBundleRequest : public ::UnityEngine::ResourceRequest {
    ...
    // Offset: 0x5471BE8
    // Implemented from: UnityEngine.ResourceRequest
    // Base method: UnityEngine.Object ResourceRequest::GetResult()
...
// Writing MetadataGetter for method: UnityEngine::AssetBundleRequest::GetResult
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Object* (UnityEngine::AssetBundleRequest::*)()>(&UnityEngine::AssetBundleRequest::GetResult)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AssetBundleRequest*), "GetResult", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

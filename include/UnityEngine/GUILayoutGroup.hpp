...
namespace UnityEngine {
  ...
  class GUILayoutGroup : public ::UnityEngine::GUILayoutEntry {
    ...
    static ::UnityEngine::GUILayoutEntry* _get_none();
...
// Writing MetadataGetter for method: UnityEngine::GUILayoutGroup::GetLast
// Il2CppName: GetLast
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rect (UnityEngine::GUILayoutGroup::*)()>(&UnityEngine::GUILayoutGroup::GetLast)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutGroup*), "GetLast", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&UnityEngine::GUILayoutGroup::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutGroup*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};

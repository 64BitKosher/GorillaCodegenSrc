...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AndroidJavaException), 144 + sizeof(::StringW)> __UnityEngine_AndroidJavaExceptionSizeCheck;
  static_assert(sizeof(AndroidJavaException) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

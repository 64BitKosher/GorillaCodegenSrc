...
namespace ExitGames::Client::Photon {
  ...
  class PeerBase : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // readonly System.Collections.Generic.Queue`1<ExitGames.Client.Photon.PeerBase/MyAction> ActionQueue
    // Size: 0x8
    // Offset: 0x60
    ...
    // Get instance field reference: readonly System.Collections.Generic.Queue`1<ExitGames.Client.Photon.PeerBase/MyAction> ActionQueue
    ...
    // System.Void EnqueueActionForDispatch(ExitGames.Client.Photon.PeerBase/MyAction action)
    // Offset: 0x49D3424

...
namespace ExitGames::Client::Photon {
  ...
  class SupportClass : public ::Il2CppObject {
    ...
    // Get static field: static protected internal ExitGames.Client.Photon.SupportClass/IntegerMillisecondsDelegate IntegerMilliseconds
    static ::ExitGames::Client::Photon::SupportClass::IntegerMillisecondsDelegate* _get_IntegerMilliseconds();
    // Set static field: static protected internal ExitGames.Client.Photon.SupportClass/IntegerMillisecondsDelegate IntegerMilliseconds
    ...
    // static public System.String ByteArrayToString(System.Byte[] list, System.Int32 length)
    // Offset: 0x49FE818
    static ::StringW ByteArrayToString(::ArrayW<uint8_t> list, int length);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::ArrayW<uint8_t>, int)>(&ExitGames::Client::Photon::SupportClass::ByteArrayToString)> {
  static const MethodInfo* get() {
    static auto* list = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    static auto* length = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(ExitGames::Client::Photon::SupportClass*), "ByteArrayToString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{list, length});
  }
};

...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SelectionCylinder), 64 + sizeof(::OculusSampleFramework::SelectionCylinder::SelectionState)> __OculusSampleFramework_SelectionCylinderSizeCheck;
  static_assert(sizeof(SelectionCylinder) == 0x44);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"

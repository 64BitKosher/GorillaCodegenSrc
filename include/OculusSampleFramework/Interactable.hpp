...
namespace OculusSampleFramework {
  ...
  class Interactable : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(::System::Action_1<::OculusSampleFramework::ColliderZoneArgs*>*) == 0x8);
    // public OculusSampleFramework.Interactable/InteractableStateArgsEvent InteractableStateChanged
    // Size: 0x8
    // Offset: 0x50
    ...
    // Get instance field reference: public OculusSampleFramework.Interactable/InteractableStateArgsEvent InteractableStateChanged
  ...
  #pragma pack(pop)
  static check_size<sizeof(Interactable), 80 + sizeof(::OculusSampleFramework::Interactable::InteractableStateArgsEvent*)> __OculusSampleFramework_InteractableSizeCheck;
  static_assert(sizeof(Interactable) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

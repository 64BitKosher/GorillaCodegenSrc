...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ButtonTriggerZone), 48 + sizeof(::OculusSampleFramework::Interactable*)> __OculusSampleFramework_ButtonTriggerZoneSizeCheck;
  static_assert(sizeof(ButtonTriggerZone) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

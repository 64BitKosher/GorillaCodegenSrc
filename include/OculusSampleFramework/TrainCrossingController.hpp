...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrainCrossingController), 104 + sizeof(::OculusSampleFramework::InteractableTool*)> __OculusSampleFramework_TrainCrossingControllerSizeCheck;
  static_assert(sizeof(TrainCrossingController) == 0x70);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InteractableTool), 104 + sizeof(::System::Collections::Generic::Dictionary_2<::OculusSampleFramework::Interactable*, ::OculusSampleFramework::InteractableCollisionInfo*>*)> __OculusSampleFramework_InteractableToolSizeCheck;
  static_assert(sizeof(InteractableTool) == 0x70);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

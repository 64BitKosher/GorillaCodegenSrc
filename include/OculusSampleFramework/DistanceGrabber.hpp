...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DistanceGrabber), 256 + sizeof(::UnityEngine::Collider*)> __OculusSampleFramework_DistanceGrabberSizeCheck;
  static_assert(sizeof(DistanceGrabber) == 0x108);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

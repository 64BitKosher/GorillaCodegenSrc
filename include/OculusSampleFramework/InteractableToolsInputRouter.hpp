...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InteractableToolsInputRouter), 64 + sizeof(::System::Collections::Generic::HashSet_1<::OculusSampleFramework::InteractableTool*>*)> __OculusSampleFramework_InteractableToolsInputRouterSizeCheck;
  static_assert(sizeof(InteractableToolsInputRouter) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BoneCapsuleTriggerLogic), 48 + sizeof(::System::Collections::Generic::List_1<::OculusSampleFramework::ColliderZone*>*)> __OculusSampleFramework_BoneCapsuleTriggerLogicSizeCheck;
  static_assert(sizeof(BoneCapsuleTriggerLogic) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrainTrack), 64 + sizeof(::ArrayW<::OculusSampleFramework::TrackSegment*>)> __OculusSampleFramework_TrainTrackSizeCheck;
  static_assert(sizeof(TrainTrack) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

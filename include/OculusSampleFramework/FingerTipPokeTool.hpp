...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FingerTipPokeTool), 176 + sizeof(::GlobalNamespace::OVRBoneCapsule*)> __OculusSampleFramework_FingerTipPokeToolSizeCheck;
  static_assert(sizeof(FingerTipPokeTool) == 0xB8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

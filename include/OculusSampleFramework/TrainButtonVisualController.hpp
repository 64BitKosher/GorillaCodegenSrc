...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrainButtonVisualController), 160 + sizeof(::UnityEngine::Vector3)> __OculusSampleFramework_TrainButtonVisualControllerSizeCheck;
  static_assert(sizeof(TrainButtonVisualController) == 0xAC);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

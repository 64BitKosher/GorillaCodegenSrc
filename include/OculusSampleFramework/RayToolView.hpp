...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(RayToolView), 88 + sizeof(::OculusSampleFramework::InteractableTool*)> __OculusSampleFramework_RayToolViewSizeCheck;
  static_assert(sizeof(RayToolView) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

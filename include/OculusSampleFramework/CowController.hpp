...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CowController), 40 + sizeof(::UnityEngine::AudioSource*)> __OculusSampleFramework_CowControllerSizeCheck;
  static_assert(sizeof(CowController) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FingerTipPokeToolView), 52 + sizeof(float)> __OculusSampleFramework_FingerTipPokeToolViewSizeCheck;
  static_assert(sizeof(FingerTipPokeToolView) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrainCarBase), 80 + sizeof(::OculusSampleFramework::Pose*)> __OculusSampleFramework_TrainCarBaseSizeCheck;
  static_assert(sizeof(TrainCarBase) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"

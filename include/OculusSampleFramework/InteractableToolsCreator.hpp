...
namespace OculusSampleFramework {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InteractableToolsCreator), 40 + sizeof(::ArrayW<::UnityEngine::Transform*>)> __OculusSampleFramework_InteractableToolsCreatorSizeCheck;
  static_assert(sizeof(InteractableToolsCreator) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
